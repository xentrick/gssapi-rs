 ...
 */
    ...
    use super::krb5_h::{krb5_int16, krb5_ui_2, krb5_octet, krb5_magic,
                        ...
                        krb5_address, krb5_error_code};
    use super::k5_int_h::_krb5_context;
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "698:1"]
        pub fn krb5_db_audit_as_req(kcontext: krb5_context,
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/net-server.h:28"]
...
#[c2rust::header_src = "/usr/include/arpa/inet.h:27"]
pub mod inet_h {
...
pub mod kdc_util_h {
    use super::krb5_h::{krb5_enctype, krb5_kdc_rep};
    extern "C" {
        /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/* kdc/kdc_util.h */
/*
 ...
 */
        ...
        pub fn ktypes2str(ktype: *mut krb5_enctype, nktypes: libc::c_int)
         -> *mut libc::c_char;
        #[no_mangle]
        #[c2rust::src_loc = "114:1"]
        pub fn rep_etypes2str(rep: *mut krb5_kdc_rep) -> *mut libc::c_char;
    }
    /* __KRB5_KDC_UTIL__ */
}
#[c2rust::header_src =
...
pub use self::krb5_h::{krb5_octet, krb5_int16, krb5_ui_2, krb5_int32,
                       ...
                       _profile_t, krb5_unparse_name, krb5_free_unparsed_name,
...
use self::kdc_util_h::{limit_string, ktypes2str, rep_etypes2str};
...
#[no_mangle]
#[c2rust::src_loc = "56:1"]
pub unsafe extern "C" fn log_as_req(mut context: krb5_context,
    ...
    let mut fromstring: *const libc::c_char = 0 as *const libc::c_char;
    let mut fromstringbuf: [libc::c_char; 70] = [0; 70];
    let mut ktypestr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut cname2: *const libc::c_char =
        if !cname.is_null() {
            cname
        } else {
            b"<unknown client>\x00" as *const u8 as *const libc::c_char
        };
    let mut sname2: *const libc::c_char =
        if !sname.is_null() {
            sname
        } else {
            b"<unknown server>\x00" as *const u8 as *const libc::c_char
        };
    fromstring =
        inet_ntop(if (*(*remote_addr).address).addrtype == 0x18 as libc::c_int
                     {
                      10 as libc::c_int
                  } else if (*(*remote_addr).address).addrtype ==
                                0x2 as libc::c_int {
                      2 as libc::c_int
                  } else { -(1 as libc::c_int) },
                  (*(*remote_addr).address).contents as *const libc::c_void,
                  fromstringbuf.as_mut_ptr(),
                  ::std::mem::size_of::<[libc::c_char; 70]>() as libc::c_ulong
                      as socklen_t);
    if fromstring.is_null() {
        fromstring = b"<unknown>\x00" as *const u8 as *const libc::c_char
    }
    ktypestr = ktypes2str((*request).ktype, (*request).nktypes);
    if status.is_null() {
        /* success */
        let mut rep_etypestr: *mut libc::c_char = rep_etypes2str(reply);
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"AS_REQ (%s) %s: ISSUE: authtime %u, %s, %s for %s\x00"
                                      as *const u8 as *const libc::c_char),
                         if !ktypestr.is_null() {
                             ktypestr as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
                         }, fromstring, authtime as libc::c_uint,
                         if !rep_etypestr.is_null() {
                             rep_etypestr as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
                         }, cname2, sname2);
        free(rep_etypestr as *mut libc::c_void);
    } else {
        /* fail */
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"AS_REQ (%s) %s: %s: %s for %s%s%s\x00" as
                                      *const u8 as *const libc::c_char),
                         if !ktypestr.is_null() {
                             ktypestr as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
                         }, fromstring, status, cname2, sname2,
                         if !emsg.is_null() {
                             b", \x00" as *const u8 as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
    ...
    krb5_db_audit_as_req(context, request, (*local_addr).address,
                         ...
                         errcode);
    free(ktypestr as *mut libc::c_void);
}
/*
...
unsafe extern "C" fn unparse_and_limit(mut ctx: krb5_context,
                                       mut princ: krb5_principal,
                                       mut str: *mut *mut libc::c_char) {
    /* Ignore errors */
    krb5_unparse_name(ctx, princ as krb5_const_principal, str);
    limit_string(*str);
}
...
pub unsafe extern "C" fn log_tgs_req(mut ctx: krb5_context,
                                     mut from: *const krb5_fulladdr,
                                     mut request: *mut krb5_kdc_req,
                                     mut reply: *mut krb5_kdc_rep,
                                     mut cprinc: krb5_principal,
                                     mut sprinc: krb5_principal,
                                     mut altcprinc: krb5_principal,
                                     mut authtime: krb5_timestamp,
                                     ...
                                     mut emsg: *const libc::c_char) {
    let mut ktypestr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut rep_etypestr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut fromstring: *const libc::c_char = 0 as *const libc::c_char;
    let mut fromstringbuf: [libc::c_char; 70] = [0; 70];
    let mut cname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut sname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut altcname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut logcname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut logsname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut logaltcname: *mut libc::c_char = 0 as *mut libc::c_char;
    fromstring =
        inet_ntop(if (*(*from).address).addrtype == 0x18 as libc::c_int {
                      10 as libc::c_int
                  } else if (*(*from).address).addrtype == 0x2 as libc::c_int
                   {
                      2 as libc::c_int
                  } else { -(1 as libc::c_int) },
                  (*(*from).address).contents as *const libc::c_void,
                  fromstringbuf.as_mut_ptr(),
                  ::std::mem::size_of::<[libc::c_char; 70]>() as libc::c_ulong
                      as socklen_t);
    if fromstring.is_null() {
    ...
    unparse_and_limit(ctx, cprinc, &mut cname);
    logcname =
        if !cname.is_null() {
            cname as *const libc::c_char
        } else { b"<unknown client>\x00" as *const u8 as *const libc::c_char }
            as *mut libc::c_char;
    unparse_and_limit(ctx, sprinc, &mut sname);
    logsname =
        if !sname.is_null() {
            sname as *const libc::c_char
        } else { b"<unknown server>\x00" as *const u8 as *const libc::c_char }
            as *mut libc::c_char;
    unparse_and_limit(ctx, altcprinc, &mut altcname);
    logaltcname =
        if !altcname.is_null() {
            altcname as *const libc::c_char
        } else { b"<unknown>\x00" as *const u8 as *const libc::c_char } as
            *mut libc::c_char;
    /* Differences: server-nomatch message logs 2nd ticket's client
       name (useful), and doesn't log ktypestr (probably not
       important).  */
    if errcode as libc::c_long != -(1765328358 as libc::c_long) {
        ktypestr = ktypes2str((*request).ktype, (*request).nktypes);
        rep_etypestr = rep_etypes2str(reply);
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"TGS_REQ (%s) %s: %s: authtime %u, %s%s %s for %s%s%s\x00"
                                      as *const u8 as *const libc::c_char),
                         if !ktypestr.is_null() {
                             ktypestr as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
                         }, fromstring, status, authtime as libc::c_uint,
                         if !rep_etypestr.is_null() {
                             rep_etypestr as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
        ...
        if c_flags & 0x100 as libc::c_int as libc::c_uint != 0 {
            krb5_klog_syslog(6 as libc::c_int,
                             dgettext(b"mit-krb5\x00" as *const u8 as
                                          *const libc::c_char,
                                      b"... PROTOCOL-TRANSITION s4u-client=%s\x00"
                                          as *const u8 as
                                          *const libc::c_char), logaltcname);
        } else if c_flags & 0x200 as libc::c_int as libc::c_uint != 0 {
            krb5_klog_syslog(6 as libc::c_int,
                             dgettext(b"mit-krb5\x00" as *const u8 as
                                          *const libc::c_char,
                                      b"... CONSTRAINED-DELEGATION s4u-client=%s\x00"
                                          as *const u8 as
                                          *const libc::c_char), logaltcname);
        }
    } else {
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"TGS_REQ %s: %s: authtime %u, %s for %s, 2nd tkt client %s\x00"
                                      as *const u8 as *const libc::c_char),
                         fromstring, status, authtime as libc::c_uint,
...
pub unsafe extern "C" fn log_tgs_badtrans(mut ctx: krb5_context,
                                          mut cprinc: krb5_principal,
                                          mut sprinc: krb5_principal,
                                          mut trcont: *mut krb5_data,
                                          mut errcode: krb5_error_code) {
    ...
    tlen = (*trcont).length;
    tdots =
        if tlen > 125 as libc::c_int as libc::c_uint {
            b"...\x00" as *const u8 as *const libc::c_char
    ...
    if errcode as libc::c_long == -(1765328341 as libc::c_long) {
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"bad realm transit path from \'%s\' to \'%s\' via \'%.*s%s\'\x00"
                                      as *const u8 as *const libc::c_char),
        ...
        krb5_klog_syslog(3 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"unexpected error checking transit from \'%s\' to \'%s\' via \'%.*s%s\': %s\x00"
                                      as *const u8 as *const libc::c_char),
                         logcname, logsname, tlen, (*trcont).data, tdots,
                         emsg);
...
pub unsafe extern "C" fn log_tgs_alt_tgt(mut context: krb5_context,
                                         mut p: krb5_principal) {
    let mut sname: *mut libc::c_char = 0 as *mut libc::c_char;
    if krb5_unparse_name(context, p as krb5_const_principal, &mut sname) != 0
       {
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"TGS_REQ: issuing alternate <un-unparseable> TGT\x00"
                                      as *const u8 as *const libc::c_char));
    } else {
        limit_string(sname);
        krb5_klog_syslog(6 as libc::c_int,
                         dgettext(b"mit-krb5\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"TGS_REQ: issuing TGT %s\x00" as *const u8
                                      as *const libc::c_char), sname);
