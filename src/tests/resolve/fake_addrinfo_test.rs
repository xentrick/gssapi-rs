...
#[c2rust::header_src = "/usr/include/bits/socket_type.h:3"]
...
#[c2rust::header_src = "/usr/include/bits/sockaddr.h:3"]
pub mod sockaddr_h {
    #[c2rust::src_loc = "28:1"]
    pub type sa_family_t = libc::c_ushort;
}
#[c2rust::header_src = "/usr/include/bits/socket.h:3"]
pub mod socket_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/usr/include/netinet/in.h:3"]
pub mod in_h {
    #[c2rust::src_loc = "40:1"]
...
#[c2rust::header_src = "/usr/include/netdb.h:3"]
pub mod netdb_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/tests/resolve/addrinfo-test.c:3"]
pub mod addrinfo_test_c {
 ...
 */
    ...
    unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char)
     -> libc::c_int {
        ...
        memset(&mut hints as *mut addrinfo as *mut libc::c_void,
               0 as libc::c_int,
        ...
        err = krb5int_getaddrinfo(hname, port, &mut hints, &mut ap);
        if err != 0 {
            printf(b"\terror => %s\n\x00" as *const u8 as *const libc::c_char,
                   if err == -(11 as libc::c_int) {
                       strerror(*__errno_location()) as *const libc::c_char
                   } else { krb5int_gai_strerror(err) });
        ...
        while !ap2.is_null() {
           ...
           either, on AIX, but getnameinfo won't complain.  */
            ...
            if krb5int_getnameinfo((*ap2).ai_addr, (*ap2).ai_addrlen,
                                   hbuf.as_mut_ptr(),
            ...
            printf(b"%p:\n\tfamily = %s\tproto = %-4s\tsocktype = %s\n\x00" as
                       *const u8 as *const libc::c_char,
                   ap2 as *mut libc::c_void, familyname((*ap2).ai_family),
            ...
            printf(b"\taddr = %-28s\tport = %s\n\x00" as *const u8 as
                   ...
                   pbuf.as_mut_ptr());
            err =
                krb5int_getnameinfo((*ap2).ai_addr, (*ap2).ai_addrlen,
                                    hbuf.as_mut_ptr(),
                                    ::std::mem::size_of::<[libc::c_char; 1025]>()
                                        as libc::c_ulong, pbuf.as_mut_ptr(),
                                    ::std::mem::size_of::<[libc::c_char; 32]>()
                                        as libc::c_ulong, 8 as libc::c_int);
            if err != 0 {
                printf(b"\tgetnameinfo(NI_NAMEREQD): %s\n\x00" as *const u8 as
                           *const libc::c_char,
                       if err == -(11 as libc::c_int) {
                           strerror(*__errno_location()) as
                               *const libc::c_char
                       } else { krb5int_gai_strerror(err) });
            } else {
        ...
        krb5int_freeaddrinfo(ap);
        return 0 as libc::c_int;
    }
    #[c2rust::src_loc = "120:1"]
    pub unsafe extern "C" fn familyname(mut f: libc::c_int)
     -> *const libc::c_char {
        pub static mut buf: [libc::c_char; 30] = [0; 30];
        match f {
            2 => { return b"AF_INET\x00" as *const u8 as *const libc::c_char }
            10 => {
                return b"AF_INET6\x00" as *const u8 as *const libc::c_char
            }
            _ => {
    ...
    #[c2rust::src_loc = "74:1"]
    pub unsafe extern "C" fn socktypename(mut t: libc::c_int)
     -> *const libc::c_char {
        pub static mut buf: [libc::c_char; 30] = [0; 30];
        match t {
            ...
            5 => {
                return b"SEQPACKET\x00" as *const u8 as *const libc::c_char
            }
            _ => { }
        }
        snprintf(buf.as_mut_ptr(),
    ...
    #[c2rust::src_loc = "48:1"]
    pub unsafe extern "C" fn protoname(mut p: libc::c_int)
     -> *const libc::c_char {
        pub static mut buf: [libc::c_char; 30] = [0; 30];
    ...
    use super::unistd_h::socklen_t;
    use super::socket_h::sockaddr;
    use super::string_h::{strrchr, memset, strerror};
    use super::in_h::{IPPROTO_UDP, IPPROTO_TCP, IPPROTO_RAW, IPPROTO_ICMP,
                      IPPROTO_IPV6, IPPROTO_GRE, IPPROTO_NONE, IPPROTO_COMP};
    use super::socket_type_h::{SOCK_DGRAM, SOCK_STREAM, SOCK_RAW};
    use super::stdio_h::{printf, snprintf, fprintf, stderr};
    use super::fake_addrinfo_h::{krb5int_getaddrinfo, krb5int_gai_strerror,
                                 krb5int_getnameinfo, krb5int_freeaddrinfo};
    use super::errno_h::__errno_location;
    use super::sockaddr_h::sa_family_t;
    use super::k5_platform_h::krb5int_strlcpy;
    use super::stdlib_h::exit;
}
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/fake-addrinfo.h:3"]
...
#[c2rust::header_src = "/usr/include/errno.h:3"]
pub mod errno_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "37:1"]
...
pub use self::addrinfo_test_c::{main_0, familyname, usage, whoami,
                                socktypename, protoname};
use self::fake_addrinfo_h::{krb5int_getnameinfo, krb5int_gai_strerror,
                            krb5int_freeaddrinfo, krb5int_getaddrinfo};
use self::errno_h::__errno_location;
use self::string_h::{strerror, strrchr, memset};
