...
#[c2rust::header_src = "/usr/lib/clang/9.0.1/include/stddef.h:43"]
pub mod stddef_h {
    #[c2rust::src_loc = "46:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-platform.h:43"]
 ...
 */
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_keyblock, krb5_data, krb5_key, krb5_keyusage,
                        krb5_crypto_iov, krb5_error_code};
...
pub mod gssapi_krb5_h {
    ...
    use super::gssapi_h::{OM_uint32, gss_ctx_id_t};
...
#[c2rust::header_src = "/usr/include/assert.h:43"]
pub mod assert_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "67:1"]
...
#[c2rust::header_src = "/usr/include/bits/byteswap.h:43"]
pub mod byteswap_h {
    #[inline]
    #[c2rust::src_loc = "48:1"]
...
pub use self::k5_platform_h::{C2RustUnnamed, C2RustUnnamed_0, C2RustUnnamed_1,
                              store_32_be, store_16_le, store_32_le};
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_enctype,
                       ...
                       _krb5_crypto_iov, krb5_crypto_iov, _profile_t,
                       krb5_k_create_key, krb5_k_free_key, krb5_k_encrypt_iov,
                       krb5_k_make_checksum, krb5_init_context,
                       krb5_free_context, krb5_free_checksum_contents};
...
pub use self::gssapi_h::{gss_name_t, gss_cred_id_t, gss_ctx_id_t, gss_uint32,
                         ...
                         gss_release_name, gss_delete_sec_context, gss_wrap,
 ...
 */
#[c2rust::src_loc = "54:1"]
unsafe extern "C" fn make_delete_token(mut lctx:
                                           *mut gss_krb5_lucid_context_v1_t,
                                       mut out: *mut gss_buffer_desc) {
    let mut ret: krb5_error_code = 0;
    let mut context: krb5_context = 0 as *mut _krb5_context;
    let mut seqkb: krb5_keyblock =
        krb5_keyblock{magic: 0,
                      enctype: 0,
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut seq: krb5_key = 0 as *mut krb5_key_st;
    let mut cksum: krb5_checksum =
        krb5_checksum{magic: 0,
                      checksum_type: 0,
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut cktype: krb5_cksumtype = 0;
    let mut ckusage: krb5_keyusage = 0;
    ...
    let mut iv: [libc::c_uchar; 8] = [0; 8];
    let mut lkey: *mut gss_krb5_lucid_key_t = &mut (*lctx).rfc1964_kd.ctx_key;
    let mut signalg: libc::c_int = (*lctx).rfc1964_kd.sign_alg as libc::c_int;
    ret = krb5_init_context(&mut context);
    check_k5err(context,
                b"krb5_init_context\x00" as *const u8 as *const libc::c_char,
                ret);
    seqkb.enctype = (*lkey).type_0 as krb5_enctype;
    seqkb.length = (*lkey).length;
    seqkb.contents = (*lkey).data as *mut krb5_octet;
    ret = krb5_k_create_key(context, &mut seqkb, &mut seq);
    check_k5err(context,
                b"krb5_k_create_key\x00" as *const u8 as *const libc::c_char,
                ret);
    if signalg == 0x4 as libc::c_int {
        cktype = 0xc as libc::c_int;
        cksize = 20 as libc::c_int as size_t;
        ckusage = 23 as libc::c_int
    } else if signalg == 0x11 as libc::c_int {
        cktype = -(138 as libc::c_int);
        cksize = 8 as libc::c_int as size_t;
        ckusage = 15 as libc::c_int
    } else { abort(); }
    tlen =
        ((20 as libc::c_int as libc::c_uint).wrapping_add(mech_krb5.length) as
             libc::c_ulong).wrapping_add(cksize);
    token = malloc(tlen) as *mut libc::c_uchar;
    if !token.is_null() {
    } else {
        __assert_fail(b"token != NULL\x00" as *const u8 as
                          *const libc::c_char,
                      b"t_pcontok.c\x00" as *const u8 as *const libc::c_char,
                      94 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 73],
                                                &[libc::c_char; 73]>(b"void make_delete_token(gss_krb5_lucid_context_v1_t *, gss_buffer_desc *)\x00")).as_ptr());
    }
    ...
    let fresh0 = ptr;
    ptr = ptr.offset(1);
    *fresh0 = 0x60 as libc::c_int as libc::c_uchar;
    let fresh1 = ptr;
    ptr = ptr.offset(1);
    *fresh1 =
        tlen.wrapping_sub(2 as libc::c_int as libc::c_ulong) as libc::c_uchar;
    let fresh2 = ptr;
    ptr = ptr.offset(1);
    *fresh2 = 0x6 as libc::c_int as libc::c_uchar;
    let fresh3 = ptr;
    ptr = ptr.offset(1);
    *fresh3 = mech_krb5.length as libc::c_uchar;
    memcpy(ptr as *mut libc::c_void, mech_krb5.elements,
           mech_krb5.length as libc::c_ulong);
    ptr = ptr.offset(mech_krb5.length as isize);
    /* Create the RFC 1964 token header (8 bytes). */
    let fresh4 = ptr;
    ptr = ptr.offset(1);
    *fresh4 = 0x1 as libc::c_int as libc::c_uchar;
    let fresh5 = ptr;
    ptr = ptr.offset(1);
    *fresh5 = 0x2 as libc::c_int as libc::c_uchar;
    store_16_le(signalg as libc::c_uint, ptr as *mut libc::c_void);
    ...
    *fresh6 = 0xff as libc::c_int as libc::c_uchar;
    let fresh7 = ptr;
    ptr = ptr.offset(1);
    *fresh7 = 0xff as libc::c_int as libc::c_uchar;
    let fresh8 = ptr;
    ptr = ptr.offset(1);
    *fresh8 = 0xff as libc::c_int as libc::c_uchar;
    let fresh9 = ptr;
    ptr = ptr.offset(1);
    *fresh9 = 0xff as libc::c_int as libc::c_uchar;
    /* Create the checksum (cksize bytes at offset 8 from the header). */
    d =
        make_data(ptr.offset(-(8 as libc::c_int as isize)) as
                      *mut libc::c_void, 8 as libc::c_int as libc::c_uint);
    ret =
        krb5_k_make_checksum(context, cktype, seq, ckusage, &mut d,
                             &mut cksum);
    check_k5err(context,
                b"krb5_k_make_checksum\x00" as *const u8 as
                    *const libc::c_char, ret);
    memcpy(ptr.offset(8 as libc::c_int as isize) as *mut libc::c_void,
           cksum.contents as *const libc::c_void, cksize);
    /* Create the sequence number (8 bytes). */
    iov.flags = 2 as libc::c_int;
    iov.data =
        make_data(ptr as *mut libc::c_void, 8 as libc::c_int as libc::c_uint);
    let ref mut fresh10 = *ptr.offset(7 as libc::c_int as isize);
    *fresh10 =
        if (*lctx).initiate != 0 {
            0 as libc::c_int
        } else { 0xff as libc::c_int } as libc::c_uchar;
    let ref mut fresh11 = *ptr.offset(6 as libc::c_int as isize);
    *fresh11 = *fresh10;
    let ref mut fresh12 = *ptr.offset(5 as libc::c_int as isize);
    *fresh12 = *fresh11;
    *ptr.offset(4 as libc::c_int as isize) = *fresh12;
    memcpy(iv.as_mut_ptr() as *mut libc::c_void,
           ptr.offset(8 as libc::c_int as isize) as *const libc::c_void,
           8 as libc::c_int as libc::c_ulong);
    d =
        make_data(iv.as_mut_ptr() as *mut libc::c_void,
                  8 as libc::c_int as libc::c_uint);
    if signalg == 0x11 as libc::c_int {
        store_32_be((*lctx).send_seq as libc::c_uint,
                    ptr as *mut libc::c_void);
        ret =
            krb5int_arcfour_gsscrypt(&mut (*seq).keyblock, 0 as libc::c_int,
                                     &mut d, &mut iov,
                                     1 as libc::c_int as size_t);
        check_k5err(context,
                    b"krb5int_arcfour_gsscrypt(seq)\x00" as *const u8 as
                        *const libc::c_char, ret);
    } else {
        store_32_le((*lctx).send_seq as libc::c_uint,
                    ptr as *mut libc::c_void);
        ret =
            krb5_k_encrypt_iov(context, seq, 24 as libc::c_int, &mut d,
                               &mut iov, 1 as libc::c_int as size_t);
        check_k5err(context,
                    b"krb5_k_encrypt_iov(seq)\x00" as *const u8 as
                        *const libc::c_char, ret);
    }
    ...
    (*out).length = tlen;
    (*out).value = token as *mut libc::c_void;
}
#[c2rust::src_loc = "146:1"]
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char)
 -> libc::c_int {
    ...
    let mut lctx: *mut gss_krb5_lucid_context_v1_t =
        0 as *mut gss_krb5_lucid_context_v1_t;
    let mut lptr: *mut libc::c_void = 0 as *mut libc::c_void;
    if argc == 2 as libc::c_int {
    } else {
        __assert_fail(b"argc == 2\x00" as *const u8 as *const libc::c_char,
                      b"t_pcontok.c\x00" as *const u8 as *const libc::c_char,
    ...
    major =
        gss_krb5_export_lucid_sec_context(&mut minor, &mut actx,
                                          ...
                                          &mut lptr);
    check_gsserr(b"gss_export_lucid_sec_context\x00" as *const u8 as
                     *const libc::c_char, major, minor);
    lctx = lptr as *mut gss_krb5_lucid_context_v1_t;
    if (*lctx).protocol == 0 {
        /* Make an RFC 1964 context deletion token and pass it to
         * gss_process_context_token. */
        make_delete_token(lctx, &mut token);
        major = gss_process_context_token(&mut minor, ictx, &mut token);
        free(token.value);
        check_gsserr(b"gss_process_context_token\x00" as *const u8 as
                         *const libc::c_char, major, minor);
        /* Check for the appropriate major code from gss_wrap. */
        major =
            gss_wrap(&mut minor, ictx, 1 as libc::c_int,
                     0 as libc::c_int as gss_qop_t, &mut in_0,
                     0 as *mut libc::c_int, &mut out);
        if major == (8 as libc::c_ulong as OM_uint32) << 16 as libc::c_int {
        } else {
            __assert_fail(b"major == GSS_S_NO_CONTEXT\x00" as *const u8 as
                              *const libc::c_char,
                          b"t_pcontok.c\x00" as *const u8 as
                              *const libc::c_char,
        ...
        token.value =
            b"abcd\x00" as *const u8 as *const libc::c_char as
                *mut libc::c_void;
        token.length = 4 as libc::c_int as size_t;
        major = gss_process_context_token(&mut minor, ictx, &mut token);
        if major == (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int {
        } else {
            __assert_fail(b"major == GSS_S_DEFECTIVE_TOKEN\x00" as *const u8
    ...
    gss_krb5_free_lucid_sec_context(&mut minor, lptr);
