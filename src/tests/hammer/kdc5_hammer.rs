...
#[c2rust::header_src = "/usr/include/bits/types/struct_timeval.h:26"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/com_err.h:26"]
pub mod com_err_h {
    /*
...
#[c2rust::header_src = "/usr/include/bits/getopt_core.h:26"]
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       _krb5_keyblock, krb5_keyblock, _krb5_encrypt_block,
                       krb5_encrypt_block, _krb5_enc_data, krb5_enc_data,
                       ...
                       krb5_ticket, _krb5_creds, krb5_creds, krb5_ccache,
                       ...
                       krb5_string_to_key, krb5_use_enctype,
                       krb5_cc_initialize, krb5_cc_close,
                       krb5_cc_get_principal, krb5_get_default_realm,
                       krb5_init_context, krb5_free_context,
                       krb5_get_credentials, krb5_mk_req_extended,
                       krb5_parse_name, krb5_unparse_name,
                       krb5_principal_compare, krb5_principal2salt,
                       krb5_cc_resolve, krb5_cc_default, krb5_free_principal,
                       krb5_free_ticket, krb5_free_creds,
                       krb5_free_cred_contents, krb5_free_keyblock,
                       krb5_free_data_contents, krb5_timeofday, krb5_rd_req,
...
use self::string_h::{strlen, strrchr, strncat, strncpy, memset};
use self::stdlib_h::{atoi, malloc, free, exit};
use self::stdio_h::{stderr, fprintf, snprintf, asprintf};
...
#[c2rust::src_loc = "34:8"]
pub struct h_timer {
    pub ht_cumulative: libc::c_float,
    pub ht_min: libc::c_float,
    pub ht_max: libc::c_float,
    pub ht_observations: krb5_int32,
}
#[no_mangle]
#[c2rust::src_loc = "43:7"]
pub static mut prog: *mut libc::c_char =
    0 as *const libc::c_char as *mut libc::c_char;
#[c2rust::src_loc = "45:12"]
static mut brief: libc::c_int = 0;
#[c2rust::src_loc = "46:14"]
static mut cur_realm: *mut libc::c_char =
    0 as *const libc::c_char as *mut libc::c_char;
#[c2rust::src_loc = "47:12"]
static mut do_timer: libc::c_int = 0 as libc::c_int;
#[no_mangle]
#[c2rust::src_loc = "49:11"]
pub static mut tgtname: krb5_data =
    {
        let mut init =
...
unsafe extern "C" fn usage(mut who: *mut libc::c_char,
    ...
    fprintf(stderr,
            b"usage: %s -p prefix -n num_to_check [-c cachename] [-r realmname]\n\x00"
                as *const u8 as *const libc::c_char, who);
    fprintf(stderr,
            b"\t [-D depth]\n\x00" as *const u8 as *const libc::c_char);
    fprintf(stderr,
            b"\t [-P preauth type] [-R repeat_count] [-t] [-b] [-v] \n\x00" as
                *const u8 as *const libc::c_char);
    exit(status);
}
#[c2rust::src_loc = "84:27"]
static mut patype: *mut krb5_preauthtype =
    0 as *const krb5_preauthtype as *mut krb5_preauthtype;
#[c2rust::src_loc = "84:42"]
static mut patypedata: [krb5_preauthtype; 2] =
    [0 as libc::c_int, -(1 as libc::c_int)];
#[c2rust::src_loc = "85:21"]
static mut test_context: krb5_context =
    0 as *const _krb5_context as *mut _krb5_context;
#[no_mangle]
#[c2rust::src_loc = "87:16"]
pub static mut tstart_time: timeval = timeval{tv_sec: 0, tv_usec: 0,};
#[no_mangle]
#[c2rust::src_loc = "87:29"]
pub static mut tend_time: timeval = timeval{tv_sec: 0, tv_usec: 0,};
#[no_mangle]
#[c2rust::src_loc = "88:17"]
pub static mut dontcare: timezone =
    timezone{tz_minuteswest: 0, tz_dsttime: 0,};
#[no_mangle]
#[c2rust::src_loc = "90:16"]
pub static mut in_tkt_times: h_timer =
    {
        let mut init =
            h_timer{ht_cumulative: 0.0f64 as libc::c_float,
                    ht_min: 1000000.0f64 as libc::c_float,
                    ht_max: -1.0f64 as libc::c_float,
                    ht_observations: 0 as libc::c_int,};
        init
    };
#[no_mangle]
#[c2rust::src_loc = "91:16"]
pub static mut tgs_req_times: h_timer =
    {
        let mut init =
            h_timer{ht_cumulative: 0.0f64 as libc::c_float,
                    ht_min: 1000000.0f64 as libc::c_float,
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char)
 -> libc::c_int {
    let mut ccache: krb5_ccache = 0 as krb5_ccache; /* -f option */
    let mut cache_name: *mut libc::c_char =
        0 as *mut libc::c_char; /* how many times? */
    let mut option: libc::c_int = 0; /* how deep to go */
    ...
    let mut repeat_count: libc::c_int = 0;
    let mut counter: libc::c_int = 0;
    let mut n_tried: libc::c_int = 0;
    let mut errors: libc::c_int = 0;
    let mut prefix: [libc::c_char; 8192] = [0; 8192];
    let mut client: [libc::c_char; 4096] = [0; 4096];
    let mut server: [libc::c_char; 4096] = [0; 4096];
    let mut depth: libc::c_int = 0;
    let mut ctmp: [libc::c_char; 4096] = [0; 4096];
    let mut ctmp2: [libc::c_char; 8192] = [0; 8192];
    let mut stmp: [libc::c_char; 4096] = [0; 4096];
    let mut stmp2: [libc::c_char; 8192] = [0; 8192];
    let mut client_princ: krb5_principal = 0 as *mut krb5_principal_data;
    let mut retval: krb5_error_code = 0;
    krb5_init_context(&mut test_context);
    ...
    } else { prog = *argv.offset(0 as libc::c_int as isize) }
    num_to_check = 0 as libc::c_int;
    depth = 1 as libc::c_int;
    repeat_count = 1 as libc::c_int;
    brief = 0 as libc::c_int;
    n_tried = 0 as libc::c_int;
    errors = 0 as libc::c_int;
    loop  {
        option =
            getopt(argc, argv,
                   b"D:p:n:c:R:P:e:bvr:t\x00" as *const u8 as
                       *const libc::c_char);
        if !(option != -(1 as libc::c_int)) { break ; }
        match option {
            116 => { do_timer = 1 as libc::c_int }
            98 => { brief = 1 as libc::c_int }
            118 => { brief = 0 as libc::c_int }
            82 => { repeat_count = atoi(optarg) }
            114 => { cur_realm = optarg }
            68 => { depth = atoi(optarg) }
            112 => {
                /* prefix name to check */
                strncpy(prefix.as_mut_ptr(), optarg,
                        (::std::mem::size_of::<[libc::c_char; 8192]>() as
                             libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                             libc::c_ulong));
                prefix[(::std::mem::size_of::<[libc::c_char; 8192]>() as
                            libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                            libc::c_ulong) as
            ...
            80 => {
                patypedata[0 as libc::c_int as usize] = atoi(optarg);
                patype = patypedata.as_mut_ptr()
            }
            99 => {
                if ccache.is_null() {
                    cache_name = optarg;
                    code =
                        krb5_cc_resolve(test_context, cache_name,
                                        &mut ccache);
                    if code != 0 as libc::c_int {
                        com_err(prog, code as errcode_t,
                                b"resolving %s\x00" as *const u8 as
                                    *const libc::c_char, cache_name);
                        errflg += 1
                    }
                } else {
                    fprintf(stderr,
    ...
    if !(num_to_check != 0 &&
             prefix[0 as libc::c_int as usize] as libc::c_int != 0) {
        usage(prog, 1 as libc::c_int);
    }
    if cur_realm.is_null() {
        retval = krb5_get_default_realm(test_context, &mut cur_realm);
        if retval != 0 {
            com_err(prog, retval as errcode_t,
    ...
    if ccache.is_null() {
        code = krb5_cc_default(test_context, &mut ccache);
        if code != 0 {
            com_err(prog, code as errcode_t,
    ...
    memset(ctmp.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong);
    memset(stmp.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<[libc::c_char; 4096]>() as libc::c_ulong);
	...
	/* we can't pick random names because we need to generate all the names
	   again given a prefix and count to test the db lib and kdb */
            ctmp[0 as libc::c_int as usize] = '\u{0}' as i32 as libc::c_char;
            i = 1 as libc::c_int;
            while i <= depth {
                snprintf(ctmp2.as_mut_ptr(),
                         ::std::mem::size_of::<[libc::c_char; 8192]>() as
                             libc::c_ulong,
                         b"%s%s%d-DEPTH-%d\x00" as *const u8 as
                             *const libc::c_char,
                         if i != 1 as libc::c_int {
                             b"/\x00" as *const u8 as *const libc::c_char
                         } else {
                             b"\x00" as *const u8 as *const libc::c_char
                         }, prefix.as_mut_ptr(), n, i);
                ctmp2[(::std::mem::size_of::<[libc::c_char; 8192]>() as
                           libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                           libc::c_ulong) as
                          usize] = '\u{0}' as i32 as libc::c_char;
                strncat(ctmp.as_mut_ptr(), ctmp2.as_mut_ptr(),
                        (::std::mem::size_of::<[libc::c_char; 4096]>() as
                             libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                             libc::c_ulong).wrapping_sub(strlen(ctmp.as_mut_ptr())));
                ctmp[(::std::mem::size_of::<[libc::c_char; 4096]>() as
                          libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                          libc::c_ulong) as
                         usize] = '\u{0}' as i32 as libc::c_char;
                snprintf(client.as_mut_ptr(),
                         ::std::mem::size_of::<[libc::c_char; 4096]>() as
                             libc::c_ulong,
                         b"%s@%s\x00" as *const u8 as *const libc::c_char,
                         ctmp.as_mut_ptr(), cur_realm);
                if get_tgt(test_context, client.as_mut_ptr(),
                           &mut client_princ, ccache) != 0 {
                    errors += 1;
                    n_tried += 1
                } else {
                    n_tried += 1;
                    stmp[0 as libc::c_int as usize] =
                        '\u{0}' as i32 as libc::c_char;
                    j = 1 as libc::c_int;
                    while j <= depth {
                        snprintf(stmp2.as_mut_ptr(),
                                 ...
                                 if j != 1 as libc::c_int {
                                     ...
                                     b"\x00" as *const u8 as
                                         *const libc::c_char
                                 }, prefix.as_mut_ptr(), n, j);
                        stmp2[(::std::mem::size_of::<[libc::c_char; 8192]>()
                                   as
                        ...
                        strncat(stmp.as_mut_ptr(), stmp2.as_mut_ptr(),
                                (::std::mem::size_of::<[libc::c_char; 4096]>()
                                     as
                                     libc::c_ulong).wrapping_sub(1 as
                                                                     libc::c_int
                                                                     as
                                                                     libc::c_ulong).wrapping_sub(strlen(stmp.as_mut_ptr())));
                        stmp[(::std::mem::size_of::<[libc::c_char; 4096]>() as
                                  libc::c_ulong).wrapping_sub(1 as libc::c_int
                                                                  as
                                                                  libc::c_ulong)
                                 as usize] = '\u{0}' as i32 as libc::c_char;
                        snprintf(server.as_mut_ptr(),
                                 ::std::mem::size_of::<[libc::c_char; 4096]>()
                                     as libc::c_ulong,
                                 b"%s@%s\x00" as *const u8 as
                                     *const libc::c_char, stmp.as_mut_ptr(),
                                 cur_realm);
                        if verify_cs_pair(test_context, client.as_mut_ptr(),
                                          client_princ, stmp.as_mut_ptr(),
                                          cur_realm, n, i, j, ccache) != 0 {
                            errors += 1
                        }
                        n_tried += 1;
                        j += 1
    ...
    fprintf(stderr,
            b"\nTried %d.  Got %d errors.\n\x00" as *const u8 as
                *const libc::c_char, n_tried, errors);
    if do_timer != 0 {
        if in_tkt_times.ht_observations != 0 {
            fprintf(stderr,
                    b"%8d  AS_REQ requests: %9.6f average (min: %9.6f, max:%9.6f)\n\x00"
                        as *const u8 as *const libc::c_char,
                    in_tkt_times.ht_observations,
                    (in_tkt_times.ht_cumulative /
                         in_tkt_times.ht_observations as libc::c_float) as
                        libc::c_double, in_tkt_times.ht_min as libc::c_double,
                    in_tkt_times.ht_max as libc::c_double);
        }
        if tgs_req_times.ht_observations != 0 {
            fprintf(stderr,
                    b"%8d TGS_REQ requests: %9.6f average (min: %9.6f, max:%9.6f)\n\x00"
                        as *const u8 as *const libc::c_char,
                    tgs_req_times.ht_observations,
                    (tgs_req_times.ht_cumulative /
                         tgs_req_times.ht_observations as libc::c_float) as
                        libc::c_double,
                    tgs_req_times.ht_min as libc::c_double,
                    tgs_req_times.ht_max as libc::c_double);
        }
    }
    krb5_cc_close(test_context, ccache);
    krb5_free_context(test_context);
    exit(errors);
}
#[c2rust::src_loc = "273:1"]
unsafe extern "C" fn get_server_key(mut context: krb5_context,
                                    mut server: krb5_principal,
                                    mut enctype: krb5_enctype,
                                    mut key: *mut *mut krb5_keyblock)
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0;
    let mut eblock: krb5_encrypt_block =
    ...
    *key = 0 as *mut krb5_keyblock;
    retval =
        krb5_principal2salt(context, server as krb5_const_principal,
                            &mut salt);
    ...
    if !(retval != 0) {
        pwd.data = string;
        pwd.length = strlen(string) as libc::c_uint;
        *key =
            malloc(::std::mem::size_of::<krb5_keyblock>() as libc::c_ulong) as
                *mut krb5_keyblock;
        if !(*key).is_null() {
            krb5_use_enctype(context, &mut eblock, enctype);
            retval =
                krb5_string_to_key(context, &mut eblock, *key, &mut pwd,
                                   &mut salt);
            if retval != 0 {
    ...
    free(salt.data as *mut libc::c_void);
    return retval;
}
#[no_mangle]
#[c2rust::src_loc = "314:1"]
pub unsafe extern "C" fn verify_cs_pair(mut context: krb5_context,
                                        mut p_client_str: *mut libc::c_char,
                                        mut p_client: krb5_principal,
                                        mut service: *mut libc::c_char,
                                        mut hostname: *mut libc::c_char,
                                        mut p_num: libc::c_int,
                                        mut c_depth: libc::c_int,
                                        mut s_depth: libc::c_int,
 ...
 -> libc::c_int {
    ...
    let mut request_data: krb5_data = empty_data();
    let mut sname: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut dt: libc::c_float = 0.;
    if brief != 0 {
        fprintf(stderr,
                b"\tprinc (%d) client (%d) for server (%d)\n\x00" as *const u8
                    as *const libc::c_char, p_num, c_depth, s_depth);
    } else {
        fprintf(stderr,
                b"\tclient %s for server %s\n\x00" as *const u8 as
                    *const libc::c_char, p_client_str, service);
    }
    ...
    /* Do client side */
    if asprintf(&mut sname as *mut *mut libc::c_char,
                b"%s@%s\x00" as *const u8 as *const libc::c_char, service,
                hostname) >= 0 as libc::c_int {
        retval = krb5_parse_name(context, sname, &mut creds.server);
    ...
    if retval != 0 {
        com_err(prog, retval as errcode_t,
                b"while getting client princ for %s\x00" as *const u8 as
                    *const libc::c_char, hostname);
        return retval
    }
    retval =
        krb5_get_credentials(context, 0 as libc::c_int, ccache, &mut creds,
                             &mut credsp);
    if retval != 0 {
        com_err(prog, retval as errcode_t,
                b"while getting creds for %s\x00" as *const u8 as
                    *const libc::c_char, hostname);
        return retval
    }
    if do_timer != 0 { gettimeofday(&mut tstart_time, &mut dontcare); }
    retval =
        krb5_mk_req_extended(context, &mut auth_context, 0 as libc::c_int,
                             0 as *mut krb5_data, credsp, &mut request_data);
    if retval != 0 {
        com_err(prog, retval as errcode_t,
                b"while preparing AP_REQ for %s\x00" as *const u8 as
                    *const libc::c_char, hostname);
    } else {
        krb5_auth_con_free(context, auth_context);
        auth_context = 0 as krb5_auth_context;
        /* Do server side now */
        retval =
            get_server_key(context, (*credsp).server,
                           (*credsp).keyblock.enctype,
                           &mut keyblock); /* -l option */
        if retval != 0 {
            com_err(prog, retval as errcode_t,
                    b"while getting server key for %s\x00" as *const u8 as
                        *const libc::c_char, hostname);
        } else if krb5_auth_con_init(context, &mut auth_context) != 0 {
            com_err(prog, retval as errcode_t,
                    b"while creating auth_context for %s\x00" as *const u8 as
                        *const libc::c_char, hostname);
        } else if krb5_auth_con_setuseruserkey(context, auth_context,
                                               keyblock) != 0 {
            com_err(prog, retval as errcode_t,
                    b"while setting auth_context key %s\x00" as *const u8 as
                        *const libc::c_char, hostname);
        } else {
            retval =
                krb5_rd_req(context, &mut auth_context, &mut request_data,
                            0 as krb5_const_principal, 0 as krb5_keytab,
                            0 as *mut krb5_flags, &mut ticket);
            if retval != 0 {
                com_err(prog, retval as errcode_t,
                        b"while decoding AP_REQ for %s\x00" as *const u8 as
                            *const libc::c_char, hostname);
            } else {
                if do_timer != 0 {
                    dt =
                        if gettimeofday(&mut tend_time, &mut dontcare) != 0 {
                            -1.0f64
                        } else {
                            ((tend_time.tv_sec - tstart_time.tv_sec) as
                                 libc::c_float as libc::c_double) +
                                (tend_time.tv_usec - tstart_time.tv_usec) as
                                    libc::c_float as libc::c_double /
                                    1000000.0f64
                        } as libc::c_float;
                    tgs_req_times.ht_cumulative += dt;
                    tgs_req_times.ht_observations += 1;
                    if dt > tgs_req_times.ht_max { tgs_req_times.ht_max = dt }
                    if dt < tgs_req_times.ht_min { tgs_req_times.ht_min = dt }
                }
                if krb5_principal_compare(context,
                                          (*(*ticket).enc_part2).client as
                                              krb5_const_principal,
                                          p_client as krb5_const_principal) ==
                       0 {
                    let mut returned_client: *mut libc::c_char =
                    ...
                    if retval != 0 {
                        com_err(prog, retval as errcode_t,
                                b"Client not as expected, but cannot unparse client name\x00"
                                    as *const u8 as *const libc::c_char);
                    } else {
                        com_err(prog, 0 as libc::c_int as errcode_t,
                                b"Client not as expected (%s).\x00" as
                                    *const u8 as *const libc::c_char,
                                returned_client);
                    }
                    retval = -(1765328238 as libc::c_long) as krb5_error_code;
                    free(returned_client as *mut libc::c_void);
...
pub unsafe extern "C" fn get_tgt(mut context: krb5_context,
                                 mut p_client_str: *mut libc::c_char,
                                 mut p_client: *mut krb5_principal,
                                 mut ccache: krb5_ccache) -> libc::c_int {
    let mut lifetime: libc::c_long =
        (60 as libc::c_int * 60 as libc::c_int * 8 as libc::c_int) as
            libc::c_long;
    let mut code: krb5_error_code = 0;
        ...
        krb5_creds{magic: 0,
                   ...
                   second_ticket:
                       krb5_data{magic: 0,
                                 ...
                                 data: 0 as *mut libc::c_char,},
                   authdata: 0 as *mut *mut krb5_authdata,};
    let mut start: krb5_timestamp = 0;
    let mut dt: libc::c_float = 0.;
    ...
    if brief == 0 {
        fprintf(stderr,
                b"\tgetting TGT for %s\n\x00" as *const u8 as
                    *const libc::c_char, p_client_str);
    }
    code = krb5_timeofday(context, &mut start);
    if code != 0 {
        com_err(prog, code as errcode_t,
                b"while getting time of day\x00" as *const u8 as
                    *const libc::c_char);
    ...
    memset(&mut my_creds as *mut krb5_creds as *mut libc::c_void,
           0 as libc::c_int,
           ::std::mem::size_of::<krb5_creds>() as libc::c_ulong);
    code = krb5_parse_name(context, p_client_str, p_client);
    if code != 0 {
        com_err(prog, code as errcode_t,
    ...
    if code != 0 as libc::c_int {
        com_err(prog, code as errcode_t,
                b"when initializing cache\x00" as *const u8 as
                    *const libc::c_char);
        return -(1 as libc::c_int)
    }
    if do_timer != 0 { gettimeofday(&mut tstart_time, &mut dontcare); }
    code = krb5_get_init_creds_opt_alloc(context, &mut options);
    if code != 0 as libc::c_int {
        com_err(prog, code as errcode_t,
                b"when allocating init cred options\x00" as *const u8 as
                    *const libc::c_char);
        return -(1 as libc::c_int)
    }
    krb5_get_init_creds_opt_set_tkt_life(options, lifetime as krb5_deltat);
    code = krb5_get_init_creds_opt_set_out_ccache(context, options, ccache);
    if code != 0 as libc::c_int {
        com_err(prog, code as errcode_t,
                b"when setting init cred output ccache\x00" as *const u8 as
                    *const libc::c_char);
        return -(1 as libc::c_int)
    }
    code =
        krb5_get_init_creds_password(context, &mut my_creds, *p_client,
                                     p_client_str, None,
                                     0 as *mut libc::c_void, 0 as libc::c_int,
                                     0 as *const libc::c_char, options);
    if do_timer != 0 {
        dt =
            if gettimeofday(&mut tend_time, &mut dontcare) != 0 {
                -1.0f64
            } else {
                ((tend_time.tv_sec - tstart_time.tv_sec) as libc::c_float as
                     libc::c_double) +
                    (tend_time.tv_usec - tstart_time.tv_usec) as libc::c_float
                        as libc::c_double / 1000000.0f64
            } as libc::c_float;
        in_tkt_times.ht_cumulative += dt;
        in_tkt_times.ht_observations += 1;
        if dt > in_tkt_times.ht_max { in_tkt_times.ht_max = dt }
        if dt < in_tkt_times.ht_min { in_tkt_times.ht_min = dt }
    }
    krb5_get_init_creds_opt_free(context, options);
    krb5_free_cred_contents(context, &mut my_creds);
    if code != 0 as libc::c_int {
        com_err(prog, code as errcode_t,
                b"while getting initial credentials\x00" as *const u8 as
                    *const libc::c_char);
        return -(1 as libc::c_int)
    }
