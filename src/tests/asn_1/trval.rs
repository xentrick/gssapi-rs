...
use self::stdio_h::{fprintf, fgetc, fputs};
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn convert_nibble(mut ch: libc::c_int) -> libc::c_int {
 ...
 -> libc::c_int {
    ...
    loop  {
        ...
        if len as libc::c_uint == maxlen {
            maxlen = maxlen.wrapping_add(8192 as libc::c_int as libc::c_uint);
            p =
                realloc(p as *mut libc::c_void, maxlen as libc::c_ulong) as
                    *mut libc::c_uchar
        }
        if do_hex != 0 {
            if cc == ' ' as i32 || cc == '\n' as i32 || cc == '\t' as i32 {
...
pub unsafe extern "C" fn trval2(mut fp: *mut FILE,
                                ...
                                mut len: libc::c_int, mut lev: libc::c_int,
                                mut rlen: *mut libc::c_int) -> libc::c_int {
    ...
    *rlen = -(1 as libc::c_int);
    ...
    loop  {
        ...
        if elen & 0x80 as libc::c_int != 0 {
            ...
            elen = decode_len(fp, enc.offset(2 as libc::c_int as isize), xlen)
        }
        if elen > len - 2 as libc::c_int - xlen {
            fprintf(fp,
                    b"length too long (%d > %d - 2 - %d)\n\x00" as *const u8
                        as *const libc::c_char, elen, len, xlen);
            return -(1 as libc::c_int)
        }
    ...
    match eid & 0x20 as libc::c_int {
        ...
        32 => {
            if print_constructed_length != 0 {
                fprintf(fp,
                        b" constr\x00" as *const u8 as *const libc::c_char);
...
pub unsafe extern "C" fn do_prim_bitstring(mut fp: *mut FILE,
 ...
 -> libc::c_int {
    ...
    if *enc.offset(0 as libc::c_int as isize) != 0 {
        fprintf(fp,
                b" (%d unused bits)\x00" as *const u8 as *const libc::c_char,
                *enc.offset(0 as libc::c_int as isize) as libc::c_int);
    }
    return 1 as libc::c_int;
}
...
pub unsafe extern "C" fn do_prim_int(mut fp: *mut FILE, mut tag: libc::c_int,
                                     mut enc: *mut libc::c_uchar,
                                     mut len: libc::c_int,
...
pub unsafe extern "C" fn do_prim_string(mut fp: *mut FILE,
    ...
    i = 0 as libc::c_int;
    while i < len {
        if *(*__ctype_b_loc()).offset(*enc.offset(i as isize) as libc::c_int
...
pub unsafe extern "C" fn do_prim(mut fp: *mut FILE, mut tag: libc::c_int,
 ...
 -> libc::c_int {
    ...
    if do_prim_string(fp, tag, enc, len, lev) != 0 { return 0 as libc::c_int }
    if do_prim_int(fp, tag, enc, len, lev) != 0 { return 0 as libc::c_int }
    if do_prim_bitstring(fp, tag, enc, len, lev) != 0 {
        return 0 as libc::c_int
    }
    if print_primitive_length != 0 {
        fprintf(fp, b" <%d>\x00" as *const u8 as *const libc::c_char, len);
    }
    width =
...
unsafe extern "C" fn lookup_typestring(mut table: *mut typestring_table,
                                       mut key1: libc::c_int,
                                       mut key2: libc::c_int)
 -> *mut libc::c_char {
    ...
    while (*ent).k1 > 0 as libc::c_int {
        if (*ent).k1 == key1 && (*ent).k2 == key2 {
            if (*ent).new_appl != 0 { current_appl_type = (*ent).new_appl }
            return (*ent).str_0
        }
        ent = ent.offset(1)
    }
     ...
     },
     {
         let mut init =
             typestring_table{k1: 0x10 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Sequence/Sequence Of\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     ...
     },
     {
         let mut init =
             typestring_table{k1: 2 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 Authenticator\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     ...
     },
     {
         let mut init =
             typestring_table{k1: 10 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 AS-REQ packet\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     },
     {
         let mut init =
             typestring_table{k1: 11 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 AS-REP packet\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     },
     {
         let mut init =
             typestring_table{k1: 12 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 TGS-REQ packet\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     },
     {
         let mut init =
             typestring_table{k1: 13 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 TGS-REP packet\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     },
     {
         let mut init =
             typestring_table{k1: 14 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 AP-REQ packet\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     },
     {
         let mut init =
             typestring_table{k1: 15 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 AP-REP packet\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     ...
     },
     {
         let mut init =
             typestring_table{k1: 28 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 Encrypted PRIV part\x00" as *const u8
     ...
     },
     {
         let mut init =
             typestring_table{k1: 29 as libc::c_int,
                              k2: -(1 as libc::c_int),
                              str_0:
                                  b"Krb5 Encrypted CRED part\x00" as *const u8
                                      as *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     ...
     },
     {
         let mut init =
             typestring_table{k1: 1007 as libc::c_int,
                              k2: 10 as libc::c_int,
                              str_0:
                                  b"enc-authorization-data\x00" as *const u8
                                      as *const libc::c_char as
                                      *mut libc::c_char,
     ...
     },
     {
         let mut init =
             typestring_table{k1: 1007 as libc::c_int,
                              k2: 11 as libc::c_int,
                              str_0:
                                  b"additional-tickets\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
                              new_appl: 0,};
         init
     ...
     },
     {
         let mut init =
             typestring_table{k1: 2 as libc::c_int,
                              k2: 8 as libc::c_int,
                              str_0:
                                  b"authorization-data\x00" as *const u8 as
                                      *const libc::c_char as
                                      *mut libc::c_char,
...
pub unsafe extern "C" fn print_tag_type(mut fp: *mut FILE,
    ...
    match eid & 0xc0 as libc::c_int {
        ...
        192 => {
            fprintf(fp, b"PRIV %d\x00" as *const u8 as *const libc::c_char,
                    tag);
        }
        _ => { }
    }
    if print_types != 0 && eid & 0xc0 as libc::c_int == 0 as libc::c_int {
        ...
        str =
            lookup_typestring(univ_types.as_mut_ptr(),
                              eid & 0x1f as libc::c_int, -(1 as libc::c_int));
        if !str.is_null() {
            fputs(str, fp);
        } else {
            fprintf(fp, b"UNIV %d???\x00" as *const u8 as *const libc::c_char,
