...
#[c2rust::header_src = "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/generic/gssapi_ext.h:27"]
...
#[c2rust::header_src = "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi_alloc.h:27"]
...
#[c2rust::header_src = "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/generic/gssapiP_generic.h:27"]
pub mod gssapiP_generic_h {
    ...
    extern "C" {
        ...
        pub fn generic_gss_release_buffer(_: *mut OM_uint32, _: gss_buffer_t) -> OM_uint32;
    }
    /* _GSSAPIP_GENERIC_H_ */
}
...
pub use self::gssapi_alloc_h::gssalloc_realloc;
pub use self::gssapi_ext_h::gss_buffer_set_desc;
pub use self::gssapi_ext_h::gss_buffer_set_desc_struct;
pub use self::gssapi_ext_h::gss_buffer_set_t;
...
pub unsafe extern "C" fn generic_gss_create_empty_buffer_set(
    ...
    mut buffer_set: *mut gss_buffer_set_t,
) -> OM_uint32 {
    let mut set = 0 as *mut gss_buffer_set_desc_struct;
    set = gssalloc_malloc(::std::mem::size_of::<gss_buffer_set_desc_struct>())
        as *mut gss_buffer_set_desc;
    if set.is_null() {
        *minor_status = 12u32;
        return (13u32) << 16i32;
    }
...
pub unsafe extern "C" fn generic_gss_add_buffer_set_member(
    ...
    (*set).elements = gssalloc_realloc(
        ...
        (*set)
            .count
            .wrapping_add(1usize)
            .wrapping_mul(::std::mem::size_of::<gss_buffer_desc>()),
    ) as *mut gss_buffer_desc;
    if (*set).elements.is_null() {
        *minor_status = 12u32;
        return (13u32) << 16i32;
    }
    p = &mut *(*set).elements.offset((*set).count as isize) as *mut gss_buffer_desc;
...
pub unsafe extern "C" fn generic_gss_release_buffer_set(
    ...
    *minor_status = 0u32;
    ...
    while i < (**buffer_set).count {
        generic_gss_release_buffer(&mut minor, &mut *(**buffer_set).elements.offset(i as isize));
        i = i.wrapping_add(1)
    }
