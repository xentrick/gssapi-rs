...
/* Forward prototypes */
#[c2rust::src_loc = "58:1"]
unsafe extern "C" fn _krb5_conf_boolean(mut s: *const libc::c_char)
 -> libc::c_int {
    let mut p: *const *const libc::c_char = 0 as *const *const libc::c_char;
    p = conf_yes.as_ptr();
    while !(*p).is_null() {
        if strcasecmp(*p, s) == 0 as libc::c_int { return 1 as libc::c_int }
        p = p.offset(1)
    }
    p = conf_no.as_ptr();
    while !(*p).is_null() {
        if strcasecmp(*p, s) == 0 as libc::c_int { return 0 as libc::c_int }
        p = p.offset(1)
    }
    /* Default to "no" */
...
#[no_mangle]
#[c2rust::src_loc = "89:1"]
pub unsafe extern "C" fn pkinit_kdcdefault_strings(mut context: krb5_context,
                                                   mut realmname:
                                                       *const libc::c_char,
                                                   mut option:
                                                       *const libc::c_char,
 ...
 -> krb5_error_code {
    ...
    let mut profile: profile_t = 0 as profile_t;
    ...
    if !realmname.is_null() {
        ...
        names[1 as libc::c_int as usize] = realmname;
        names[2 as libc::c_int as usize] = option;
        names[3 as libc::c_int as usize] = 0 as *const libc::c_char;
        retval =
            profile_get_values(profile, names.as_mut_ptr(), &mut values) as
                krb5_error_code;
        if retval == 0 as libc::c_int && !values.is_null() {
            current_block = 9843193537529789728;
     ...
     */
            ...
            retval =
                profile_get_values(profile, names.as_mut_ptr(), &mut values)
                    as krb5_error_code;
            (retval == 0 as libc::c_int) && !values.is_null();
        }
        _ => { }
    }
    if values.is_null() { retval = 2 as libc::c_int }
    *ret_value = values;
    return retval;
}
#[no_mangle]
#[c2rust::src_loc = "146:1"]
pub unsafe extern "C" fn pkinit_kdcdefault_string(mut context: krb5_context,
                                                  mut realmname:
                                                      *const libc::c_char,
                                                  mut option:
                                                      *const libc::c_char,
 ...
 -> krb5_error_code {
    ...
    let mut values: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    retval =
        pkinit_kdcdefault_strings(context, realmname, option, &mut values);
    if retval != 0 { return retval }
    if (*values.offset(0 as libc::c_int as isize)).is_null() {
        retval = 2 as libc::c_int
    } else {
        *ret_value = strdup(*values.offset(0 as libc::c_int as isize));
...
pub unsafe extern "C" fn pkinit_kdcdefault_boolean(mut context: krb5_context,
                                                   mut realmname:
                                                       *const libc::c_char,
                                                   mut option:
                                                       *const libc::c_char,
 ...
 -> krb5_error_code {
    ...
    let mut retval: krb5_error_code = 0;
    retval =
        pkinit_kdcdefault_string(context, realmname, option, &mut string);
    if retval == 0 as libc::c_int {
        *ret_value = _krb5_conf_boolean(string);
        free(string as *mut libc::c_void);
    } else { *ret_value = default_value }
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "187:1"]
pub unsafe extern "C" fn pkinit_kdcdefault_integer(mut context: krb5_context,
                                                   mut realmname:
                                                       *const libc::c_char,
                                                   mut option:
                                                       *const libc::c_char,
 ...
 -> krb5_error_code {
    ...
    if retval == 0 as libc::c_int {
        ...
        l = strtol(string, &mut endptr, 0 as libc::c_int);
        if endptr == string {
            *ret_value = default_value
        } else { *ret_value = l as libc::c_int }
        free(string as *mut libc::c_void);
    } else { *ret_value = default_value }
    return 0 as libc::c_int;
}
...
pub unsafe extern "C" fn pkinit_libdefault_strings(mut context: krb5_context,
                                                   mut realm:
                                                       *const krb5_data,
                                                   mut option:
                                                       *const libc::c_char,
 ...
 -> krb5_error_code {
    ...
    if !realm.is_null() {
        ...
        retval =
            profile_get_values(profile, names.as_mut_ptr(), &mut values) as
                krb5_error_code;
        if retval == 0 as libc::c_int && !values.is_null() &&
               !(*values.offset(0 as libc::c_int as isize)).is_null() {
            current_block = 3416110339510083145;
        } else {
            /*
         * Try number two:
         *
    ...
    if values.is_null() { return 2 as libc::c_int }
    *ret_value = values;
    return retval;
}
#[no_mangle]
#[c2rust::src_loc = "304:1"]
pub unsafe extern "C" fn pkinit_libdefault_string(mut context: krb5_context,
 ...
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0;
    let mut values: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    retval = pkinit_libdefault_strings(context, realm, option, &mut values);
    if retval != 0 { return retval }
    if (*values.offset(0 as libc::c_int as isize)).is_null() {
        retval = 2 as libc::c_int
    } else {
...
pub unsafe extern "C" fn pkinit_libdefault_boolean(mut context: krb5_context,
                                                   mut realm:
                                                       *const krb5_data,
                                                   mut option:
                                                       *const libc::c_char,
 ...
 -> krb5_error_code {
    let mut string: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut retval: krb5_error_code = 0;
    retval = pkinit_libdefault_string(context, realm, option, &mut string);
    if retval == 0 as libc::c_int {
        *ret_value = _krb5_conf_boolean(string);
        free(string as *mut libc::c_void);
    } else { *ret_value = default_value }
...
pub unsafe extern "C" fn pkinit_libdefault_integer(mut context: krb5_context,
                                                   mut realm:
                                                       *const krb5_data,
                                                   mut option:
                                                       *const libc::c_char,
