 ...
 */
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_authdatatype, krb5_context, krb5_data,
                        krb5_error_code, krb5_octet};
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       _krb5_auth_context, krb5_copy_authdata,
...
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         ...
                         krb5int_copy_data_contents_add0, krb5_ser_pack_int32,
                         krb5_ser_unpack_int32, krb5_ser_pack_bytes,
                         krb5_ser_unpack_bytes};
pub use self::k5_err_h::errinfo;
pub use self::k5_plugin_h::{plugin_dir_handle, plugin_file_handle};
pub use self::profile_h::profile_t;
pub use self::authdata_plugin_h::{authdata_client_copy_proc,
                                  authdata_client_request_fini_proc,
                                  authdata_client_request_init_proc,
                                  krb5plugin_authdata_client_ftable_v0,
...
#[repr(C)]
#[c2rust::src_loc = "30:8"]
pub struct greet_context {
    pub greeting: krb5_data,
    pub verified: krb5_boolean,
}
// Initialized in run_static_initializers
#[c2rust::src_loc = "35:18"]
static mut greet_attr: krb5_data =
    krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
#[c2rust::src_loc = "38:1"]
unsafe extern "C" fn greet_init(mut kcontext: krb5_context,
...
#[c2rust::src_loc = "45:1"]
unsafe extern "C" fn greet_flags(mut kcontext: krb5_context,
                                 mut plugin_context: *mut libc::c_void,
                                 mut ad_type: krb5_authdatatype,
                                 mut flags: *mut krb5_flags) {
    *flags = 0x4 as libc::c_int | 0x8 as libc::c_int | 0x10 as libc::c_int;
}
#[c2rust::src_loc = "54:1"]
unsafe extern "C" fn greet_fini(mut kcontext: krb5_context,
                                mut plugin_context: *mut libc::c_void) {
}
#[c2rust::src_loc = "60:1"]
unsafe extern "C" fn greet_request_init(mut kcontext: krb5_context,
                                        mut context: krb5_authdata_context,
                                        mut plugin_context: *mut libc::c_void,
                                        mut request_context:
                                            *mut *mut libc::c_void)
 -> krb5_error_code {
    let mut greet: *mut greet_context = 0 as *mut greet_context;
    greet =
        malloc(::std::mem::size_of::<greet_context>() as libc::c_ulong) as
            *mut greet_context;
    if greet.is_null() { return 12 as libc::c_int }
    (*greet).greeting.data = 0 as *mut libc::c_char;
    (*greet).greeting.length = 0 as libc::c_int as libc::c_uint;
    (*greet).verified = 0 as libc::c_int as krb5_boolean;
    *request_context = greet as *mut libc::c_void;
    return 0 as libc::c_int;
}
#[c2rust::src_loc = "81:1"]
unsafe extern "C" fn greet_export_authdata(mut kcontext: krb5_context,
                                           mut context: krb5_authdata_context,
                                           mut plugin_context:
                                               *mut libc::c_void,
                                           mut request_context:
 ...
 -> krb5_error_code {
    let mut greet: *mut greet_context = request_context as *mut greet_context;
    let mut data: [*mut krb5_authdata; 2] = [0 as *mut krb5_authdata; 2];
    let mut datum: krb5_authdata =
        krb5_authdata{magic: 0,
                      ad_type: 0,
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut code: krb5_error_code = 0;
    datum.ad_type = -(42 as libc::c_int);
    datum.length = (*greet).greeting.length;
    datum.contents = (*greet).greeting.data as *mut krb5_octet;
    data[0 as libc::c_int as usize] = &mut datum;
    data[1 as libc::c_int as usize] = 0 as *mut krb5_authdata;
    code = krb5_copy_authdata(kcontext, data.as_mut_ptr(), out_authdata);
    return code;
}
#[c2rust::src_loc = "106:1"]
unsafe extern "C" fn greet_import_authdata(mut kcontext: krb5_context,
                                           mut context: krb5_authdata_context,
                                           mut plugin_context:
                                               *mut libc::c_void,
                                           mut request_context:
                                           ...
                                           mut kdc_issued_flag: krb5_boolean,
                                           mut issuer: krb5_const_principal)
 -> krb5_error_code {
    let mut code: krb5_error_code = 0;
    let mut greet: *mut greet_context = request_context as *mut greet_context;
    let mut data: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    krb5_free_data_contents(kcontext, &mut (*greet).greeting);
    (*greet).verified = 0 as libc::c_int as krb5_boolean;
    if !(*authdata.offset(0 as libc::c_int as isize)).is_null() {
    } else {
        __assert_fail(b"authdata[0] != NULL\x00" as *const u8 as
                          *const libc::c_char,
                      b"greet.c\x00" as *const u8 as *const libc::c_char,
                      122 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 145],
                                                &[libc::c_char; 145]>(b"krb5_error_code greet_import_authdata(krb5_context, krb5_authdata_context, void *, void *, krb5_authdata **, krb5_boolean, krb5_const_principal)\x00")).as_ptr());
    }
    data.length = (**authdata.offset(0 as libc::c_int as isize)).length;
    data.data =
        (**authdata.offset(0 as libc::c_int as isize)).contents as
            *mut libc::c_char;
    code =
        krb5int_copy_data_contents_add0(kcontext, &mut data,
                                        &mut (*greet).greeting);
    if code == 0 as libc::c_int { (*greet).verified = kdc_issued_flag }
    return code;
}
#[c2rust::src_loc = "134:1"]
unsafe extern "C" fn greet_request_fini(mut kcontext: krb5_context,
                                        mut context: krb5_authdata_context,
                                        mut plugin_context: *mut libc::c_void,
                                        mut request_context:
                                            *mut libc::c_void) {
    ...
    if !greet.is_null() {
        krb5_free_data_contents(kcontext, &mut (*greet).greeting);
        free(greet as *mut libc::c_void);
    };
}
#[c2rust::src_loc = "148:1"]
unsafe extern "C" fn greet_get_attribute_types(mut kcontext: krb5_context,
                                               mut context:
 ...
 -> krb5_error_code {
    let mut code: krb5_error_code = 0;
    let mut greet: *mut greet_context = request_context as *mut greet_context;
    if (*greet).greeting.length == 0 as libc::c_int as libc::c_uint {
    ...
    *out_attrs =
        calloc(2 as libc::c_int as libc::c_ulong,
            ...
            *mut krb5_data;
    if (*out_attrs).is_null() { return 12 as libc::c_int }
    code =
        krb5int_copy_data_contents_add0(kcontext, &mut greet_attr,
                                        &mut *(*out_attrs).offset(0 as
                                                                      libc::c_int
                                                                      as
                                                                      isize));
    if code != 0 as libc::c_int {
        free(*out_attrs as *mut libc::c_void);
...
#[c2rust::src_loc = "177:1"]
unsafe extern "C" fn greet_get_attribute(mut kcontext: krb5_context,
                                         mut context: krb5_authdata_context,
                                         mut plugin_context:
                                             *mut libc::c_void,
                                         mut request_context:
 ...
 -> krb5_error_code {
    let mut greet: *mut greet_context = request_context as *mut greet_context;
    let mut code: krb5_error_code = 0;
    if data_eq(*attribute, greet_attr) == 0 ||
           (*greet).greeting.length == 0 as libc::c_int as libc::c_uint {
        return 2 as libc::c_int
    }
    ...
    *more = 0 as libc::c_int;
    code =
        krb5int_copy_data_contents_add0(kcontext, &mut (*greet).greeting,
                                        value);
    if code == 0 as libc::c_int {
        code =
            krb5int_copy_data_contents_add0(kcontext, &mut (*greet).greeting,
...
unsafe extern "C" fn greet_set_attribute(mut kcontext: krb5_context,
                                         mut context: krb5_authdata_context,
                                         mut plugin_context:
                                             *mut libc::c_void,
                                         mut request_context:
 ...
 -> krb5_error_code {
    ...
    let mut data: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    let mut code: krb5_error_code = 0;
    if data_eq(*attribute, greet_attr) == 0 { return 2 as libc::c_int }
    if !(*greet).greeting.data.is_null() { return 17 as libc::c_int }
    code = krb5int_copy_data_contents_add0(kcontext, value, &mut data);
...
unsafe extern "C" fn greet_delete_attribute(mut kcontext: krb5_context,
                                            mut context:
                                                krb5_authdata_context,
                                            mut plugin_context:
                                                *mut libc::c_void,
...
unsafe extern "C" fn greet_size(mut kcontext: krb5_context,
                                mut context: krb5_authdata_context,
                                mut plugin_context: *mut libc::c_void,
    ...
    *sizep =
        (*sizep as
             libc::c_ulong).wrapping_add((::std::mem::size_of::<krb5_int32>()
                                              as
                                              libc::c_ulong).wrapping_add((*greet).greeting.length
                                                                              as
                                                                              libc::c_ulong).wrapping_add(::std::mem::size_of::<krb5_int32>()
                                                                                                              as
                                                                                                              libc::c_ulong))
...
unsafe extern "C" fn greet_externalize(mut kcontext: krb5_context,
                                       mut context: krb5_authdata_context,
                                       mut plugin_context: *mut libc::c_void,
                                       mut request_context: *mut libc::c_void,
 ...
 -> krb5_error_code {
    ...
    let mut greet: *mut greet_context = request_context as *mut greet_context;
    greet_size(kcontext, context, plugin_context, request_context,
               &mut required);
    if *lenremain < required { return 12 as libc::c_int }
    /* Greeting Length | Greeting Contents | Verified */
    krb5_ser_pack_int32((*greet).greeting.length as krb5_int32, buffer,
                        lenremain);
    krb5_ser_pack_bytes((*greet).greeting.data as *mut krb5_octet,
                        (*greet).greeting.length as size_t, buffer,
                        lenremain);
    krb5_ser_pack_int32((*greet).verified as krb5_int32, buffer, lenremain);
    return 0 as libc::c_int;
}
#[c2rust::src_loc = "299:1"]
unsafe extern "C" fn greet_internalize(mut kcontext: krb5_context,
                                       mut context: krb5_authdata_context,
                                       mut plugin_context: *mut libc::c_void,
                                       mut request_context: *mut libc::c_void,
                                       mut buffer: *mut *mut krb5_octet,
 ...
 -> krb5_error_code {
    let mut greet: *mut greet_context = request_context as *mut greet_context;
    let mut code: krb5_error_code = 0;
    let mut length: krb5_int32 = 0;
    let mut contents: *mut krb5_octet = 0 as *mut krb5_octet;
    let mut verified: krb5_int32 = 0;
    let mut bp: *mut krb5_octet = 0 as *mut krb5_octet;
    let mut remain: size_t = 0;
    bp = *buffer;
    remain = *lenremain;
    /* Greeting Length */
    code = krb5_ser_unpack_int32(&mut length, &mut bp, &mut remain);
    if code != 0 as libc::c_int { return code }
    /* Greeting Contents */
    if length != 0 as libc::c_int {
        contents = malloc(length as libc::c_ulong) as *mut krb5_octet;
        if contents.is_null() { return 12 as libc::c_int }
        code =
            krb5_ser_unpack_bytes(contents, length as size_t, &mut bp,
                                  &mut remain);
        if code != 0 as libc::c_int {
    ...
    /* Verified */
    code = krb5_ser_unpack_int32(&mut verified, &mut bp, &mut remain);
    if code != 0 as libc::c_int {
        free(contents as *mut libc::c_void);
        return code
    }
    krb5_free_data_contents(kcontext, &mut (*greet).greeting);
    (*greet).greeting.length = length as libc::c_uint;
    (*greet).greeting.data = contents as *mut libc::c_char;
    (*greet).verified =
        (verified != 0 as libc::c_int) as libc::c_int as krb5_boolean;
    *buffer = bp;
    *lenremain = remain;
    return 0 as libc::c_int;
}
#[c2rust::src_loc = "354:26"]
static mut greet_ad_types: [krb5_authdatatype; 2] =
    [-(42 as libc::c_int), 0 as libc::c_int];
#[no_mangle]
#[c2rust::src_loc = "356:38"]
pub static mut authdata_client_0: krb5plugin_authdata_client_ftable_v0 =
    unsafe {
        {
            let mut init =
                                                     ...
                                                     request_fini:
                                                         Some(greet_request_fini
                                                                  ...
                                                                  unsafe extern "C" fn(_:
                                                                      ...
                                                                      -> ()),
                                                     get_attribute_types:
                                                         Some(greet_get_attribute_types
                                                                  as
                                                                  unsafe extern "C" fn(_:
                                                                                           krb5_context,
                                                                                       _:
                ...
                _krb5_data{magic: -(1760647422 as libc::c_long) as krb5_magic,
                           length:
                               (::std::mem::size_of::<[libc::c_char; 19]>() as
                                   ...
                                   as libc::c_uint,
                           data:
                               b"urn:greet:greeting\x00" as *const u8 as
