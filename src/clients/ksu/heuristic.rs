...
pub mod ksu_h {
    use super::k5_int_h::_krb5_context;
    use super::krb5_h::{krb5_context, krb5_ticket_times, krb5_timestamp,
                        krb5_error_code, _krb5_ccache, krb5_ccache,
                        krb5_boolean, krb5_data, krb5_principal};
    use super::FILE_h::FILE;
    ...
    extern "C" {
        ...
        pub static mut k5login_path: [libc::c_char; 4096];
        #[no_mangle]
        #[c2rust::src_loc = "68:13"]
        pub static mut k5users_path: [libc::c_char; 4096];
        #[no_mangle]
        #[c2rust::src_loc = "69:15"]
        pub static mut gb_err: *mut libc::c_char;
        #[no_mangle]
        #[c2rust::src_loc = "115:1"]
        pub fn krb5_check_exp(_: krb5_context, _: krb5_ticket_times)
         -> krb5_error_code;
        #[no_mangle]
        ...
        pub fn fowner(_: *mut FILE, _: uid_t) -> krb5_boolean;
        #[no_mangle]
        #[c2rust::src_loc = "165:1"]
        pub fn k5users_lookup(_: *mut FILE, _: *mut libc::c_char,
                              _: *mut libc::c_char, _: *mut krb5_boolean,
                              _: *mut *mut libc::c_char) -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "183:1"]
        pub fn get_line(_: *mut FILE, _: *mut *mut libc::c_char)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "185:1"]
        pub fn get_first_token(_: *mut libc::c_char,
        ...
        pub fn ksu_tgtname(_: krb5_context, _: *const krb5_data,
                           _: *const krb5_data, tgtprinc: *mut krb5_principal)
         -> krb5_error_code;
    }
}
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_addrtype,
                       ...
                       _profile_t, _krb5_ccache, krb5_cc_retrieve_cred,
                       krb5_cc_get_principal, krb5_parse_name,
                       krb5_unparse_name, krb5_copy_principal,
                       krb5_free_principal, krb5_sname_to_principal};
...
use self::stdio_h::{fclose, fopen, printf, rewind};
use self::errno_h::__errno_location;
use self::unistd_h::seteuid;
use self::string_h::{strcmp, memcmp, memset};
use self::sys_stat_h::stat;
use self::ksu_h::{auth_debug, k5login_path, k5users_path, gb_err,
                  krb5_check_exp, ks_ccache_is_initialized, fowner,
                  k5users_lookup, get_line, get_first_token, xstrdup,
                  ksu_tgtname};
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "506:16"]
pub struct princ_info {
    pub p: krb5_principal,
    pub found: krb5_boolean,
}
#[no_mangle]
#[c2rust::src_loc = "44:1"]
pub unsafe extern "C" fn get_all_princ_from_file(mut fp: *mut FILE,
                                                 mut plist:
                                                     *mut *mut *mut libc::c_char)
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0;
    let mut line: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut fprinc: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut lp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut temp_list: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    ...
    temp_list =
        malloc((3 as libc::c_int as
                    libc::c_ulong).wrapping_mul(::std::mem::size_of::<*mut libc::c_char>()
                                                    as libc::c_ulong)) as
            *mut *mut libc::c_char;
    if temp_list.is_null() { return 12 as libc::c_int }
    retval = get_line(fp, &mut line);
    if retval != 0 { return retval }
    while !line.is_null() {
        fprinc = get_first_token(line, &mut lp);
        if !fprinc.is_null() {
            let ref mut fresh0 = *temp_list.offset(count as isize);
            *fresh0 = xstrdup(fprinc);
            count += 1
        }
        if count == chunk_count * 3 as libc::c_int - 1 as libc::c_int {
            chunk_count += 1;
            temp_list =
                realloc(temp_list as *mut libc::c_void,
    ...
    let ref mut fresh1 = *temp_list.offset(count as isize);
...
#[no_mangle]
#[c2rust::src_loc = "95:1"]
pub unsafe extern "C" fn list_union(mut list1: *mut *mut libc::c_char,
                                    mut list2: *mut *mut libc::c_char,
                                    mut combined_list:
                                        *mut *mut *mut libc::c_char)
 -> krb5_error_code {
    let mut c1: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut c2: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut i: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut j: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut tlist: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    if list1.is_null() { *combined_list = list2; return 0 as libc::c_int }
    if list2.is_null() { *combined_list = list1; return 0 as libc::c_int }
    while !(*list1.offset(c1 as isize)).is_null() { c1 = c1.wrapping_add(1) }
    while !(*list2.offset(c2 as isize)).is_null() { c2 = c2.wrapping_add(1) }
    tlist =
        calloc(c1.wrapping_add(c2).wrapping_add(1 as libc::c_int as
                                                    libc::c_uint) as
                   libc::c_ulong,
               ::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong) as
            *mut *mut libc::c_char;
    if tlist.is_null() { return 12 as libc::c_int }
    i = 0 as libc::c_int as libc::c_uint;
    while !(*list1.offset(i as isize)).is_null() {
        let ref mut fresh2 = *tlist.offset(i as isize);
        *fresh2 = *list1.offset(i as isize);
        i = i.wrapping_add(1)
    }
    j = 0 as libc::c_int as libc::c_uint;
    while !(*list2.offset(j as isize)).is_null() {
        if find_str_in_list(list1, *list2.offset(j as isize)) ==
               0 as libc::c_int as libc::c_uint {
            let ref mut fresh3 = *tlist.offset(i as isize);
            *fresh3 = *list2.offset(j as isize);
            i = i.wrapping_add(1)
        }
        j = j.wrapping_add(1)
    }
    free(list1 as *mut libc::c_void);
    free(list2 as *mut libc::c_void);
    let ref mut fresh4 = *tlist.offset(i as isize);
...
pub unsafe extern "C" fn filter(mut fp: *mut FILE, mut cmd: *mut libc::c_char,
                                mut k5users_list: *mut *mut libc::c_char,
                                mut k5users_filt_list:
                                    *mut *mut *mut libc::c_char)
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0 as libc::c_int;
    let mut found: krb5_boolean = 0 as libc::c_int as krb5_boolean;
    let mut out_cmd: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut j: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut found_count: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut k: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut temp_filt_list: *mut *mut libc::c_char =
        0 as *mut *mut libc::c_char;
    *k5users_filt_list = 0 as *mut *mut libc::c_char;
    if k5users_list.is_null() { return 0 as libc::c_int }
    while !(*k5users_list.offset(i as isize)).is_null() {
        retval =
            k5users_lookup(fp, *k5users_list.offset(i as isize), cmd,
                           &mut found, &mut out_cmd);
        if retval != 0 { return retval }
        if found == 0 as libc::c_int as libc::c_uint {
            free(*k5users_list.offset(i as isize) as *mut libc::c_void);
            let ref mut fresh5 = *k5users_list.offset(i as isize);
            *fresh5 = 0 as *mut libc::c_char;
            if !out_cmd.is_null() { gb_err = out_cmd }
        } else { found_count = found_count.wrapping_add(1) }
        i = i.wrapping_add(1)
    }
    temp_filt_list =
        calloc(found_count.wrapping_add(1 as libc::c_int as libc::c_uint) as
                   libc::c_ulong,
               ::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong) as
            *mut *mut libc::c_char;
    if temp_filt_list.is_null() { return 12 as libc::c_int }
    j = 0 as libc::c_int as libc::c_uint;
    k = 0 as libc::c_int as libc::c_uint;
    while j < i {
        if !(*k5users_list.offset(j as isize)).is_null() {
            let ref mut fresh6 = *temp_filt_list.offset(k as isize);
            *fresh6 = *k5users_list.offset(j as isize);
            k = k.wrapping_add(1)
        }
        j = j.wrapping_add(1)
    }
    let ref mut fresh7 = *temp_filt_list.offset(k as isize);
    *fresh7 = 0 as *mut libc::c_char;
    free(k5users_list as *mut libc::c_void);
    *k5users_filt_list = temp_filt_list;
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "197:1"]
pub unsafe extern "C" fn get_authorized_princ_names(mut luser:
                                                        *const libc::c_char,
                                                    mut cmd:
                                                        *mut libc::c_char,
                                                    mut princ_list:
 ...
 -> krb5_error_code {
    ...
    let mut k5login_flag: libc::c_int = 0 as libc::c_int;
    let mut k5users_flag: libc::c_int = 0 as libc::c_int;
    let mut login_fp: *mut FILE = 0 as *mut FILE;
    let mut users_fp: *mut FILE = 0 as *mut FILE;
    let mut k5login_list: *mut *mut libc::c_char =
        0 as *mut *mut libc::c_char;
    let mut k5users_list: *mut *mut libc::c_char =
        0 as *mut *mut libc::c_char;
    let mut k5users_filt_list: *mut *mut libc::c_char =
        0 as *mut *mut libc::c_char;
    let mut combined_list: *mut *mut libc::c_char =
        0 as *mut *mut libc::c_char;
    let mut tb: stat =
        stat{st_dev: 0,
             st_ino: 0,
    ...
    let mut retval: krb5_error_code = 0;
    *princ_list = 0 as *mut *mut libc::c_char;
    /* no account => no access */
    pwd = getpwnam(luser);
    if pwd.is_null() { return 0 as libc::c_int }
    k5login_flag = stat(k5login_path.as_mut_ptr(), &mut tb);
    k5users_flag = stat(k5users_path.as_mut_ptr(), &mut tb);
    if k5login_flag == 0 {
        login_fp =
            fopen(k5login_path.as_mut_ptr(),
                  b"r\x00" as *const u8 as *const libc::c_char);
        if login_fp.is_null() { return 0 as libc::c_int }
        if fowner(login_fp, (*pwd).pw_uid) == 0 as libc::c_int as libc::c_uint
           {
            close_time(1 as libc::c_int, 0 as *mut FILE, k5login_flag,
                       login_fp);
            return 0 as libc::c_int
        }
    }
    if k5users_flag == 0 {
        users_fp =
            fopen(k5users_path.as_mut_ptr(),
                  b"r\x00" as *const u8 as *const libc::c_char);
        if users_fp.is_null() { return 0 as libc::c_int }
        if fowner(users_fp, (*pwd).pw_uid) == 0 as libc::c_int as libc::c_uint
           {
            close_time(k5users_flag, users_fp, k5login_flag, login_fp);
            return 0 as libc::c_int
        }
        retval = get_all_princ_from_file(users_fp, &mut k5users_list);
        if retval != 0 {
            close_time(k5users_flag, users_fp, k5login_flag, login_fp);
            return retval
        }
        rewind(users_fp);
        retval = filter(users_fp, cmd, k5users_list, &mut k5users_filt_list);
        if retval != 0 {
            close_time(k5users_flag, users_fp, k5login_flag, login_fp);
            return retval
        }
    ...
    if k5login_flag == 0 {
        retval = get_all_princ_from_file(login_fp, &mut k5login_list);
        if retval != 0 {
            close_time(k5users_flag, users_fp, k5login_flag, login_fp);
            return retval
        }
    ...
    close_time(k5users_flag, users_fp, k5login_flag, login_fp);
    retval = list_union(k5login_list, k5users_filt_list, &mut combined_list);
    if retval != 0 { return retval }
...
unsafe extern "C" fn close_time(mut k5users_flag: libc::c_int,
                                mut users_fp: *mut FILE,
                                mut k5login_flag: libc::c_int,
                                mut login_fp: *mut FILE) {
    if k5users_flag == 0 { fclose(users_fp); }
    if k5login_flag == 0 { fclose(login_fp); };
}
#[c2rust::src_loc = "287:1"]
unsafe extern "C" fn find_str_in_list(mut list: *mut *mut libc::c_char,
                                      mut elm: *mut libc::c_char)
 -> krb5_boolean {
    let mut i: libc::c_int = 0 as libc::c_int;
    let mut found: krb5_boolean = 0 as libc::c_int as krb5_boolean;
    if list.is_null() { return found }
    while !(*list.offset(i as isize)).is_null() {
        if strcmp(*list.offset(i as isize), elm) == 0 {
...
pub unsafe extern "C" fn get_closest_principal(mut context: krb5_context,
                                               mut plist:
                                                   *mut *mut libc::c_char,
                                               mut client:
                                                   *mut krb5_principal,
                                               mut found: *mut krb5_boolean)
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0 as libc::c_int;
    let mut temp_client: krb5_principal = 0 as *mut krb5_principal_data;
    let mut best_client: krb5_principal = 0 as krb5_principal;
    let mut i: libc::c_int = 0 as libc::c_int;
    let mut j: libc::c_int = 0 as libc::c_int;
    let mut cnelem: libc::c_int = 0;
    let mut pnelem: libc::c_int = 0;
    let mut got_one: krb5_boolean = 0;
    *found = 0 as libc::c_int as krb5_boolean;
    if plist.is_null() { return 0 as libc::c_int }
    cnelem = (**client).length;
    while !(*plist.offset(i as isize)).is_null() {
        retval =
            krb5_parse_name(context, *plist.offset(i as isize),
                            &mut temp_client);
        if retval != 0 { return retval }
        pnelem = (*temp_client).length;
        if cnelem > pnelem {
            i += 1
        } else {
            if data_eq((**client).realm, (*temp_client).realm) != 0 {
                got_one = 1 as libc::c_int as krb5_boolean;
                j = 0 as libc::c_int;
                while j < cnelem {
                    let mut p1: *mut krb5_data =
                        if j < (**client).length {
                            (**client).data.offset(j as isize)
                        } else { 0 as *mut krb5_data };
                    let mut p2: *mut krb5_data =
                        if j < (*temp_client).length {
                            (*temp_client).data.offset(j as isize)
                        } else { 0 as *mut krb5_data };
                    if p1.is_null() || p2.is_null() || data_eq(*p1, *p2) == 0
                       {
                        got_one = 0 as libc::c_int as krb5_boolean;
                        break ;
                    } else { j += 1 }
                }
                if got_one == 1 as libc::c_int as libc::c_uint {
                    if !best_client.is_null() {
                        if (*best_client).length > (*temp_client).length {
                            best_client = temp_client
                        }
                    } else { best_client = temp_client }
                }
            }
            i += 1
        }
...
pub unsafe extern "C" fn find_either_ticket(mut context: krb5_context,
                                            mut cc: krb5_ccache,
                                            mut client: krb5_principal,
                                            mut end_server: krb5_principal,
                                            mut found: *mut krb5_boolean)
 -> krb5_error_code {
    let mut kdc_server: krb5_principal = 0 as *mut krb5_principal_data;
    let mut retval: krb5_error_code = 0;
    let mut temp_found: krb5_boolean = 0 as libc::c_int as krb5_boolean;
    if ks_ccache_is_initialized(context, cc) != 0 {
        retval =
            find_ticket(context, cc, client, end_server, &mut temp_found);
        if retval != 0 { return retval }
        if temp_found == 0 as libc::c_int as libc::c_uint {
            retval =
                ksu_tgtname(context, &mut (*client).realm,
                            &mut (*client).realm, &mut kdc_server);
            if retval != 0 { return retval }
            retval =
                find_ticket(context, cc, client, kdc_server, &mut temp_found);
            if retval != 0 { return retval }
        } else if auth_debug != 0 {
            printf(b"find_either_ticket: found end server ticket\n\x00" as
...
pub unsafe extern "C" fn find_ticket(mut context: krb5_context,
                                     mut cc: krb5_ccache,
                                     mut client: krb5_principal,
                                     mut server: krb5_principal,
                                     mut found: *mut krb5_boolean)
 -> krb5_error_code {
    let mut tgt: krb5_creds =
        krb5_creds{magic: 0,
    ...
    *found = 0 as libc::c_int as krb5_boolean;
    ...
    memset(&mut tgt as *mut krb5_creds as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<krb5_creds>() as libc::c_ulong);
    retval =
    ...
    if retval != 0 { return retval }
    retval =
        krb5_copy_principal(context, server as krb5_const_principal,
                            &mut tgtq.server);
    if retval != 0 { return retval }
    retval =
        krb5_cc_retrieve_cred(context, cc,
                              0x40 as libc::c_int | 0x200 as libc::c_int,
                              &mut tgtq, &mut tgt);
    if retval == 0 { retval = krb5_check_exp(context, tgt.times) }
    if retval != 0 {
        if retval as libc::c_long != -(1765328243 as libc::c_long) &&
               retval as libc::c_long != -(1765328352 as libc::c_long) {
            return retval
        }
    } else {
        *found = 1 as libc::c_int as krb5_boolean;
    ...
    free(tgtq.server as *mut libc::c_void);
    free(tgtq.client as *mut libc::c_void);
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "475:1"]
pub unsafe extern "C" fn find_princ_in_list(mut context: krb5_context,
                                            mut princ: krb5_principal,
                                            mut plist: *mut *mut libc::c_char,
                                            mut found: *mut krb5_boolean)
 -> krb5_error_code {
    let mut i: libc::c_int = 0 as libc::c_int;
    ...
    *found = 0 as libc::c_int as krb5_boolean;
    ...
    if retval != 0 { return retval }
    while !(*plist.offset(i as isize)).is_null() {
        if strcmp(*plist.offset(i as isize), princname) == 0 {
            *found = 1 as libc::c_int as krb5_boolean;
            break ;
        } else { i += 1 }
    }
...
pub unsafe extern "C" fn get_best_princ_for_target(mut context: krb5_context,
                                                   mut source_uid: uid_t,
                                                   mut target_uid: uid_t,
                                                   mut source_user:
                                                       *mut libc::c_char,
                                                   mut target_user:
                                                       *mut libc::c_char,
                                                   mut cc_source: krb5_ccache,
                                                   mut options:
                                                   ...
                                                   mut path_out:
                                                       *mut libc::c_int)
 -> krb5_error_code {
    let mut princ_trials: [princ_info; 10] =
        [princ_info{p: 0 as *mut krb5_principal_data, found: 0,}; 10];
    let mut cc_def_princ: krb5_principal = 0 as krb5_principal;
    let mut temp_client: krb5_principal = 0 as *mut krb5_principal_data;
    let mut target_client: krb5_principal = 0 as *mut krb5_principal_data;
    let mut source_client: krb5_principal = 0 as *mut krb5_principal_data;
    let mut end_server: krb5_principal = 0 as *mut krb5_principal_data;
    let mut retval: krb5_error_code = 0;
    let mut aplist: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    let mut found: krb5_boolean = 0 as libc::c_int as krb5_boolean;
    let mut tb: stat =
        stat{st_dev: 0,
             st_ino: 0,
    ...
    *path_out = 0 as libc::c_int;
    /* -n option was specified client is set we are done */
    if !(*client).is_null() {
        return 0 as libc::c_int
    } /* this will be used to restrict
                                        the cache copty */
    if ks_ccache_is_initialized(context, cc_source) != 0 {
        retval = krb5_cc_get_principal(context, cc_source, &mut cc_def_princ);
        if retval != 0 { return retval }
    }
    retval = krb5_parse_name(context, target_user, &mut target_client);
    if retval != 0 { return retval }
    retval = krb5_parse_name(context, source_user, &mut source_client);
    if retval != 0 { return retval }
    if source_uid == 0 as libc::c_int as libc::c_uint {
        if target_uid != 0 as libc::c_int as libc::c_uint {
            *client = target_client
        } else if !cc_def_princ.is_null() {
            *client = cc_def_princ
        } else { *client = target_client }
        if auth_debug != 0 {
            printf(b" GET_best_princ_for_target: via source_uid == 0\n\x00" as
                       *const u8 as *const libc::c_char);
        }
        return 0 as libc::c_int
    }
    ...
    if source_uid != 0 && source_uid == target_uid {
        if !cc_def_princ.is_null() {
            *client = cc_def_princ
        } else { *client = target_client }
        if auth_debug != 0 {
            printf(b"GET_best_princ_for_target: via source_uid == target_uid\n\x00"
                       as *const u8 as *const libc::c_char);
        }
        return 0 as libc::c_int
    }
    /* Become root, then target for looking at .k5login.*/
    if seteuid(0 as libc::c_int as uid_t) != 0 || seteuid(target_uid) != 0 {
        return *__errno_location()
    }
    /* if .k5users and .k5login do not exist */
    if stat(k5login_path.as_mut_ptr(), &mut tb) != 0 &&
           stat(k5users_path.as_mut_ptr(), &mut tb) != 0 {
        *client = target_client;
        if !cmd.is_null() { *path_out = 1 as libc::c_int }
        if auth_debug != 0 {
            printf(b" GET_best_princ_for_target: via no auth files path\n\x00"
                       as *const u8 as *const libc::c_char);
        }
        return 0 as libc::c_int
    } else {
        retval = get_authorized_princ_names(target_user, cmd, &mut aplist);
        if retval != 0 { return retval }
        /* .k5users or .k5login exist, but no authorization */
        if aplist.is_null() ||
               (*aplist.offset(0 as libc::c_int as isize)).is_null() {
            *path_out = 1 as libc::c_int;
            if auth_debug != 0 {
                printf(b"GET_best_princ_for_target: via empty auth files path\n\x00"
                           as *const u8 as *const libc::c_char);
            }
            return 0 as libc::c_int
        }
    ...
    retval =
        krb5_sname_to_principal(context, hostname, 0 as *const libc::c_char,
                                3 as libc::c_int, &mut end_server);
    if retval != 0 { return retval }
    ...
    if !cc_def_princ.is_null() {
        let fresh8 = count;
        count = count + 1;
        princ_trials[fresh8 as usize].p = cc_def_princ
    } else {
        let fresh9 = count;
        count = count + 1;
        princ_trials[fresh9 as usize].p = 0 as krb5_principal
    }
    let fresh10 = count;
    count = count + 1;
    princ_trials[fresh10 as usize].p = target_client;
    let fresh11 = count;
    count = count + 1;
    princ_trials[fresh11 as usize].p = source_client;
    i = 0 as libc::c_int;
    while i < count {
        princ_trials[i as usize].found = 0 as libc::c_int as krb5_boolean;
        i += 1
    }
    i = 0 as libc::c_int;
    while i < count {
        if !princ_trials[i as usize].p.is_null() {
            retval =
                find_princ_in_list(context, princ_trials[i as usize].p,
                                   aplist, &mut found);
            if retval != 0 { return retval }
            if found == 1 as libc::c_int as libc::c_uint {
                princ_trials[i as usize].found =
                    1 as libc::c_int as krb5_boolean;
                retval =
                    find_either_ticket(context, cc_source,
                                       princ_trials[i as usize].p, end_server,
                                       &mut found);
                if retval != 0 { return retval }
                if found == 1 as libc::c_int as libc::c_uint {
                    *client = princ_trials[i as usize].p;
                    if auth_debug != 0 {
                        printf(b"GET_best_princ_for_target: via ticket file, choice #%d\n\x00"
    ...
    /* out of preferred principals, see if there is any ticket that will
       get us in */
    i = 0 as libc::c_int;
    while !(*aplist.offset(i as isize)).is_null() {
        retval =
            krb5_parse_name(context, *aplist.offset(i as isize),
                            &mut temp_client);
        if retval != 0 { return retval }
        retval =
            find_either_ticket(context, cc_source, temp_client, end_server,
                               &mut found);
        if retval != 0 { return retval }
        if found == 1 as libc::c_int as libc::c_uint {
            if auth_debug != 0 {
                printf(b"GET_best_princ_for_target: via ticket file, choice: any ok ticket \n\x00"
                           as *const u8 as *const libc::c_char);
            }
            *client = temp_client;
            return 0 as libc::c_int
    ...
    i = 0 as libc::c_int;
    while i < count {
        if princ_trials[i as usize].found == 1 as libc::c_int as libc::c_uint
           {
            *client = princ_trials[i as usize].p;
            if auth_debug != 0 {
                printf(b"GET_best_princ_for_target: via prompt passwd list choice #%d \n\x00"
                           as *const u8 as *const libc::c_char, i);
            }
            return 0 as libc::c_int
        }
    ...
    while i < count {
        if !princ_trials[i as usize].p.is_null() {
            ...
            retval =
                get_closest_principal(context, aplist, &mut temp_client,
                                      &mut found);
            if retval != 0 { return retval }
            if found == 1 as libc::c_int as libc::c_uint {
                *client = temp_client;
                if auth_debug != 0 {
                    printf(b"GET_best_princ_for_target: via prompt passwd list choice: approximation of princ in trials # %d \n\x00"
                               as *const u8 as *const libc::c_char, i);
                }
                return 0 as libc::c_int
            }
    ...
    /* PRINC_LOOK_AHEAD */
    if auth_debug != 0 {
        printf(b"GET_best_princ_for_target: out of luck, can\'t get appropriate default principal\n\x00"
                   as *const u8 as *const libc::c_char);
    }
    *path_out = 1 as libc::c_int;
    return 0 as libc::c_int;
