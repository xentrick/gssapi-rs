use ::libc;
#[c2rust::header_src = "/usr/lib/clang/9.0.1/include/stddef.h:104"]
pub mod stddef_h {
    #[c2rust::src_loc = "46:1"]
    pub type size_t = libc::c_ulong;
}
#[c2rust::header_src = "/usr/include/bits/types.h:104"]
pub mod types_h {
    #[c2rust::src_loc = "38:1"]
...
#[c2rust::header_src = "/usr/include/bits/stdint-uintn.h:104"]
...
#[c2rust::header_src = "/usr/include/unistd.h:104"]
pub mod unistd_h {
    #[c2rust::src_loc = "274:1"]
    pub type socklen_t = __socklen_t;
    use super::types_h::__socklen_t;
}
#[c2rust::header_src = "/usr/include/bits/sockaddr.h:106"]
pub mod sockaddr_h {
    #[c2rust::src_loc = "28:1"]
    pub type sa_family_t = libc::c_ushort;
}
#[c2rust::header_src = "/usr/include/bits/socket.h:106"]
pub mod socket_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/usr/include/netinet/in.h:106"]
pub mod in_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/usr/include/netdb.h:106"]
pub mod netdb_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
pub use self::types_h::{__uint8_t, __uint16_t, __uint32_t, __socklen_t};
pub use self::stdint_uintn_h::{uint8_t, uint16_t, uint32_t};
pub use self::unistd_h::socklen_t;
pub use self::sockaddr_h::sa_family_t;
pub use self::socket_h::sockaddr;
pub use self::in_h::{in6_addr, C2RustUnnamed};
pub use self::netdb_h::{addrinfo, getaddrinfo, freeaddrinfo, gai_strerror,
                        getnameinfo};
#[inline]
#[c2rust::src_loc = "320:1"]
unsafe extern "C" fn system_getaddrinfo(mut name: *const libc::c_char,
                                        mut serv: *const libc::c_char,
                                        mut hint: *const addrinfo,
...
unsafe extern "C" fn system_freeaddrinfo(mut ai: *mut addrinfo) {
    freeaddrinfo(ai);
}
/* ! HAVE_GETADDRINFO */
...
/* NEED_FAKE_GETADDRINFO */
#[inline]
#[c2rust::src_loc = "1087:1"]
unsafe extern "C" fn my_fake_getaddrinfo(mut name: *const libc::c_char,
                                         mut serv: *const libc::c_char,
                                         mut hint: *const addrinfo,
 ...
 -> libc::c_int {
    ...
    if aierr != 0 || (*result).is_null() { return aierr }
...
unsafe extern "C" fn my_fake_freeaddrinfo(mut ai: *mut addrinfo) {
    system_freeaddrinfo(ai);
}
/* WRAP_GETADDRINFO */
/* Some systems don't define in6addr_any.  */
#[no_mangle]
#[c2rust::src_loc = "1318:23"]
pub static mut krb5int_in6addr_any: in6_addr =
    {
        let mut init =
            in6_addr{__in6_u:
...
pub unsafe extern "C" fn krb5int_getaddrinfo(mut node: *const libc::c_char,
                                             mut service: *const libc::c_char,
                                             mut hints: *const addrinfo,
                                             mut aip: *mut *mut addrinfo)
 -> libc::c_int {
    return my_fake_getaddrinfo(node, service, hints, aip);
}
#[no_mangle]
#[c2rust::src_loc = "1327:1"]
pub unsafe extern "C" fn krb5int_freeaddrinfo(mut ai: *mut addrinfo) {
    my_fake_freeaddrinfo(ai);
}
#[no_mangle]
#[c2rust::src_loc = "1332:1"]
pub unsafe extern "C" fn krb5int_gai_strerror(mut err: libc::c_int)
 -> *const libc::c_char {
    return gai_strerror(err);
}
#[no_mangle]
#[c2rust::src_loc = "1337:1"]
pub unsafe extern "C" fn krb5int_getnameinfo(mut sa: *const sockaddr,
                                             mut salen: socklen_t,
                                             mut hbuf: *mut libc::c_char,
                                             mut hbuflen: size_t,
                                             mut sbuf: *mut libc::c_char,
                                             mut sbuflen: size_t,
                                             mut flags: libc::c_int)
 -> libc::c_int {
    return getnameinfo(sa, salen, hbuf, hbuflen as socklen_t, sbuf,
                       sbuflen as socklen_t, flags);
}
