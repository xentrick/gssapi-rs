...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/kdb_log.h:56"]
pub mod kdb_log_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/iprop.h:56"]
pub mod iprop_h {
    #[c2rust::src_loc = "22:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/iprop_hdr.h:56"]
pub mod iprop_hdr_h {
    #[c2rust::src_loc = "32:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/com_err.h:52"]
pub mod com_err_h {
    /*
...
#[c2rust::header_src = "/home/nmavis/dev/gssapi-rs/code/src/include/kdb.h:54"]
pub mod kdb_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    ...
    use super::krb5_h::{krb5_enctype, krb5_int32, krb5_context,
                        ...
                        krb5_boolean, krb5_kvno, krb5_data, krb5_keyblock};
    use super::k5_int_h::_krb5_context;
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "400:1"]
        pub fn krb5_db_store_master_key_list(kcontext: krb5_context,
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/kadm5/admin.h:54"]
pub mod admin_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/usr/include/stdio.h:52"]
pub mod stdio_h {
    extern "C" {
        #[no_mangle]
...
#[c2rust::header_src = "/usr/include/bits/getopt_core.h:52"]
...
#[c2rust::header_src = "/usr/include/libintl.h:52"]
pub mod libintl_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "44:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/kadmin/dbutil/kdb5_util.h:56"]
pub mod kdb5_util_h {
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       krb5_c_valid_enctype, krb5_enctype_to_name};
...
pub use self::kdb_h::{__krb5_key_salt_tuple, krb5_key_salt_tuple,
                      krb5_db_store_master_key_list, krb5_db_fetch_mkey,
...
use self::kdb5_util_h::{progname, master_keyblock, master_princ, exit_status,
                        util_context, global_params, valid_master_key, usage};
#[no_mangle]
#[c2rust::src_loc = "65:1"]
pub unsafe extern "C" fn kdb5_stash(mut argc: libc::c_int,
                                    mut argv: *mut *mut libc::c_char) {
    extern "C" {
        #[link_name = "optarg"]
        pub static mut optarg_0: *mut libc::c_char;
    } /* use whatever krb5_db_fetch_mkey finds */
    extern "C" {
        #[link_name = "optind"]
    ...
    let mut keyfile: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if krb5_c_valid_enctype(master_keyblock.enctype) == 0 {
        ...
        if krb5_enctype_to_name(master_keyblock.enctype,
            ...
            com_err(progname, -(1765328233 as libc::c_long),
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"while setting up enctype %d\x00" as *const u8
    ...
    } else { mkey_kvno = 0 as libc::c_int as krb5_kvno }
    if valid_master_key == 0 {
        ...
        retval =
            krb5_db_fetch_mkey(util_context, master_princ,
                               ...
                               &mut mkey_kvno, 0 as *mut krb5_data,
                               &mut master_keyblock);
        if retval != 0 {
        ...
        if retval != 0 {
            com_err(progname, retval as errcode_t,
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"while getting master key list\x00" as *const u8
                                 as *const libc::c_char));
            exit_status += 1;
            return
        }
        ...
        printf(dgettext(b"mit-krb5\x00" as *const u8 as *const libc::c_char,
                        b"Using existing stashed keys to update stash file.\n\x00"
                            as *const u8 as *const libc::c_char));
    }
    retval =
        krb5_db_store_master_key_list(util_context, keyfile, master_princ,
