...
pub unsafe extern "C" fn krb5_gss_compare_name(
    ...
    *minor_status = 0u32;
    *name_equal = crate::src::krb5::naming_exts::kg_compare_name(
        context,
        name1 as crate::gssapiP_krb5_h::krb5_gss_name_t,
        name2 as crate::gssapiP_krb5_h::krb5_gss_name_t,
    ) as i32;
