...
pub unsafe extern "C" fn krb5_gss_release_oid(
     ...
     */
    if krb5_gss_internal_release_oid(minor_status, oid) != 0u32 {
...
pub unsafe extern "C" fn krb5_gss_internal_release_oid(
    mut minor_status: *mut crate::gssapi_h::OM_uint32,
    mut oid: *mut crate::gssapi_h::gss_OID,
) -> crate::gssapi_h::OM_uint32 {
    /*
     ...
     */
    *minor_status = 0u32;
    if *oid != crate::src::krb5::gssapi_krb5::gss_mech_krb5
        && *oid != crate::src::krb5::gssapi_krb5::gss_mech_krb5_old
        && *oid != crate::src::krb5::gssapi_krb5::gss_mech_krb5_wrong
        && *oid != crate::src::krb5::gssapi_krb5::gss_mech_iakerb
        && *oid != crate::src::krb5::gssapi_krb5::gss_nt_krb5_name
        && *oid != crate::src::krb5::gssapi_krb5::gss_nt_krb5_principal
    {
