...
pub unsafe extern "C" fn krb5_gss_convert_static_mech_oid(
    mut oid: crate::gssapi_h::gss_OID,
) -> crate::gssapi_h::gss_OID {
    let mut p = 0 as *const crate::gssapi_h::gss_OID_desc;
    let mut minor_status: crate::gssapi_h::OM_uint32 = 0;
    p = crate::src::krb5::gssapi_krb5::krb5_gss_oid_array.as_ptr();
    while (*p).length != 0 {
        if (*oid).length == (*p).length
            && crate::stdlib::memcmp((*oid).elements, (*p).elements, (*p).length as usize) == 0i32
        {
            crate::src::generic::oid_ops::generic_gss_release_oid(&mut minor_status, &mut oid);
            return p as crate::gssapi_h::gss_OID;
        }
        p = p.offset(1)
    }
    return oid;
...
pub unsafe extern "C" fn krb5_gss_import_sec_context(
    ...
    let mut ibp = 0 as *mut crate::krb5_h::krb5_octet;
    ...
    kret = crate::src::krb5::init_sec_context::krb5_gss_init_context(&mut context);
    if kret != 0 {
        *minor_status = kret as crate::gssapi_h::OM_uint32;
        return (13u32) << 16i32;
    }
    /* Assume a tragic failure */
    ctx = 0 as crate::gssapiP_krb5_h::krb5_gss_ctx_id_t;
    *minor_status = 0u32;
    /* Internalize the context */
    ibp = (*interprocess_token).value as *mut crate::krb5_h::krb5_octet;
    blen = (*interprocess_token).length;
    kret = crate::src::krb5::ser_sctx::kg_ctx_internalize(context, &mut ctx, &mut ibp, &mut blen);
    if kret != 0 {
        *minor_status = kret as crate::gssapi_h::OM_uint32;
