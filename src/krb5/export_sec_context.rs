...
pub use crate::src::krb5::export_sec_context::gssapi_alloc_h::gssalloc_malloc;
pub use crate::src::krb5::ser_sctx::kg_ctx_externalize;
pub use crate::src::krb5::ser_sctx::kg_ctx_size;
...
pub unsafe extern "C" fn krb5_gss_export_sec_context(
    ...
    let mut blen: crate::stddef_h::size_t = 0;
    let mut ctx = 0 as *mut crate::gssapiP_krb5_h::_krb5_gss_ctx_id_rec;
    let mut obuffer = 0 as *mut crate::krb5_h::krb5_octet;
    let mut obp = 0 as *mut crate::krb5_h::krb5_octet;
    /* Assume a tragic failure */
    obuffer = 0 as *mut crate::krb5_h::krb5_octet;
    retval = (13u32) << 16i32;
    *minor_status = 0u32;
    ...
    bufsize = 0usize;
    kret = crate::src::krb5::ser_sctx::kg_ctx_size(context, ctx, &mut bufsize);
    if !(kret != 0) {
        /* Allocate the buffer */
        obuffer = gssalloc_malloc(bufsize) as *mut crate::krb5_h::krb5_octet;
        if obuffer.is_null() {
            kret = 12i32
        } else {
            obp = obuffer;
            ...
            kret =
                crate::src::krb5::ser_sctx::kg_ctx_externalize(context, ctx, &mut obp, &mut blen);
            if !(kret != 0) {
    ...
    if retval != 0u32 {
        if kret != 0i32 && !context.is_null() {
            crate::src::krb5::disp_status::krb5_gss_save_error_info(
                kret as crate::gssapi_h::OM_uint32,
                context,
            );
        }
    }
    if !obuffer.is_null() && bufsize != 0 {
        crate::stdlib::explicit_bzero(obuffer as *mut libc::c_void, bufsize);
        crate::stdlib::free(obuffer as *mut libc::c_void);
    }
