...
pub use crate::src::krb5::copy_ccache::k5_thread_h::k5_mutex_lock;
pub use crate::src::krb5::copy_ccache::k5_thread_h::k5_mutex_unlock;
...
pub unsafe extern "C" fn gss_krb5int_copy_ccache(
    ...
    let mut k5creds = 0 as *mut crate::gssapiP_krb5_h::_krb5_gss_cred_id_rec;
    let mut code: crate::krb5_h::krb5_error_code = 0;
    let mut context = 0 as crate::krb5_h::krb5_context;
    let mut out_ccache = 0 as *mut crate::krb5_h::_krb5_ccache;
    if (*value).length == ::std::mem::size_of::<crate::krb5_h::krb5_ccache>() {
    } else {
        crate::stdlib::__assert_fail(b"value->length == sizeof(out_ccache)\x00" as *const u8
                          as *const i8,
                      b"copy_ccache.c\x00" as *const u8 as
                          *const i8,
                      15u32,
                      (*::std::mem::transmute::<&[u8; 99],
                                                &[i8; 99]>(b"OM_uint32 gss_krb5int_copy_ccache(OM_uint32 *, gss_cred_id_t *, const gss_OID, const gss_buffer_t)\x00")).as_ptr());
    }
    if (*value).length != ::std::mem::size_of::<crate::krb5_h::krb5_ccache>() {
        return (13u32) << 16i32;
    }
    out_ccache = (*value).value as crate::krb5_h::krb5_ccache;
    /* cred handle will have been validated by gssspi_set_cred_option() */
    k5creds = *cred_handle as crate::gssapiP_krb5_h::krb5_gss_cred_id_t;
    k5_mutex_lock(&mut (*k5creds).lock);
    if (*k5creds).usage == 2i32 {
        ...
        if !(code != 0) {
            code = crate::krb5_h::krb5_cc_copy_creds(context, (*k5creds).ccache, out_ccache)
        }
    }
    ...
    *minor_status = code as crate::gssapi_h::OM_uint32;
    ...
    return if code != 0 { (13u32) << 16i32 } else { 0u32 };
}
