...
pub mod k5_platform_h {
    ...
    use crate::src::krb5::prf::byteswap_h::__bswap_32;
    /* K5_PLATFORM_H */
}
...
pub use crate::krb5_h::krb5_c_prf_length;
...
pub use crate::krb5_h::krb5_k_key_enctype;
pub use crate::krb5_h::krb5_k_prf;
...
pub use crate::src::krb5::prf::k5_int_h::k5alloc;
pub use crate::src::krb5::prf::k5_int_h::k5calloc;
pub use crate::src::krb5::prf::k5_platform_h::store_32_be;
...
pub use crate::src::krb5::prf::byteswap_h::__bswap_32;
pub use crate::src::krb5::prf::gssapi_alloc_h::gssalloc_malloc;
...
pub unsafe extern "C" fn krb5_gss_pseudo_random(
    ...
    let mut key = 0 as crate::krb5_h::krb5_key;
    let mut ctx = 0 as *mut crate::gssapiP_krb5_h::_krb5_gss_ctx_id_rec;
    let mut i: i32 = 0;
    let mut minor: crate::gssapi_h::OM_uint32 = 0;
    let mut prflen: crate::stddef_h::size_t = 0;
    let mut t = crate::krb5_h::krb5_data {
        magic: 0,
        length: 0,
        data: 0 as *mut i8,
    };
    let mut ns = crate::krb5_h::krb5_data {
        magic: 0,
        length: 0,
        data: 0 as *mut i8,
    };
    let mut p = 0 as *mut u8;
    (*prf_out).length = 0usize;
    (*prf_out).value = 0 as *mut libc::c_void;
    t.length = 0u32;
    t.data = 0 as *mut i8;
    ns.length = 0u32;
    ns.data = 0 as *mut i8;
    ctx = context as crate::gssapiP_krb5_h::krb5_gss_ctx_id_t;
    ...
    match prf_key {
        0 => {
            if (*ctx).have_acceptor_subkey() != 0 {
                ...
                current_block = 9367819545240679859;
            }
        }
        1 => {
            current_block = 9367819545240679859;
    ...
    match current_block {
        224731115979188411 => {
            if key.is_null() {
                ...
                if desired_output_len == 0isize {
                    return 0u32;
                }
                (*prf_out).value = gssalloc_malloc(desired_output_len as crate::stddef_h::size_t);
                if (*prf_out).value.is_null() {
                    code = 39756047i32
                } else {
                    (*prf_out).length = desired_output_len as crate::stddef_h::size_t;
                    code = crate::krb5_h::krb5_c_prf_length(
                        (*ctx).k5_context,
                        crate::krb5_h::krb5_k_key_enctype((*ctx).k5_context, key),
                        &mut prflen,
                    );
                    if !(code != 0i32) {
                        ns.length = (4usize).wrapping_add((*prf_in).length) as u32;
                        ns.data =
                            k5alloc(ns.length as crate::stddef_h::size_t, &mut code) as *mut i8;
                        if ns.data.is_null() {
                            code = 39756047i32
                        } else {
                            t.length = prflen as u32;
                            t.data =
                                k5alloc(t.length as crate::stddef_h::size_t, &mut code) as *mut i8;
                            if !t.data.is_null() {
                                crate::stdlib::memcpy(
                                    ns.data.offset(4isize) as *mut libc::c_void,
                                    (*prf_in).value,
                                    (*prf_in).length,
                                );
                                i = 0i32;
                                p = (*prf_out).value as *mut u8;
                                while desired_output_len > 0isize {
                                    store_32_be(i as u32, ns.data as *mut libc::c_void);
                                    code = crate::krb5_h::krb5_k_prf(
                                        (*ctx).k5_context,
                                        key,
                                        &mut ns,
                                        &mut t,
                                    ...
                                    crate::stdlib::memcpy(
                                        ...
                                        if (t.length as isize) < desired_output_len {
                                            t.length as isize
                                        } else {
                                            desired_output_len
                                        } as usize,
                                    ...
                                    desired_output_len -= t.length as isize;
                                    i += 1
                                }
                            }
                        }
    ...
    if code != 0i32 {
        crate::src::mechglue::g_rel_buffer::gss_release_buffer(&mut minor, prf_out);
    }
    crate::krb5_h::krb5_free_data_contents((*ctx).k5_context, &mut ns);
    crate::krb5_h::krb5_free_data_contents((*ctx).k5_context, &mut t);
    *minor_status = code as crate::gssapi_h::OM_uint32;
    return if code == 0i32 { 0u32 } else { (13u32) << 16i32 };
}
