...
pub unsafe extern "C" fn krb5_gss_display_name(
    ...
    let mut k5name = input_name as crate::gssapiP_krb5_h::krb5_gss_name_t;
    let mut nametype = crate::src::krb5::gssapi_krb5::gss_nt_krb5_name;
    ...
    if (*(*k5name).princ).type_0 == 11i32 {
        if crate::krb5_h::krb5_principal_compare(
            context,
            (*k5name).princ as crate::krb5_h::krb5_const_principal,
            crate::krb5_h::krb5_anonymous_principal(),
        ) != 0
        {
            nametype = crate::src::generic::gssapi_generic::GSS_C_NT_ANONYMOUS
        }
    }
    code = crate::krb5_h::krb5_unparse_name(
        context,
        (*(input_name as crate::gssapiP_krb5_h::krb5_gss_name_t)).princ
            as crate::krb5_h::krb5_const_principal,
        &mut str,
    );
    if code != 0 {
        *minor_status = code as crate::gssapi_h::OM_uint32;
    ...
    if crate::src::generic::util_buffer::gssint_g_make_string_buffer(str, output_name_buffer) == 0 {
        crate::krb5_h::krb5_free_unparsed_name(context, str);
        crate::krb5_h::krb5_free_context(context);
        *minor_status = -(2045022972 as isize) as crate::gssapi_h::OM_uint32;
        return (13u32) << 16i32;
    }
    crate::krb5_h::krb5_free_unparsed_name(context, str);
    crate::krb5_h::krb5_free_context(context);
