...
pub use crate::src::krb5::k5unseal::kg_unseal;
...
pub unsafe extern "C" fn krb5_gss_process_context_token(
    ...
    let mut majerr: crate::gssapi_h::OM_uint32 = 0;
