...
pub mod stdio_h {
    extern "C" {
        ...
        pub fn asprintf(__ptr: *mut *mut i8,
                        __fmt: *const i8, _: ...) -> i32;
    }
}
...
pub mod libintl_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "44:1"]
        pub fn dgettext(__domainname: *const i8,
                        __msgid: *const i8) -> *mut i8;
    }
}
...
static mut calling_error: *const i8 =
    b"calling error\x00" as *const u8 as *const i8;
/* */
...
static mut routine_error: *const i8 =
    b"routine error\x00" as *const u8 as *const i8;
/* */
...
static mut sinfo_code: *const i8 =
    b"supplementary info code\x00" as *const u8 as *const i8;
/* */
/* */
...
static mut unknown_error: *const i8 =
    b"Unknown %s (field = %d)\x00" as *const u8 as *const i8;
/* */
#[c2rust::src_loc = "111:1"]
unsafe extern "C" fn display_unknown(mut kind: *const i8,
                                     mut value: OM_uint32,
                                     mut buffer: gss_buffer_t)
 -> i32 {
    let mut str = 0 as *mut i8;
    if asprintf(&mut str as *mut *mut i8,
                dgettext(b"mit-krb5\x00" as *const u8 as *const i8,
                         unknown_error), kind, value) < 0 as i32 {
        return 0 as i32
    }
...
unsafe extern "C" fn display_calling(mut minor_status: *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    str =
        if (code & (0o377 as usize as OM_uint32) << 24 as i32)
               < (1 as usize as OM_uint32) << 24 as i32 ||
               code &
                   (0o377 as usize as OM_uint32) << 24 as i32
                   > (3 as usize as OM_uint32) << 24 as i32 {
            0 as *mut i8
        } else {
            dgettext(b"mit-krb5\x00" as *const u8 as *const i8,
                     calling_error_string[(code >> 24 as i32 &
                                               0o377 as usize as
                                                   OM_uint32) as usize])
        };
    if !str.is_null() {
...
unsafe extern "C" fn display_routine(mut minor_status: *mut OM_uint32,
 ...
 -> OM_uint32 {
    let mut str = 0 as *const i8;
    str =
        if (code & (0o377 as usize as OM_uint32) << 16 as i32)
               < (1 as usize as OM_uint32) << 16 as i32 ||
               code &
                   (0o377 as usize as OM_uint32) << 16 as i32
                   > (13 as usize as OM_uint32) << 16 as i32 {
            0 as *mut i8
        } else {
            dgettext(b"mit-krb5\x00" as *const u8 as *const i8,
                     routine_error_string[(code >> 16 as i32 &
                                               0o377 as usize as
                                                   OM_uint32) as usize])
        };
    if !str.is_null() {
...
pub unsafe extern "C" fn gssint_g_display_major_status(mut minor_status:
 ...
 -> OM_uint32 {
    ...
    if status_value == 0 as i32 as u32 {
        if gssint_g_make_string_buffer(no_error, status_string) == 0 {
            *minor_status = 12 as i32 as OM_uint32;
            return (13 as usize as OM_uint32) << 16 as i32
        }
        *message_context = 0 as i32 as OM_uint32;
        *minor_status = 0 as i32 as OM_uint32;
        return 0 as i32 as OM_uint32
    }
    /* ** do routine error */
    if *message_context == 0 as i32 as u32 {
        tmp =
            status_value &
                (0o377 as usize as OM_uint32) << 16 as i32;
        if tmp != 0 {
            status_value =
                (status_value as u32).wrapping_sub(tmp) as OM_uint32
                    as OM_uint32;
    ...
    /* ** do calling error */
    if *message_context == 1 as i32 as u32 {
        tmp =
            status_value &
                (0o377 as usize as OM_uint32) << 24 as i32;
        if tmp != 0 {
    ...
    tmp =
        status_value >> 0 as i32 &
            0o177777 as usize as OM_uint32;
    /* mask off the bits which have been done */
    if *message_context > 2 as i32 as u32 {
        tmp &=
            !((1 as i32) <<
                  (*message_context).wrapping_sub(3 as i32 as
                                                      u32) ^
                  ((1 as i32) <<
                       (*message_context).wrapping_sub(3 as i32 as
                                                           u32)) -
    ...
    /*SUPPRESS 570*/
    bit = 0 as i32;
    while (1 as i32 as OM_uint32) << bit !=
              (tmp ^
                   tmp.wrapping_sub(1 as i32 as
    ...
    status_value =
        (status_value as
             u32).wrapping_sub((1 as i32 as OM_uint32) <<
                                            bit) as OM_uint32 as OM_uint32;
    if status_value != 0 {
        *message_context = (bit + 3 as i32) as OM_uint32;
        return 0 as i32 as OM_uint32
    } else {
        *message_context = 0 as i32 as OM_uint32;
        return 0 as i32 as OM_uint32
