...
unsafe extern "C" fn val_acq_cred_impersonate_name_args(
...
pub unsafe extern "C" fn gss_acquire_cred_impersonate_name(
    mut minor_status: *mut crate::gssapi_h::OM_uint32,
    impersonator_cred_handle: crate::gssapi_h::gss_cred_id_t,
    desired_name: crate::gssapi_h::gss_name_t,
     ...
     */
    if !actual_mechs.is_null() {
        let mut oids = crate::gssapi_h::gss_OID_set_desc {
            count: 0,
            elements: 0 as *mut crate::gssapi_h::gss_OID_desc_struct,
        };
        oids.count = (*creds).count as crate::stddef_h::size_t;
        oids.elements = (*creds).mechs_array;
        major = crate::src::generic::oid_ops::generic_gss_copy_oid_set(
            minor_status,
            &mut oids,
            actual_mechs,
        );
...
unsafe extern "C" fn val_add_cred_impersonate_name_args(
    mut minor_status: *mut crate::gssapi_h::OM_uint32,
...
pub unsafe extern "C" fn gss_add_cred_impersonate_name(
    mut minor_status: *mut crate::gssapi_h::OM_uint32,
    mut input_cred_handle: crate::gssapi_h::gss_cred_id_t,
    impersonator_cred_handle: crate::gssapi_h::gss_cred_id_t,
    desired_name: crate::gssapi_h::gss_name_t,
    ...
    let mut mech_impersonator_cred = 0 as *mut crate::mglueP_h::gss_cred_id_struct;
    ...
    mech_impersonator_cred = crate::src::mechglue::g_glue::gssint_get_mechanism_cred(
        impersonator_cred_handle,
        selected_mech,
    );
