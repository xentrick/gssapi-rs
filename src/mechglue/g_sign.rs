...
unsafe extern "C" fn val_get_mic_args(
    ...
    mut msg_token: crate::gssapi_h::gss_buffer_t,
...
pub unsafe extern "C" fn gss_get_mic(
    mut minor_status: *mut crate::gssapi_h::OM_uint32,
    mut context_handle: crate::gssapi_h::gss_ctx_id_t,
    ...
    if !mech.is_null() {
        if (*mech).gss_get_mic.is_some() {
            status = (*mech).gss_get_mic.expect("non-null function pointer")(
                minor_status,
                (*ctx).internal_ctx_id,
                qop_req,
                message_buffer,
...
pub unsafe extern "C" fn gss_sign(
    mut minor_status: *mut crate::gssapi_h::OM_uint32,
    mut context_handle: crate::gssapi_h::gss_ctx_id_t,
    mut qop_req: i32,
    mut message_buffer: crate::gssapi_h::gss_buffer_t,
