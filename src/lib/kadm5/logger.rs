 ...
 */
        ...
        #[no_mangle]
        #[c2rust::src_loc = "72:1"]
        pub fn reset_com_err_hook() -> et_old_error_hook_func;
    }
    /* ! defined(__COM_ERR_H) */
}
#[c2rust::header_src =
 ...
 * undefined after the call. */
        #[no_mangle]
        #[c2rust::src_loc = "85:1"]
        pub fn k5_buf_add_vfmt(buf: *mut k5buf, fmt: *const libc::c_char,
                               ap: ::std::ffi::VaList);
...
#[c2rust::header_src = "/usr/include/fcntl.h:33"]
pub mod fcntl_h {
    extern "C" {
        #[no_mangle]
...
#[c2rust::header_src = "/usr/include/sys/syslog.h:38"]
pub mod syslog_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "175:1"]
...
pub use self::types_h::{__int32_t, __off_t, __off64_t, __pid_t, __time_t};
...
use self::syslog_h::{closelog, openlog, syslog};
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "132:8"]
pub struct log_control {
    pub log_entries: *mut log_entry,
    pub log_nentries: libc::c_int,
    pub log_whoami: *mut libc::c_char,
    pub log_hostname: *mut libc::c_char,
    pub log_opened: krb5_boolean,
    pub log_debug: krb5_boolean,
}
/* nb: avoid trigraphs */
/*
 * Output logging.
...
pub struct log_entry {
    pub log_type: log_type,
    pub log_2free: krb5_pointer,
    pub log_union: log_union,
}
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "112:11"]
pub union log_union {
    pub log_file: log_file,
    pub log_syslog: log_syslog,
    pub log_device: log_device,
}
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "120:16"]
pub struct log_device {
    pub ld_filep: *mut FILE,
    pub ld_devname: *mut libc::c_char,
}
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "117:16"]
pub struct log_syslog {
    pub ls_facility: libc::c_int,
}
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "113:16"]
pub struct log_file {
    pub lf_filep: *mut FILE,
    pub lf_fname: *mut libc::c_char,
}
#[c2rust::src_loc = "105:5"]
pub type log_type = libc::c_uint;
#[c2rust::src_loc = "110:21"]
pub const K_LOG_NONE: log_type = 5;
#[c2rust::src_loc = "109:21"]
pub const K_LOG_DEVICE: log_type = 4;
#[c2rust::src_loc = "108:21"]
pub const K_LOG_CONSOLE: log_type = 3;
#[c2rust::src_loc = "107:21"]
pub const K_LOG_STDERR: log_type = 2;
#[c2rust::src_loc = "106:21"]
pub const K_LOG_SYSLOG: log_type = 1;
#[c2rust::src_loc = "105:21"]
pub const K_LOG_FILE: log_type = 0;
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "351:42"]
pub struct C2RustUnnamed {
    pub name: *const libc::c_char,
    pub value: libc::c_int,
}
#[c2rust::src_loc = "141:27"]
static mut log_control: log_control =
    {
        let mut init =
            log_control{log_entries:
                            0 as *const libc::c_void as *mut libc::c_void as
                                *mut log_entry,
                        log_nentries: 0 as libc::c_int,
                        log_whoami:
                            0 as *const libc::c_void as *mut libc::c_void as
                                *mut libc::c_char,
                        log_hostname:
                            0 as *const libc::c_void as *mut libc::c_void as
                                *mut libc::c_char,
                        log_opened: 0 as libc::c_int as krb5_boolean,
                        log_debug: 0,};
        init
    };
#[c2rust::src_loc = "148:25"]
static mut def_log_entry: log_entry =
    log_entry{log_type: K_LOG_FILE,
              log_2free: 0 as *const libc::c_void as *mut libc::c_void,
              log_union:
                  log_union{log_file:
                                log_file{lf_filep:
 ...
 *                        profile.
 */
#[c2rust::src_loc = "165:21"]
static mut err_context: krb5_context =
 ...
 */
#[c2rust::src_loc = "181:1"]
unsafe extern "C" fn klog_com_err_proc(mut whoami: *const libc::c_char,
    ...
    if code != 0 {
        ...
        emsg = krb5_get_error_message(err_context, code as krb5_error_code);
        k5_buf_add(&mut buf, emsg);
        krb5_free_error_message(err_context, emsg);
        k5_buf_add(&mut buf, b" - \x00" as *const u8 as *const libc::c_char);
    }
    /* Add the formatted message. */
    k5_buf_add_vfmt(&mut buf, format, ap.as_va_list());
    if k5_buf_status(&mut buf) == 0 as libc::c_int {
        krb5_klog_syslog(if code != 0 {
                             3 as libc::c_int
                         } else { 6 as libc::c_int },
                         b"%s\x00" as *const u8 as *const libc::c_char,
                         buf.data as *mut libc::c_char);
    }
    k5_buf_free(&mut buf);
}
/* KRB5_KDB5__ */
...
pub unsafe extern "C" fn krb5_klog_init(mut kcontext: krb5_context,
                                        mut ename: *mut libc::c_char,
                                        mut whoami: *mut libc::c_char,
                                        mut do_com_err: krb5_boolean)
 -> krb5_error_code {
    let mut logging_profent: [*const libc::c_char; 3] =
        [0 as *const libc::c_char; 3];
    let mut logging_defent: [*const libc::c_char; 3] =
        [0 as *const libc::c_char; 3];
    let mut logging_specs: *mut *mut libc::c_char =
        0 as *mut *mut libc::c_char;
    let mut i: libc::c_int = 0;
    let mut ngood: libc::c_int = 0;
    let mut fd: libc::c_int = 0;
    let mut append: libc::c_int = 0;
    let mut cp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut cp2: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut savec: libc::c_char = '\u{0}' as i32 as libc::c_char;
    let mut error: libc::c_int = 0;
    let mut debug: libc::c_int = 0;
    let mut do_openlog: libc::c_int = 0;
    let mut log_facility: libc::c_int = 0;
    let mut f: *mut FILE = 0 as *mut FILE;
    /* Initialize */
    do_openlog = 0 as libc::c_int;
    log_facility = 0 as libc::c_int;
    ...
    if profile_get_boolean((*kcontext).profile,
                           b"logging\x00" as *const u8 as *const libc::c_char,
                           b"debug\x00" as *const u8 as *const libc::c_char,
                           0 as *const libc::c_char, 0 as libc::c_int,
                           &mut debug) == 0 {
        log_control.log_debug = debug as krb5_boolean
    }
    /*
     * Look up [logging]-><ename> in the profile.  If that doesn't
     * succeed, then look for [logging]->default.
     */
    logging_profent[0 as libc::c_int as usize] =
        b"logging\x00" as *const u8 as *const libc::c_char;
    logging_profent[1 as libc::c_int as usize] = ename;
    logging_profent[2 as libc::c_int as usize] =
        0 as *mut libc::c_void as *mut libc::c_char;
    logging_defent[0 as libc::c_int as usize] =
        b"logging\x00" as *const u8 as *const libc::c_char;
    logging_defent[1 as libc::c_int as usize] =
        b"default\x00" as *const u8 as *const libc::c_char;
    logging_defent[2 as libc::c_int as usize] =
        0 as *mut libc::c_void as *mut libc::c_char;
    logging_specs = 0 as *mut libc::c_void as *mut *mut libc::c_char;
    ngood = 0 as libc::c_int;
    log_control.log_nentries = 0 as libc::c_int;
    if profile_get_values((*kcontext).profile, logging_profent.as_mut_ptr(),
                          &mut logging_specs) == 0 ||
           profile_get_values((*kcontext).profile,
                              logging_defent.as_mut_ptr(), &mut logging_specs)
               == 0 {
        /*
         * We have a match, so we first count the number of elements
         */
        log_control.log_nentries = 0 as libc::c_int;
        while !(*logging_specs.offset(log_control.log_nentries as
                                          isize)).is_null() {
         ...
         */
        log_control.log_entries =
            malloc((log_control.log_nentries as
                        libc::c_ulong).wrapping_mul(::std::mem::size_of::<log_entry>()
                                                        as libc::c_ulong)) as
                *mut log_entry;
        if !log_control.log_entries.is_null() {
            let mut current_block_91: u64;
            /*
             * Scan through the list.
             */
            i = 0 as libc::c_int;
            while i < log_control.log_nentries {
                (*log_control.log_entries.offset(i as isize)).log_type =
                    K_LOG_NONE;
                let ref mut fresh0 =
                    (*log_control.log_entries.offset(i as isize)).log_2free;
                *fresh0 = *logging_specs.offset(i as isize) as krb5_pointer;
                /*
                 * The format is:
                 *      <whitespace><data><whitespace>
                 * so, trim off the leading and trailing whitespace here.
                 */
                cp = *logging_specs.offset(i as isize);
                while *(*__ctype_b_loc()).offset(*cp as libc::c_int as isize)
                          as libc::c_int &
                ...
                cp2 =
                    &mut *(*logging_specs.offset(i as
                                                     isize)).offset((strlen as
                                                                         unsafe extern "C" fn(_:
                                                                                                  *const libc::c_char)
                                                                             ->
                                                                                 libc::c_ulong)(*logging_specs.offset(i
                                                                                                                          as
                                                                        ...
                                                                        isize)
                        as *mut libc::c_char;
                while *(*__ctype_b_loc()).offset(*cp2 as libc::c_int as isize)
                          as libc::c_int &
                          _ISspace as libc::c_int as libc::c_ushort as
                              libc::c_int != 0 {
                    cp2 = cp2.offset(-1)
                ...
                *cp2 = '\u{0}' as i32 as libc::c_char;
                ...
                if strncasecmp(cp,
                     ...
                     */
                    append =
                        if *cp.offset(4 as libc::c_int as isize) as
                               libc::c_int == ':' as i32 {
                            0o2000 as libc::c_int
                        } else { 0 as libc::c_int };
                    if append != 0 ||
                           *cp.offset(4 as libc::c_int as isize) as
                               libc::c_int == '=' as i32 {
                        fd =
                            open(&mut *cp.offset(5 as libc::c_int as isize) as
                                     *mut libc::c_char,
                        ...
                        if fd == -(1 as libc::c_int) || f.is_null() {
                            fprintf(stderr,
                                    b"Couldn\'t open log file %s: %s\n\x00" as
                                        *const u8 as *const libc::c_char,
                                    &mut *cp.offset(5 as libc::c_int as isize)
                                        as *mut libc::c_char,
                                    error_message(*__errno_location() as
                                                      errcode_t));
                            current_block_91 = 14401909646449704462;
                        } else {
                            fcntl(fileno(f), 2 as libc::c_int,
                                  1 as libc::c_int);
                            let ref mut fresh1 =
                                (*log_control.log_entries.offset(i as
                                                                     isize)).log_union.log_file.lf_filep;
                            *fresh1 = f;
                            (*log_control.log_entries.offset(i as
                                                                 isize)).log_type
                                = K_LOG_FILE;
                            let ref mut fresh2 =
                                (*log_control.log_entries.offset(i as
                                                                     isize)).log_union.log_file.lf_fname;
                            *fresh2 =
                                &mut *cp.offset(5 as libc::c_int as isize) as
                                    *mut libc::c_char;
                            current_block_91 = 7301440000599063274;
                        }
                    } else { current_block_91 = 7301440000599063274; }
                } else {
                    /*
                 * Is this a syslog?
                 */
                    if strncasecmp(cp,
                                   b"SYSLOG\x00" as *const u8 as
                                       *const libc::c_char,
                                   6 as libc::c_int as libc::c_ulong) == 0 {
                        error = 0 as libc::c_int;
                        (*log_control.log_entries.offset(i as
                                                             isize)).log_union.log_syslog.ls_facility
                            = (4 as libc::c_int) << 3 as libc::c_int;
                        /*
                     * Is there a severify (which is now ignored) specified?
                     */
                        if *cp.offset(6 as libc::c_int as isize) as
                               libc::c_int == ':' as i32 {
                            /*
                         * Find the end of the severity.
                         */
                            cp2 =
                                strchr(&mut *cp.offset(7 as libc::c_int as
                                                           isize),
                                       ':' as i32);
                            if !cp2.is_null() {
                                savec = *cp2;
                         ...
                         */
                            if !cp2.is_null() {
                                static mut facilities: [C2RustUnnamed; 19] =
                                    [{
                                         let mut init =
                                             C2RustUnnamed{name:
                                                               b"AUTH\x00" as
                                ...
                                while (j as libc::c_ulong) <
                                          (::std::mem::size_of::<[C2RustUnnamed; 19]>()
                                               as
                                      ...
                                      {
                                    if strcasecmp(cp2,
                                                  facilities[j as usize].name)
                                           == 0 {
                                        (*log_control.log_entries.offset(i as
                                                                             isize)).log_union.log_syslog.ls_facility
                                            = facilities[j as usize].value;
                                        break ;
                        ...
                        *fresh3 =
                            fdopen(fileno(stderr),
                                   b"w\x00" as *const u8 as
                                       *const libc::c_char);
                        if !(*log_control.log_entries.offset(i as
                                                                 isize)).log_union.log_file.lf_filep.is_null()
                           {
                            (*log_control.log_entries.offset(i as
                                                                 isize)).log_type
                                = K_LOG_STDERR;
                            let ref mut fresh4 =
                                (*log_control.log_entries.offset(i as
                                                                     isize)).log_union.log_file.lf_fname;
                            *fresh4 =
                                b"standard error\x00" as *const u8 as
                        ...
                        let ref mut fresh5 =
                            (*log_control.log_entries.offset(i as
                                                                 isize)).log_union.log_device.ld_filep;
                        *fresh5 =
                            fopen(b"/dev/console\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"a+\x00" as *const u8 as
                                      *const libc::c_char);
                        if !(*log_control.log_entries.offset(i as
                                                                 isize)).log_union.log_device.ld_filep.is_null()
                           {
                            fcntl(fileno((*log_control.log_entries.offset(i as
                                                                              isize)).log_union.log_device.ld_filep),
                            ...
                            let ref mut fresh6 =
                                (*log_control.log_entries.offset(i as
                                                                     isize)).log_union.log_device.ld_devname;
                            *fresh6 =
                                b"console\x00" as *const u8 as
                                    *const libc::c_char as *mut libc::c_char
                        }
                        ...
                        if *cp.offset(6 as libc::c_int as isize) as
                            ...
                            let ref mut fresh7 =
                                (*log_control.log_entries.offset(i as
                                                                     isize)).log_union.log_device.ld_filep;
                            *fresh7 =
                                fopen(&mut *cp.offset(7 as libc::c_int as
                                                          isize),
                                      b"w\x00" as *const u8 as
                                          *const libc::c_char);
                            if !(*log_control.log_entries.offset(i as
                                                                     isize)).log_union.log_device.ld_filep.is_null()
                               {
                                fcntl(fileno((*log_control.log_entries.offset(i
                                                                                  as
                                                                                  isize)).log_union.log_device.ld_filep),
                                      2 as libc::c_int, 1 as libc::c_int);
                                (*log_control.log_entries.offset(i as
                                ...
                                let ref mut fresh8 =
                                    (*log_control.log_entries.offset(i as
                                                                         isize)).log_union.log_device.ld_devname;
                                *fresh8 =
                                    &mut *cp.offset(7 as libc::c_int as isize)
                                        as *mut libc::c_char
                            }
                        }
                    }
                 ...
                 */
                        if (*log_control.log_entries.offset(i as
                                                                isize)).log_type
                               as libc::c_uint ==
                               K_LOG_NONE as libc::c_int as libc::c_uint {
                            fprintf(stderr,
                            ...
                            fprintf(stderr,
                                    dgettext(b"mit-krb5\x00" as *const u8 as
                                                 *const libc::c_char,
                                             b"%s: warning - logging entry syntax error\n\x00"
                                                 as *const u8 as
                                                 *const libc::c_char),
                                    whoami);
                        } else { ngood += 1 }
         ...
         */
        if ngood == 0 as libc::c_int {
            i = 0 as libc::c_int;
            while i < log_control.log_nentries {
                free(*logging_specs.offset(i as isize) as *mut libc::c_void);
                i += 1
            }
        }
        free(logging_specs as *mut libc::c_void);
    }
    /*
    ...
    if ngood == 0 as libc::c_int {
        if !log_control.log_entries.is_null() {
            free(log_control.log_entries as *mut libc::c_void);
        }
        log_control.log_entries = &mut def_log_entry;
        (*log_control.log_entries).log_type = K_LOG_SYSLOG;
        (*log_control.log_entries).log_2free = 0 as *mut libc::c_void;
        (*log_control.log_entries).log_union.log_syslog.ls_facility =
            (4 as libc::c_int) << 3 as libc::c_int;
        log_facility =
            (*log_control.log_entries).log_union.log_syslog.ls_facility;
        do_openlog = 1 as libc::c_int;
        log_control.log_nentries = 1 as libc::c_int
    }
    if log_control.log_nentries != 0 {
        log_control.log_whoami = strdup(whoami);
        log_control.log_hostname =
            malloc((64 as libc::c_int + 1 as libc::c_int) as libc::c_ulong) as
                *mut libc::c_char;
        if !log_control.log_hostname.is_null() {
            if gethostname(log_control.log_hostname,
                           64 as libc::c_int as size_t) == -(1 as libc::c_int)
               {
                free(log_control.log_hostname as *mut libc::c_void);
                log_control.log_hostname = 0 as *mut libc::c_char
            } else {
                *log_control.log_hostname.offset(64 as libc::c_int as isize) =
                    '\u{0}' as i32 as libc::c_char
            }
        }
        if do_openlog != 0 {
            openlog(whoami, 0x8 as libc::c_int | 0x1 as libc::c_int,
                    log_facility);
            log_control.log_opened = 1 as libc::c_int as krb5_boolean
        }
        if do_com_err != 0 {
            set_com_err_hook(Some(klog_com_err_proc as
                                      unsafe extern "C" fn(_:
                                                               *const libc::c_char,
                                                           _: libc::c_long,
                                                           _:
    ...
    return if log_control.log_nentries != 0 {
               0 as libc::c_int
...
pub unsafe extern "C" fn krb5_klog_set_context(mut kcontext: krb5_context) {
    err_context = kcontext;
}
/*
...
pub unsafe extern "C" fn krb5_klog_close(mut kcontext: krb5_context) {
    let mut lindex: libc::c_int = 0;
    reset_com_err_hook();
    lindex = 0 as libc::c_int;
    while lindex < log_control.log_nentries {
        match (*log_control.log_entries.offset(lindex as isize)).log_type as
                  libc::c_uint {
            0 | 2 => {
                /*
             * Files/standard error.
             */
                fclose((*log_control.log_entries.offset(lindex as
                                                            isize)).log_union.log_file.lf_filep);
            }
            3 | 4 => {
                /*
        ...
        if !(*log_control.log_entries.offset(lindex as
                                                 isize)).log_2free.is_null() {
            free((*log_control.log_entries.offset(lindex as
                                                      isize)).log_2free);
        }
        lindex += 1
    }
    if log_control.log_entries != &mut def_log_entry as *mut log_entry {
        free(log_control.log_entries as *mut libc::c_void);
    }
    log_control.log_entries = 0 as *mut libc::c_void as *mut log_entry;
    log_control.log_nentries = 0 as libc::c_int;
    if !log_control.log_whoami.is_null() {
        free(log_control.log_whoami as *mut libc::c_void);
    }
    log_control.log_whoami = 0 as *mut libc::c_void as *mut libc::c_char;
    if !log_control.log_hostname.is_null() {
        free(log_control.log_hostname as *mut libc::c_void);
    }
    log_control.log_hostname = 0 as *mut libc::c_void as *mut libc::c_char;
    if log_control.log_opened != 0 { closelog(); };
}
/*
 * severity2string()    - Convert a severity to a string.
 */
#[c2rust::src_loc = "582:1"]
unsafe extern "C" fn severity2string(mut severity: libc::c_int)
 -> *const libc::c_char {
    let mut s: libc::c_int = 0;
    let mut ss: *const libc::c_char = 0 as *const libc::c_char;
    s = severity & 0x7 as libc::c_int;
    ss = b"???\x00" as *const u8 as *const libc::c_char;
    match s {
        0 => {
            ss =
                dgettext(b"mit-krb5\x00" as *const u8 as *const libc::c_char,
                         b"EMERGENCY\x00" as *const u8 as *const libc::c_char)
        }
        1 => {
            ss =
                dgettext(b"mit-krb5\x00" as *const u8 as *const libc::c_char,
                         b"ALERT\x00" as *const u8 as *const libc::c_char)
        }
        2 => {
            ss =
                dgettext(b"mit-krb5\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn klog_vsyslog(mut priority: libc::c_int,
                                  mut format: *const libc::c_char,
                                  mut arglist: ::std::ffi::VaList)
 -> libc::c_int {
    let mut outbuf: [libc::c_char; 2048] = [0; 2048];
    let mut lindex: libc::c_int = 0;
    let mut syslogp: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut cp: *mut libc::c_char = 0 as *mut libc::c_char;
     ...
     *          <date> <message>
     */
    cp = outbuf.as_mut_ptr();
    time(&mut now);
    /*
     * Format the date: mon dd hh:mm:ss
     */
    tm = localtime(&mut now);
    if tm.is_null() { return -(1 as libc::c_int) }
    soff =
        strftime(outbuf.as_mut_ptr(),
                 ::std::mem::size_of::<[libc::c_char; 2048]>() as
                     libc::c_ulong,
                 b"%b %d %H:%M:%S\x00" as *const u8 as *const libc::c_char,
                 tm);
    if soff > 0 as libc::c_int as libc::c_ulong {
        cp = cp.offset(soff as isize)
    } else { return -(1 as libc::c_int) }
    snprintf(cp,
             (::std::mem::size_of::<[libc::c_char; 2048]>() as
                  libc::c_ulong).wrapping_sub(cp.wrapping_offset_from(outbuf.as_mut_ptr())
                                                  as libc::c_long as
                                                  libc::c_ulong),
             b" %s %s[%ld](%s): \x00" as *const u8 as *const libc::c_char,
             if !log_control.log_hostname.is_null() {
                 log_control.log_hostname as *const libc::c_char
             } else { b"\x00" as *const u8 as *const libc::c_char },
             if !log_control.log_whoami.is_null() {
                 log_control.log_whoami as *const libc::c_char
             } else { b"\x00" as *const u8 as *const libc::c_char },
             getpid() as libc::c_long, severity2string(priority));
    syslogp =
        &mut *outbuf.as_mut_ptr().offset((strlen as
                                              unsafe extern "C" fn(_:
                                                                       *const libc::c_char)
                                                  ->
                                                      libc::c_ulong)(outbuf.as_mut_ptr())
                                             as isize) as *mut libc::c_char;
    /* Now format the actual message */
    vsnprintf(syslogp,
              (::std::mem::size_of::<[libc::c_char; 2048]>() as
                   libc::c_ulong).wrapping_sub(syslogp.wrapping_offset_from(outbuf.as_mut_ptr())
                                                   as libc::c_long as
                                                   libc::c_ulong), format,
              arglist.as_va_list());
    /*
     ...
     */
    if log_control.log_nentries == 0 as libc::c_int {
        /* Log the message with our header trimmed off */
        syslog(priority, b"%s\x00" as *const u8 as *const libc::c_char,
               syslogp);
    }
    /*
    ...
    while lindex < log_control.log_nentries {
        ...
        if !(priority == 7 as libc::c_int && log_control.log_debug == 0 &&
                 (*log_control.log_entries.offset(lindex as isize)).log_type
                     as libc::c_uint !=
                     K_LOG_SYSLOG as libc::c_int as libc::c_uint) {
            match (*log_control.log_entries.offset(lindex as isize)).log_type
                      as libc::c_uint {
                0 | 2 => {
                    /*
             * Files/standard error.
             */
                    if fprintf((*log_control.log_entries.offset(lindex as
                                                                    isize)).log_union.log_file.lf_filep,
                               b"%s\n\x00" as *const u8 as
                                   *const libc::c_char, outbuf.as_mut_ptr()) <
                           0 as libc::c_int {
                        /* Attempt to report error */
                        fprintf(stderr,
                                dgettext(b"mit-krb5\x00" as *const u8 as
                                             *const libc::c_char,
                                         b"%s: error writing to %s\n\x00" as
                                             *const u8 as
                                             *const libc::c_char),
                                log_control.log_whoami,
                                (*log_control.log_entries.offset(lindex as
                                                                     isize)).log_union.log_file.lf_fname);
                    } else {
                        fflush((*log_control.log_entries.offset(lindex as
                                                                    isize)).log_union.log_file.lf_filep);
                    }
                }
                3 | 4 => {
             ...
             * Devices (may need special handling)
             */
                    if (if fprintf((*log_control.log_entries.offset(lindex as
                                                                        isize)).log_union.log_device.ld_filep,
                                   b"%s\r\n\x00" as *const u8 as
                                       *const libc::c_char,
                                   outbuf.as_mut_ptr()) >= 0 as libc::c_int {
                            fflush((*log_control.log_entries.offset(lindex as
                                                                        isize)).log_union.log_device.ld_filep);
                            0 as libc::c_int
...
pub unsafe extern "C" fn krb5_klog_syslog(mut priority: libc::c_int,
                                          mut format: *const libc::c_char,
                                          mut args: ...) -> libc::c_int {
    let mut retval: libc::c_int = 0;
    let mut pvar: ::std::ffi::VaListImpl;
    pvar = args.clone();
    retval = klog_vsyslog(priority, format, pvar.as_va_list());
    return retval;
}
/*
...
pub unsafe extern "C" fn krb5_klog_reopen(mut kcontext: krb5_context) {
    let mut lindex: libc::c_int = 0;
    let mut f: *mut FILE = 0 as *mut FILE;
    /*
    ...
    lindex = 0 as libc::c_int;
    while lindex < log_control.log_nentries {
        if (*log_control.log_entries.offset(lindex as isize)).log_type as
               libc::c_uint == K_LOG_FILE as libc::c_int as libc::c_uint {
            fclose((*log_control.log_entries.offset(lindex as
                                                        isize)).log_union.log_file.lf_filep);
            /*
             ...
             */
            f =
                fopen((*log_control.log_entries.offset(lindex as
                                                           isize)).log_union.log_file.lf_fname,
