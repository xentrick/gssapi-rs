...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/plugin.h:29"]
pub mod plugin_h {
    #[c2rust::src_loc = "34:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/pwqual_plugin.h:30"]
...
pub use self::krb5_h::{krb5_int32, krb5_boolean, krb5_enctype, krb5_flags,
                       ...
                       krb5_prompt_type, _profile_t, krb5_set_error_message};
...
#[c2rust::src_loc = "33:1"]
unsafe extern "C" fn empty_check(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    if *password as libc::c_int == '\u{0}' as i32 {
        krb5_set_error_message(context,
                               43787542 as libc::c_long as krb5_error_code,
                               dgettext(b"mit-krb5\x00" as *const u8 as
                                            *const libc::c_char,
                                        b"Empty passwords are not allowed\x00"
                                            as *const u8 as
                                            *const libc::c_char));
        return 43787542 as libc::c_long as krb5_error_code
    }
...
#[no_mangle]
#[c2rust::src_loc = "48:1"]
pub unsafe extern "C" fn pwqual_empty_initvt(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    (*vt).name = b"empty\x00" as *const u8 as *const libc::c_char;
    (*vt).check =
        Some(empty_check as
