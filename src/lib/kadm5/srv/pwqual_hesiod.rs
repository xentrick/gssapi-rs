...
/* HESIOD */
#[c2rust::src_loc = "94:1"]
unsafe extern "C" fn hesiod_check(mut context: krb5_context,
...
pub unsafe extern "C" fn pwqual_hesiod_initvt(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    (*vt).name = b"hesiod\x00" as *const u8 as *const libc::c_char;
    (*vt).check =
        Some(hesiod_check as
