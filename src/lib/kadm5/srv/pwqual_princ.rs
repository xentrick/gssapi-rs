...
#[c2rust::header_src = "/usr/include/strings.h:29"]
pub mod strings_h {
    extern "C" {
        #[no_mangle]
...
#[c2rust::src_loc = "33:1"]
unsafe extern "C" fn princ_check(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    n = (*princ).length;
    cp = (*princ).realm.data;
    if strcasecmp(cp, password) == 0 as libc::c_int {
        ...
        if strcasecmp(cp, password) == 0 as libc::c_int {
            krb5_set_error_message(context,
                                   ...
                                   dgettext(b"mit-krb5\x00" as *const u8 as
                                                *const libc::c_char,
                                            b"Password may not match principal name\x00"
                                                as *const u8 as
                                                *const libc::c_char));
            return 43787544 as libc::c_long as krb5_error_code
        }
...
#[no_mangle]
#[c2rust::src_loc = "62:1"]
pub unsafe extern "C" fn pwqual_princ_initvt(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    (*vt).name = b"princ\x00" as *const u8 as *const libc::c_char;
    (*vt).check =
        Some(princ_check as
