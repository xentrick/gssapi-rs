...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_enctype,
                       ...
                       krb5_c_make_checksum, krb5_free_checksum_contents,
                       krb5_free_data_contents};
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         CANONHOST_FALLBACK, CANONHOST_TRUE, CANONHOST_FALSE,
                         krb5_preauth_context, kdb5_dal_handle,
                         _krb5_os_context, alloc_data, plugin_mapping,
...
pub use self::krad_h::krad_attr;
use self::stdlib_h::calloc;
use self::string_h::{explicit_bzero, strlen, strcmp, memset, memcpy};
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "43:9"]
pub struct attribute_record {
    pub name: *const libc::c_char,
    pub minval: libc::c_uchar,
    pub maxval: libc::c_uchar,
    pub encode: attribute_transform_fn,
    pub decode: attribute_transform_fn,
}
#[c2rust::src_loc = "38:1"]
pub type attribute_transform_fn
    =
    Option<unsafe extern "C" fn(_: krb5_context, _: *const libc::c_char,
                                _: *const libc::c_uchar, _: *const krb5_data,
                                _: *mut libc::c_uchar, _: *mut size_t)
               -> krb5_error_code>;
#[c2rust::src_loc = "61:31"]
static mut attributes: [attribute_record; 255] =
    unsafe {
        [{
             let mut init =
                 attribute_record{name:
                                      b"User-Name\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"User-Password\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval: 128 as libc::c_int as libc::c_uchar,
                                  encode:
                                      Some(user_password_encode as
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"CHAP-Password\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 17 as libc::c_int as libc::c_uchar,
                                  maxval: 17 as libc::c_int as libc::c_uchar,
                                  encode: None,
                                  decode: None,};
             init
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"NAS-IP-Address\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
                                  decode: None,};
             init
         },
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-Protocol\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-IP-Address\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-IP-Netmask\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-Routing\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Filter-Id\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-MTU\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-Compression\x00" as *const u8
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-IP-Host\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-Service\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-TCP-Port\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         {
             let mut init =
                 attribute_record{name: 0 as *const libc::c_char,
                                  minval: 0 as libc::c_int as libc::c_uchar,
                                  maxval: 0 as libc::c_int as libc::c_uchar,
                                  encode: None,
                                  decode: None,};
             init
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Reply-Message\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Callback-Number\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Callback-Id\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-Route\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-IPX-Network\x00" as *const u8
                                          as *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Vendor-Specific\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 5 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
                                           1 as libc::c_int -
                                           2 as libc::c_int) as libc::c_uchar,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Session-Timeout\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Termination-Action\x00" as *const u8
                                          as *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Called-Station-Id\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Calling-Station-Id\x00" as *const u8
                                          as *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"NAS-Identifier\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Proxy-State\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-LAT-Service\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-LAT-Node\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-LAT-Group\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 32 as libc::c_int as libc::c_uchar,
                                  maxval: 32 as libc::c_int as libc::c_uchar,
                                  encode: None,
                                  decode: None,};
             init
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-AppleTalk-Link\x00" as
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-AppleTalk-Network\x00" as
                                          *const u8 as *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Framed-AppleTalk-Zone\x00" as
                                          *const u8 as *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"CHAP-Challenge\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 5 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"NAS-Port-Type\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Port-Limit\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 4 as libc::c_int as libc::c_uchar,
                                  maxval: 4 as libc::c_int as libc::c_uchar,
                                  encode: None,
         ...
         },
         {
             let mut init =
                 attribute_record{name:
                                      b"Login-LAT-Port\x00" as *const u8 as
                                          *const libc::c_char,
                                  minval: 1 as libc::c_int as libc::c_uchar,
                                  maxval:
                                      (127 as libc::c_int * 2 as libc::c_int +
...
unsafe extern "C" fn user_password_encode(mut ctx: krb5_context,
 ...
 -> krb5_error_code {
    let mut indx: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut retval: krb5_error_code = 0;
    let mut seclen: libc::c_uint = 0;
    let mut sum: krb5_checksum =
        krb5_checksum{magic: 0,
                      checksum_type: 0,
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut blck: size_t = 0;
    ...
    len =
        (*in_0).length.wrapping_add(16 as libc::c_int as
                                        libc::c_uint).wrapping_sub(1 as
                                                                       libc::c_int
                                                                       as
                                                                       libc::c_uint).wrapping_div(16
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint).wrapping_mul(16
                                                                                                                                     as
                                                                                                                                     libc::c_int
                                                                                                                                     as
                                                                                                                                     libc::c_uint)
    ...
    memset(outbuf as *mut libc::c_void, 0 as libc::c_int, len);
    memcpy(outbuf as *mut libc::c_void, (*in_0).data as *const libc::c_void,
           (*in_0).length as libc::c_ulong);
    /* Create our temporary space for processing each block. */
    seclen = strlen(secret) as libc::c_uint;
    retval =
        alloc_data(&mut tmp,
                   seclen.wrapping_add(16 as libc::c_int as libc::c_uint));
    if retval != 0 as libc::c_int { return retval }
    memcpy(tmp.data as *mut libc::c_void, secret as *const libc::c_void,
           seclen as libc::c_ulong);
    blck = 0 as libc::c_int as size_t;
    indx = auth;
    while blck.wrapping_mul(16 as libc::c_int as libc::c_ulong) < len {
        memcpy(tmp.data.offset(seclen as isize) as *mut libc::c_void,
               indx as *const libc::c_void,
        ...
        if retval != 0 as libc::c_int {
            explicit_bzero(tmp.data as *mut libc::c_void,
                           tmp.length as size_t);
            explicit_bzero(outbuf as *mut libc::c_void, len);
            krb5_free_data_contents(ctx, &mut tmp);
            return retval
        }
        i = 0 as libc::c_int as size_t;
        while i < 16 as libc::c_int as libc::c_ulong {
            let ref mut fresh0 =
                *outbuf.offset(blck.wrapping_mul(16 as libc::c_int as
                                                     libc::c_ulong).wrapping_add(i)
                                   as isize);
            *fresh0 =
                (*fresh0 as libc::c_int ^
                     *sum.contents.offset(i as isize) as libc::c_int) as
                    libc::c_uchar;
            i = i.wrapping_add(1)
        }
        krb5_free_checksum_contents(ctx, &mut sum);
        indx =
            &mut *outbuf.offset(blck.wrapping_mul(16 as libc::c_int as
                                                      libc::c_ulong) as isize)
                as *mut libc::c_uchar;
        blck = blck.wrapping_add(1)
    }
    explicit_bzero(tmp.data as *mut libc::c_void, tmp.length as size_t);
    krb5_free_data_contents(ctx, &mut tmp);
    *outlen = len;
    return 0 as libc::c_int;
}
...
#[c2rust::src_loc = "180:1"]
unsafe extern "C" fn user_password_decode(mut ctx: krb5_context,
                                          mut secret: *const libc::c_char,
                                          mut auth: *const libc::c_uchar,
                                          mut in_0: *const krb5_data,
                                          mut outbuf: *mut libc::c_uchar,
 ...
 -> krb5_error_code {
    ...
    let mut sum: krb5_checksum =
        krb5_checksum{magic: 0,
                      ...
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut blck: ssize_t = 0;
    let mut i: ssize_t = 0;
    let mut tmp: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    if (*in_0).length.wrapping_rem(16 as libc::c_int as libc::c_uint) !=
    ...
    memcpy(tmp.data as *mut libc::c_void, secret as *const libc::c_void,
           seclen as libc::c_ulong);
    blck = 0 as libc::c_int as ssize_t;
    indx = auth;
    while (blck * 16 as libc::c_int as libc::c_long) <
              (*in_0).length as libc::c_long {
        memcpy(tmp.data.offset(seclen as isize) as *mut libc::c_void,
               indx as *const libc::c_void,
               16 as libc::c_int as libc::c_ulong);
        retval =
        ...
        if retval != 0 as libc::c_int {
            explicit_bzero(tmp.data as *mut libc::c_void,
                           tmp.length as size_t);
            explicit_bzero(outbuf as *mut libc::c_void,
                           (*in_0).length as size_t);
            krb5_free_data_contents(ctx, &mut tmp);
            return retval
        }
        i = 0 as libc::c_int as ssize_t;
        while i < 16 as libc::c_int as libc::c_long {
            *outbuf.offset((blck * 16 as libc::c_int as libc::c_long + i) as
                               isize) =
                (*(*in_0).data.offset((blck *
                                           16 as libc::c_int as libc::c_long +
                                           i) as isize) as libc::c_int ^
                     *sum.contents.offset(i as isize) as libc::c_int) as
                    libc::c_uchar;
            i += 1
        }
    ...
    *outlen = (*in_0).length as size_t;
    while *outlen > 0 as libc::c_int as libc::c_ulong &&
              *outbuf.offset((*outlen).wrapping_sub(1 as libc::c_int as
                                                        libc::c_ulong) as
...
pub unsafe extern "C" fn kr_attr_valid(mut type_0: krad_attr,
                                       mut data: *const krb5_data)
 -> krb5_error_code {
    let mut ar: *const attribute_record = 0 as *const attribute_record;
    if type_0 as libc::c_int == 0 as libc::c_int { return 22 as libc::c_int }
    ar =
        &*attributes.as_ptr().offset((type_0 as libc::c_int -
                                          1 as libc::c_int) as isize) as
            *const attribute_record;
    return if (*data).length >= (*ar).minval as libc::c_uint &&
                  (*data).length <= (*ar).maxval as libc::c_uint {
               0 as libc::c_int
           } else { 90 as libc::c_int };
}
/* Encode an attribute. */
#[no_mangle]
#[c2rust::src_loc = "247:1"]
pub unsafe extern "C" fn kr_attr_encode(mut ctx: krb5_context,
                                        mut secret: *const libc::c_char,
                                        mut auth: *const libc::c_uchar,
 ...
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0;
    retval = kr_attr_valid(type_0, in_0);
    if retval != 0 as libc::c_int { return retval }
    if attributes[(type_0 as libc::c_int - 1 as libc::c_int) as
                      usize].encode.is_none() {
        if (*in_0).length >
               (127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int -
                    2 as libc::c_int) as libc::c_uint {
            return 105 as libc::c_int
        ...
        *outlen = (*in_0).length as size_t;
        memcpy(outbuf as *mut libc::c_void,
               (*in_0).data as *const libc::c_void,
               (*in_0).length as libc::c_ulong);
        return 0 as libc::c_int
    }
    return attributes[(type_0 as libc::c_int - 1 as libc::c_int) as
                          usize].encode.expect("non-null function pointer")(ctx,
                                                                            secret,
                                                                            auth,
                                                                            in_0,
                                                                            outbuf,
...
pub unsafe extern "C" fn kr_attr_decode(mut ctx: krb5_context,
                                        mut secret: *const libc::c_char,
                                        mut auth: *const libc::c_uchar,
                                        mut type_0: krad_attr,
                                        mut in_0: *const krb5_data,
 ...
 -> krb5_error_code {
    ...
    return attributes[(type_0 as libc::c_int - 1 as libc::c_int) as
                          usize].decode.expect("non-null function pointer")(ctx,
                                                                            secret,
                                                                            auth,
                                                                            in_0,
                                                                            outbuf,
...
pub unsafe extern "C" fn krad_attr_name2num(mut name: *const libc::c_char)
 -> krad_attr {
    let mut i: libc::c_uchar = 0;
    i = 0 as libc::c_int as libc::c_uchar;
    while (i as libc::c_int) <
              127 as libc::c_int * 2 as libc::c_int + 1 as libc::c_int {
        if !attributes[i as usize].name.is_null() {
            if strcmp(attributes[i as usize].name, name) == 0 as libc::c_int {
                return (i as libc::c_int + 1 as libc::c_int) as krad_attr
            }
        }
        i = i.wrapping_add(1)
    }
    return 0 as libc::c_int as krad_attr;
}
#[no_mangle]
#[c2rust::src_loc = "310:1"]
pub unsafe extern "C" fn krad_attr_num2name(mut type_0: krad_attr)
 -> *const libc::c_char {
