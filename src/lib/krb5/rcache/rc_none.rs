...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/rcache/rc-int.h:33"]
pub mod rc_int_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "33:9"]
 ...
 */
#[c2rust::src_loc = "35:1"]
unsafe extern "C" fn none_resolve(mut ctx: krb5_context,
...
#[c2rust::src_loc = "42:1"]
unsafe extern "C" fn none_close(mut ctx: krb5_context,
                                mut rcdata: *mut libc::c_void) {
}
#[c2rust::src_loc = "47:1"]
unsafe extern "C" fn none_store(mut ctx: krb5_context,
                                mut rcdata: *mut libc::c_void,
...
pub static mut k5_rc_none_ops: krb5_rc_ops =
    unsafe {
        {
            let mut init =
                krb5_rc_ops{type_0:
