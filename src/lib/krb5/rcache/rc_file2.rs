...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/rcache/rc-int.h:35"]
pub mod rc_int_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "33:9"]
    pub struct krb5_rc_ops {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-hashtab.h:34"]
pub mod k5_hashtab_h {
    ...
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "79:1"]
        pub fn k5_siphash24(data: *const uint8_t, len: size_t,
                            seed: *const uint8_t) -> uint64_t;
    }
    /* K5_HASH_H */
}
pub use self::types_h::{__uint8_t, __int32_t, __uint32_t, __uint64_t, __off_t,
                        __ssize_t};
...
pub use self::krb5_h::{krb5_int32, krb5_boolean, krb5_enctype, krb5_flags,
                       ...
                       _profile_t, krb5_c_random_make_octets, krb5_timeofday,
                       krb5_set_error_message};
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         CANONHOST_FALLBACK, CANONHOST_TRUE, CANONHOST_FALSE,
                         krb5_preauth_context, kdb5_dal_handle,
                         _krb5_os_context, make_data, ts_incr, ts_after,
...
pub use self::rc_int_h::krb5_rc_ops;
pub use self::com_err_h::{errcode_t, error_message};
use self::stdlib_h::free;
use self::fcntl_h::open;
use self::errno_h::__errno_location;
use self::unistd_h::{lseek, close, read, write};
use self::string_h::{strdup, memcmp, memset, memcpy};
pub use self::byteswap_h::__bswap_32;
use self::k5_hashtab_h::k5_siphash24;
/* Return the offset and number of records in the next table.  *offset should
 * initially be -1. */
#[inline]
#[c2rust::src_loc = "48:1"]
unsafe extern "C" fn next_table(mut offset: *mut off_t,
                                mut nrecords: *mut off_t) -> krb5_error_code {
    if *offset == -(1 as libc::c_int) as libc::c_long {
        *offset = 16 as libc::c_int as off_t;
        *nrecords = 1023 as libc::c_int as off_t
    } else if *offset == 16 as libc::c_int as libc::c_long {
        *offset +=
            *nrecords *
                (12 as libc::c_int + 4 as libc::c_int) as libc::c_long;
        *nrecords =
            ((1023 as libc::c_int + 1 as libc::c_int) * 2 as libc::c_int) as
                off_t
    } else {
        *offset +=
            *nrecords *
                (12 as libc::c_int + 4 as libc::c_int) as libc::c_long;
        *nrecords *= 2 as libc::c_int as libc::c_long
    }
...
#[c2rust::src_loc = "73:1"]
unsafe extern "C" fn read_records(mut fd: libc::c_int, mut offset: off_t,
                                  mut tag1_out: *mut uint8_t,
                                  mut timestamp1_out: *mut uint32_t,
                                  mut tag2_out: *mut uint8_t,
                                  mut timestamp2_out: *mut uint32_t,
                                  mut nread: *mut libc::c_int)
 -> krb5_error_code {
    let mut buf: [uint8_t; 32] = [0; 32];
    let mut st: ssize_t = 0;
    *nread = 0 as libc::c_int;
    st = lseek(fd, offset, 0 as libc::c_int);
    if st == -(1 as libc::c_int) as libc::c_long {
        return *__errno_location()
    }
    st =
        read(fd, buf.as_mut_ptr() as *mut libc::c_void,
             ((12 as libc::c_int + 4 as libc::c_int) * 2 as libc::c_int) as
                 size_t);
    if st == -(1 as libc::c_int) as libc::c_long {
        return *__errno_location()
    }
    if st >= (12 as libc::c_int + 4 as libc::c_int) as libc::c_long {
        memcpy(tag1_out as *mut libc::c_void,
               buf.as_mut_ptr() as *const libc::c_void,
               12 as libc::c_int as libc::c_ulong);
        *timestamp1_out =
            load_32_be(buf.as_mut_ptr().offset(12 as libc::c_int as isize) as
                           *const libc::c_void);
        *nread = 1 as libc::c_int
    }
    if st ==
           ((12 as libc::c_int + 4 as libc::c_int) * 2 as libc::c_int) as
               libc::c_long {
        memcpy(tag2_out as *mut libc::c_void,
               buf.as_mut_ptr().offset((12 as libc::c_int + 4 as libc::c_int)
                                           as isize) as *const libc::c_void,
               12 as libc::c_int as libc::c_ulong);
        *timestamp2_out =
            load_32_be(buf.as_mut_ptr().offset((12 as libc::c_int +
                                                    4 as libc::c_int) as
                                                   isize).offset(12 as
                                                                     libc::c_int
                                                                     as isize)
                           as *const libc::c_void);
        *nread = 2 as libc::c_int
    }
    return 0 as libc::c_int;
}
/* Write one record to fd at offset, marshalling the tag and timestamp. */
#[c2rust::src_loc = "104:1"]
unsafe extern "C" fn write_record(mut fd: libc::c_int, mut offset: off_t,
                                  mut tag: *const uint8_t,
                                  mut timestamp: uint32_t)
 -> krb5_error_code {
    let mut record: [uint8_t; 16] = [0; 16];
    let mut st: ssize_t = 0;
    memcpy(record.as_mut_ptr() as *mut libc::c_void,
           tag as *const libc::c_void, 12 as libc::c_int as libc::c_ulong);
    store_32_be(timestamp,
                record.as_mut_ptr().offset(12 as libc::c_int as isize) as
                    *mut libc::c_void);
    st = lseek(fd, offset, 0 as libc::c_int);
    if st == -(1 as libc::c_int) as libc::c_long {
        return *__errno_location()
    ...
    st =
        write(fd, record.as_mut_ptr() as *const libc::c_void,
              (12 as libc::c_int + 4 as libc::c_int) as size_t);
    if st == -(1 as libc::c_int) as libc::c_long {
        return *__errno_location()
    }
    if st != (12 as libc::c_int + 4 as libc::c_int) as libc::c_long {
        /* Unexpected for a regular file */
...
unsafe extern "C" fn expired(mut timestamp: uint32_t, mut now: uint32_t,
                             mut skew: uint32_t) -> krb5_boolean {
    return ts_after(now as krb5_timestamp,
                    ts_incr(timestamp as krb5_timestamp,
                            skew as krb5_deltat));
}
/* Check and store a record into an open and locked file.  fd is assumed to be
 * at offset 0. */
#[c2rust::src_loc = "136:1"]
unsafe extern "C" fn store(mut context: krb5_context, mut fd: libc::c_int,
                           mut tag: *const uint8_t, mut now: uint32_t,
                           mut skew: uint32_t) -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut d: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    let mut table_offset: off_t = -(1 as libc::c_int) as off_t;
    let mut nrecords: off_t = 0 as libc::c_int as off_t;
    let mut avail_offset: off_t = -(1 as libc::c_int) as off_t;
    let mut record_offset: off_t = 0;
    let mut st: ssize_t = 0;
    let mut ind: libc::c_int = 0;
    let mut nread: libc::c_int = 0;
    let mut seed: [uint8_t; 16] = [0; 16];
    let mut r1tag: [uint8_t; 12] = [0; 12];
    let mut r2tag: [uint8_t; 12] = [0; 12];
    let mut r1stamp: uint32_t = 0;
    let mut r2stamp: uint32_t = 0;
    /* Read or generate the hash seed. */
    st =
        read(fd, seed.as_mut_ptr() as *mut libc::c_void,
             ::std::mem::size_of::<[uint8_t; 16]>() as libc::c_ulong);
    if st < 0 as libc::c_int as libc::c_long { return *__errno_location() }
    if (st as size_t) <
           ::std::mem::size_of::<[uint8_t; 16]>() as libc::c_ulong {
        d =
        ...
        if ret != 0 { return ret }
        st =
            write(fd, seed.as_mut_ptr() as *const libc::c_void,
                  ::std::mem::size_of::<[uint8_t; 16]>() as libc::c_ulong);
        if st < 0 as libc::c_int as libc::c_long {
            return *__errno_location()
        }
        if st as size_t !=
               ::std::mem::size_of::<[uint8_t; 16]>() as libc::c_ulong {
    ...
    loop  {
        ret = next_table(&mut table_offset, &mut nrecords);
        if ret != 0 { return ret }
        ind =
            k5_siphash24(tag, 12 as libc::c_int as size_t,
                         seed.as_mut_ptr() as
                             *const uint8_t).wrapping_rem(nrecords as
                                                              libc::c_ulong)
                as libc::c_int;
        record_offset =
            table_offset +
                (ind * (12 as libc::c_int + 4 as libc::c_int)) as
                    libc::c_long;
        ret =
            read_records(fd, record_offset, r1tag.as_mut_ptr(), &mut r1stamp,
                         r2tag.as_mut_ptr(), &mut r2stamp, &mut nread);
        if ret != 0 { return ret }
        if nread >= 1 as libc::c_int && r1stamp != 0 &&
               memcmp(r1tag.as_mut_ptr() as *const libc::c_void,
                      tag as *const libc::c_void,
                      12 as libc::c_int as libc::c_ulong) == 0 as libc::c_int
               ||
               nread == 2 as libc::c_int && r2stamp != 0 &&
                   memcmp(r2tag.as_mut_ptr() as *const libc::c_void,
                          tag as *const libc::c_void,
                          12 as libc::c_int as libc::c_ulong) ==
                       0 as libc::c_int {
            return -(1765328350 as libc::c_long) as krb5_error_code
        }
        /* Make note of the first record available for writing (empty, beyond
         * the end of the file, or expired). */
        if avail_offset == -(1 as libc::c_int) as libc::c_long {
            if nread == 0 as libc::c_int || r1stamp == 0 ||
                   expired(r1stamp, now, skew) != 0 {
                avail_offset = record_offset
            } else if nread == 1 as libc::c_int || r2stamp == 0 ||
                          expired(r2stamp, now, skew) != 0 {
                avail_offset =
                    record_offset +
                        (12 as libc::c_int + 4 as libc::c_int) as libc::c_long
            }
        ...
        if nread < 2 as libc::c_int || r1stamp == 0 || r2stamp == 0 {
            return write_record(fd, avail_offset, tag, now)
        }
        /* Use a different hash seed for the next table we search. */
        seed[0 as libc::c_int as usize] =
            seed[0 as libc::c_int as usize].wrapping_add(1)
    };
}
...
pub unsafe extern "C" fn k5_rcfile2_store(mut context: krb5_context,
                                          mut fd: libc::c_int,
                                          mut tag_data: *const krb5_data)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut now: krb5_timestamp = 0;
    let mut tagbuf: [uint8_t; 12] = [0; 12];
    let mut tag: *mut uint8_t = 0 as *mut uint8_t;
    ret = krb5_timeofday(context, &mut now);
    if ret != 0 { return ret }
    /* Extract a tag from the authenticator checksum. */
    if (*tag_data).length >= 12 as libc::c_int as libc::c_uint {
        tag = (*tag_data).data as *mut uint8_t
    } else {
        memcpy(tagbuf.as_mut_ptr() as *mut libc::c_void,
               (*tag_data).data as *const libc::c_void,
               (*tag_data).length as libc::c_ulong);
        memset(tagbuf.as_mut_ptr().offset((*tag_data).length as isize) as
                   *mut libc::c_void, 0 as libc::c_int,
               (12 as libc::c_int as
                    libc::c_uint).wrapping_sub((*tag_data).length) as
                   libc::c_ulong);
        tag = tagbuf.as_mut_ptr()
    }
    ret = krb5_lock_file(context, fd, 0x2 as libc::c_int);
    if ret != 0 { return ret }
    ret =
        store(context, fd, tag as *const uint8_t, now as uint32_t,
              (*context).clockskew as uint32_t);
    krb5_unlock_file(0 as krb5_context, fd);
    return ret;
}
#[c2rust::src_loc = "228:1"]
unsafe extern "C" fn file2_resolve(mut context: krb5_context,
                                   mut residual: *const libc::c_char,
                                   mut rcdata_out: *mut *mut libc::c_void)
 -> krb5_error_code {
    *rcdata_out = strdup(residual) as *mut libc::c_void;
    return if (*rcdata_out).is_null() {
               12 as libc::c_int
           } else { 0 as libc::c_int };
}
#[c2rust::src_loc = "235:1"]
unsafe extern "C" fn file2_close(mut context: krb5_context,
                                 mut rcdata: *mut libc::c_void) {
    free(rcdata);
}
#[c2rust::src_loc = "241:1"]
unsafe extern "C" fn file2_store(mut context: krb5_context,
                                 mut rcdata: *mut libc::c_void,
                                 mut tag: *const krb5_data)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut filename: *const libc::c_char = rcdata as *const libc::c_char;
    let mut fd: libc::c_int = 0;
    fd =
        open(filename,
             0o100 as libc::c_int | 0o2 as libc::c_int | 0 as libc::c_int,
             0o600 as libc::c_int);
    if fd < 0 as libc::c_int {
        ...
        krb5_set_error_message(context, ret,
                               b"%s (filename: %s)\x00" as *const u8 as
                                   *const libc::c_char,
                               error_message(ret as errcode_t), filename);
        return ret
    }
...
#[no_mangle]
#[c2rust::src_loc = "260:19"]
pub static mut k5_rc_file2_ops: krb5_rc_ops =
    unsafe {
        {
            let mut init =
                krb5_rc_ops{type_0:
                                b"file2\x00" as *const u8 as
                                    *const libc::c_char,
                            resolve:
                                Some(file2_resolve as
