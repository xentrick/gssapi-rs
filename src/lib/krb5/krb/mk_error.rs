...
pub mod k5_int_h {
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_error, krb5_data, krb5_error_code};
...
#[no_mangle]
#[c2rust::src_loc = "37:1"]
pub unsafe extern "C" fn krb5_mk_error(mut context: krb5_context,
                                       mut dec_err: *const krb5_error,
                                       mut enc_err: *mut krb5_data)
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0;
    let mut new_enc_err: *mut krb5_data = 0 as *mut krb5_data;
    retval = encode_krb5_error(dec_err, &mut new_enc_err);
    if retval != 0 { return retval }
    *enc_err = *new_enc_err;
    free(new_enc_err as *mut libc::c_void);
