...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/krb/init_creds_ctx.h:30"]
pub mod init_creds_ctx_h {
    ...
    use super::int_proto_h::{get_as_key_fn, krb5int_fast_request_state,
                             k5_response_items};
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-json.h:30"]
pub mod k5_json_h {
    /*
 * Object
 */
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/krb/int-proto.h:29"]
pub mod int_proto_h {
    #[c2rust::src_loc = "32:1"]
    ...
    use super::krb5_h::{krb5_error_code, krb5_context, krb5_principal,
                        ...
                        krb5_keyblock, krb5_init_creds_context, krb5_creds,
                        krb5_principal_data, krb5_deltat,
                        krb5_get_init_creds_opt, krb5_kdc_rep, krb5_flags,
                        krb5_address, krb5_preauthtype};
 ...
 */
        ...
        pub fn k5_init_creds_get(context: krb5_context,
                                 ctx: krb5_init_creds_context,
                                 use_master: *mut libc::c_int)
         -> krb5_error_code;
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-trace.h:28"]
pub mod k5_trace_h {
    use super::k5_int_h::_krb5_context;
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_ui_4, krb5_boolean,
                       ...
                       _krb5_error, krb5_error, krb5_ccache, krb5_kt_cursor,
                       krb5_keytab_entry_st, krb5_keytab_entry, krb5_keytab,
                       krb5_prompter_fct, krb5_prompt, _krb5_prompt,
                       krb5_init_creds_context, krb5_get_init_creds_opt,
                       _krb5_get_init_creds_opt, _profile_t, _krb5_ccache,
                       krb5_c_valid_enctype, krb5_cc_store_cred,
                       krb5_kt_close, krb5_kt_get_entry,
                       krb5_kt_start_seq_get, krb5_kt_next_entry,
                       krb5_kt_end_seq_get, krb5_unparse_name,
                       krb5_principal_compare, krb5_copy_keyblock,
                       krb5_kt_default, krb5_free_keytab_entry_contents,
                       krb5_kt_free_entry, krb5_free_principal,
                       krb5_free_keyblock_contents, krb5_free_unparsed_name,
                       krb5_get_init_creds_opt_free, krb5_prompter_posix,
                       krb5_init_creds_free, krb5_init_creds_get_creds,
                       krb5_init_creds_init, krb5_set_error_message,
...
pub use self::init_creds_ctx_h::{_krb5_init_creds_context,
                                 krb5_preauth_req_context, C2RustUnnamed,
                                 AUTH_OFFSET, UNAUTH_OFFSET, NO_OFFSET,
                                 krb5_responder_context_st, gak_password,
...
pub use self::int_proto_h::{k5_response_items, get_as_key_fn,
                            ...
                            k5_init_creds_get, k5_save_ctx_error,
                            k5_restore_ctx_error, k5_get_init_creds,
                            k5_populate_gic_opt};
 ...
 */
#[c2rust::src_loc = "32:1"]
unsafe extern "C" fn get_as_key_keytab(mut context: krb5_context,
 ...
 -> krb5_error_code {
    let mut keytab: krb5_keytab = gak_data as krb5_keytab;
    ...
    ret =
        krb5_kt_get_entry(context, keytab, client as krb5_const_principal,
                          0 as libc::c_int as krb5_kvno, etype, &mut kt_ent);
    if ret != 0 { return ret }
    ret = krb5_copy_keyblock(context, &mut kt_ent.key, &mut kt_key);
    /* again, krb5's memory management is lame... */
    *as_key = *kt_key;
    free(kt_key as *mut libc::c_void);
    krb5_kt_free_entry(context, &mut kt_ent);
    return ret;
}
/* Return the list of etypes available for client in keytab. */
#[c2rust::src_loc = "86:1"]
unsafe extern "C" fn lookup_etypes_for_keytab(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    *etypes_out = 0 as *mut krb5_enctype;
    ...
    loop  {
        ...
        if !(ret == 0) { current_block = 6669252993407410313; break ; }
        ...
        if vno < max_kvno || match_0 == 0 || krb5_c_valid_enctype(etype) == 0
           {
            continue ;
        }
        ...
        if vno > max_kvno {
            ...
            etypes = 0 as *mut krb5_enctype;
            count = 0 as libc::c_int as size_t
        }
        /* Leave room for the terminator and possibly a second entry. */
        p =
            realloc(etypes as *mut libc::c_void,
                    count.wrapping_add(3 as libc::c_int as
        ...
        if p.is_null() {
            ...
            current_block = 11250344101140755159;
            break ;
        } else {
            etypes = p;
            let fresh0 = count;
            count = count.wrapping_add(1);
            *etypes.offset(fresh0 as isize) = etype;
            *etypes.offset(count as isize) = 0 as libc::c_int
        }
    }
    match current_block {
        6669252993407410313 => {
...
unsafe extern "C" fn sort_enctypes(mut req_list: *mut krb5_enctype,
                                   mut req_len: libc::c_int,
                                   mut keytab_list: *mut krb5_enctype)
 -> krb5_error_code {
    let mut save_list: *mut krb5_enctype = 0 as *mut krb5_enctype;
    let mut save_pos: libc::c_int = 0;
    let mut req_pos: libc::c_int = 0;
    ...
    save_list =
        malloc((req_len as
                    libc::c_ulong).wrapping_mul(::std::mem::size_of::<krb5_enctype>()
                                                    as libc::c_ulong)) as
            *mut krb5_enctype;
    if save_list.is_null() { return 12 as libc::c_int }
    /* Sort req_list entries into the front of req_list or into save_list. */
    save_pos = 0 as libc::c_int;
    req_pos = save_pos;
    i = 0 as libc::c_int;
    while i < req_len {
        if k5_etypes_contains(keytab_list, *req_list.offset(i as isize)) != 0
           {
            let fresh1 = req_pos;
            req_pos = req_pos + 1;
            *req_list.offset(fresh1 as isize) = *req_list.offset(i as isize)
        } else {
            let fresh2 = save_pos;
            save_pos = save_pos + 1;
            *save_list.offset(fresh2 as isize) = *req_list.offset(i as isize)
        }
        i += 1
    }
    ...
    while i < save_pos {
        let fresh3 = req_pos;
        req_pos = req_pos + 1;
        *req_list.offset(fresh3 as isize) = *save_list.offset(i as isize);
        i += 1
    }
    if req_pos == req_len {
    } else {
        __assert_fail(b"req_pos == req_len\x00" as *const u8 as
                          *const libc::c_char,
                      b"gic_keytab.c\x00" as *const u8 as *const libc::c_char,
                      172 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 67],
                                                &[libc::c_char; 67]>(b"krb5_error_code sort_enctypes(krb5_enctype *, int, krb5_enctype *)\x00")).as_ptr());
    }
    free(save_list as *mut libc::c_void);
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "178:1"]
pub unsafe extern "C" fn krb5_init_creds_set_keytab(mut context: krb5_context,
                                                    mut ctx:
                                                        krb5_init_creds_context,
                                                    mut keytab: krb5_keytab)
 -> krb5_error_code {
    let mut etype_list: *mut krb5_enctype = 0 as *mut krb5_enctype;
    let mut ret: krb5_error_code = 0;
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    (*ctx).gak_fct =
        Some(get_as_key_keytab as
                 unsafe extern "C" fn(_: krb5_context, _: krb5_principal,
                                      ...
                                      _: *mut k5_response_items)
                     -> krb5_error_code);
    (*ctx).gak_data = keytab as *mut libc::c_void;
    ret =
        lookup_etypes_for_keytab(context, keytab, (*(*ctx).request).client,
                                 &mut etype_list);
    if ret != 0 {
        if (*context).trace_callback.is_some() {
            krb5int_trace(context,
                          b"Couldn\'t lookup etypes in keytab: {kerr}\x00" as
    ...
    if (*context).trace_callback.is_some() {
        krb5int_trace(context,
                      b"Looked up etypes in keytab: {etypes}\x00" as *const u8
                          as *const libc::c_char, etype_list);
    }
    /* Error out if we have no keys for the client principal. */
    if etype_list.is_null() {
        ret =
            krb5_unparse_name(context,
                              (*(*ctx).request).client as
                                  krb5_const_principal, &mut name);
        if ret == 0 as libc::c_int {
            krb5_set_error_message(context,
                                   ...
                                   dgettext(b"mit-krb5\x00" as *const u8 as
                                                *const libc::c_char,
                                            b"Keytab contains no suitable keys for %s\x00"
                                                as *const u8 as
    ...
    ret =
        sort_enctypes((*(*ctx).request).ktype, (*(*ctx).request).nktypes,
                      etype_list);
    free(etype_list as *mut libc::c_void);
    return ret;
}
#[c2rust::src_loc = "216:1"]
unsafe extern "C" fn get_init_creds_keytab(mut context: krb5_context,
...
pub unsafe extern "C" fn krb5_get_init_creds_keytab(mut context: krb5_context,
                                                    mut creds:
                                                        *mut krb5_creds,
                                                    mut client:
                                                        krb5_principal,
 ...
 -> krb5_error_code {
    ...
    if arg_keytab.is_null() {
        ret = krb5_kt_default(context, &mut keytab);
        if ret != 0 { return ret }
    } else { keytab = arg_keytab }
    use_master = 0 as libc::c_int;
    /* first try: get the requested tkt from any kdc */
    ret =
        get_init_creds_keytab(context, creds, client, keytab, start_time,
                              in_tkt_service, options, &mut use_master);
    /* check for success */
    if !(ret == 0 as libc::c_int) {
       ...
       the master kdc */
            if use_master == 0 {
                ...
                ret =
                    get_init_creds_keytab(context, creds, client, keytab,
    ...
    if arg_keytab.is_null() { krb5_kt_close(context, keytab); }
    k5_clear_error(&mut errsave);
    return ret;
}
#[no_mangle]
#[c2rust::src_loc = "322:1"]
pub unsafe extern "C" fn krb5_get_in_tkt_with_keytab(mut context:
                                                         krb5_context,
 ...
 -> krb5_error_code {
    ...
    if arg_keytab.is_null() {
        retval = krb5_kt_default(context, &mut keytab);
        if retval != 0 {
            current_block = 663287279186661040;
        } else { current_block = 1917311967535052937; }
    } else { keytab = arg_keytab; current_block = 1917311967535052937; }
    match current_block {
        1917311967535052937 => {
            retval =
                krb5_unparse_name(context,
