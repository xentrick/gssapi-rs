...
pub use self::krb5_h::{krb5_int32, krb5_flags, _krb5_verify_init_creds_opt,
                       krb5_verify_init_creds_opt};
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
#[no_mangle]
#[c2rust::src_loc = "4:1"]
pub unsafe extern "C" fn krb5_verify_init_creds_opt_init(mut opt:
                                                             *mut krb5_verify_init_creds_opt) {
    (*opt).flags = 0 as libc::c_int;
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "10:1"]
pub unsafe extern "C" fn krb5_verify_init_creds_opt_set_ap_req_nofail(mut opt:
                                                                          *mut krb5_verify_init_creds_opt,
                                                                      mut ap_req_nofail:
                                                                          libc::c_int) {
