...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_ui_4, krb5_boolean,
                       ...
                       _krb5_keyblock, krb5_keyblock, C2RustUnnamed,
...
#[no_mangle]
#[c2rust::src_loc = "49:1"]
pub unsafe extern "C" fn krb5_generate_seq_number(mut context: krb5_context,
                                                  mut key:
                                                      *const krb5_keyblock,
                                                  mut seqno: *mut krb5_ui_4)
 -> krb5_error_code {
    ...
    seed.data = seqno as *mut libc::c_char;
    retval = krb5_c_random_make_octets(context, &mut seed);
    if retval != 0 { return retval }
    /*
     ...
     * "negative" numbers.
     */
    *seqno &= 0x3fffffff as libc::c_int as libc::c_uint;
    if *seqno == 0 as libc::c_int as libc::c_uint {
        *seqno = 1 as libc::c_int as krb5_ui_4
    }
