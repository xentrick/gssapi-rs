...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_authdatatype,
                       krb5_error_code, krb5_magic, _krb5_data, krb5_data,
                       _krb5_authdata, krb5_authdata};
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn k5_size_authdata(mut authdata: *mut krb5_authdata,
                 ...
                 libc::c_ulong).wrapping_add((::std::mem::size_of::<krb5_int32>()
                                                  ...
                                                  libc::c_ulong).wrapping_add(::std::mem::size_of::<krb5_int32>()
                                                                                  ...
                                                                                  libc::c_ulong).wrapping_add(::std::mem::size_of::<krb5_int32>()
                                                                                                                  ...
                                                                                                                  libc::c_ulong).wrapping_add(::std::mem::size_of::<krb5_int32>()
                                                                                                                                                  as
                                                                                                                                                  libc::c_ulong).wrapping_add((*authdata).length
                                                                                                                                                                                  as
                                                                                                                                                                                  size_t))
                as size_t as size_t;
...
#[no_mangle]
#[c2rust::src_loc = "55:1"]
pub unsafe extern "C" fn k5_externalize_authdata(mut authdata:
                                                     *mut krb5_authdata,
                                                 mut buffer:
                                                     *mut *mut krb5_octet,
 ...
 -> krb5_error_code {
    ...
    if !authdata.is_null() {
        ...
        if k5_size_authdata(authdata, &mut required) == 0 &&
               required <= remain {
            /* Our identifier */
            krb5_ser_pack_int32(-(1760647414 as libc::c_long) as krb5_int32,
                                &mut bp, &mut remain);
            /* Our ad_type */
            krb5_ser_pack_int32((*authdata).ad_type, &mut bp, &mut remain);
            /* Our length */
            krb5_ser_pack_int32((*authdata).length as krb5_int32, &mut bp,
                                &mut remain);
            /* Our contents */
            krb5_ser_pack_bytes((*authdata).contents,
                                (*authdata).length as size_t, &mut bp,
                                &mut remain);
            /* Finally, our trailer */
            krb5_ser_pack_int32(-(1760647414 as libc::c_long) as krb5_int32,
                                &mut bp, &mut remain);
...
#[no_mangle]
#[c2rust::src_loc = "97:1"]
pub unsafe extern "C" fn k5_internalize_authdata(mut argp:
 ...
 -> krb5_error_code {
    let mut kret: krb5_error_code = 0;
    let mut authdata: *mut krb5_authdata = 0 as *mut krb5_authdata;
    ...
    if ibuf as libc::c_long == -(1760647414 as libc::c_long) {
        kret = 12 as libc::c_int;
        /* Get a authdata */
        if remain >=
               (2 as libc::c_int as
            ...
            (*authdata).ad_type = ibuf;
            /* Get the length */
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*authdata).length = ibuf as libc::c_uint;
            /* Get the string */
            (*authdata).contents = malloc(ibuf as size_t) as *mut krb5_octet;
            if !(*authdata).contents.is_null() &&
                   {
                       kret =
                           krb5_ser_unpack_bytes((*authdata).contents,
            ...
            if kret != 0 {
                if !(*authdata).contents.is_null() {
                    free((*authdata).contents as *mut libc::c_void);
                }
