...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_enctype, krb5_error_code,
                       krb5_magic, _krb5_data, krb5_data, _krb5_keyblock,
                       krb5_keyblock};
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn k5_size_keyblock(mut keyblock: *mut krb5_keyblock,
            ...
            (*sizep as
                 libc::c_ulong).wrapping_add((4 as libc::c_int as
                                                  libc::c_ulong).wrapping_mul(::std::mem::size_of::<krb5_int32>()
                                                                                  as
                                                                                  libc::c_ulong).wrapping_add((*keyblock).length
                                                                                                                  as
                                                                                                                  libc::c_ulong))
                as size_t as size_t;
...
#[no_mangle]
#[c2rust::src_loc = "51:1"]
pub unsafe extern "C" fn k5_externalize_keyblock(mut keyblock:
                                                     *mut krb5_keyblock,
                                                 mut buffer:
                                                     *mut *mut krb5_octet,
 ...
 -> krb5_error_code {
    ...
    if !keyblock.is_null() {
        ...
        if k5_size_keyblock(keyblock, &mut required) == 0 &&
               required <= remain {
            /* Our identifier */
            krb5_ser_pack_int32(-(1760647421 as libc::c_long) as krb5_int32,
                                &mut bp, &mut remain);
            /* Our enctype */
            krb5_ser_pack_int32((*keyblock).enctype, &mut bp, &mut remain);
            /* Our length */
            krb5_ser_pack_int32((*keyblock).length as krb5_int32, &mut bp,
                                &mut remain);
            /* Our contents */
            krb5_ser_pack_bytes((*keyblock).contents,
                                (*keyblock).length as size_t, &mut bp,
                                &mut remain);
            /* Finally, our trailer */
            krb5_ser_pack_int32(-(1760647421 as libc::c_long) as krb5_int32,
                                &mut bp, &mut remain);
...
#[no_mangle]
#[c2rust::src_loc = "94:1"]
pub unsafe extern "C" fn k5_internalize_keyblock(mut argp:
 ...
 -> krb5_error_code {
    ...
    if ibuf as libc::c_long == -(1760647421 as libc::c_long) {
        kret = 12 as libc::c_int;
        /* Get a keyblock */
        if remain >=
               (3 as libc::c_int as
                   ...
                   keyblock =
                       calloc(1 as libc::c_int as libc::c_ulong,
                              ::std::mem::size_of::<krb5_keyblock>() as
                                  libc::c_ulong) as *mut krb5_keyblock;
                   !keyblock.is_null()
               } {
            /* Get the enctype */
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*keyblock).enctype = ibuf;
            /* Get the length */
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*keyblock).length = ibuf as libc::c_uint;
            /* Get the string */
            (*keyblock).contents = malloc(ibuf as size_t) as *mut krb5_octet;
            if !(*keyblock).contents.is_null() &&
                   {
                       kret =
                           krb5_ser_unpack_bytes((*keyblock).contents,
                ...
                if kret == 0 &&
                       ibuf as libc::c_long == -(1760647421 as libc::c_long) {
                    kret = 0 as libc::c_int;
                    *buffer = bp;
                    *lenremain = remain;
                    (*keyblock).magic =
                        -(1760647421 as libc::c_long) as krb5_magic;
                    *argp = keyblock
                } else { kret = 22 as libc::c_int }
            }
            if kret != 0 {
                if !(*keyblock).contents.is_null() {
                    free((*keyblock).contents as *mut libc::c_void);
                }
                free(keyblock as *mut libc::c_void);
            }
        }
    }
    return kret;
