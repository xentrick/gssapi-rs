 ...
 */
#[c2rust::src_loc = "29:1"]
unsafe extern "C" fn address_count(mut addrlist: *const *mut krb5_address)
 -> libc::c_uint {
    let mut i: libc::c_uint = 0;
    if addrlist.is_null() { return 0 as libc::c_int as libc::c_uint }
    i = 0 as libc::c_int as libc::c_uint;
    while !(*addrlist.offset(i as isize)).is_null() { i = i.wrapping_add(1) }
    return i;
}
/*
...
#[no_mangle]
#[c2rust::src_loc = "47:1"]
pub unsafe extern "C" fn krb5_address_search(mut context: krb5_context,
 ...
 -> krb5_boolean {
     ...
     */
    if address_count(addrlist) == 1 as libc::c_int as libc::c_uint &&
           (**addrlist.offset(0 as libc::c_int as isize)).addrtype ==
               0x14 as libc::c_int {
        return 1 as libc::c_int as krb5_boolean
    }
    if addrlist.is_null() { return 1 as libc::c_int as krb5_boolean }
    while !(*addrlist).is_null() {
        if krb5_address_compare(context, addr, *addrlist) != 0 {
            return 1 as libc::c_int as krb5_boolean
        }
        addrlist = addrlist.offset(1)
    }
