...
pub mod k5_int_h {
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_enc_tkt_part, krb5_data, krb5_error_code};
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       krb5_ticket, _profile_t, krb5_free_data};
...
#[no_mangle]
#[c2rust::src_loc = "41:1"]
pub unsafe extern "C" fn krb5_encrypt_tkt_part(mut context: krb5_context,
                                               mut srv_key:
                                                   *const krb5_keyblock,
                                               mut dec_ticket:
                                                   *mut krb5_ticket)
 -> krb5_error_code {
    ...
    let mut dec_tkt_part: *mut krb5_enc_tkt_part = (*dec_ticket).enc_part2;
    /*  start by encoding the to-be-encrypted part. */
    retval = encode_krb5_enc_tkt_part(dec_tkt_part, &mut scratch);
    if retval != 0 { return retval }
    /* call the encryption routine */
    retval =
        krb5_encrypt_helper(context, srv_key, 2 as libc::c_int, scratch,
                            &mut (*dec_ticket).enc_part);
