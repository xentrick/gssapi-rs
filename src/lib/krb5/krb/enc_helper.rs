...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       _krb5_enc_data, krb5_enc_data, _profile_t,
                       krb5_c_encrypt, krb5_c_encrypt_length};
...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5_encrypt_helper(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    ret =
        krb5_c_encrypt_length(context, (*key).enctype,
                              (*plain).length as size_t, &mut enclen);
    if ret != 0 { return ret }
    ...
    ret =
        krb5_c_encrypt(context, key, usage, 0 as *const krb5_data, plain,
                       cipher);
    if ret != 0 {
