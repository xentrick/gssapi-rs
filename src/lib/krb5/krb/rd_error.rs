...
pub mod k5_int_h {
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_data, krb5_error, krb5_error_code};
...
pub use self::krb5_h::{krb5_int32, krb5_ui_4, krb5_boolean, krb5_enctype,
                       ...
                       _krb5_error, krb5_error, _profile_t};
...
#[no_mangle]
#[c2rust::src_loc = "37:1"]
pub unsafe extern "C" fn krb5_rd_error(mut context: krb5_context,
                                       mut enc_errbuf: *const krb5_data,
                                       mut dec_error: *mut *mut krb5_error)
 -> krb5_error_code {
    if !(!enc_errbuf.is_null() && (*enc_errbuf).length != 0 &&
             *(*enc_errbuf).data.offset(0 as libc::c_int as isize) as
