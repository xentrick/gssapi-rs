 ...
 */
    ...
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "57:1"]
        pub fn k5_vset_error(ep: *mut errinfo, code: libc::c_long,
                             fmt: *const libc::c_char,
                             args: ::std::ffi::VaList);
        #[no_mangle]
        #[c2rust::src_loc = "65:1"]
        pub fn k5_free_error(ep: *mut errinfo, msg: *const libc::c_char);
        #[no_mangle]
        #[c2rust::src_loc = "51:1"]
        ...
        #[no_mangle]
        #[c2rust::src_loc = "64:1"]
        pub fn k5_get_error(ep: *mut errinfo, code: libc::c_long)
         -> *const libc::c_char;
        #[no_mangle]
        #[c2rust::src_loc = "66:1"]
...
pub use self::k5_err_h::{errinfo, k5_vset_error, k5_free_error, k5_set_error,
                         k5_get_error, k5_clear_error};
pub use self::k5_plugin_h::{plugin_dir_handle, plugin_file_handle};
pub use self::profile_h::profile_t;
pub use self::k5_buf_h::{k5buf, k5buftype, K5BUF_DYNAMIC_ZAP, K5BUF_DYNAMIC,
                         K5BUF_FIXED, K5BUF_ERROR, k5_buf_add, k5_buf_add_fmt,
                         k5_buf_add_len, k5_buf_init_dynamic};
...
#[no_mangle]
#[c2rust::src_loc = "37:1"]
pub unsafe extern "C" fn krb5_set_error_message(mut ctx: krb5_context,
    ...
    args_0 = args.clone();
    k5_vset_error(&mut (*ctx).err, code as libc::c_long, fmt,
                  args_0.as_va_list());
}
#[no_mangle]
#[c2rust::src_loc = "61:1"]
pub unsafe extern "C" fn krb5_vset_error_message(mut ctx: krb5_context,
                                                 mut code: krb5_error_code,
                                                 mut fmt: *const libc::c_char,
                                                 mut args:
                                                     ::std::ffi::VaList) {
...
#[no_mangle]
#[c2rust::src_loc = "80:1"]
pub unsafe extern "C" fn krb5_prepend_error_message(mut ctx: krb5_context,
                                                    mut code: krb5_error_code,
                                                    mut fmt:
                                                        *const libc::c_char,
                                                    mut args: ...) {
    ...
    ap = args.clone();
    krb5_vwrap_error_message(ctx, code, code, fmt, ap.as_va_list());
}
#[no_mangle]
#[c2rust::src_loc = "91:1"]
pub unsafe extern "C" fn krb5_vprepend_error_message(mut ctx: krb5_context,
                                                     mut code:
                                                         krb5_error_code,
                                                     mut fmt:
                                                         *const libc::c_char,
                                                     mut ap:
                                                         ::std::ffi::VaList) {
    krb5_wrap_error_message(ctx, code, code, fmt, ap.as_va_list());
}
#[no_mangle]
#[c2rust::src_loc = "98:1"]
pub unsafe extern "C" fn krb5_wrap_error_message(mut ctx: krb5_context,
                                                 mut old_code:
                                                     krb5_error_code,
                                                 mut code: krb5_error_code,
                                                 mut fmt: *const libc::c_char,
    ...
    let mut ap: ::std::ffi::VaListImpl;
    ap = args.clone();
    krb5_vwrap_error_message(ctx, old_code, code, fmt, ap.as_va_list());
}
#[no_mangle]
#[c2rust::src_loc = "109:1"]
pub unsafe extern "C" fn krb5_vwrap_error_message(mut ctx: krb5_context,
                                                  mut old_code:
                                                      krb5_error_code,
                                                  mut code: krb5_error_code,
                                                  mut fmt:
                                                  ...
                                                  mut ap:
                                                      ::std::ffi::VaList) {
    let mut prev_msg: *const libc::c_char = 0 as *const libc::c_char;
    let mut prepend: *mut libc::c_char = 0 as *mut libc::c_char;
    if ctx.is_null() ||
           vasprintf(&mut prepend, fmt, ap.as_va_list()) < 0 as libc::c_int {
        return
    }
    prev_msg = k5_get_error(&mut (*ctx).err, old_code as libc::c_long);
    k5_set_error(&mut (*ctx).err as *mut errinfo, code as libc::c_long,
                 b"%s: %s\x00" as *const u8 as *const libc::c_char, prepend,
                 prev_msg);
    k5_free_error(&mut (*ctx).err, prev_msg);
    free(prepend as *mut libc::c_void);
}
/* Set the error message state of dest_ctx to that of src_ctx. */
#[no_mangle]
#[c2rust::src_loc = "125:1"]
pub unsafe extern "C" fn krb5_copy_error_message(mut dest_ctx: krb5_context,
                                                 mut src_ctx: krb5_context) {
    if dest_ctx == src_ctx { return }
    if !(*src_ctx).err.msg.is_null() {
        k5_set_error(&mut (*dest_ctx).err as *mut errinfo,
                     (*src_ctx).err.code,
                     b"%s\x00" as *const u8 as *const libc::c_char,
                     (*src_ctx).err.msg);
    } else { k5_clear_error(&mut (*dest_ctx).err); };
}
...
unsafe extern "C" fn err_fmt_fmt(mut err_fmt: *const libc::c_char,
 ...
 -> *mut libc::c_char {
    let mut buf: k5buf =
        k5buf{buftype: K5BUF_ERROR,
              ...
              space: 0,
              len: 0,}; /* Remainder after last token */
    let mut p: *const libc::c_char = 0 as *const libc::c_char;
    let mut s: *const libc::c_char = 0 as *const libc::c_char;
    if err_fmt.is_null() { return 0 as *mut libc::c_char }
    k5_buf_init_dynamic(&mut buf);
    s = err_fmt;
    loop  {
        p = strchr(s, '%' as i32);
        if p.is_null() { break ; }
        k5_buf_add_len(&mut buf, s as *const libc::c_void,
                       p.wrapping_offset_from(s) as libc::c_long as size_t);
        s = p;
    ...
    k5_buf_add(&mut buf, s);
    return buf.data as *mut libc::c_char;
}
#[no_mangle]
#[c2rust::src_loc = "171:1"]
pub unsafe extern "C" fn krb5_get_error_message(mut ctx: krb5_context,
                                                mut code: krb5_error_code)
 -> *const libc::c_char {
    let mut std: *const libc::c_char = 0 as *const libc::c_char;
    let mut custom: *const libc::c_char = 0 as *const libc::c_char;
    if ctx.is_null() { return error_message(code as errcode_t) }
    std = k5_get_error(&mut (*ctx).err, code as libc::c_long);
    custom = err_fmt_fmt((*ctx).err_fmt, code as libc::c_long, std);
    if !custom.is_null() {
        free(std as *mut libc::c_char as *mut libc::c_void);
        return custom
    }
    return std;
}
...
pub unsafe extern "C" fn krb5_free_error_message(mut ctx: krb5_context,
                                                 mut msg:
                                                     *const libc::c_char) {
    if ctx.is_null() { return }
    k5_free_error(&mut (*ctx).err, msg);
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "204:1"]
pub unsafe extern "C" fn krb5_clear_error_message(mut ctx: krb5_context) {
    if ctx.is_null() { return }
    k5_clear_error(&mut (*ctx).err);
}
/* Save code and its extended message (if any) in out. */
#[no_mangle]
#[c2rust::src_loc = "216:1"]
pub unsafe extern "C" fn k5_save_ctx_error(mut ctx: krb5_context,
                                           mut code: krb5_error_code,
                                           mut out: *mut errinfo) {
    (*out).code = code as libc::c_long;
    (*out).msg = 0 as *mut libc::c_char;
    if !ctx.is_null() && (*ctx).err.code == code as libc::c_long {
        (*out).msg = (*ctx).err.msg;
        (*ctx).err.code = 0 as libc::c_int as libc::c_long;
        (*ctx).err.msg = 0 as *mut libc::c_char
    };
}
/* Return the code from in and restore its extended message (if any). */
#[no_mangle]
#[c2rust::src_loc = "228:1"]
pub unsafe extern "C" fn k5_restore_ctx_error(mut ctx: krb5_context,
                                              mut in_0: *mut errinfo)
 -> krb5_error_code {
    let mut code: krb5_error_code = (*in_0).code as krb5_error_code;
    if !ctx.is_null() {
        k5_clear_error(&mut (*ctx).err);
        (*ctx).err.code = (*in_0).code;
        (*ctx).err.msg = (*in_0).msg;
        (*in_0).msg = 0 as *mut libc::c_char
    } else { k5_clear_error(in_0); }
    return code;
}
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
...
pub unsafe extern "C" fn k5_change_error_message_code(mut ctx: krb5_context,
                                                      mut oldcode:
                                                          krb5_error_code,
                                                      mut newcode:
                                                          krb5_error_code) {
    if !ctx.is_null() && !(*ctx).err.msg.is_null() &&
           (*ctx).err.code == oldcode as libc::c_long {
        (*ctx).err.code = newcode as libc::c_long
    };
}
