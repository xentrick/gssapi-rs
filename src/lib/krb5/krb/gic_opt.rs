...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/krb/int-proto.h:3"]
pub mod int_proto_h {
    use super::k5_int_h::_krb5_context;
    use super::krb5_h::{krb5_context, krb5_get_init_creds_opt,
                        krb5_error_code};
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "60:1"]
        pub fn krb5_preauth_supply_preauth_data(context: krb5_context,
                                                opt:
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_addrtype,
                       krb5_enctype, krb5_preauthtype, krb5_flags,
                       ...
                       _krb5_trace_info, krb5_prompt_type, krb5_ccache,
                       krb5_responder_context, krb5_responder_fn,
                       _krb5_get_init_creds_opt, krb5_get_init_creds_opt,
                       krb5_expire_callback_func, krb5_gic_opt_pa_data,
                       _krb5_gic_opt_pa_data, _profile_t, _krb5_ccache,
                       krb5_responder_context_st, krb5_cc_get_full_name};
...
use self::int_proto_h::krb5_preauth_supply_preauth_data;
/* Match struct packing of krb5_get_init_creds_opt on macOS. */
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "19:8"]
pub struct extended_options {
    pub opt: krb5_get_init_creds_opt,
    pub num_preauth_data: libc::c_int,
    pub preauth_data: *mut krb5_gic_opt_pa_data,
    pub fast_ccache_name: *mut libc::c_char,
    pub in_ccache: krb5_ccache,
    pub out_ccache: krb5_ccache,
    pub fast_flags: krb5_flags,
    pub expire_cb: krb5_expire_callback_func,
    pub expire_data: *mut libc::c_void,
    pub responder: krb5_responder_fn,
    pub responder_data: *mut libc::c_void,
    pub pac_request: libc::c_int,
}
/* -1 unset, 0 false, 1 true */
#[no_mangle]
#[c2rust::src_loc = "37:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_init(mut opt:
                                                          *mut krb5_get_init_creds_opt) {
    (*opt).flags = 0x100 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "43:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_tkt_life(mut opt:
                                                                  *mut krb5_get_init_creds_opt,
                                                              mut tkt_life:
                                                                  krb5_deltat) {
    (*opt).flags |= 0x1 as libc::c_int;
    (*opt).tkt_life = tkt_life;
}
#[no_mangle]
#[c2rust::src_loc = "51:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_renew_life(mut opt:
                                                                    *mut krb5_get_init_creds_opt,
                                                                mut renew_life:
                                                                    krb5_deltat) {
    (*opt).flags |= 0x2 as libc::c_int;
    (*opt).renew_life = renew_life;
}
#[no_mangle]
#[c2rust::src_loc = "59:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_forwardable(mut opt:
                                                                     *mut krb5_get_init_creds_opt,
                                                                 mut forwardable:
                                                                     libc::c_int) {
    (*opt).flags |= 0x4 as libc::c_int;
    (*opt).forwardable = forwardable;
}
#[no_mangle]
#[c2rust::src_loc = "67:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_proxiable(mut opt:
                                                                   *mut krb5_get_init_creds_opt,
                                                               mut proxiable:
                                                                   libc::c_int) {
    (*opt).flags |= 0x8 as libc::c_int;
    (*opt).proxiable = proxiable;
}
#[no_mangle]
#[c2rust::src_loc = "75:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_canonicalize(mut opt:
                                                                      *mut krb5_get_init_creds_opt,
                                                                  mut canonicalize:
                                                                      libc::c_int) {
    if canonicalize != 0 {
        (*opt).flags |= 0x200 as libc::c_int
    } else { (*opt).flags &= !(0x200 as libc::c_int) };
}
#[no_mangle]
#[c2rust::src_loc = "85:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_anonymous(mut opt:
                                                                   *mut krb5_get_init_creds_opt,
                                                               mut anonymous:
                                                                   libc::c_int) {
    if anonymous != 0 {
        (*opt).flags |= 0x400 as libc::c_int
    } else { (*opt).flags &= !(0x400 as libc::c_int) };
}
#[no_mangle]
#[c2rust::src_loc = "94:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_etype_list(mut opt:
                                                                    *mut krb5_get_init_creds_opt,
                                                                mut etype_list:
                                                                    *mut krb5_enctype,
                                                                mut etype_list_length:
                                                                    libc::c_int) {
    (*opt).flags |= 0x10 as libc::c_int;
    (*opt).etype_list = etype_list;
    (*opt).etype_list_length = etype_list_length;
}
#[no_mangle]
#[c2rust::src_loc = "102:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_address_list(mut opt:
                                                                      *mut krb5_get_init_creds_opt,
                                                                  mut addresses:
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_preauth_list(mut opt:
                                                                      *mut krb5_get_init_creds_opt,
                                                                  mut preauth_list:
                                                                      *mut krb5_preauthtype,
                                                                  mut preauth_list_length:
                                                                      libc::c_int) {
    (*opt).flags |= 0x40 as libc::c_int;
    (*opt).preauth_list = preauth_list;
    (*opt).preauth_list_length = preauth_list_length;
}
#[no_mangle]
#[c2rust::src_loc = "120:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_salt(mut opt:
                                                              *mut krb5_get_init_creds_opt,
                                                          mut salt:
                                                              *mut krb5_data) {
    (*opt).flags |= 0x80 as libc::c_int;
    (*opt).salt = salt;
}
#[no_mangle]
#[c2rust::src_loc = "127:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_change_password_prompt(mut opt:
                                                                                *mut krb5_get_init_creds_opt,
                                                                            mut prompt:
                                                                                libc::c_int) {
    if prompt != 0 {
        (*opt).flags |= 0x100 as libc::c_int
    } else { (*opt).flags &= !(0x100 as libc::c_int) };
}
#[no_mangle]
#[c2rust::src_loc = "137:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_alloc(mut context:
                                                           krb5_context,
                                                       mut opt:
                                                           *mut *mut krb5_get_init_creds_opt)
 -> krb5_error_code {
    let mut opte: *mut extended_options = 0 as *mut extended_options;
    if opt.is_null() { return 22 as libc::c_int }
    *opt = 0 as *mut krb5_get_init_creds_opt;
    /* Return an extended structure cast as a krb5_get_init_creds_opt. */
    opte =
        calloc(1 as libc::c_int as libc::c_ulong,
               ::std::mem::size_of::<extended_options>() as libc::c_ulong) as
            *mut extended_options;
    if opte.is_null() { return 12 as libc::c_int }
    (*opte).opt.flags =
        (0x100 as libc::c_int as libc::c_uint | 0x80000000 as libc::c_uint) as
            krb5_flags;
    (*opte).pac_request = -(1 as libc::c_int);
    *opt = opte as *mut krb5_get_init_creds_opt;
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "157:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_free(mut context:
                                                          krb5_context,
                                                      mut opt:
                                                          *mut krb5_get_init_creds_opt) {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    let mut i: libc::c_int = 0;
    if opt.is_null() ||
           (*opt).flags as libc::c_uint & 0x80000000 as libc::c_uint == 0 {
        return
    }
    if (*opt).flags & 0x40000000 as libc::c_int == 0 {
    } else {
        __assert_fail(b"!(opt->flags & GIC_OPT_SHALLOW_COPY)\x00" as *const u8
                          as *const libc::c_char,
                      b"gic_opt.c\x00" as *const u8 as *const libc::c_char,
                      166 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 75],
                                                &[libc::c_char; 75]>(b"void krb5_get_init_creds_opt_free(krb5_context, krb5_get_init_creds_opt *)\x00")).as_ptr());
    }
    i = 0 as libc::c_int;
    while i < (*opte).num_preauth_data {
        free((*(*opte).preauth_data.offset(i as isize)).attr as
                 *mut libc::c_void);
        free((*(*opte).preauth_data.offset(i as isize)).value as
                 *mut libc::c_void);
        i += 1
    }
    free((*opte).preauth_data as *mut libc::c_void);
    free((*opte).fast_ccache_name as *mut libc::c_void);
    free(opte as *mut libc::c_void);
}
#[no_mangle]
#[c2rust::src_loc = "176:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_pa(mut context:
                                                            krb5_context,
                                                        mut opt:
                                                            *mut krb5_get_init_creds_opt,
                                                        mut attr:
 ...
 -> krb5_error_code {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    let mut t: *mut krb5_gic_opt_pa_data = 0 as *mut krb5_gic_opt_pa_data;
    let mut pa: *mut krb5_gic_opt_pa_data = 0 as *mut krb5_gic_opt_pa_data;
    if opt.is_null() ||
           (*opt).flags as libc::c_uint & 0x80000000 as libc::c_uint == 0 {
    ...
    if (*opt).flags & 0x40000000 as libc::c_int == 0 {
        ...
        __assert_fail(b"!(opt->flags & GIC_OPT_SHALLOW_COPY)\x00" as *const u8
                      ...
                      (*::std::mem::transmute::<&[u8; 116],
                                                &[libc::c_char; 116]>(b"krb5_error_code krb5_get_init_creds_opt_set_pa(krb5_context, krb5_get_init_creds_opt *, const char *, const char *)\x00")).as_ptr());
    }
    /* Allocate space for another option. */
    t =
        realloc((*opte).preauth_data as *mut libc::c_void,
                (((*opte).num_preauth_data + 1 as libc::c_int) as
    ...
    pa =
        &mut *(*opte).preauth_data.offset((*opte).num_preauth_data as isize)
            as *mut krb5_gic_opt_pa_data;
    (*pa).attr = strdup(attr);
    if (*pa).attr.is_null() { return 12 as libc::c_int }
    (*pa).value = strdup(value);
    if (*pa).value.is_null() {
        free((*pa).attr as *mut libc::c_void);
        return 12 as libc::c_int
    }
    (*opte).num_preauth_data += 1;
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_get_pa(mut context:
                                                            krb5_context,
                                                        mut opt:
                                                            *mut krb5_get_init_creds_opt,
                                                        mut num_preauth_data:
                                                            *mut libc::c_int,
                                                        mut preauth_data:
                                                            *mut *mut krb5_gic_opt_pa_data)
 -> krb5_error_code {
    let mut current_block: u64;
    let mut opte: *mut extended_options = opt as *mut extended_options;
    let mut p: *mut krb5_gic_opt_pa_data = 0 as *mut krb5_gic_opt_pa_data;
    let mut i: libc::c_int = 0;
    if num_preauth_data.is_null() || preauth_data.is_null() {
        return 22 as libc::c_int
    }
    *num_preauth_data = 0 as libc::c_int;
    *preauth_data = 0 as *mut krb5_gic_opt_pa_data;
    if opt.is_null() ||
           (*opt).flags as libc::c_uint & 0x80000000 as libc::c_uint == 0 {
        return 22 as libc::c_int
    }
    if (*opte).num_preauth_data == 0 as libc::c_int {
        return 0 as libc::c_int
    }
    p =
        calloc((*opte).num_preauth_data as libc::c_ulong,
               ::std::mem::size_of::<krb5_gic_opt_pa_data>() as libc::c_ulong)
            as *mut krb5_gic_opt_pa_data;
    if p.is_null() { return 12 as libc::c_int }
    i = 0 as libc::c_int;
    loop  {
        if !(i < (*opte).num_preauth_data) {
            current_block = 1054647088692577877;
            break ;
        }
        let ref mut fresh0 = (*p.offset(i as isize)).attr;
        *fresh0 = strdup((*(*opte).preauth_data.offset(i as isize)).attr);
        let ref mut fresh1 = (*p.offset(i as isize)).value;
        *fresh1 = strdup((*(*opte).preauth_data.offset(i as isize)).value);
        if (*p.offset(i as isize)).attr.is_null() ||
               (*p.offset(i as isize)).value.is_null() {
    ...
    match current_block {
        7135116673376365024 => {
            krb5_get_init_creds_opt_free_pa(context, (*opte).num_preauth_data,
                                            p);
            return 12 as libc::c_int
        }
        _ => {
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_free_pa(mut context:
                                                             krb5_context,
                                                         mut num_preauth_data:
                                                             libc::c_int,
                                                         mut preauth_data:
                                                             *mut krb5_gic_opt_pa_data) {
    let mut i: libc::c_int = 0;
    if num_preauth_data <= 0 as libc::c_int || preauth_data.is_null() {
        return
    }
    i = 0 as libc::c_int;
    while i < num_preauth_data {
        free((*preauth_data.offset(i as isize)).attr as *mut libc::c_void);
        free((*preauth_data.offset(i as isize)).value as *mut libc::c_void);
        i += 1
    }
    free(preauth_data as *mut libc::c_void);
}
#[no_mangle]
#[c2rust::src_loc = "278:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_fast_ccache_name(mut context:
                                                                          krb5_context,
                                                                      mut opt:
                                                                          *mut krb5_get_init_creds_opt,
                                                                      mut ccache_name:
 ...
 -> krb5_error_code {
    ...
    if (*opt).flags & 0x40000000 as libc::c_int == 0 {
        ...
        __assert_fail(b"!(opt->flags & GIC_OPT_SHALLOW_COPY)\x00" as *const u8
                      ...
                      (*::std::mem::transmute::<&[u8; 116],
                                                &[libc::c_char; 116]>(b"krb5_error_code krb5_get_init_creds_opt_set_fast_ccache_name(krb5_context, krb5_get_init_creds_opt *, const char *)\x00")).as_ptr());
    }
    free((*opte).fast_ccache_name as *mut libc::c_void);
    (*opte).fast_ccache_name = strdup(ccache_name);
    if (*opte).fast_ccache_name.is_null() { return 12 as libc::c_int }
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "295:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_fast_ccache(mut context:
                                                                     krb5_context,
                                                                 mut opt:
                                                                     *mut krb5_get_init_creds_opt,
                                                                 mut ccache:
 ...
 -> krb5_error_code {
    ...
    ret = krb5_cc_get_full_name(context, ccache, &mut name);
    if ret != 0 { return ret }
...
pub unsafe extern "C" fn k5_gic_opt_get_fast_ccache_name(mut opt:
                                                             *mut krb5_get_init_creds_opt)
 -> *const libc::c_char {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    if opt.is_null() ||
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_in_ccache(mut context:
                                                                   krb5_context,
                                                               mut opt:
                                                                   *mut krb5_get_init_creds_opt,
                                                               mut ccache:
...
pub unsafe extern "C" fn k5_gic_opt_get_in_ccache(mut opt:
                                                      *mut krb5_get_init_creds_opt)
 -> krb5_ccache {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    if opt.is_null() ||
           (*opt).flags as libc::c_uint & 0x80000000 as libc::c_uint == 0 {
        return 0 as krb5_ccache
    }
    return (*opte).in_ccache;
}
#[no_mangle]
#[c2rust::src_loc = "344:1"]
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_out_ccache(mut context:
                                                                    krb5_context,
                                                                mut opt:
                                                                    *mut krb5_get_init_creds_opt,
                                                                mut ccache:
...
pub unsafe extern "C" fn k5_gic_opt_get_out_ccache(mut opt:
                                                       *mut krb5_get_init_creds_opt)
 -> krb5_ccache {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    if opt.is_null() ||
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_fast_flags(mut context:
                                                                    krb5_context,
                                                                mut opt:
                                                                    *mut krb5_get_init_creds_opt,
                                                                mut flags:
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_get_fast_flags(mut context:
                                                                    krb5_context,
                                                                mut opt:
                                                                    *mut krb5_get_init_creds_opt,
                                                                mut out_flags:
 ...
 -> krb5_error_code {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    if out_flags.is_null() { return 22 as libc::c_int }
...
pub unsafe extern "C" fn k5_gic_opt_get_fast_flags(mut opt:
                                                       *mut krb5_get_init_creds_opt)
 -> krb5_flags {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    if opt.is_null() ||
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_expire_callback(mut context:
                                                                         krb5_context,
                                                                     mut opt:
                                                                         *mut krb5_get_init_creds_opt,
                                                                     mut cb:
...
pub unsafe extern "C" fn k5_gic_opt_get_expire_cb(mut opt:
                                                      *mut krb5_get_init_creds_opt,
                                                  mut cb_out:
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_responder(mut context:
                                                                   krb5_context,
                                                               mut opt:
                                                                   *mut krb5_get_init_creds_opt,
                                                               mut responder:
...
pub unsafe extern "C" fn k5_gic_opt_get_responder(mut opt:
                                                      *mut krb5_get_init_creds_opt,
                                                  mut responder_out:
                                                      *mut krb5_responder_fn,
                                                  mut data_out:
                                                      *mut *mut libc::c_void) {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    *responder_out = None;
...
pub unsafe extern "C" fn k5_gic_opt_shallow_copy(mut opt:
                                                     *mut krb5_get_init_creds_opt)
 -> *mut krb5_get_init_creds_opt {
    let mut opte: *mut extended_options = 0 as *mut extended_options;
    opte =
        calloc(1 as libc::c_int as libc::c_ulong,
            ...
            *mut extended_options;
    if opt.is_null() {
        (*opte).opt.flags = 0x100 as libc::c_int
    } else if (*opt).flags as libc::c_uint & 0x80000000 as libc::c_uint != 0 {
        *opte = *(opt as *mut extended_options)
    } else { (*opte).opt = *opt }
    (*opte).opt.flags |= 0x40000000 as libc::c_int;
    return opte as *mut krb5_get_init_creds_opt;
}
/* *
...
pub unsafe extern "C" fn krb5_get_init_creds_opt_set_pac_request(mut context:
                                                                     krb5_context,
                                                                 mut opt:
                                                                     *mut krb5_get_init_creds_opt,
                                                                 mut req_pac:
 ...
 -> krb5_error_code {
    ...
    (*opte).pac_request = (req_pac != 0) as libc::c_int;
    return 0 as libc::c_int;
}
...
pub unsafe extern "C" fn k5_gic_opt_pac_request(mut opt:
                                                    *mut krb5_get_init_creds_opt)
 -> libc::c_int {
    let mut opte: *mut extended_options = opt as *mut extended_options;
    if opt.is_null() ||
