...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5_524_convert_creds(mut context: krb5_context,
                                                mut v5creds: *mut krb5_creds,
                                                mut v4creds: *mut credentials)
 -> libc::c_int {
    return -(1750206200 as libc::c_long) as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "51:1"]
pub unsafe extern "C" fn krb524_convert_creds_kdc(mut context: krb5_context,
                                                  mut v5creds:
                                                      *mut krb5_creds,
                                                  mut v4creds:
                                                      *mut credentials)
 -> krb5_error_code {
    return -(1750206200 as libc::c_long) as krb5_error_code;
}
...
#[no_mangle]
#[c2rust::src_loc = "58:1"]
pub unsafe extern "C" fn krb524_init_ets() { }
