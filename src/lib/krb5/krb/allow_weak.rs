...
#[no_mangle]
#[c2rust::src_loc = "29:1"]
pub unsafe extern "C" fn krb5_allow_weak_crypto(mut context: krb5_context,
                                                mut enable: krb5_boolean)
 -> krb5_error_code {
    (*context).allow_weak_crypto =
        (enable != 0 as libc::c_int as libc::c_uint) as libc::c_int as
            krb5_boolean;
