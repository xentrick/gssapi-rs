...
pub use self::krb5_h::{krb5_int32, krb5_boolean, krb5_enctype, krb5_flags,
                       ...
                       _profile_t, _krb5_ccache, krb5_cc_resolve,
...
#[no_mangle]
#[c2rust::src_loc = "40:1"]
pub unsafe extern "C" fn krb5_cc_default(mut context: krb5_context,
                                         mut ccache: *mut krb5_ccache)
 -> krb5_error_code {
    let mut default_name: *const libc::c_char = 0 as *const libc::c_char;
    if context.is_null() ||
    ...
    if default_name.is_null() {
        ...
        return -(1765328188 as libc::c_long) as krb5_error_code
    }
...
#[no_mangle]
#[c2rust::src_loc = "68:1"]
pub unsafe extern "C" fn krb5int_cc_default(mut context: krb5_context,
                                            mut ccache: *mut krb5_ccache)
 -> krb5_error_code {
    if context.is_null() ||
           (*context).magic as libc::c_long != -(1760647388 as libc::c_long) {
