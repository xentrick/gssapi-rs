 ...
 */
    ...
    use super::krb5_h::{krb5_magic, krb5_pointer, krb5_context, krb5_ccache,
                        ...
                        krb5_int32, krb5_cc_ops};
    use super::krb5_cc_typecursor_0;
    ...
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "105:20"]
        pub static mut krb5int_mcc_mutex: k5_cc_mutex;
        #[no_mangle]
        #[c2rust::src_loc = "106:20"]
        pub static mut krb5int_krcc_mutex: k5_cc_mutex;
        #[no_mangle]
        #[c2rust::src_loc = "107:20"]
        pub static mut krb5int_cc_file_mutex: k5_cc_mutex;
        #[no_mangle]
        #[c2rust::src_loc = "117:1"]
        pub fn k5_cc_lock(context: krb5_context, ccache: krb5_ccache)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "120:1"]
        pub fn k5_cc_unlock(context: krb5_context, ccache: krb5_ccache)
         -> krb5_error_code;
        #[no_mangle]
...
#[c2rust::header_src = "/usr/include/ctype.h:194"]
pub mod ctype_h {
    #[c2rust::src_loc = "50:3"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/ccache/fcc.h:30"]
pub mod fcc_h {
    use super::krb5_h::{krb5_cc_ops, krb5_magic, krb5_context, krb5_ccache,
                        krb5_error_code, krb5_principal, krb5_creds,
                        krb5_flags, krb5_cc_cursor, krb5_timestamp};
    use super::cc_int_h::krb5_cc_ptcursor;
    extern "C" {
        /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_addrtype,
                       ...
                       krb5_cc_initialize, krb5_cc_destroy,
                       krb5_cc_get_principal, krb5_free_principal,
                       krb5_cc_copy_creds};
...
pub use self::cc_int_h::{_krb5_ccache, _krb5_cc_ops, krb5_cc_ptcursor,
                         krb5_cc_ptcursor_s, krb5_cc_typecursor, k5_cc_mutex,
                         _k5_cc_mutex, krb5int_mcc_mutex, krb5int_krcc_mutex,
                         krb5int_cc_file_mutex, k5_cc_lock, k5_cc_unlock,
                         krb5_cc_dfl_ops};
...
extern "C" {
    ...
    pub static krb5_mcc_ops: krb5_cc_ops;
    #[no_mangle]
    #[c2rust::src_loc = "72:26"]
    pub static krb5_krcc_ops: krb5_cc_ops;
    /* USE_KEYRING_CCACHE */
    #[no_mangle]
    #[c2rust::src_loc = "79:26"]
    pub static krb5_dcc_ops: krb5_cc_ops;
    #[no_mangle]
    #[c2rust::src_loc = "84:26"]
    pub static krb5_kcm_ops: krb5_cc_ops;
}
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
...
#[repr(C)]
#[c2rust::src_loc = "33:8"]
pub struct krb5_cc_typelist {
    pub ops: *const krb5_cc_ops,
    pub next: *mut krb5_cc_typelist,
}
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "38:8"]
pub struct krb5_cc_typecursor_0 {
    pub tptr: *mut krb5_cc_typelist,
}
#[c2rust::src_loc = "61:32"]
static mut cc_mcc_entry: krb5_cc_typelist =
    unsafe {
        {
            let mut init =
                krb5_cc_typelist{ops: &krb5_mcc_ops as *const krb5_cc_ops,
                                 next:
                                     0 as *const krb5_cc_typelist as
                                         *mut krb5_cc_typelist,};
            init
        }
    };
#[c2rust::src_loc = "66:32"]
static mut cc_fcc_entry: krb5_cc_typelist =
    unsafe {
        {
            let mut init =
                krb5_cc_typelist{ops: &krb5_cc_file_ops as *const krb5_cc_ops,
                                 next:
                                     &cc_mcc_entry as *const krb5_cc_typelist
                                         as *mut krb5_cc_typelist,};
            init
        }
    };
#[c2rust::src_loc = "73:32"]
static mut cc_krcc_entry: krb5_cc_typelist =
    unsafe {
        {
            let mut init =
                krb5_cc_typelist{ops: &krb5_krcc_ops as *const krb5_cc_ops,
                                 next:
                                     &cc_fcc_entry as *const krb5_cc_typelist
                                         as *mut krb5_cc_typelist,};
            init
        }
    };
#[c2rust::src_loc = "80:32"]
static mut cc_dcc_entry: krb5_cc_typelist =
    unsafe {
        {
            let mut init =
                krb5_cc_typelist{ops: &krb5_dcc_ops as *const krb5_cc_ops,
                                 next:
                                     &cc_krcc_entry as *const krb5_cc_typelist
                                         as *mut krb5_cc_typelist,};
            init
        }
    };
#[c2rust::src_loc = "85:32"]
static mut cc_kcm_entry: krb5_cc_typelist =
    unsafe {
        {
            let mut init =
                krb5_cc_typelist{ops: &krb5_kcm_ops as *const krb5_cc_ops,
                                 next:
                                     &cc_dcc_entry as *const krb5_cc_typelist
                                         as *mut krb5_cc_typelist,};
            init
        }
    };
#[c2rust::src_loc = "92:33"]
static mut cc_typehead: *mut krb5_cc_typelist =
    unsafe {
        &cc_kcm_entry as *const krb5_cc_typelist as *mut krb5_cc_typelist
    };
#[c2rust::src_loc = "93:19"]
static mut cc_typelist_lock: k5_mutex_t =
...
static mut cccol_lock: k5_cc_mutex =
    {
        let mut init =
            _k5_cc_mutex{lock:
                             pthread_mutex_t{__data:
...
pub unsafe extern "C" fn krb5int_cc_initialize() -> libc::c_int {
    let mut err: libc::c_int = 0;
    err = k5_cc_mutex_finish_init(&mut cccol_lock);
    if err != 0 { return err }
    err = k5_cc_mutex_finish_init(&mut krb5int_mcc_mutex);
    if err != 0 { return err }
    err = k5_mutex_finish_init(&mut cc_typelist_lock);
    if err != 0 { return err }
    err = k5_cc_mutex_finish_init(&mut krb5int_cc_file_mutex);
    if err != 0 { return err }
    err = k5_cc_mutex_finish_init(&mut krb5int_krcc_mutex);
    if err != 0 { return err }
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "128:1"]
pub unsafe extern "C" fn krb5int_cc_finalize() {
    let mut t: *mut krb5_cc_typelist = 0 as *mut krb5_cc_typelist;
    let mut t_next: *mut krb5_cc_typelist = 0 as *mut krb5_cc_typelist;
    k5_cccol_force_unlock();
    k5_os_mutex_destroy(&mut cccol_lock.lock);
    k5_os_mutex_destroy(&mut cc_typelist_lock);
    k5_os_mutex_destroy(&mut krb5int_cc_file_mutex.lock);
    k5_os_mutex_destroy(&mut krb5int_mcc_mutex.lock);
    k5_os_mutex_destroy(&mut krb5int_krcc_mutex.lock);
    t = cc_typehead;
    while t != &mut cc_kcm_entry as *mut krb5_cc_typelist {
        t_next = (*t).next;
...
pub unsafe extern "C" fn krb5_cc_register(mut context: krb5_context,
                                          mut ops: *const krb5_cc_ops,
                                          mut override_0: krb5_boolean)
 -> krb5_error_code {
    let mut t: *mut krb5_cc_typelist = 0 as *mut krb5_cc_typelist;
    k5_mutex_lock(&mut cc_typelist_lock);
    t = cc_typehead;
    ...
    if !t.is_null() {
        if override_0 != 0 {
            (*t).ops = ops;
            k5_mutex_unlock(&mut cc_typelist_lock);
            return 0 as libc::c_int
        } else {
            k5_mutex_unlock(&mut cc_typelist_lock);
            return -(1765328193 as libc::c_long) as krb5_error_code
        }
    }
    t =
        malloc(::std::mem::size_of::<krb5_cc_typelist>() as libc::c_ulong) as
            *mut krb5_cc_typelist;
    if t.is_null() {
        k5_mutex_unlock(&mut cc_typelist_lock);
...
#[no_mangle]
#[c2rust::src_loc = "195:1"]
pub unsafe extern "C" fn krb5_cc_resolve(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    let mut ops: *const krb5_cc_ops = 0 as *const krb5_cc_ops;
    if name.is_null() {
        return -(1765328245 as libc::c_long) as krb5_error_code
    }
    pfx = 0 as *mut libc::c_char;
    cp = strchr(name, ':' as i32);
    if cp.is_null() {
        if !krb5_cc_dfl_ops.is_null() {
            return Some((*krb5_cc_dfl_ops).resolve.expect("non-null function pointer")).expect("non-null function pointer")(context,
                                                                                                                            cache,
                                                                                                                            name)
        } else { return -(1765328245 as libc::c_long) as krb5_error_code }
    }
    ...
    *cache = 0 as krb5_ccache;
    err = krb5int_cc_getops(context, pfx, &mut ops);
    if !pfx.is_null() { free(pfx as *mut libc::c_void); }
    if err != 0 { return err }
    return (*ops).resolve.expect("non-null function pointer")(context, cache,
                                                              resid);
}
#[no_mangle]
#[c2rust::src_loc = "242:1"]
pub unsafe extern "C" fn krb5_cc_dup(mut context: krb5_context,
                                     mut in_0: krb5_ccache,
                                     mut out: *mut krb5_ccache)
 -> krb5_error_code {
    return (*(*in_0).ops).resolve.expect("non-null function pointer")(context,
                                                                      out,
...
unsafe extern "C" fn krb5int_cc_getops(mut context: krb5_context,
                                       mut pfx: *const libc::c_char,
                                       mut ops: *mut *const krb5_cc_ops)
 -> krb5_error_code {
    let mut tlist: *mut krb5_cc_typelist = 0 as *mut krb5_cc_typelist;
    k5_mutex_lock(&mut cc_typelist_lock);
    tlist = cc_typehead;
    while !tlist.is_null() {
    ...
    k5_mutex_unlock(&mut cc_typelist_lock);
    if !krb5_cc_dfl_ops.is_null() &&
           strcmp(pfx, (*krb5_cc_dfl_ops).prefix) == 0 {
        *ops = krb5_cc_dfl_ops;
        return 0 as libc::c_int
    }
    return -(1765328244 as libc::c_long) as krb5_error_code;
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "283:1"]
pub unsafe extern "C" fn krb5_cc_new_unique(mut context: krb5_context,
    ...
    *id = 0 as krb5_ccache;
    if (*context).trace_callback.is_some() {
        krb5int_trace(context,
                      b"Resolving unique ccache of type {str}\x00" as
                          *const u8 as *const libc::c_char, type_0);
    }
    err = krb5int_cc_getops(context, type_0, &mut ops);
    if err != 0 { return err }
    return (*ops).gen_new.expect("non-null function pointer")(context, id);
}
/*
 * cc_typecursor
 *
...
pub unsafe extern "C" fn krb5int_cc_typecursor_new(mut context: krb5_context,
                                                   mut t:
                                                       *mut krb5_cc_typecursor)
 -> krb5_error_code {
    let mut n: krb5_cc_typecursor = 0 as krb5_cc_typecursor;
    *t = 0 as krb5_cc_typecursor;
    n =
        malloc(::std::mem::size_of::<krb5_cc_typecursor_0>() as libc::c_ulong)
            as krb5_cc_typecursor;
...
pub unsafe extern "C" fn krb5int_cc_typecursor_next(mut context: krb5_context,
                                                    mut t: krb5_cc_typecursor,
                                                    mut ops:
                                                        *mut *const krb5_cc_ops)
 -> krb5_error_code {
    *ops = 0 as *const krb5_cc_ops;
    if (*t).tptr.is_null() { return 0 as libc::c_int }
    k5_mutex_lock(&mut cc_typelist_lock);
    *ops = (*(*t).tptr).ops;
    (*t).tptr = (*(*t).tptr).next;
    k5_mutex_unlock(&mut cc_typelist_lock);
...
pub unsafe extern "C" fn krb5int_cc_typecursor_free(mut context: krb5_context,
                                                    mut t:
                                                        *mut krb5_cc_typecursor)
 -> krb5_error_code {
    free(*t as *mut libc::c_void);
...
#[no_mangle]
#[c2rust::src_loc = "351:1"]
pub unsafe extern "C" fn krb5_cc_move(mut context: krb5_context,
                                      mut src: krb5_ccache,
                                      mut dst: krb5_ccache)
 -> krb5_error_code {
    ...
    if (*context).trace_callback.is_some() {
        krb5int_trace(context,
                      b"Moving contents of ccache {src} to {dst}\x00" as
                          *const u8 as *const libc::c_char, src, dst);
    }
    ret = k5_cccol_lock(context);
    if ret != 0 { return ret }
    ret = k5_cc_lock(context, src);
    if ret != 0 { k5_cccol_unlock(context); return ret }
    ret = krb5_cc_get_principal(context, src, &mut princ);
    if ret == 0 { ret = krb5_cc_initialize(context, dst, princ) }
    if ret != 0 {
    ...
    k5_cc_unlock(context, src);
    if ret == 0 { ret = krb5_cc_destroy(context, src) }
    k5_cccol_unlock(context);
    if !princ.is_null() {
...
pub unsafe extern "C" fn krb5_cc_support_switch(mut context: krb5_context,
                                                mut type_0:
                                                    *const libc::c_char)
 -> krb5_boolean {
    let mut ops: *const krb5_cc_ops = 0 as *const krb5_cc_ops;
    ...
    return if err != 0 {
               0 as libc::c_int
           } else { (*ops).switch_to.is_some() as libc::c_int } as
               krb5_boolean;
}
#[no_mangle]
#[c2rust::src_loc = "408:1"]
pub unsafe extern "C" fn k5_cc_mutex_init(mut m: *mut k5_cc_mutex)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0 as libc::c_int;
    ret = k5_mutex_init(&mut (*m).lock);
    if ret != 0 { return ret }
    (*m).owner = 0 as krb5_context;
    (*m).refcount = 0 as libc::c_int;
    return ret;
}
#[no_mangle]
#[c2rust::src_loc = "421:1"]
pub unsafe extern "C" fn k5_cc_mutex_finish_init(mut m: *mut k5_cc_mutex)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0 as libc::c_int;
    ret = k5_mutex_finish_init(&mut (*m).lock);
    if ret != 0 { return ret }
    (*m).owner = 0 as krb5_context;
    (*m).refcount = 0 as libc::c_int;
    return ret;
...
pub unsafe extern "C" fn k5_cc_mutex_assert_locked(mut context: krb5_context,
                                                   mut m: *mut k5_cc_mutex) {
}
#[no_mangle]
#[c2rust::src_loc = "444:1"]
pub unsafe extern "C" fn k5_cc_mutex_assert_unlocked(mut context:
                                                         krb5_context,
                                                     mut m:
                                                         *mut k5_cc_mutex) {
}
...
pub unsafe extern "C" fn k5_cc_mutex_lock(mut context: krb5_context,
                                          mut m: *mut k5_cc_mutex) {
    /* not locked or already locked by another context */
    if (*m).owner != context {
        /* acquire lock, blocking until available */
        k5_mutex_lock(&mut (*m).lock);
        (*m).owner = context;
        (*m).refcount = 1 as libc::c_int
    } else {
...
pub unsafe extern "C" fn k5_cc_mutex_unlock(mut context: krb5_context,
                                            mut m: *mut k5_cc_mutex) {
    /* verify owner and sanity check refcount */
    if (*m).owner != context || (*m).refcount < 1 as libc::c_int { return }
    /* decrement & unlock when count reaches zero */
    (*m).refcount -= 1;
    if (*m).refcount == 0 as libc::c_int {
        (*m).owner = 0 as krb5_context;
        k5_mutex_unlock(&mut (*m).lock);
    };
}
/* necessary to make reentrant locks play nice with krb5int_cc_finalize */
#[no_mangle]
#[c2rust::src_loc = "486:1"]
pub unsafe extern "C" fn k5_cc_mutex_force_unlock(mut m: *mut k5_cc_mutex) {
    (*m).refcount = 0 as libc::c_int;
    (*m).owner = 0 as krb5_context;
    if (*m).refcount > 0 as libc::c_int { k5_mutex_unlock(&mut (*m).lock); };
}
/*
...
pub unsafe extern "C" fn k5_cccol_lock(mut context: krb5_context)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0 as libc::c_int;
    k5_cc_mutex_lock(context, &mut cccol_lock);
    k5_mutex_lock(&mut cc_typelist_lock);
    k5_cc_mutex_lock(context, &mut krb5int_cc_file_mutex);
...
pub unsafe extern "C" fn k5_cccol_unlock(mut context: krb5_context)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0 as libc::c_int;
    /* sanity check */
    k5_cc_mutex_assert_locked(context, &mut cccol_lock);
    k5_mutex_lock(&mut cc_typelist_lock);
    /* unlock each type in the opposite order */
    k5_cc_mutex_assert_locked(context, &mut krb5int_krcc_mutex);
    k5_cc_mutex_unlock(context, &mut krb5int_krcc_mutex);
    k5_cc_mutex_assert_locked(context, &mut krb5int_mcc_mutex);
    k5_cc_mutex_unlock(context, &mut krb5int_mcc_mutex);
    k5_cc_mutex_assert_locked(context, &mut krb5int_cc_file_mutex);
    k5_cc_mutex_unlock(context, &mut krb5int_cc_file_mutex);
    k5_mutex_unlock(&mut cc_typelist_lock);
    k5_cc_mutex_unlock(context, &mut cccol_lock);
    return ret;
}
/* necessary to make reentrant locks play nice with krb5int_cc_finalize */
#[no_mangle]
#[c2rust::src_loc = "557:1"]
pub unsafe extern "C" fn k5_cccol_force_unlock() {
    /* sanity check */
    if cccol_lock.refcount == 0 as libc::c_int { return }
    k5_mutex_lock(&mut cc_typelist_lock);
    /* unlock each type in the opposite order */
    k5_cc_mutex_force_unlock(&mut krb5int_krcc_mutex);
    k5_cc_mutex_force_unlock(&mut krb5int_mcc_mutex);
    k5_cc_mutex_force_unlock(&mut krb5int_cc_file_mutex);
    k5_mutex_unlock(&mut cc_typelist_lock);
    k5_cc_mutex_force_unlock(&mut cccol_lock);
}
