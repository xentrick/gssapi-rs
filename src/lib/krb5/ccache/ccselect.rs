...
pub mod k5_int_h {
    ...
    use super::ccselect_module_handle;
 ...
 */
    ...
    use super::krb5_h::{krb5_context, krb5_error_code, krb5_principal,
                        krb5_ccache};
    extern "C" {
 ...
 */
    ...
    extern "C" {
        ...
        pub fn ccselect_hostname_initvt(context: krb5_context,
                                        maj_ver: libc::c_int,
                                        min_ver: libc::c_int,
        ...
        pub fn ccselect_realm_initvt(context: krb5_context,
                                     maj_ver: libc::c_int,
                                     min_ver: libc::c_int,
                                     vtable: krb5_plugin_vtable)
         -> krb5_error_code;
        ...
        pub fn ccselect_k5identity_initvt(context: krb5_context,
                                          maj_ver: libc::c_int,
                                          min_ver: libc::c_int,
                                          vtable: krb5_plugin_vtable)
         -> krb5_error_code;
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_addrtype,
                       ...
                       krb5_ccache, krb5_creds, _krb5_creds, krb5_authdata,
                       _krb5_authdata, krb5_ticket_times, _krb5_ticket_times,
                       krb5_keyblock, _krb5_keyblock, krb5_cc_cursor,
                       krb5_prompt_type, _profile_t, krb5_is_referral_realm,
                       krb5_set_principal_realm, krb5_copy_principal,
                       krb5_free_host_realm, krb5_free_principal,
...
pub use self::cc_int_h::{_krb5_ccache, _krb5_cc_ops, krb5_cc_ptcursor,
                         krb5_cc_ptcursor_s, ccselect_hostname_initvt,
                         ccselect_realm_initvt, ccselect_k5identity_initvt};
...
#[repr(C)]
#[c2rust::src_loc = "32:8"]
pub struct ccselect_module_handle {
    pub vt: krb5_ccselect_vtable_st,
    pub data: krb5_ccselect_moddata,
    pub priority: libc::c_int,
}
#[c2rust::src_loc = "38:1"]
unsafe extern "C" fn free_handles(mut context: krb5_context,
                                  mut handles:
                                      *mut *mut ccselect_module_handle) {
    let mut h: *mut ccselect_module_handle = 0 as *mut ccselect_module_handle;
    let mut hp: *mut *mut ccselect_module_handle =
        0 as *mut *mut ccselect_module_handle;
...
#[c2rust::src_loc = "54:1"]
unsafe extern "C" fn load_modules(mut context: krb5_context)
 -> krb5_error_code {
    let mut current_block: u64;
    let mut ret: krb5_error_code = 0;
    let mut list: *mut *mut ccselect_module_handle =
        0 as *mut *mut ccselect_module_handle;
    let mut handle: *mut ccselect_module_handle =
        0 as *mut ccselect_module_handle;
    ...
    ret =
        k5_plugin_register(context, 4 as libc::c_int,
                           b"k5identity\x00" as *const u8 as
                               *const libc::c_char,
                           Some(ccselect_k5identity_initvt as
    ...
    if !(ret != 0 as libc::c_int) {
        ...
        if !(ret != 0 as libc::c_int) {
            ret =
                k5_plugin_register(context, 4 as libc::c_int,
                                   b"hostname\x00" as *const u8 as
                                       *const libc::c_char,
                                   Some(ccselect_hostname_initvt as
            ...
            if !(ret != 0 as libc::c_int) {
                ret =
                    k5_plugin_load_all(context, 4 as libc::c_int,
                                       &mut modules);
                if !(ret != 0 as libc::c_int) {
                    ...
                    list =
                        k5calloc(count.wrapping_add(1 as libc::c_int as
                                                        libc::c_ulong),
                                 ::std::mem::size_of::<*mut ccselect_module_handle>()
                    ...
                    if !list.is_null() {
                        ...
                        loop  {
                            ...
                            handle =
                                k5alloc(::std::mem::size_of::<ccselect_module_handle>()
                                            as libc::c_ulong, &mut ret) as
                                    *mut ccselect_module_handle;
                            if handle.is_null() {
                                current_block = 17860184692688695543;
                                break ;
                            }
                            ret =
                            ...
                            if ret != 0 as libc::c_int {
                                ...
                                if (*context).trace_callback.is_some() {
                                    krb5int_trace(context,
                                                  b"ccselect module failed to init vtable: {kerr}\x00"
                                                      as *const u8 as
                                                      *const libc::c_char,
                                                  ret);
                                }
                                ...
                                (*handle).data = 0 as krb5_ccselect_moddata;
                                ret =
                                ...
                                if ret != 0 as libc::c_int {
                                    ...
                                    if (*context).trace_callback.is_some() {
                                        krb5int_trace(context,
                                                      b"ccselect module {str} failed to init: {kerr}\x00"
                                                          as *const u8 as
                                                          *const libc::c_char,
                                                      (*handle).vt.name, ret);
                                    }
                                    ...
                                    *fresh2 = 0 as *mut ccselect_module_handle
                                }
                            }
                            mod_0 = mod_0.offset(1)
                        }
                        match current_block {
                            17860184692688695543 => { }
                            _ => {
                                let ref mut fresh3 =
                                    *list.offset(count as isize);
                                *fresh3 = 0 as *mut ccselect_module_handle;
                                ret = 0 as libc::c_int;
                                (*context).ccselect_handles = list;
                                list = 0 as *mut *mut ccselect_module_handle
                            }
                        }
                    }
                }
...
pub unsafe extern "C" fn krb5_cc_select(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    let mut srvcp: krb5_principal = 0 as krb5_principal;
    let mut fbrealms: *mut *mut libc::c_char = 0 as *mut *mut libc::c_char;
    *cache_out = 0 as krb5_ccache;
    *princ_out = 0 as krb5_principal;
    if (*context).ccselect_handles.is_null() {
        ret = load_modules(context);
        if ret != 0 {
            current_block = 15260119302872389717;
     ...
     * authoritative realm. */
        {
            if krb5_is_referral_realm(&mut (*server).realm) != 0 &&
                ...
                if ret != 0 {
                    ...
                    if ret != 0 {
                        ...
                        ret =
                            krb5_set_principal_realm(context, srvcp,
                                                     *fbrealms.offset(0 as
                                                                          libc::c_int
                                                                          as
                                                                          isize));
                        if ret != 0 {
            ...
            match current_block {
                ...
                /* Consult authoritative modules first, then heuristic ones. */
                {
                    ...
                    's_92:
                        loop  {
                            if !(priority >= 1 as libc::c_int) {
                                current_block = 11626999923138678822;
                                break ;
                            }
                            hp = (*context).ccselect_handles;
                            while !(*hp).is_null() {
                                h = *hp;
                                if !((*h).priority != priority) {
                                    ret =
                                        (*h).vt.choose.expect("non-null function pointer")(context,
                                                                                           (*h).data,
                                                                                           server,
                                                                                           &mut cache,
                                                                                           &mut princ);
                                    if ret == 0 as libc::c_int {
                                        if (*context).trace_callback.is_some()
                                           {
                                            krb5int_trace(context,
                                                          b"ccselect module {str} chose cache {ccache} with client principal {princ} for server principal {princ}\x00"
                                                              as *const u8 as
                                                              *const libc::c_char,
                                                          (*h).vt.name, cache,
                                                          princ, server);
                                        ...
                                        *princ_out = princ;
                                        ...
                                        if (*context).trace_callback.is_some()
                                           {
                                            krb5int_trace(context,
                                                          b"ccselect module {str} chose client principal {princ} for server principal {princ} but found no cache\x00"
                                                              as *const u8 as
                                                              *const libc::c_char,
                                                          (*h).vt.name, princ,
                                                          server);
                                        ...
                                        *princ_out = princ;
                                        ...
                                        if (*context).trace_callback.is_some()
                                           {
                                            krb5int_trace(context,
                                                          b"ccselect module {str} yielded error {kerr} for server principal {princ}\x00"
                                                              as *const u8 as
                                                              *const libc::c_char,
                                                          (*h).vt.name, ret,
                                                          server);
                    ...
                    match current_block {
                        ...
                        _ => {
                            if (*context).trace_callback.is_some() {
                                krb5int_trace(context,
                                              b"ccselect can\'t find appropriate cache for server principal {princ}\x00"
                                                  as *const u8 as
                                                  *const libc::c_char,
                                              server);
                            }
...
pub unsafe extern "C" fn k5_ccselect_free_context(mut context: krb5_context) {
    free_handles(context, (*context).ccselect_handles);
    (*context).ccselect_handles = 0 as *mut *mut ccselect_module_handle;
}
