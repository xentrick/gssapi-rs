...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       _krb5_keyblock, krb5_keyblock, krb5_keytab_entry_st,
                       krb5_keytab_entry, _profile_t, krb5_free_principal};
...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5_free_keytab_entry_contents(mut context:
                                                             krb5_context,
                                                         mut entry:
 ...
 -> krb5_error_code {
    ...
    if !(*entry).key.contents.is_null() {
        explicit_bzero((*entry).key.contents as *mut libc::c_char as
                           *mut libc::c_void, (*entry).key.length as size_t);
        free((*entry).key.contents as *mut libc::c_void);
    }
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn krb5_kt_free_entry(mut context: krb5_context,
