...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/os/os-proto.h:33"]
pub mod os_proto_h {
    ...
    extern "C" {
        ...
        pub fn k5_kt_client_default_name(context: krb5_context,
                                         name_out: *mut *mut libc::c_char)
         -> krb5_error_code;
    }
...
use self::os_proto_h::k5_kt_client_default_name;
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
...
#[no_mangle]
#[c2rust::src_loc = "37:1"]
pub unsafe extern "C" fn krb5_kt_default(mut context: krb5_context,
                                         mut id: *mut krb5_keytab)
 -> krb5_error_code {
    let mut defname: [libc::c_char; 8192] = [0; 8192];
    let mut retval: krb5_error_code = 0;
    retval =
        krb5_kt_default_name(context, defname.as_mut_ptr(),
                             ::std::mem::size_of::<[libc::c_char; 8192]>() as
                                 libc::c_ulong as libc::c_int);
    if retval != 0 { return retval }
    return krb5_kt_resolve(context, defname.as_mut_ptr(), id);
}
#[no_mangle]
#[c2rust::src_loc = "48:1"]
pub unsafe extern "C" fn krb5_kt_client_default(mut context: krb5_context,
                                                mut keytab_out:
                                                    *mut krb5_keytab)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut name: *mut libc::c_char = 0 as *mut libc::c_char;
    ret = k5_kt_client_default_name(context, &mut name);
    if ret != 0 { return ret }
