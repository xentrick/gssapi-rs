...
pub mod fcntl_h {
    ...
    use super::types_h::{__off_t, __pid_t};
}
#[c2rust::header_src =
...
#[c2rust::header_src = "/usr/include/sys/file.h:27"]
pub mod file_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "50:1"]
        pub fn flock(__fd: libc::c_int, __operation: libc::c_int)
         -> libc::c_int;
    }
}
pub use self::types_h::{__int32_t, __off_t, __pid_t};
pub use self::stdint_intn_h::int32_t;
pub use self::fcntl_h::flock;
...
use self::include_fcntl_h::fcntl;
use self::errno_h::__errno_location;
use self::assert_h::__assert_fail;
use self::file_h::flock;
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
...
#[c2rust::src_loc = "65:1"]
pub type fcntl_lock_st = flock;
/* defined(HAVE_FCNTL_H) && defined(F_SETLKW) && defined(F_RDLCK) */
/*
 ...
 */
#[c2rust::src_loc = "90:1"]
unsafe extern "C" fn ofdlock(mut fd: libc::c_int, mut cmd: libc::c_int,
                             mut lock_arg: *mut fcntl_lock_st)
 -> libc::c_int {
    let mut st: libc::c_int = 0;
    let mut ofdcmd: libc::c_int = 0;
    if cmd == 7 as libc::c_int || cmd == 6 as libc::c_int {
    } else {
        __assert_fail(b"cmd == F_SETLKW || cmd == F_SETLK\x00" as *const u8 as
                          *const libc::c_char,
                      b"lock_file.c\x00" as *const u8 as *const libc::c_char,
                      96 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 39],
                                                &[libc::c_char; 39]>(b"int ofdlock(int, int, fcntl_lock_st *)\x00")).as_ptr());
    }
    ofdcmd =
        if cmd == 7 as libc::c_int {
            38 as libc::c_int
        } else { 37 as libc::c_int };
    st = fcntl(fd, ofdcmd, lock_arg);
    if st == 0 as libc::c_int || *__errno_location() != 22 as libc::c_int {
        return st
    }
...
pub unsafe extern "C" fn krb5_lock_file(mut context: krb5_context,
                                        mut fd: libc::c_int,
                                        mut mode: libc::c_int)
 -> krb5_error_code {
    let mut lock_flag: libc::c_int =
        -(1 as libc::c_int); /* We succeeded.  Yay. */
    let mut retval: krb5_error_code = 0 as libc::c_int;
    let mut lock_cmd: libc::c_int = 7 as libc::c_int;
    let mut lock_arg: fcntl_lock_st =
        {
            let mut init =
                flock{l_type: 0 as libc::c_int as libc::c_short,
                      l_whence: 0,
                      l_start: 0,
                      l_len: 0,
                      l_pid: 0,};
    ...
    match mode & !(0x4 as libc::c_int) {
        1 => {
            lock_arg.l_type = 0 as libc::c_int as libc::c_short;
            lock_flag = 1 as libc::c_int
        }
        2 => {
            lock_arg.l_type = 1 as libc::c_int as libc::c_short;
            lock_flag = 2 as libc::c_int
        }
        8 => {
            lock_arg.l_type = 2 as libc::c_int as libc::c_short;
            lock_flag = 8 as libc::c_int
        }
        _ => { }
    }
    if lock_flag == -(1 as libc::c_int) {
        return -(1765328255 as libc::c_long) as krb5_error_code
    }
    if mode & 0x4 as libc::c_int != 0 {
        lock_cmd = 6 as libc::c_int;
        lock_flag |= 4 as libc::c_int
    }
    lock_arg.l_whence = 0 as libc::c_int as libc::c_short;
    lock_arg.l_start = 0 as libc::c_int as __off_t;
    lock_arg.l_len = 0 as libc::c_int as __off_t;
    if ofdlock(fd, lock_cmd, &mut lock_arg) == -(1 as libc::c_int) {
        if *__errno_location() == 13 as libc::c_int ||
               *__errno_location() == 11 as libc::c_int {
            /* see POSIX/IEEE 1003.1-1988,
                                                   6.5.2.4 */
            return 11 as libc::c_int
        }
        if *__errno_location() != 22 as libc::c_int {
            /* Fall back to flock if we get EINVAL */
            return *__errno_location()
        }
        retval = *__errno_location()
    } else { return 0 as libc::c_int }
    if flock(fd, lock_flag) == -(1 as libc::c_int) {
        retval = *__errno_location()
    }
    return retval;
}
