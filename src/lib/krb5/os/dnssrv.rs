...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/krb5/os/dnsglue.h:174"]
pub mod dnsglue_h {
    extern "C" {
        #[c2rust::src_loc = "146:8"]
        pub type krb5int_dns_state;
        /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
 ...
 */
        ...
        pub fn krb5int_dns_init(_: *mut *mut krb5int_dns_state,
                                _: *mut libc::c_char, _: libc::c_int,
                                _: libc::c_int) -> libc::c_int;
        #[no_mangle]
        #[c2rust::src_loc = "151:1"]
        pub fn krb5int_dns_expand(_: *mut krb5int_dns_state,
                                  _: *const libc::c_uchar,
                                  _: *mut libc::c_char, _: libc::c_int)
         -> libc::c_int;
        #[no_mangle]
        #[c2rust::src_loc = "153:1"]
        pub fn krb5int_dns_fini(_: *mut krb5int_dns_state);
        #[no_mangle]
        #[c2rust::src_loc = "149:1"]
        pub fn krb5int_dns_nextans(_: *mut krb5int_dns_state,
                                   _: *mut *const libc::c_uchar,
                                   _: *mut libc::c_int) -> libc::c_int;
    }
    /* !defined(KRB5_DNSGLUE_H) */
    /* KRB5_DNS_LOOKUP */
}
#[c2rust::header_src = "/usr/include/arpa/nameser.h:174"]
pub mod nameser_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-trace.h:29"]
pub mod k5_trace_h {
    use super::k5_int_h::_krb5_context;
...
pub use self::os_proto_h::srv_dns_entry;
use self::dnsglue_h::{krb5int_dns_state, krb5int_dns_init, krb5int_dns_expand,
                      krb5int_dns_fini, krb5int_dns_nextans};
pub use self::nameser_h::{ns_t_srv, ns_c_in, ns_t_uri, __ns_type, ns_t_max,
                          ns_t_dlv, ns_t_ta, ns_t_avc, ns_t_caa, ns_t_any,
                          ns_t_maila, ns_t_mailb, ns_t_axfr, ns_t_ixfr,
                          ns_t_tsig, ns_t_tkey, ns_t_eui64, ns_t_eui48,
                          ns_t_lp, ns_t_l64, ns_t_l32, ns_t_nid, ns_t_unspec,
                          ns_t_gid, ns_t_uid, ns_t_uinfo, ns_t_spf,
                          ns_t_csync, ns_t_openpgpkey, ns_t_cdnskey, ns_t_cds,
                          ...
                          ns_t_kx, ns_t_naptr, ns_t_atma, ns_t_nimloc,
                          ns_t_eid, ns_t_nxt, ns_t_loc, ns_t_aaaa, ns_t_gpos,
                          ns_t_px, ns_t_key, ns_t_sig, ns_t_nsap_ptr,
                          ns_t_nsap, ns_t_rt, ns_t_isdn, ns_t_x25, ns_t_afsdb,
                          ns_t_rp, ns_t_txt, ns_t_mx, ns_t_minfo, ns_t_hinfo,
                          ns_t_ptr, ns_t_wks, ns_t_null, ns_t_mr, ns_t_mg,
                          ns_t_mb, ns_t_soa, ns_t_cname, ns_t_mf, ns_t_md,
                          ns_t_ns, ns_t_a, ns_t_invalid, __ns_class, ns_c_max,
                          ns_c_any, ns_c_none, ns_c_hs, ns_c_chaos, ns_c_2,
                          ns_c_invalid};
use self::stdlib_h::{malloc, calloc, free};
use self::stdio_h::asprintf;
use self::errno_h::__errno_location;
use self::string_h::{memchr, memcpy};
...
#[no_mangle]
#[c2rust::src_loc = "36:1"]
pub unsafe extern "C" fn krb5int_free_srv_dns_data(mut p:
                                                       *mut srv_dns_entry) {
    let mut next: *mut srv_dns_entry = 0 as *mut srv_dns_entry;
    while !p.is_null() {
        next = (*p).next;
        free((*p).host as *mut libc::c_void);
 ...
 * be NULL. */
#[c2rust::src_loc = "50:1"]
unsafe extern "C" fn make_lookup_name(mut realm: *const krb5_data,
 ...
 -> *mut libc::c_char {
    let mut buf: k5buf =
        k5buf{buftype: K5BUF_ERROR,
              ...
              space: 0,
              len: 0,};
    if !memchr((*realm).data as *const libc::c_void, 0 as libc::c_int,
               (*realm).length as libc::c_ulong).is_null() {
        return 0 as *mut libc::c_char
    }
    k5_buf_init_dynamic(&mut buf);
    k5_buf_add_fmt(&mut buf as *mut k5buf,
                   b"%s.\x00" as *const u8 as *const libc::c_char, service);
    if !protocol.is_null() {
        k5_buf_add_fmt(&mut buf as *mut k5buf,
                       b"%s.\x00" as *const u8 as *const libc::c_char,
                       protocol);
    }
    k5_buf_add_len(&mut buf, (*realm).data as *const libc::c_void,
                   (*realm).length as size_t);
    /*
 ...
 * currently used. */
#[c2rust::src_loc = "80:1"]
unsafe extern "C" fn place_srv_entry(mut head: *mut *mut srv_dns_entry,
                                     mut new: *mut srv_dns_entry) {
    let mut entry: *mut srv_dns_entry = 0 as *mut srv_dns_entry;
    if (*head).is_null() || (**head).priority > (*new).priority {
        (*new).next = *head;
        *head = new;
        return
    }
...
pub unsafe extern "C" fn k5_make_uri_query(mut context: krb5_context,
                                           mut realm: *const krb5_data,
                                           mut service: *const libc::c_char,
                                           mut answers:
                                               *mut *mut srv_dns_entry)
 -> krb5_error_code {
    ...
    let mut priority: libc::c_ushort = 0;
    let mut weight: libc::c_ushort = 0;
    let mut ds: *mut krb5int_dns_state = 0 as *mut krb5int_dns_state;
    let mut head: *mut srv_dns_entry = 0 as *mut srv_dns_entry;
    let mut uri: *mut srv_dns_entry = 0 as *mut srv_dns_entry;
    *answers = 0 as *mut srv_dns_entry;
    /* Construct service.realm. */
    name = make_lookup_name(realm, service, 0 as *const libc::c_char);
    if name.is_null() { return 0 as libc::c_int }
    if (*context).trace_callback.is_some() {
        krb5int_trace(context,
                      b"Sending DNS URI query for {str}\x00" as *const u8 as
                          *const libc::c_char, name);
    }
    size =
        krb5int_dns_init(&mut ds, name, ns_c_in as libc::c_int,
                         ns_t_uri as libc::c_int);
    if size < 0 as libc::c_int {
        current_block = 2114805028422497969;
    } else { current_block = 3512920355445576850; }
    loop  {
        match current_block {
            2114805028422497969 => { krb5int_dns_fini(ds); break ; }
            _ => {
                ...
                priority =
                    ((*p.offset(0 as libc::c_int as isize) as libc::c_ushort
                          as libc::c_int) << 8 as libc::c_int |
                         *p.offset(1 as libc::c_int as isize) as
                             libc::c_ushort as libc::c_int) as libc::c_ushort;
                ...
                p = p.offset(2 as libc::c_int as isize);
                uri =
                    k5alloc(::std::mem::size_of::<srv_dns_entry>() as
                ...
                (*uri).priority = priority as libc::c_int;
                (*uri).weight = weight as libc::c_int;
                /* rdlen - 4 bytes remain after the priority and weight. */
                (*uri).host =
                    k5memdup0(p as *const libc::c_void,
                              (rdlen - 4 as libc::c_int) as size_t, &mut ret)
                        as *mut libc::c_char;
                if (*uri).host.is_null() {
                    ...
                    if (*context).trace_callback.is_some() {
                        krb5int_trace(context,
                                      b"URI answer: {int} {int} \"{str}\"\x00"
                                          as *const u8 as *const libc::c_char,
                                      (*uri).priority, (*uri).weight,
                                      (*uri).host);
                    }
                    place_srv_entry(&mut head, uri);
...
pub unsafe extern "C" fn krb5int_make_srv_query_realm(mut context:
                                                          krb5_context,
                                                      mut realm:
                                                          *const krb5_data,
                                                      mut service:
 ...
 -> krb5_error_code {
    ...
    let mut ds: *mut krb5int_dns_state = 0 as *mut krb5int_dns_state;
    let mut head: *mut srv_dns_entry = 0 as *mut srv_dns_entry;
    let mut srv: *mut srv_dns_entry = 0 as *mut srv_dns_entry;
    /*
    ...
    if (*context).trace_callback.is_some() {
        krb5int_trace(context,
                      b"Sending DNS SRV query for {str}\x00" as *const u8 as
                          *const libc::c_char, name);
    }
    size =
        krb5int_dns_init(&mut ds, name, ns_c_in as libc::c_int,
                         ns_t_srv as libc::c_int);
    if size < 0 as libc::c_int {
        current_block = 10054921217821771350;
    } else { current_block = 13586036798005543211; }
    loop  {
        match current_block {
            10054921217821771350 => { krb5int_dns_fini(ds); break ; }
            _ => {
                ret = krb5int_dns_nextans(ds, &mut base, &mut rdlen);
                if ret < 0 as libc::c_int || base.is_null() {
                    current_block = 10054921217821771350;
         ...
         */
                nlen =
                    krb5int_dns_expand(ds, p, host.as_mut_ptr(),
         ...
         */
                srv =
                    malloc(::std::mem::size_of::<srv_dns_entry>() as
                               libc::c_ulong) as *mut srv_dns_entry;
                if srv.is_null() {
                    current_block = 10054921217821771350;
                    continue ;
                }
                (*srv).priority = priority as libc::c_int;
                (*srv).weight = weight as libc::c_int;
                (*srv).port = port;
                /* The returned names are fully qualified.  Don't let the
         * local resolver code do domain search path stuff. */
                if asprintf(&mut (*srv).host as *mut *mut libc::c_char,
                            b"%s.\x00" as *const u8 as *const libc::c_char,
                            host.as_mut_ptr()) < 0 as libc::c_int {
                    free(srv as *mut libc::c_void);
                    current_block = 10054921217821771350;
                } else {
                    if (*context).trace_callback.is_some() {
                        krb5int_trace(context,
                                      b"SRV answer: {int} {int} {int} \"{str}\"\x00"
                                          as *const u8 as *const libc::c_char,
                                      (*srv).priority, (*srv).weight,
                                      (*srv).port as libc::c_int,
                                      (*srv).host);
                    }
                    place_srv_entry(&mut head, srv);
