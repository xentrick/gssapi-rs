...
#[no_mangle]
#[c2rust::src_loc = "44:1"]
pub unsafe extern "C" fn krb5_get_realm_domain(mut context: krb5_context,
                                               mut realm: *const libc::c_char,
                                               mut domain:
                                                   *mut *mut libc::c_char)
 -> krb5_error_code {
    let mut retval: krb5_error_code = 0;
    let mut temp_domain: *mut libc::c_char = 0 as *mut libc::c_char;
    retval =
        profile_get_string((*context).profile,
                           b"realms\x00" as *const u8 as *const libc::c_char,
                           realm,
                           b"default_domain\x00" as *const u8 as
                               *const libc::c_char, realm, &mut temp_domain)
            as krb5_error_code;
    if retval == 0 && !temp_domain.is_null() {
        *domain = strdup(temp_domain);
        if (*domain).is_null() { retval = 12 as libc::c_int }
