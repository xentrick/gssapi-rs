...
#[c2rust::header_src = "/usr/include/fcntl.h:36"]
pub mod fcntl_h {
    extern "C" {
        #[no_mangle]
...
use self::stdio_h::{fflush, fileno};
use self::fcntl_h::open;
use self::errno_h::__errno_location;
use self::unistd_h::{close, fsync};
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
...
#[no_mangle]
#[c2rust::src_loc = "51:1"]
pub unsafe extern "C" fn k5_create_secure_file(mut context: krb5_context,
                                               mut pathname:
                                                   *const libc::c_char)
 -> krb5_error_code {
...
#[no_mangle]
#[c2rust::src_loc = "88:1"]
pub unsafe extern "C" fn k5_sync_disk_file(mut context: krb5_context,
                                           mut fp: *mut FILE)
 -> krb5_error_code {
    fflush(fp);
    if fsync(fileno(fp)) != 0 { return *__errno_location() }
    return 0 as libc::c_int;
}
