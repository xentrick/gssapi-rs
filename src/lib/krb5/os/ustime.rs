...
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         ...
                         _krb5_os_context, krb5_os_context, ts_incr,
...
#[no_mangle]
#[c2rust::src_loc = "39:1"]
pub unsafe extern "C" fn k5_time_with_offset(mut offset: krb5_timestamp,
                                             mut offset_usec: krb5_int32,
                                             mut time_out:
                                                 *mut krb5_timestamp,
 ...
 -> krb5_error_code {
    ...
    usec += offset_usec;
    if usec > 1000000 as libc::c_int {
        usec -= 1000000 as libc::c_int;
        sec = ts_incr(sec, 1 as libc::c_int)
    }
...
#[no_mangle]
#[c2rust::src_loc = "66:1"]
pub unsafe extern "C" fn krb5_us_timeofday(mut context: krb5_context,
                                           mut seconds: *mut krb5_timestamp,
                                           mut microseconds: *mut krb5_int32)
 -> krb5_error_code {
    ...
    if (*os_ctx).os_flags & 2 as libc::c_int != 0 {
        ...
        *microseconds = (*os_ctx).usec_offset;
        return 0 as libc::c_int
    } else if (*os_ctx).os_flags & 1 as libc::c_int != 0 {
        return k5_time_with_offset((*os_ctx).time_offset,
                                   (*os_ctx).usec_offset, seconds,
                                   microseconds)
