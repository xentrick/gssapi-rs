...
pub use self::krb5_h::{krb5_octet, krb5_int16, krb5_int32, krb5_ui_4,
                       krb5_boolean, krb5_addrtype, krb5_enctype, krb5_flags,
                       krb5_deltat, krb5_error_code, krb5_magic, _krb5_data,
                       krb5_data, _krb5_address, krb5_address,
...
#[no_mangle]
#[c2rust::src_loc = "32:1"]
pub unsafe extern "C" fn krb5_unpack_full_ipaddr(mut context: krb5_context,
                                                 mut inaddr:
                                                     *const krb5_address,
                                                 mut adr: *mut krb5_int32,
                                                 mut port: *mut krb5_int16)
 -> krb5_error_code {
    let mut smushaddr: libc::c_ulong = 0;
    let mut smushport: libc::c_ushort = 0;
    let mut marshal: *mut krb5_octet = 0 as *mut krb5_octet;
    let mut temptype: krb5_addrtype = 0;
    let mut templength: krb5_ui_4 = 0;
    if (*inaddr).addrtype != 0x100 as libc::c_int {
        return -(1765328170 as libc::c_long) as krb5_error_code
    }
    if (*inaddr).length as libc::c_ulong !=
    ...
    memcpy(&mut temptype as *mut krb5_addrtype as *mut libc::c_void,
           marshal as *const libc::c_void,
           ::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong
                           as isize);
    if temptype != htons(0x2 as libc::c_int as uint16_t) as libc::c_int {
        return -(1765328170 as libc::c_long) as krb5_error_code
    }
    memcpy(&mut templength as *mut krb5_ui_4 as *mut libc::c_void,
           marshal as *const libc::c_void,
           ::std::mem::size_of::<krb5_ui_4>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_ui_4>() as libc::c_ulong as
                           isize);
    if templength !=
    ...
    memcpy(&mut smushaddr as *mut libc::c_ulong as *mut libc::c_void,
           marshal as *const libc::c_void,
    ...
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong
                           as isize);
    if temptype != htons(0x101 as libc::c_int as uint16_t) as libc::c_int {
        return -(1765328170 as libc::c_long) as krb5_error_code
    }
    memcpy(&mut templength as *mut krb5_ui_4 as *mut libc::c_void,
           marshal as *const libc::c_void,
    ...
    memcpy(&mut smushport as *mut libc::c_ushort as *mut libc::c_void,
           marshal as *const libc::c_void,
           ::std::mem::size_of::<libc::c_ushort>() as libc::c_ulong);
    /* leave in net order */
    *adr = smushaddr as krb5_int32;
    *port = smushport as krb5_int16;
