...
#[no_mangle]
#[c2rust::src_loc = "33:1"]
pub unsafe extern "C" fn krb5_make_full_ipaddr(mut context: krb5_context,
                                               mut adr: krb5_int32,
                                               mut port: libc::c_int,
                                               mut outaddr:
                                                   *mut *mut krb5_address)
 -> krb5_error_code {
    let mut smushaddr: libc::c_ulong =
        adr as libc::c_ulong; /* already in net order */
    let mut smushport: libc::c_ushort = port as libc::c_ushort; /* ditto */
    let mut retaddr: *mut krb5_address = 0 as *mut krb5_address;
    let mut marshal: *mut krb5_octet = 0 as *mut krb5_octet;
    let mut temptype: krb5_addrtype = 0;
    let mut templength: krb5_int32 = 0;
    retaddr =
        malloc(::std::mem::size_of::<krb5_address>() as libc::c_ulong) as
            *mut krb5_address;
    if retaddr.is_null() { return 12 as libc::c_int }
    (*retaddr).magic = -(1760647390 as libc::c_long) as krb5_magic;
    (*retaddr).addrtype = 0x100 as libc::c_int;
    (*retaddr).length =
        (::std::mem::size_of::<libc::c_ulong>() as
             libc::c_ulong).wrapping_add(::std::mem::size_of::<libc::c_ushort>()
                                             ...
                                             libc::c_ulong).wrapping_add((2 as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_ulong).wrapping_mul(::std::mem::size_of::<krb5_addrtype>()
                                                                                                              as
            ...
            as libc::c_uint;
    (*retaddr).contents =
        malloc((*retaddr).length as libc::c_ulong) as *mut krb5_octet;
    if (*retaddr).contents.is_null() {
        free(retaddr as *mut libc::c_void);
        return 12 as libc::c_int
    }
    marshal = (*retaddr).contents;
    temptype = htons(0x2 as libc::c_int as uint16_t) as krb5_addrtype;
    memcpy(marshal as *mut libc::c_void,
           &mut temptype as *mut krb5_addrtype as *const libc::c_void,
           ::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong
                           as isize);
    templength =
        htonl(::std::mem::size_of::<libc::c_ulong>() as libc::c_ulong as
                  uint32_t) as krb5_int32;
    memcpy(marshal as *mut libc::c_void,
           &mut templength as *mut krb5_int32 as *const libc::c_void,
           ::std::mem::size_of::<krb5_int32>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_int32>() as libc::c_ulong as
                           isize);
    memcpy(marshal as *mut libc::c_void,
           &mut smushaddr as *mut libc::c_ulong as *const libc::c_void,
           ::std::mem::size_of::<libc::c_ulong>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<libc::c_ulong>() as libc::c_ulong
                           as isize);
    temptype = htons(0x101 as libc::c_int as uint16_t) as krb5_addrtype;
    memcpy(marshal as *mut libc::c_void,
           &mut temptype as *mut krb5_addrtype as *const libc::c_void,
           ::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_addrtype>() as libc::c_ulong
                           as isize);
    templength =
        htonl(::std::mem::size_of::<libc::c_ushort>() as libc::c_ulong as
                  uint32_t) as krb5_int32;
    memcpy(marshal as *mut libc::c_void,
           &mut templength as *mut krb5_int32 as *const libc::c_void,
           ::std::mem::size_of::<krb5_int32>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<krb5_int32>() as libc::c_ulong as
                           isize);
    memcpy(marshal as *mut libc::c_void,
           &mut smushport as *mut libc::c_ushort as *const libc::c_void,
           ::std::mem::size_of::<libc::c_ushort>() as libc::c_ulong);
    marshal =
        marshal.offset(::std::mem::size_of::<libc::c_ushort>() as
