...
pub mod os_proto_h {
    use super::k5_int_h::_krb5_context;
    use super::krb5_h::{krb5_context, krb5_int32, krb5_address,
                        krb5_error_code};
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "110:1"]
        pub fn krb5_make_full_ipaddr(_: krb5_context, _: krb5_int32,
                                     _: libc::c_int,
...
use self::os_proto_h::krb5_make_full_ipaddr;
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_gen_portaddr(mut context: krb5_context,
                                           mut addr: *const krb5_address,
                                           mut ptr: krb5_const_pointer,
                                           mut outaddr:
                                               *mut *mut krb5_address)
 -> krb5_error_code {
    let mut adr: krb5_int32 = 0;
    let mut port: krb5_int16 = 0;
    if (*addr).addrtype != 0x2 as libc::c_int {
        return -(1765328170 as libc::c_long) as krb5_error_code
    }
    port = *(ptr as *const krb5_int16);
    memcpy(&mut adr as *mut krb5_int32 as *mut libc::c_void,
           (*addr).contents as *const libc::c_void,
           ::std::mem::size_of::<krb5_int32>() as libc::c_ulong);
    return krb5_make_full_ipaddr(context, adr, port as libc::c_int, outaddr);
}
