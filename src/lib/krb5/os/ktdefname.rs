...
#[no_mangle]
#[c2rust::src_loc = "33:7"]
pub static mut krb5_overridekeyname: *mut libc::c_char =
    0 as *const libc::c_char as *mut libc::c_char;
#[c2rust::src_loc = "35:1"]
unsafe extern "C" fn kt_default_name(mut context: krb5_context,
                                     mut name_out: *mut *mut libc::c_char)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    if !krb5_overridekeyname.is_null() {
        *name_out = strdup(krb5_overridekeyname);
        return if (*name_out).is_null() {
                   12 as libc::c_int
               } else { 0 as libc::c_int }
    } else if (*context).profile_secure == 0 as libc::c_int as libc::c_uint &&
                  {
                      str =
                          secure_getenv(b"KRB5_KTNAME\x00" as *const u8 as
                                            *const libc::c_char);
                      !str.is_null()
                  } {
        *name_out = strdup(str);
        return if (*name_out).is_null() {
                   12 as libc::c_int
                                 ...
                                 b"libdefaults\x00" as *const u8 as
                                     *const libc::c_char,
                                 b"default_keytab_name\x00" as *const u8 as
                                     *const libc::c_char,
                                 0 as *const libc::c_char,
                                 0 as *const libc::c_char, &mut str) ==
                  0 as libc::c_int as libc::c_long && !str.is_null() {
        ret = k5_expand_path_tokens(context, str, name_out);
        profile_release_string(str);
        return ret
    } else {
        return k5_expand_path_tokens(context,
                                     b"FILE:/etc/krb5.keytab\x00" as *const u8
                                         as *const libc::c_char, name_out)
    };
}
#[no_mangle]
#[c2rust::src_loc = "59:1"]
pub unsafe extern "C" fn k5_kt_client_default_name(mut context: krb5_context,
                                                   mut name_out:
                                                       *mut *mut libc::c_char)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut str: *mut libc::c_char = 0 as *mut libc::c_char;
    if (*context).profile_secure == 0 as libc::c_int as libc::c_uint &&
           {
               str =
                   secure_getenv(b"KRB5_CLIENT_KTNAME\x00" as *const u8 as
                                     *const libc::c_char);
               !str.is_null()
           } {
        *name_out = strdup(str);
        return if (*name_out).is_null() {
                   12 as libc::c_int
                                 ...
                                 b"libdefaults\x00" as *const u8 as
                                     *const libc::c_char,
                                 b"default_client_keytab_name\x00" as
        ...
        return k5_expand_path_tokens(context,
                                     b"FILE:/var/lib/krb5/user/%{euid}/client.keytab\x00"
...
#[no_mangle]
#[c2rust::src_loc = "80:1"]
pub unsafe extern "C" fn krb5_kt_default_name(mut context: krb5_context,
                                              mut name: *mut libc::c_char,
                                              mut name_size: libc::c_int)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut namesize: libc::c_uint =
        if name_size < 0 as libc::c_int {
            0 as libc::c_int
        } else { name_size } as libc::c_uint;
    let mut ktname: *mut libc::c_char = 0 as *mut libc::c_char;
    ret = kt_default_name(context, &mut ktname);
    if ret != 0 { return ret }
    if krb5int_strlcpy(name, ktname, namesize as size_t) >=
           namesize as libc::c_ulong {
        ret = -(1765328247 as libc::c_long) as krb5_error_code
    }
    free(ktname as *mut libc::c_void);
    return ret;
}
