...
#[no_mangle]
#[c2rust::src_loc = "35:1"]
pub unsafe extern "C" fn krb5_gen_replay_name(mut context: krb5_context,
                                              mut address:
                                                  *const krb5_address,
                                              mut uniq: *const libc::c_char,
                                              mut string:
                                                  *mut *mut libc::c_char)
 -> krb5_error_code {
    ...
    len =
        strlen(uniq).wrapping_add((*address).length.wrapping_mul(2 as
                                                                     libc::c_int
                                                                     as
                                                                     libc::c_uint)
                                      as
                                      libc::c_ulong).wrapping_add(1 as
                                                                      ...
                                                                      libc::c_ulong)
            as libc::c_uint;
    *string = malloc(len as libc::c_ulong) as *mut libc::c_char;
    if (*string).is_null() { return 12 as libc::c_int }
    snprintf(*string, len as libc::c_ulong,
             b"%s\x00" as *const u8 as *const libc::c_char, uniq);
    tmp = (*string).offset(strlen(uniq) as isize);
    i = 0 as libc::c_int as libc::c_uint;
    while i < (*address).length {
        snprintf(tmp,
                 (len as libc::c_long -
                      tmp.wrapping_offset_from(*string) as libc::c_long) as
                     libc::c_ulong,
                 b"%.2x\x00" as *const u8 as *const libc::c_char,
                 *(*address).contents.offset(i as isize) as libc::c_int &
                     0xff as libc::c_int);
