...
pub use self::port_sockets_h::sg_buf;
...
#[no_mangle]
#[c2rust::src_loc = "38:1"]
pub unsafe extern "C" fn k5_write_messages(mut context: krb5_context,
                                           mut fdp: krb5_pointer,
                                           mut outbuf: *mut krb5_data,
                                           mut nbufs: libc::c_int)
 -> krb5_error_code {
    let mut fd: libc::c_int = *(fdp as *mut libc::c_int);
    while nbufs != 0 {
        let mut nbufs1: libc::c_int = 0;
        let mut sg: [sg_buf; 4] =
            [sg_buf{iov_base: 0 as *mut libc::c_void, iov_len: 0,}; 4];
        let mut len: [krb5_int32; 2] = [0; 2];
        if nbufs > 1 as libc::c_int {
            nbufs1 = 2 as libc::c_int
        } else { nbufs1 = 1 as libc::c_int }
        len[0 as libc::c_int as usize] =
            htonl((*outbuf.offset(0 as libc::c_int as isize)).length) as
                krb5_int32;
        sg[0 as libc::c_int as usize].iov_base =
            &mut *len.as_mut_ptr().offset(0 as libc::c_int as isize) as
                *mut krb5_int32 as *mut libc::c_char as *mut libc::c_void;
        sg[0 as libc::c_int as usize].iov_len = 4 as libc::c_int as size_t;
        sg[1 as libc::c_int as usize].iov_base =
            (if (*outbuf.offset(0 as libc::c_int as isize)).length != 0 {
                 (*outbuf.offset(0 as libc::c_int as isize)).data
             } else { 0 as *mut libc::c_char }) as *mut libc::c_void;
        sg[1 as libc::c_int as usize].iov_len =
            (*outbuf.offset(0 as libc::c_int as isize)).length as size_t;
        if nbufs1 == 2 as libc::c_int {
            len[1 as libc::c_int as usize] =
                htonl((*outbuf.offset(1 as libc::c_int as isize)).length) as
                    krb5_int32;
            sg[2 as libc::c_int as usize].iov_base =
                &mut *len.as_mut_ptr().offset(1 as libc::c_int as isize) as
                    *mut krb5_int32 as *mut libc::c_char as *mut libc::c_void;
            sg[2 as libc::c_int as usize].iov_len =
                4 as libc::c_int as size_t;
            sg[3 as libc::c_int as usize].iov_base =
                (if (*outbuf.offset(1 as libc::c_int as isize)).length != 0 {
                     (*outbuf.offset(1 as libc::c_int as isize)).data
                 } else { 0 as *mut libc::c_char }) as *mut libc::c_void;
            sg[3 as libc::c_int as usize].iov_len =
                (*outbuf.offset(1 as libc::c_int as isize)).length as size_t
        }
        if krb5int_net_writev(context, fd, sg.as_mut_ptr(),
                              nbufs1 * 2 as libc::c_int) < 0 as libc::c_int {
            return *__errno_location()
        }
        outbuf = outbuf.offset(nbufs1 as isize);
        nbufs -= nbufs1
    }
...
#[no_mangle]
#[c2rust::src_loc = "72:1"]
pub unsafe extern "C" fn krb5_write_message(mut context: krb5_context,
                                            mut fdp: krb5_pointer,
                                            mut outbuf: *mut krb5_data)
 -> krb5_error_code {
    return k5_write_messages(context, fdp, outbuf, 1 as libc::c_int);
}
