...
pub use self::krb5_h::{krb5_int32, krb5_ui_4, krb5_boolean, krb5_enctype,
                       ...
                       _krb5_data, krb5_data, krb5_pointer, krb5_post_recv_fn,
...
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         ...
                         _kdb5_dal_handle, krb5_net_read};
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_read_message(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    *inbuf = empty_data();
    len2 =
        krb5_net_read(context, fd,
                      &mut len as *mut krb5_int32 as *mut libc::c_char,
                      4 as libc::c_int);
    if len2 != 4 as libc::c_int {
        return if len2 < 0 as libc::c_int {
                   *__errno_location()
               } else { 103 as libc::c_int }
    }
    len = ntohl(len as uint32_t) as krb5_int32;
    ...
    if ilen != 0 {
         ...
         */
        buf = malloc(ilen as libc::c_ulong) as *mut libc::c_char;
        if buf.is_null() { return 12 as libc::c_int }
        len2 = krb5_net_read(context, fd, buf, ilen);
        if len2 != ilen {
    ...
    *inbuf = make_data(buf as *mut libc::c_void, ilen as libc::c_uint);
