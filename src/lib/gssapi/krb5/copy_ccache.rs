...
#[c2rust::header_src = "/usr/include/bits/thread-shared-types.h:2"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/authdata_plugin.h:2"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi.h:2"]
pub mod gssapi_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:2"]
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       krb5_free_context, krb5_cc_copy_creds};
...
#[no_mangle]
#[c2rust::src_loc = "4:1"]
pub unsafe extern "C" fn gss_krb5int_copy_ccache(mut minor_status:
                                                     *mut OM_uint32,
                                                 mut cred_handle:
                                                     *mut gss_cred_id_t,
                                                 ...
                                                 value: gss_buffer_t)
 -> OM_uint32 {
    let mut k5creds: krb5_gss_cred_id_t = 0 as *mut _krb5_gss_cred_id_rec;
    let mut code: krb5_error_code = 0;
    let mut context: krb5_context = 0 as krb5_context;
    let mut out_ccache: krb5_ccache = 0 as *mut _krb5_ccache;
    if (*value).length ==
           ::std::mem::size_of::<krb5_ccache>() as libc::c_ulong {
    } else {
        __assert_fail(b"value->length == sizeof(out_ccache)\x00" as *const u8
                          as *const libc::c_char,
                      b"copy_ccache.c\x00" as *const u8 as
                          *const libc::c_char,
                      15 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 99],
                                                &[libc::c_char; 99]>(b"OM_uint32 gss_krb5int_copy_ccache(OM_uint32 *, gss_cred_id_t *, const gss_OID, const gss_buffer_t)\x00")).as_ptr());
    }
    if (*value).length !=
           ::std::mem::size_of::<krb5_ccache>() as libc::c_ulong {
        return (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    out_ccache = (*value).value as krb5_ccache;
    /* cred handle will have been validated by gssspi_set_cred_option() */
    k5creds = *cred_handle as krb5_gss_cred_id_t;
    k5_mutex_lock(&mut (*k5creds).lock);
    if (*k5creds).usage == 2 as libc::c_int {
    ...
    k5_mutex_unlock(&mut (*k5creds).lock);
    *minor_status = code as OM_uint32;
    if !context.is_null() {
        if code != 0 { krb5_gss_save_error_info(*minor_status, context); }
