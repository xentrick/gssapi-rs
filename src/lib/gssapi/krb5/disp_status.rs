...
#[c2rust::header_src = "/usr/lib/clang/9.0.1/include/stdarg.h:24"]
pub mod stdarg_h {
    #[c2rust::src_loc = "14:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-thread.h:24"]
pub mod k5_thread_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/krb5.h:24"]
pub mod krb5_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-int.h:24"]
pub mod k5_int_h {
    /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-err.h:24"]
pub mod k5_err_h {
    /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/* include/k5-err.h */
/*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-plugin.h:24"]
pub mod k5_plugin_h {
    /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/profile.h:24"]
pub mod profile_h {
    /*
 * profile.h
 */
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/com_err.h:24"]
pub mod com_err_h {
    /*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/error_map.h:44"]
pub mod error_map_h {
    #[c2rust::src_loc = "32:1"]
    pub type gsserrmap = gsserrmap__head;
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "29:8"]
    pub struct gsserrmap__head {
        pub first: *mut gsserrmap__element,
    }
    /*
 ...
 */
    ...
    pub struct gsserrmap__element {
        ...
        pub next: *mut gsserrmap__element,
    }
    #[inline]
    #[c2rust::src_loc = "33:1"]
    pub unsafe extern "C" fn gsserrmap_init(mut head: *mut gsserrmap__head)
     -> libc::c_int {
        (*head).first = 0 as *mut gsserrmap__element;
        return 0 as libc::c_int;
    }
    #[inline]
    #[c2rust::src_loc = "38:1"]
    pub unsafe extern "C" fn gsserrmap_destroy(mut head:
                                                   *mut gsserrmap__head) {
        let mut e: *mut gsserrmap__element = 0 as *mut gsserrmap__element;
        let mut e_next: *mut gsserrmap__element =
            0 as *mut gsserrmap__element;
        let mut free_key: Option<unsafe extern "C" fn(_: OM_uint32) -> ()> =
            None;
        let mut free_value:
        ...
        while !e.is_null() {
            e_next = (*e).next;
            if free_key.is_some() {
                Some(free_key.expect("non-null function pointer")).expect("non-null function pointer")((*e).key);
            }
            if free_value.is_some() {
                Some(free_value.expect("non-null function pointer")).expect("non-null function pointer")((*e).value);
            }
    ...
    #[inline]
    #[c2rust::src_loc = "54:1"]
    pub unsafe extern "C" fn gsserrmap__find_node(mut head:
                                                      *mut gsserrmap__head,
                                                  mut key: OM_uint32)
     -> *mut gsserrmap__element {
        let mut e: *mut gsserrmap__element = 0 as *mut gsserrmap__element;
        e = (*head).first;
        while !e.is_null() {
            if compare_OM_uint32(key, (*e).key) == 0 as libc::c_int {
                return e
            }
            e = (*e).next
        }
        return 0 as *mut gsserrmap__element;
    }
    /* Returns pointer to value, or null if key not found.  */
    #[inline]
    #[c2rust::src_loc = "64:1"]
    pub unsafe extern "C" fn gsserrmap_find(mut head: *mut gsserrmap__head,
                                            mut key: OM_uint32)
     -> *mut *mut libc::c_char {
        let mut e: *mut gsserrmap__element = gsserrmap__find_node(head, key);
        if !e.is_null() { return &mut (*e).value }
        return 0 as *mut *mut libc::c_char;
    }
    /* Returns 0 or error code.  */
    #[inline]
    #[c2rust::src_loc = "73:1"]
    pub unsafe extern "C" fn gsserrmap__copy_key(mut out: *mut OM_uint32,
                                                 mut in_0: OM_uint32)
     -> libc::c_int {
        let mut copykey:
                Option<unsafe extern "C" fn(_: *mut OM_uint32, _: OM_uint32)
                           -> libc::c_int> = None;
        if copykey.is_none() {
            *out = in_0;
            return 0 as libc::c_int
        } else {
            return Some(copykey.expect("non-null function pointer")).expect("non-null function pointer")(out,
                                                                                                         in_0)
        };
    }
    /* Returns 0 or error code.  */
    #[inline]
    #[c2rust::src_loc = "84:1"]
    pub unsafe extern "C" fn gsserrmap_replace_or_insert(mut head:
                                                             *mut gsserrmap__head,
                                                         mut key: OM_uint32,
                                                         mut new_value:
                                                             *mut libc::c_char)
     -> libc::c_int {
        ...
        if !e.is_null() {
            ...
            /* insert */
            e =
                malloc(::std::mem::size_of::<gsserrmap__element>() as
                           libc::c_ulong) as *mut gsserrmap__element;
            if e.is_null() { return 12 as libc::c_int }
            ret = gsserrmap__copy_key(&mut (*e).key, key);
            if ret != 0 { free(e as *mut libc::c_void); return ret }
            (*e).value = new_value;
            (*e).next = (*head).first;
            (*head).first = e
        }
    ...
    use super::{free_string, compare_OM_uint32};
...
pub mod gssapiP_generic_h {
    ...
    extern "C" {
        ...
        pub fn gssint_g_display_major_status(minor_status: *mut OM_uint32,
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapi_krb5.h:24"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:24"]
...
pub use self::error_map_h::{gsserrmap, gsserrmap__head, gsserrmap__element,
                            gsserrmap_init, gsserrmap_destroy,
                            gsserrmap__find_node, gsserrmap_find,
                            gsserrmap__copy_key, gsserrmap_replace_or_insert};
use self::stdio_h::vasprintf;
use self::stdlib_h::{free, malloc};
use self::string_h::{strdup, memcmp};
use self::gssapiP_generic_h::{gssint_g_make_string_buffer,
                              gssint_g_display_major_status};
use self::gssapi_krb5_h::{gss_mech_krb5, gss_mech_krb5_old, gss_mech_iakerb};
use self::gssapiP_krb5_h::gss_krb5int_initialize_library;
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
 * Copyright 1993 by OpenVision Technologies, Inc.
 *
...
#[inline]
#[c2rust::src_loc = "29:1"]
unsafe extern "C" fn compare_OM_uint32(mut a: OM_uint32, mut b: OM_uint32)
 -> libc::c_int {
    if a < b {
...
#[inline]
#[c2rust::src_loc = "39:1"]
unsafe extern "C" fn free_string(mut s: *mut libc::c_char) {
    free(s as *mut libc::c_void);
}
#[no_mangle]
#[c2rust::src_loc = "46:1"]
pub unsafe extern "C" fn krb5_gss_get_error_message(mut minor_code: OM_uint32)
 -> *mut libc::c_char {
    let mut p: *mut gsserrmap =
        krb5int_getspecific(K5_KEY_GSS_KRB5_ERROR_MESSAGE) as *mut gsserrmap;
    let mut msg: *mut libc::c_char = 0 as *mut libc::c_char;
    if !p.is_null() {
        let mut v: *mut *mut libc::c_char = gsserrmap_find(p, minor_code);
        if !v.is_null() { msg = *v }
    }
    if msg.is_null() {
        msg =
            error_message(minor_code as krb5_error_code as errcode_t) as
                *mut libc::c_char
    }
    return msg;
}
#[c2rust::src_loc = "71:1"]
unsafe extern "C" fn gss_krb5_save_error_string_nocopy(mut minor_code:
                                                           OM_uint32,
                                                       mut msg:
                                                           *mut libc::c_char)
 -> libc::c_int {
    let mut current_block: u64;
    let mut p: *mut gsserrmap = 0 as *mut gsserrmap;
    let mut ret: libc::c_int = 0;
    p = krb5int_getspecific(K5_KEY_GSS_KRB5_ERROR_MESSAGE) as *mut gsserrmap;
    if p.is_null() {
        p =
            malloc(::std::mem::size_of::<gsserrmap>() as libc::c_ulong) as
                *mut gsserrmap;
        if p.is_null() {
            ret = 1 as libc::c_int;
            current_block = 9353323475770310880;
        } else if gsserrmap_init(p) != 0 as libc::c_int {
            free(p as *mut libc::c_void);
            p = 0 as *mut gsserrmap;
            ret = 1 as libc::c_int;
            current_block = 9353323475770310880;
        } else if krb5int_setspecific(K5_KEY_GSS_KRB5_ERROR_MESSAGE,
...
pub unsafe extern "C" fn krb5_gss_save_error_string(mut minor_code: OM_uint32,
                                                    mut msg:
                                                        *mut libc::c_char) {
    let mut s: *mut libc::c_char = strdup(msg);
    if !s.is_null() {
        if gss_krb5_save_error_string_nocopy(minor_code, s) !=
               0 as libc::c_int {
            free(s as *mut libc::c_void);
        }
    };
...
pub unsafe extern "C" fn krb5_gss_save_error_message(mut minor_code:
                                                         OM_uint32,
                                                     mut format:
                                                         *const libc::c_char,
                                                     mut args: ...) {
    ...
    ap = args.clone();
    n = vasprintf(&mut s, format, ap.as_va_list());
...
pub unsafe extern "C" fn krb5_gss_save_error_info(mut minor_code: OM_uint32,
                                                  mut ctx: krb5_context) {
    let mut s: *mut libc::c_char = 0 as *mut libc::c_char;
    s =
        krb5_get_error_message(ctx, minor_code as krb5_error_code) as
            *mut libc::c_char;
    ...
    krb5_set_error_message(ctx, minor_code as krb5_error_code,
...
pub unsafe extern "C" fn krb5_gss_delete_error_info(mut p:
                                                        *mut libc::c_void) {
    gsserrmap_destroy(p as *mut gsserrmap__head);
    free(p);
}
/* -*- mode: c; indent-tabs-mode: nil -*- */
/*
...
pub unsafe extern "C" fn krb5_gss_display_status(mut minor_status:
                                                     *mut OM_uint32,
                                                 ...
                                                 mut status_string:
                                                     gss_buffer_t)
 -> OM_uint32 {
    (*status_string).length = 0 as libc::c_int as size_t;
    (*status_string).value = 0 as *mut libc::c_void;
    if !mech_type.is_null() &&
           !((*gss_mech_krb5).length == (*mech_type).length &&
                 memcmp((*gss_mech_krb5).elements, (*mech_type).elements,
                        (*gss_mech_krb5).length as libc::c_ulong) ==
                     0 as libc::c_int) &&
           !((*gss_mech_krb5_old).length == (*mech_type).length &&
                 memcmp((*gss_mech_krb5_old).elements, (*mech_type).elements,
                        (*gss_mech_krb5_old).length as libc::c_ulong) ==
                     0 as libc::c_int) &&
           !((*gss_mech_iakerb).length == (*mech_type).length &&
                 memcmp((*gss_mech_iakerb).elements, (*mech_type).elements,
    ...
    if status_type == 1 as libc::c_int {
        return gssint_g_display_major_status(minor_status, status_value,
                                             message_context, status_string)
    } else if status_type == 2 as libc::c_int {
        ...
        if gssint_g_make_string_buffer(krb5_gss_get_error_message(status_value),
                                       status_string) == 0 {
