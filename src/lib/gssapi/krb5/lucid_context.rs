...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/generic/gssapi_ext.h:29"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapi_krb5.h:29"]
 ...
 */
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "169:16"]
    pub struct gss_krb5_lucid_context_version {
        pub version: OM_uint32,
    }
    #[c2rust::src_loc = "169:1"]
    pub type gss_krb5_lucid_context_version_t
        =
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:29"]
...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_ctx_id_t,
                         ...
                         gss_buffer_t, gss_ctx_id_struct};
...
#[no_mangle]
#[c2rust::src_loc = "59:1"]
pub unsafe extern "C" fn gss_krb5int_export_lucid_sec_context(mut minor_status:
                                                                  *mut OM_uint32,
                                                              context_handle:
                                                                  gss_ctx_id_t,
                                                              desired_object:
 ...
 -> OM_uint32 {
    let mut kret: krb5_error_code = 0 as libc::c_int;
    let mut retval: OM_uint32 = 0;
    let mut ctx: krb5_gss_ctx_id_t = context_handle as krb5_gss_ctx_id_t;
    let mut lctx: *mut libc::c_void = 0 as *mut libc::c_void;
    let mut version: libc::c_int = 0 as libc::c_int;
    let mut rep: gss_buffer_desc =
        gss_buffer_desc{length: 0, value: 0 as *mut libc::c_void,};
    /* Assume failure */
    retval = (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int;
    ...
    *data_set = 0 as gss_buffer_set_t;
    ...
    match version {
        1 => {
            kret =
                make_external_lucid_ctx_v1(ctx as krb5_pointer as
                                               *mut krb5_gss_ctx_id_rec,
                                           version, &mut lctx)
        }
        _ => {
            kret = 39756046 as libc::c_long as OM_uint32 as krb5_error_code
        }
    }
    if !(kret != 0) {
        ...
        retval =
            generic_gss_add_buffer_set_member(minor_status, &mut rep,
                                              data_set);
        (retval &
             ((0o377 as libc::c_ulong as OM_uint32) << 24 as libc::c_int |
                  (0o377 as libc::c_ulong as OM_uint32) << 16 as libc::c_int))
    ...
    if *minor_status == 0 as libc::c_int as libc::c_uint {
        *minor_status = kret as OM_uint32
    }
    return retval;
}
/* -*- mode: c; indent-tabs-mode: nil -*- */
...
#[no_mangle]
#[c2rust::src_loc = "122:1"]
pub unsafe extern "C" fn gss_krb5int_free_lucid_sec_context(mut minor_status:
                                                                *mut OM_uint32,
                                                            desired_mech:
                                                                gss_OID,
                                                            desired_object:
 ...
 -> OM_uint32 {
    ...
    let mut kctx: *mut libc::c_void = 0 as *mut libc::c_void;
    /* Assume failure */
    retval = (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int;
    *minor_status = 0 as libc::c_int as OM_uint32;
    kctx = (*value).value;
    if kctx.is_null() {
        ...
        version =
            (*(kctx as *mut gss_krb5_lucid_context_version_t)).version as
                libc::c_int;
        match version {
            1 => {
                free_external_lucid_ctx_v1(kctx as
                                               *mut gss_krb5_lucid_context_v1_t);
            }
            _ => { kret = 22 as libc::c_int }
        }
        if !(kret != 0) {
            /* Success! */
            *minor_status = 0 as libc::c_int as OM_uint32;
            retval = 0 as libc::c_int as OM_uint32;
            return retval
        }
    }
    if *minor_status == 0 as libc::c_int as libc::c_uint {
 ...
 */
#[c2rust::src_loc = "174:1"]
unsafe extern "C" fn make_external_lucid_ctx_v1(mut gctx:
                                                    *mut krb5_gss_ctx_id_rec,
 ...
 -> krb5_error_code {
    ...
    let mut bufsize: libc::c_uint =
        ::std::mem::size_of::<gss_krb5_lucid_context_v1_t>() as libc::c_ulong
            as libc::c_uint;
    let mut retval: krb5_error_code = 0;
    /* Allocate the structure */
    lctx =
        malloc(bufsize as libc::c_ulong) as *mut gss_krb5_lucid_context_v1_t;
    if lctx.is_null() {
        retval = 12 as libc::c_int
    } else {
        memset(lctx as *mut libc::c_void, 0 as libc::c_int,
               bufsize as libc::c_ulong);
        (*lctx).version = 1 as libc::c_int as OM_uint32;
        (*lctx).initiate =
            if (*gctx).initiate() as libc::c_int != 0 {
                1 as libc::c_int
            } else { 0 as libc::c_int } as OM_uint32;
        (*lctx).endtime = (*gctx).krb_times.endtime as OM_uint32;
        (*lctx).send_seq = (*gctx).seq_send;
        (*lctx).recv_seq = (*gctx).seq_recv;
        (*lctx).protocol = (*gctx).proto as OM_uint32;
        /* gctx->proto == 0 ==> rfc1964-style key information
       gctx->proto == 1 ==> cfx-style (draft-ietf-krb-wg-gssapi-cfx-07) keys */
        if (*gctx).proto == 0 as libc::c_int {
            (*lctx).rfc1964_kd.sign_alg = (*gctx).signalg as OM_uint32;
            (*lctx).rfc1964_kd.seal_alg = (*gctx).sealalg as OM_uint32;
            /* Copy key */
            retval =
                copy_keyblock_to_lucid_key(&mut (*(*gctx).seq).keyblock,
                                           &mut (*lctx).rfc1964_kd.ctx_key);
            if retval != 0 {
                current_block = 5031962668085496365;
            } else { current_block = 1109700713171191020; }
        } else if (*gctx).proto == 1 as libc::c_int {
            /* Copy keys */
        /* (subkey is always present, either a copy of the kerberos
           session key or a subkey) */
            retval =
                copy_keyblock_to_lucid_key(&mut (*(*gctx).subkey).keyblock,
                                           &mut (*lctx).cfx_kd.ctx_key);
            if retval != 0 {
                current_block = 5031962668085496365;
            } else if (*gctx).have_acceptor_subkey() != 0 {
                retval =
                    copy_keyblock_to_lucid_key(&mut (*(*gctx).acceptor_subkey).keyblock,
    ...
    if !lctx.is_null() { free_external_lucid_ctx_v1(lctx); }
    return retval;
}
/* Copy the contents of a krb5_keyblock to a gss_krb5_lucid_key_t structure */
#[c2rust::src_loc = "240:1"]
unsafe extern "C" fn copy_keyblock_to_lucid_key(mut k5key: *mut krb5_keyblock,
                                                mut lkey:
                                                    *mut gss_krb5_lucid_key_t)
 -> krb5_error_code {
    if k5key.is_null() || (*k5key).contents.is_null() ||
           (*k5key).length == 0 as libc::c_int as libc::c_uint {
        return 22 as libc::c_int
    }
    memset(lkey as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<gss_krb5_lucid_key_t>() as libc::c_ulong);
    /* Allocate storage for the key data */
    (*lkey).data = malloc((*k5key).length as libc::c_ulong);
    if (*lkey).data.is_null() { return 12 as libc::c_int }
    memcpy((*lkey).data, (*k5key).contents as *const libc::c_void,
           (*k5key).length as libc::c_ulong);
    (*lkey).length = (*k5key).length;
    (*lkey).type_0 = (*k5key).enctype as OM_uint32;
    return 0 as libc::c_int;
}
/* Free any storage associated with a gss_krb5_lucid_key_t structure */
#[c2rust::src_loc = "263:1"]
unsafe extern "C" fn free_lucid_key_data(mut key: *mut gss_krb5_lucid_key_t) {
    if !key.is_null() {
        if !(*key).data.is_null() && (*key).length != 0 {
            explicit_bzero((*key).data, (*key).length as size_t);
            free((*key).data);
            explicit_bzero(key as *mut libc::c_void,
                           ::std::mem::size_of::<gss_krb5_lucid_key_t>() as
                               libc::c_ulong);
        }
    };
}
...
unsafe extern "C" fn free_external_lucid_ctx_v1(mut ctx:
                                                    *mut gss_krb5_lucid_context_v1_t) {
    if !ctx.is_null() {
        if (*ctx).protocol == 0 as libc::c_int as libc::c_uint {
            free_lucid_key_data(&mut (*ctx).rfc1964_kd.ctx_key);
        }
        if (*ctx).protocol == 1 as libc::c_int as libc::c_uint {
        ...
        ctx = 0 as *mut gss_krb5_lucid_context_v1_t
    };
}
