...
#[c2rust::header_src = "/usr/include/bits/thread-shared-types.h:50"]
...
#[c2rust::header_src = "/usr/include/bits/pthreadtypes.h:50"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-thread.h:50"]
pub mod k5_thread_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-platform.h:50"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/authdata_plugin.h:50"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:50"]
pub mod gssapiP_krb5_h {
    ...
    use super::krb5_h::{krb5_principal, krb5_magic, krb5_key,
                        ...
                        krb5_pointer, krb5_const_pointer, krb5_keyblock};
    use super::k5_thread_h::k5_mutex_t;
    use super::k5_int_h::{krb5_authdata_context, _krb5_context, krb5_key_st};
    use super::gssapi_h::{OM_uint32, gss_OID_desc, gss_buffer_desc,
    ...
    extern "C" {
        ...
        pub fn kg_encrypt(context: krb5_context, key: krb5_key,
                          usage: libc::c_int, iv: krb5_pointer,
                          in_0: krb5_const_pointer, out: krb5_pointer,
                          length: libc::c_uint) -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "310:1"]
        pub fn kg_arcfour_docrypt(keyblock: *const krb5_keyblock,
                                  usage: libc::c_int,
                                  kd_data: *const libc::c_uchar,
                                  kd_data_len: size_t,
                                  input_buf: *const libc::c_uchar,
                                  input_len: size_t,
                                  output_buf: *mut libc::c_uchar)
         -> krb5_error_code;
        #[no_mangle]
        ...
        pub fn gss_krb5int_make_seal_token_v3(_: krb5_context,
                                              _: *mut krb5_gss_ctx_id_rec,
                                              _: *const gss_buffer_desc,
                                              _: gss_buffer_t, _: libc::c_int,
                                              _: libc::c_int)
         -> krb5_error_code;
    }
    /* _GSSAPIP_KRB5_H_ */
...
#[c2rust::header_src = "/usr/include/bits/byteswap.h:50"]
pub mod byteswap_h {
    #[inline]
    #[c2rust::src_loc = "48:1"]
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_ui_4, krb5_boolean,
                       ...
                       krb5_k_key_keyblock, krb5_k_make_checksum,
...
pub use self::gssapiP_krb5_h::{sgn_alg, SGN_ALG_HMAC_SHA1_DES3_KD,
                               ...
                               kg_make_confounder, kg_encrypt,
                               kg_arcfour_docrypt, krb5_gss_save_error_info,
 ...
 */
#[c2rust::src_loc = "54:1"]
unsafe extern "C" fn make_seal_token_v1(mut context: krb5_context,
                                        mut enc: krb5_key, mut seq: krb5_key,
                                        mut seqnum: *mut uint64_t,
                                        mut direction: libc::c_int,
                                        mut text: gss_buffer_t,
                                        mut token: gss_buffer_t,
                                        mut signalg: libc::c_int,
                                        mut cksum_size: size_t,
                                        mut sealalg: libc::c_int,
                                        mut do_encrypt: libc::c_int,
                                        mut toktype: libc::c_int,
                                        mut oid: gss_OID) -> krb5_error_code {
    let mut code: krb5_error_code = 0;
    let mut sumlen: size_t = 0;
    let mut data_ptr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut plaind: krb5_data =
     ...
     * including header. */
    let mut conflen: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut tmsglen: libc::c_uint = 0;
    let mut tlen: libc::c_uint = 0;
    let mut msglen: libc::c_uint = 0;
    let mut t: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut ptr: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut plain: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut pad: libc::c_uchar = 0;
    let mut sign_usage: krb5_keyusage = 23 as libc::c_int;
    if do_encrypt == 0 || toktype == 0x201 as libc::c_int {
    } else {
        __assert_fail(b"(!do_encrypt) || (toktype == KG_TOK_SEAL_MSG)\x00" as
                          *const u8 as *const libc::c_char,
                      b"k5seal.c\x00" as *const u8 as *const libc::c_char,
                      87 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 151],
                                                &[libc::c_char; 151]>(b"krb5_error_code make_seal_token_v1(krb5_context, krb5_key, krb5_key, uint64_t *, int, gss_buffer_t, gss_buffer_t, int, size_t, int, int, int, gss_OID)\x00")).as_ptr());
    }
    /* create the token buffer */
    /* Do we need confounder? */
    if do_encrypt != 0 || toktype == 0x201 as libc::c_int {
        conflen =
            kg_confounder_size(context, (*enc).keyblock.enctype) as
                libc::c_uint
    } else { conflen = 0 as libc::c_int as libc::c_uint }
    if toktype == 0x201 as libc::c_int {
        match sealalg {
            16 => {
                msglen =
                    (conflen as
                         libc::c_ulong).wrapping_add((*text).length).wrapping_add(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      libc::c_ulong)
                        as libc::c_uint;
                pad = 1 as libc::c_int as libc::c_uchar
            }
            _ => {
                /* XXX knows that des block size is 8 */
                msglen =
                    ((conflen as
                          libc::c_ulong).wrapping_add((*text).length).wrapping_add(8
                                                                                       as
                                                                                       libc::c_int
                                                                                       as
                                                                                       libc::c_ulong)
                         & !(7 as libc::c_int) as libc::c_ulong) as
                        libc::c_uint;
                pad =
                    (8 as libc::c_int as
                         libc::c_ulong).wrapping_sub((*text).length.wrapping_rem(8
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     libc::c_ulong))
        ...
        tmsglen = 0 as libc::c_int as libc::c_uint;
        msglen = (*text).length as libc::c_uint;
        pad = 0 as libc::c_int as libc::c_uchar
    }
    tlen =
        gssint_g_token_size(oid as *const gss_OID_desc,
                            (14 as libc::c_int as
                                 libc::c_ulong).wrapping_add(cksum_size).wrapping_add(tmsglen
                                                                                          as
                                                                                          libc::c_ulong)
                                as libc::c_uint);
    ...
    /* ** fill in the token */
    ptr = t;
    gssint_g_make_token_header(oid as *const gss_OID_desc,
                               (14 as libc::c_int as
                                    libc::c_ulong).wrapping_add(cksum_size).wrapping_add(tmsglen
                                                                                             as
                                                                                             libc::c_ulong)
                                   as libc::c_uint, &mut ptr, toktype);
    /* 0..1 SIGN_ALG */
    store_16_le(signalg as libc::c_uint,
                &mut *ptr.offset(0 as libc::c_int as isize) as
                    *mut libc::c_uchar as *mut libc::c_void);
    /* 2..3 SEAL_ALG or Filler */
    if toktype == 0x201 as libc::c_int && do_encrypt != 0 {
        store_16_le(sealalg as libc::c_uint,
    ...
    *ptr.offset(5 as libc::c_int as isize) =
    ...
    code =
        krb5_c_checksum_length(context, md5cksum.checksum_type, &mut sumlen);
    if code != 0 { gssalloc_free(t as *mut libc::c_void); return code }
    md5cksum.length = sumlen as libc::c_uint;
    plain =
        malloc(if msglen != 0 {
                   msglen
               } else { 1 as libc::c_int as libc::c_uint } as libc::c_ulong)
            as *mut libc::c_uchar;
    if plain.is_null() {
    ...
    if conflen != 0 {
        code = kg_make_confounder(context, (*enc).keyblock.enctype, plain);
        if code != 0 {
    ...
    memcpy(plain.offset(conflen as isize) as *mut libc::c_void, (*text).value,
           (*text).length);
    if pad != 0 {
        memset(plain.offset(conflen as isize).offset((*text).length as isize)
                   as *mut libc::c_void, pad as libc::c_int,
               pad as libc::c_ulong);
    }
    /* compute the checksum */
    /* 8 = head of token body as specified by mech spec */
    data_ptr =
        malloc((8 as libc::c_int as libc::c_uint).wrapping_add(msglen) as
    ...
    memcpy(data_ptr as *mut libc::c_void,
           ptr.offset(-(2 as libc::c_int as isize)) as *const libc::c_void,
           8 as libc::c_int as libc::c_ulong);
    memcpy(data_ptr.offset(8 as libc::c_int as isize) as *mut libc::c_void,
           plain as *const libc::c_void, msglen as libc::c_ulong);
    plaind.length = (8 as libc::c_int as libc::c_uint).wrapping_add(msglen);
    plaind.data = data_ptr;
    code =
        krb5_k_make_checksum(context, md5cksum.checksum_type, seq, sign_usage,
                             &mut plaind, &mut md5cksum);
    ...
    match signalg {
         ...
         */
            if md5cksum.length as libc::c_ulong != cksum_size { abort(); }
            memcpy(ptr.offset(14 as libc::c_int as isize) as
                       *mut libc::c_void,
                   md5cksum.contents as *const libc::c_void,
                   md5cksum.length as libc::c_ulong);
        }
        17 => {
            memcpy(ptr.offset(14 as libc::c_int as isize) as
                       *mut libc::c_void,
                   md5cksum.contents as *const libc::c_void, cksum_size);
        }
        _ => { }
    }
    ...
    /* create the seq_num */
    code =
        kg_make_seq_num(context, seq,
                        if direction != 0 {
                            0 as libc::c_int
                        } else { 0xff as libc::c_int }, *seqnum as krb5_ui_4,
    ...
    if do_encrypt != 0 {
        match sealalg {
            16 => {
                ...
                store_32_be(*seqnum as libc::c_uint,
                            bigend_seqnum.as_mut_ptr() as *mut libc::c_void);
                code = krb5_k_key_keyblock(context, enc, &mut enc_key);
                if code != 0 {
                    free(plain as *mut libc::c_void);
                    gssalloc_free(t as *mut libc::c_void);
                    return code
                ...
                if (*enc_key).length == 16 as libc::c_int as libc::c_uint {
                    ...
                    __assert_fail(b"enc_key->length == 16\x00" as *const u8 as
                                      *const libc::c_char,
                ...
                code =
                    kg_arcfour_docrypt(enc_key, 0 as libc::c_int,
                                       bigend_seqnum.as_mut_ptr(),
                                       4 as libc::c_int as size_t, plain,
                                       tmsglen as size_t,
                                       ptr.offset(14 as libc::c_int as
                                                      isize).offset(cksum_size
                                                                        as
                                                                        isize));
            ...
            _ => {
                code =
                    kg_encrypt(context, enc, 22 as libc::c_int,
                               0 as *mut libc::c_void,
                               plain as krb5_pointer as krb5_const_pointer,
                               ptr.offset(cksum_size as
                                              isize).offset(14 as libc::c_int
                                                                as isize) as
                                   krb5_pointer, tmsglen);
                if code != 0 {
                    free(plain as *mut libc::c_void);
                    gssalloc_free(t as *mut libc::c_void);
                    return code
        ...
        memcpy(ptr.offset(14 as libc::c_int as
                              isize).offset(cksum_size as isize) as
                   *mut libc::c_void, plain as *const libc::c_void,
               tmsglen as libc::c_ulong);
    }
    free(plain as *mut libc::c_void);
    /* that's it.  return the token */
    *seqnum = (*seqnum).wrapping_add(1);
    *seqnum &= 0xffffffff as libc::c_long as libc::c_ulong;
...
pub unsafe extern "C" fn kg_seal(mut minor_status: *mut OM_uint32,
                                 mut context_handle: gss_ctx_id_t,
                                 mut conf_req_flag: libc::c_int,
                                 mut qop_req: gss_qop_t,
                                 mut input_message_buffer: gss_buffer_t,
                                 mut conf_state: *mut libc::c_int,
                                 mut output_message_buffer: gss_buffer_t,
    ...
    (*output_message_buffer).length = 0 as libc::c_int as size_t;
    ...
    if qop_req != 0 as libc::c_int as libc::c_uint {
        *minor_status = -(2045022968 as libc::c_long) as OM_uint32; /* XXX */
    ...
    match (*ctx).proto {
        0 => {
            code =
                make_seal_token_v1(context, (*ctx).enc, (*ctx).seq,
                                   &mut (*ctx).seq_send,
                                   (*ctx).initiate() as libc::c_int,
        ...
        1 => {
            code =
                gss_krb5int_make_seal_token_v3(context, ctx,
                                               input_message_buffer as
...
pub unsafe extern "C" fn krb5_gss_wrap(mut minor_status: *mut OM_uint32,
                                       mut context_handle: gss_ctx_id_t,
                                       mut conf_req_flag: libc::c_int,
                                       mut qop_req: gss_qop_t,
                                       mut input_message_buffer: gss_buffer_t,
...
pub unsafe extern "C" fn krb5_gss_get_mic(mut minor_status: *mut OM_uint32,
                                          mut context_handle: gss_ctx_id_t,
                                          mut qop_req: gss_qop_t,
                                          mut message_buffer: gss_buffer_t,
                                          mut message_token: gss_buffer_t)
 -> OM_uint32 {
    return kg_seal(minor_status, context_handle, 0 as libc::c_int, qop_req,
                   message_buffer, 0 as *mut libc::c_int, message_token,
                   0x101 as libc::c_int);
}
