 ...
 */
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_authdatatype, krb5_error_code, krb5_data,
                        krb5_context};
    ...
    extern "C" {
        ...
        pub fn krb5_authdata_get_attribute_types(kcontext: krb5_context,
                                                 context:
                                                     krb5_authdata_context,
                                                 attrs: *mut *mut krb5_data)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1025:1"]
        pub fn krb5_authdata_get_attribute(kcontext: krb5_context,
                                           context: krb5_authdata_context,
                                           attribute: *const krb5_data,
                                           authenticated: *mut krb5_boolean,
                                           complete: *mut krb5_boolean,
                                           value: *mut krb5_data,
                                           display_value: *mut krb5_data,
                                           more: *mut libc::c_int)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1033:1"]
        pub fn krb5_authdata_set_attribute(kcontext: krb5_context,
                                           context: krb5_authdata_context,
                                           complete: krb5_boolean,
                                           attribute: *const krb5_data,
                                           value: *const krb5_data)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1039:1"]
        pub fn krb5_authdata_delete_attribute(kcontext: krb5_context,
                                              context: krb5_authdata_context,
                                              attribute: *const krb5_data)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1049:1"]
        pub fn krb5_authdata_export_attributes(kcontext: krb5_context,
                                               context: krb5_authdata_context,
                                               usage: krb5_flags,
                                               pattributes:
                                                   *mut *mut krb5_data)
        ...
        pub fn krb5_authdata_export_internal(kcontext: krb5_context,
                                             context: krb5_authdata_context,
        ...
        pub fn krb5_authdata_context_copy(kcontext: krb5_context,
                                          src: krb5_authdata_context,
                                          dst: *mut krb5_authdata_context)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1064:1"]
        pub fn krb5_authdata_free_internal(kcontext: krb5_context,
                                           context: krb5_authdata_context,
                                           module: *const libc::c_char,
                                           ptr: *mut libc::c_void)
         -> krb5_error_code;
...
pub mod gssapiP_krb5_h {
    ...
    use super::krb5_h::{krb5_principal, krb5_data, krb5_error_code,
                        krb5_context};
    use super::k5_thread_h::k5_mutex_t;
    use super::k5_int_h::{krb5_authdata_context, empty_data};
...
pub mod gssapi_alloc_h {
    ...
    use super::stddef_h::size_t;
    use super::stdlib_h::{malloc, calloc};
}
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapi_krb5.h:28"]
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       _krb5_auth_context, krb5_free_context,
                       krb5_unparse_name, krb5_principal_compare,
                       krb5_copy_principal, krb5_build_principal,
                       krb5_free_principal, krb5_free_data,
...
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         ...
                         k5memdup0, k5alloc, k5calloc, empty_data, make_data,
...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_name_t,
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn kg_init_name(mut context: krb5_context,
                                      ...
                                      mut ret_name: *mut krb5_gss_name_t)
 -> krb5_error_code {
    let mut current_block: u64;
    let mut code: krb5_error_code = 0;
    let mut name: krb5_gss_name_t = 0 as *mut _krb5_gss_name_rec;
    *ret_name = 0 as krb5_gss_name_t;
    if !principal.is_null() {
        ...
        __assert_fail(b"principal != NULL\x00" as *const u8 as
                      ...
                      (*::std::mem::transmute::<&[u8; 129],
                                                &[libc::c_char; 129]>(b"krb5_error_code kg_init_name(krb5_context, krb5_principal, char *, char *, krb5_authdata_context, krb5_flags, krb5_gss_name_t *)\x00")).as_ptr());
    }
    if principal.is_null() { return 22 as libc::c_int }
    name =
        malloc(::std::mem::size_of::<krb5_gss_name_rec>() as libc::c_ulong) as
            krb5_gss_name_t;
    if name.is_null() { return 12 as libc::c_int }
    memset(name as *mut libc::c_void, 0 as libc::c_int,
        ...
        if flags & 0x1 as libc::c_int == 0 as libc::c_int {
            ...
            if code != 0 as libc::c_int {
                ...
                if !ad_context.is_null() {
                    code =
                        krb5_authdata_context_copy(context, ad_context,
                                                   &mut (*name).ad_context);
                    if code != 0 as libc::c_int {
                        current_block = 4931485695408934665;
    ...
    if code != 0 as libc::c_int { kg_release_name(context, &mut name); }
    return code;
}
#[no_mangle]
#[c2rust::src_loc = "96:1"]
pub unsafe extern "C" fn kg_release_name(mut context: krb5_context,
                                         mut name: *mut krb5_gss_name_t)
 -> krb5_error_code {
    if !(*name).is_null() {
        krb5_free_principal(context, (**name).princ);
        free((**name).service as *mut libc::c_void);
        free((**name).host as *mut libc::c_void);
        krb5_authdata_context_free(context, (**name).ad_context);
        k5_os_mutex_destroy(&mut (**name).lock);
        free(*name as *mut libc::c_void);
        *name = 0 as krb5_gss_name_t
    }
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "113:1"]
pub unsafe extern "C" fn kg_duplicate_name(mut context: krb5_context,
                                           src: krb5_gss_name_t,
                                           mut dst: *mut krb5_gss_name_t)
 -> krb5_error_code {
    let mut code: krb5_error_code = 0;
    k5_mutex_lock(&mut (*src).lock);
    code =
        kg_init_name(context, (*src).princ, (*src).service, (*src).host,
                     (*src).ad_context, 0 as libc::c_int, dst);
    k5_mutex_unlock(&mut (*src).lock);
    return code;
}
#[no_mangle]
#[c2rust::src_loc = "128:1"]
pub unsafe extern "C" fn kg_compare_name(mut context: krb5_context,
                                         mut name1: krb5_gss_name_t,
                                         mut name2: krb5_gss_name_t)
 -> krb5_boolean {
    return krb5_principal_compare(context,
                                  (*name1).princ as krb5_const_principal,
                                  (*name2).princ as krb5_const_principal);
}
/* Determine the principal to use for an acceptor name, which is different from
 * name->princ for host-based names. */
#[no_mangle]
#[c2rust::src_loc = "138:1"]
pub unsafe extern "C" fn kg_acceptor_princ(mut context: krb5_context,
 ...
 -> krb5_boolean {
    ...
    *princ_out = 0 as krb5_principal;
    if name.is_null() { return 0 as libc::c_int as krb5_boolean }
    /* If it's not a host-based name, just copy name->princ. */
    if (*name).service.is_null() {
        return krb5_copy_principal(context,
                                   (*name).princ as krb5_const_principal,
                                   princ_out) as krb5_boolean
    } /* No host was given; use an empty string. */
    if !(*name).host.is_null() && (*(*name).princ).length == 2 as libc::c_int
       {
        let mut d: *const krb5_data =
            &mut *(*(*name).princ).data.offset(1 as libc::c_int as isize) as
                *mut krb5_data;
        tmp =
            k5memdup0((*d).data as *const libc::c_void, (*d).length as size_t,
                      &mut code) as *mut libc::c_char;
        if tmp.is_null() { return 12 as libc::c_int as krb5_boolean }
        host = tmp
    ...
    } else { host = b"\x00" as *const u8 as *const libc::c_char }
    code =
        krb5_build_principal(context, princ_out,
                             0 as libc::c_int as libc::c_uint,
                             b"\x00" as *const u8 as *const libc::c_char,
                             (*name).service, host,
                             0 as *mut libc::c_void as *mut libc::c_char);
    if !(*princ_out).is_null() { (**princ_out).type_0 = 3 as libc::c_int }
    free(tmp as *mut libc::c_void);
    return code as krb5_boolean;
}
#[c2rust::src_loc = "173:1"]
unsafe extern "C" fn kg_map_name_error(mut minor_status: *mut OM_uint32,
                                       mut code: krb5_error_code)
 -> OM_uint32 {
    let mut major_status: OM_uint32 = 0;
    match code {
        0 => { major_status = 0 as libc::c_int as OM_uint32 }
        2 | 1 => {
            major_status =
...
#[c2rust::src_loc = "197:1"]
unsafe extern "C" fn data_list_to_buffer_set(mut context: krb5_context,
                                             mut data: *mut krb5_data,
                                             mut buffer_set:
                                                 *mut gss_buffer_set_t)
 -> krb5_error_code {
    let mut set: gss_buffer_set_t = 0 as gss_buffer_set_t;
    let mut minor_status: OM_uint32 = 0;
    let mut i: libc::c_int = 0;
    let mut code: krb5_error_code = 0 as libc::c_int;
    if !data.is_null() {
        if !buffer_set.is_null() {
            if gss_create_empty_buffer_set(&mut minor_status, &mut set) &
                ...
                if minor_status != 0 as libc::c_int as libc::c_uint {
                    ...
                    __assert_fail(b"minor_status != 0\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"naming_exts.c\x00" as *const u8 as
                                      *const libc::c_char,
                                  215 as libc::c_int as libc::c_uint,
                                  (*::std::mem::transmute::<&[u8; 87],
                                                            &[libc::c_char; 87]>(b"krb5_error_code data_list_to_buffer_set(krb5_context, krb5_data *, gss_buffer_set_t *)\x00")).as_ptr());
                }
                code = minor_status as krb5_error_code
            } else {
                i = 0 as libc::c_int;
                while !(*data.offset(i as isize)).data.is_null() { i += 1 }
                (*set).count = i as size_t;
                (*set).elements =
                    gssalloc_calloc(i as size_t,
                                    ::std::mem::size_of::<gss_buffer_desc>()
                                        as libc::c_ulong) as
                        *mut gss_buffer_desc;
                if (*set).elements.is_null() {
                    gss_release_buffer_set(&mut minor_status, &mut set);
                    code = 12 as libc::c_int
                } else {
                    /*
     ...
     */
                    i =
                        (*set).count.wrapping_sub(1 as libc::c_int as
                                                      libc::c_ulong) as
                            libc::c_int;
                    while i >= 0 as libc::c_int {
                        if data_to_gss(&mut *data.offset(i as isize),
                                       &mut *(*set).elements.offset(i as
                                                                        isize))
                               != 0 {
                            gss_release_buffer_set(&mut minor_status,
                                                   &mut set);
                            code = 12 as libc::c_int;
                            break ;
                        } else { i -= 1 }
    ...
    if !buffer_set.is_null() { *buffer_set = set }
    return code;
}
#[no_mangle]
#[c2rust::src_loc = "252:1"]
pub unsafe extern "C" fn krb5_gss_inquire_name(mut minor_status:
                                                   *mut OM_uint32,
                                               mut name: gss_name_t,
                                               mut name_is_MN:
                                                   *mut libc::c_int,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    match current_block {
        3512920355445576850 => {
            code =
                krb5_authdata_get_attribute_types(context,
                                                  (*kname).ad_context,
                                                  &mut kattrs);
            if !(code != 0 as libc::c_int) {
                code = data_list_to_buffer_set(context, kattrs, attrs);
                kattrs = 0 as *mut krb5_data;
                (code) != 0 as libc::c_int;
            }
        }
        _ => { }
...
pub unsafe extern "C" fn krb5_gss_get_name_attribute(mut minor_status:
                                                         *mut OM_uint32,
                                                     mut name: gss_name_t,
 ...
 -> OM_uint32 {
    ...
    let mut code: krb5_error_code = 0;
    let mut kname: krb5_gss_name_t = 0 as *mut _krb5_gss_name_rec;
    let mut kattr: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    let mut kauthenticated: krb5_boolean = 0;
    let mut kcomplete: krb5_boolean = 0;
    let mut kvalue: krb5_data = empty_data();
    let mut kdisplay_value: krb5_data = empty_data();
    *minor_status = 0 as libc::c_int as OM_uint32;
    code = krb5_gss_init_context(&mut context);
    if code != 0 as libc::c_int {
        *minor_status = code as OM_uint32;
    ...
    kattr.data = (*attr).value as *mut libc::c_char;
    kattr.length = (*attr).length as libc::c_uint;
    kauthenticated = 0 as libc::c_int as krb5_boolean;
    kcomplete = 0 as libc::c_int as krb5_boolean;
    code =
        krb5_authdata_get_attribute(context, (*kname).ad_context, &mut kattr,
                                    &mut kauthenticated, &mut kcomplete,
                                    &mut kvalue, &mut kdisplay_value, more);
    if code == 0 as libc::c_int {
        if !value.is_null() { code = data_to_gss(&mut kvalue, value) }
        if !authenticated.is_null() {
            *authenticated = kauthenticated as libc::c_int
        }
        if !complete.is_null() { *complete = kcomplete as libc::c_int }
        if !display_value.is_null() && code == 0 as libc::c_int {
            code = data_to_gss(&mut kdisplay_value, display_value)
        }
    }
    free(kdisplay_value.data as *mut libc::c_void);
    free(kvalue.data as *mut libc::c_void);
    k5_mutex_unlock(&mut (*kname).lock);
    krb5_free_context(context);
    return kg_map_name_error(minor_status, code);
}
...
pub unsafe extern "C" fn krb5_gss_set_name_attribute(mut minor_status:
                                                         *mut OM_uint32,
                                                     mut name: gss_name_t,
                                                     mut complete:
                                                         libc::c_int,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    kattr.data = (*attr).value as *mut libc::c_char;
    kattr.length = (*attr).length as libc::c_uint;
    kvalue.data = (*value).value as *mut libc::c_char;
    kvalue.length = (*value).length as libc::c_uint;
    code =
        krb5_authdata_set_attribute(context, (*kname).ad_context,
                                    complete as krb5_boolean, &mut kattr,
                                    &mut kvalue);
    k5_mutex_unlock(&mut (*kname).lock);
    krb5_free_context(context);
    return kg_map_name_error(minor_status, code);
...
pub unsafe extern "C" fn krb5_gss_delete_name_attribute(mut minor_status:
                                                            *mut OM_uint32,
                                                        mut name: gss_name_t,
                                                        mut attr:
                                                            gss_buffer_t)
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    kattr.length = (*attr).length as libc::c_uint;
    code =
        krb5_authdata_delete_attribute(context, (*kname).ad_context,
                                       &mut kattr);
    k5_mutex_unlock(&mut (*kname).lock);
    krb5_free_context(context);
    return kg_map_name_error(minor_status, code);
...
pub unsafe extern "C" fn krb5_gss_map_name_to_any(mut minor_status:
                                                      *mut OM_uint32,
                                                  mut name: gss_name_t,
                                                  mut authenticated:
                                                      libc::c_int,
                                                  mut type_id: gss_buffer_t,
                                                  mut output: *mut gss_any_t)
 -> OM_uint32 {
    let mut context: krb5_context = 0 as *mut _krb5_context;
    let mut code: krb5_error_code = 0;
    let mut kname: krb5_gss_name_t = 0 as *mut _krb5_gss_name_rec;
    let mut kmodule: *mut libc::c_char = 0 as *mut libc::c_char;
    *minor_status = 0 as libc::c_int as OM_uint32;
    code = krb5_gss_init_context(&mut context);
    if code != 0 as libc::c_int {
        *minor_status = code as OM_uint32;
    ...
    kmodule = (*type_id).value as *mut libc::c_char;
    if *kmodule.offset((*type_id).length as isize) as libc::c_int !=
           '\u{0}' as i32 {
        k5_mutex_unlock(&mut (*kname).lock);
        krb5_free_context(context);
        return (16 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    ...
    code =
        krb5_authdata_export_internal(context, (*kname).ad_context,
                                      authenticated as krb5_boolean, kmodule,
...
pub unsafe extern "C" fn krb5_gss_release_any_name_mapping(mut minor_status:
                                                               *mut OM_uint32,
                                                           mut name:
                                                               gss_name_t,
                                                           mut type_id:
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    code =
        krb5_authdata_free_internal(context, (*kname).ad_context, kmodule,
                                    *input as *mut libc::c_void);
    if code == 0 as libc::c_int { *input = 0 as gss_any_t }
    k5_mutex_unlock(&mut (*kname).lock);
    krb5_free_context(context);
    return kg_map_name_error(minor_status, code);
}
...
pub unsafe extern "C" fn krb5_gss_export_name_composite(mut minor_status:
                                                            *mut OM_uint32,
                                                        mut name: gss_name_t,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    k5_mutex_lock(&mut (*kname).lock);
    code =
        krb5_unparse_name(context, (*kname).princ as krb5_const_principal,
                          &mut princstr);
    if !(code != 0 as libc::c_int) {
        princlen = strlen(princstr);
        if !(*kname).ad_context.is_null() {
            code =
                krb5_authdata_export_attributes(context, (*kname).ad_context,
                                                0x2f as libc::c_int,
                                                &mut attrs);
            if code != 0 as libc::c_int {
        ...
        match current_block {
            ...
            _ => {
                ...
                (*exp_composite_name).length =
                    ((10 as libc::c_int as
                          libc::c_uint).wrapping_add((*gss_mech_krb5).length)
                         as
                         libc::c_ulong).wrapping_add(princlen); /* length of encoded attributes */
                (*exp_composite_name).length =
                    ((*exp_composite_name).length as
                ...
                if !attrs.is_null() {
                    (*exp_composite_name).length =
                        ((*exp_composite_name).length as
                             libc::c_ulong).wrapping_add((*attrs).length as
                                                             libc::c_ulong) as
                            size_t as size_t
                }
                (*exp_composite_name).value =
                    gssalloc_malloc((*exp_composite_name).length);
                if (*exp_composite_name).value.is_null() {
                    code = 12 as libc::c_int
                } else {
                    cp = (*exp_composite_name).value as *mut libc::c_uchar;
                    /* Note: we assume the OID will be less than 128 bytes... */
                    let fresh0 = cp;
                    cp = cp.offset(1);
                    *fresh0 = 0x4 as libc::c_int as libc::c_uchar;
                    let fresh1 = cp;
                    cp = cp.offset(1);
                    *fresh1 = 0x2 as libc::c_int as libc::c_uchar;
                    store_16_be((*gss_mech_krb5).length.wrapping_add(2 as
                                                                         libc::c_int
                                                                         as
                                                                         libc::c_uint),
                    ...
                    let fresh2 = cp;
                    cp = cp.offset(1);
                    *fresh2 = 0x6 as libc::c_int as libc::c_uchar;
                    let fresh3 = cp;
                    cp = cp.offset(1);
                    *fresh3 =
                        ((*gss_mech_krb5).length &
                            ...
                            libc::c_uchar;
                    memcpy(cp as *mut libc::c_void, (*gss_mech_krb5).elements,
                           (*gss_mech_krb5).length as libc::c_ulong);
                    cp = cp.offset((*gss_mech_krb5).length as isize);
                    store_32_be(princlen as libc::c_uint,
                                cp as *mut libc::c_void);
                    cp = cp.offset(4 as libc::c_int as isize);
                    memcpy(cp as *mut libc::c_void,
                           princstr as *const libc::c_void, princlen);
                    cp = cp.offset(princlen as isize);
                    store_32_be(if !attrs.is_null() {
                                    (*attrs).length
