...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_name_t, gss_name_struct};
pub use self::gssapiP_krb5_h::{_krb5_gss_name_rec, krb5_gss_name_t,
                               kg_release_name, krb5_gss_init_context};
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
 * Copyright 1993 by OpenVision Technologies, Inc.
 *
...
#[no_mangle]
#[c2rust::src_loc = "26:1"]
pub unsafe extern "C" fn krb5_gss_release_name(mut minor_status:
                                                   *mut OM_uint32,
                                               mut input_name:
                                                   *mut gss_name_t)
 -> OM_uint32 {
    ...
    kg_release_name(context, input_name as *mut krb5_gss_name_t);
    krb5_free_context(context);
    *input_name = 0 as *mut libc::c_void as gss_name_t;
