...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       krb5_principal_compare, krb5_free_principal};
...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5_gss_validate_cred_1(mut minor_status:
                                                      *mut OM_uint32,
                                                  mut cred_handle:
                                                      gss_cred_id_t,
 ...
 -> OM_uint32 {
    ...
    if !(*cred).ccache.is_null() && (*cred).expire != 0 as libc::c_int {
        code = krb5_cc_get_principal(context, (*cred).ccache, &mut princ);
        if code != 0 {
...
#[no_mangle]
#[c2rust::src_loc = "59:1"]
pub unsafe extern "C" fn krb5_gss_validate_cred(mut minor_status:
                                                    *mut OM_uint32,
                                                mut cred_handle:
                                                    gss_cred_id_t)
 -> OM_uint32 {
    ...
    if maj == 0 as libc::c_int as libc::c_uint {
