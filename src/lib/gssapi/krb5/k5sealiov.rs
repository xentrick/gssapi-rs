...
pub mod gssapiP_krb5_h {
    ...
    use super::krb5_h::{krb5_principal, krb5_magic, krb5_key,
                        ...
                        krb5_pointer, krb5_keyblock, krb5_keyusage,
                        krb5_checksum, krb5_boolean};
    ...
    extern "C" {
        ...
        pub fn kg_make_seq_num(context: krb5_context, key: krb5_key,
                               direction: libc::c_int, seqnum: krb5_ui_4,
                               cksum: *mut libc::c_uchar,
                               buf: *mut libc::c_uchar) -> krb5_error_code;
        #[no_mangle]
        ...
        pub fn kg_make_confounder(context: krb5_context,
                                  enctype: krb5_enctype,
                                  buf: *mut libc::c_uchar) -> krb5_error_code;
        #[no_mangle]
        ...
        pub fn gss_krb5int_make_seal_token_v3_iov(context: krb5_context,
                                                  ctx:
...
/* Returns a shared string, not a private copy!  */
        ...
        pub fn kg_integ_only_iov(iov: *mut gss_iov_buffer_desc,
                                 iov_count: libc::c_int) -> krb5_boolean;
    }
    /* _GSSAPIP_KRB5_H_ */
}
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_ui_4, krb5_boolean,
                       ...
                       krb5_c_checksum_length, krb5_c_crypto_length,
                       krb5_c_padding_length, krb5_k_key_keyblock,
...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_ctx_id_t,
...
pub use self::gssapiP_krb5_h::{sgn_alg, SGN_ALG_HMAC_SHA1_DES3_KD,
                               ...
                               kg_make_seq_num, kg_confounder_size,
                               kg_make_confounder, kg_encrypt_iov,
                               kg_arcfour_docrypt_iov,
                               gss_krb5int_make_seal_token_v3_iov,
                               kg_locate_iov, kg_locate_header_iov,
                               kg_iov_msglen, kg_release_iov,
                               kg_make_checksum_iov_v1,
                               krb5_gss_save_error_info, kg_allocate_iov,
                               kg_integ_only_iov};
 ...
 */
#[c2rust::src_loc = "30:1"]
unsafe extern "C" fn make_seal_token_v1_iov(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    if padding.is_null() && toktype == 0x201 as libc::c_int &&
           (*ctx).gss_flags & 0x1000 as libc::c_int as libc::c_uint ==
               0 as libc::c_int as libc::c_uint {
        return 22 as libc::c_int
    }
    trailer = kg_locate_iov(iov, iov_count, 7 as libc::c_int as OM_uint32);
    if !trailer.is_null() {
        (*trailer).buffer.length = 0 as libc::c_int as size_t
    }
    /* Determine confounder length */
    if toktype == 0x201 as libc::c_int || conf_req_flag != 0 {
        k5_headerlen =
            kg_confounder_size(context, (*(*ctx).enc).keyblock.enctype) as
                size_t
    }
    /* Check padding length */
    if toktype == 0x201 as libc::c_int {
        let mut k5_padlen: size_t =
            if (*ctx).sealalg == SEAL_ALG_MICROSOFT_RC4 as libc::c_int {
                1 as libc::c_int
            } else { 8 as libc::c_int } as
                size_t; /* one byte to indicate one byte of padding */
        let mut gss_padlen: size_t = 0;
        let mut conf_data_length: size_t = 0;
        kg_iov_msglen(iov, iov_count, &mut data_length,
                      &mut assoc_data_length);
        conf_data_length =
            k5_headerlen.wrapping_add(data_length).wrapping_sub(assoc_data_length);
        if k5_padlen == 1 as libc::c_int as libc::c_ulong {
            gss_padlen = 1 as libc::c_int as size_t
        } else {
            gss_padlen =
                k5_padlen.wrapping_sub(conf_data_length.wrapping_rem(k5_padlen))
        }
        if (*ctx).gss_flags & 0x1000 as libc::c_int as libc::c_uint != 0 {
            ...
            gss_padlen = 0 as libc::c_int as size_t;
            if conf_data_length.wrapping_rem(k5_padlen) != 0 {
                code = -(1765328194 as libc::c_long) as krb5_error_code
            }
        } else if (*padding).type_0 & 0x10000 as libc::c_int as libc::c_uint
                      != 0 {
        ...
        if code != 0 as libc::c_int {
            ...
            if !padding.is_null() {
                ...
                memset((*padding).buffer.value, gss_padlen as libc::c_int,
                       gss_padlen);
            }
            if (*ctx).gss_flags & 0x1000 as libc::c_int as libc::c_uint != 0 {
                ...
                tmsglen =
                    conf_data_length.wrapping_add((*padding).buffer.length)
            }
    ...
    match current_block {
        3222590281903869779 => {
            ...
            tlen =
                gssint_g_token_size((*ctx).mech_used,
                                    (14 as libc::c_int as
                                         libc::c_ulong).wrapping_add((*ctx).cksum_size).wrapping_add(tmsglen)
                                        as libc::c_uint) as size_t;
            k5_headerlen =
                (k5_headerlen as
                     libc::c_ulong).wrapping_add(tlen.wrapping_sub(tmsglen))
                    as size_t as size_t;
            ...
            if !(code != 0 as libc::c_int) {
                ...
                gssint_g_make_token_header((*ctx).mech_used,
                                           (14 as libc::c_int as
                                                libc::c_ulong).wrapping_add((*ctx).cksum_size).wrapping_add(tmsglen)
                                               as libc::c_uint, &mut ptr,
                                           toktype);
                /* 0..1 SIGN_ALG */
                store_16_le((*ctx).signalg as libc::c_uint,
                            &mut *ptr.offset(0 as libc::c_int as isize) as
                                *mut libc::c_uchar as *mut libc::c_void);
                /* 2..3 SEAL_ALG or Filler */
                if toktype == 0x201 as libc::c_int && conf_req_flag != 0 {
                    store_16_le((*ctx).sealalg as libc::c_uint,
                                &mut *ptr.offset(2 as libc::c_int as isize) as
                                    *mut libc::c_uchar as *mut libc::c_void);
                } else {
                    /* No seal */
                ...
                *ptr.offset(5 as libc::c_int as isize) =
                ...
                match (*ctx).signalg {
                    ...
                    17 => {
                        md5cksum.checksum_type = -(138 as libc::c_int);
                        if toktype != 0x201 as libc::c_int {
                ...
                code =
                    krb5_c_checksum_length(context, md5cksum.checksum_type,
                                           &mut k5_trailerlen);
                if !(code != 0 as libc::c_int) {
                    md5cksum.length = k5_trailerlen as libc::c_uint;
                    if k5_headerlen != 0 as libc::c_int as libc::c_ulong &&
                           toktype == 0x201 as libc::c_int {
                        code =
                            kg_make_confounder(context,
                                               (*(*ctx).enc).keyblock.enctype,
                                               ptr.offset(14 as libc::c_int as
                                                              isize).offset((*ctx).cksum_size
                                                                                as
                                                                                isize));
                        if code != 0 as libc::c_int {
                            current_block = 2491959576112690396;
                        } else { current_block = 16029476503615101993; }
                    } else { current_block = 16029476503615101993; }
                    match current_block {
                        2491959576112690396 => { }
                        _ => {
                            ...
                            if !(code != 0 as libc::c_int) {
                                match (*ctx).signalg {
                                    4 => {
                                        if md5cksum.length as libc::c_ulong ==
                                               (*ctx).cksum_size {
                                        } else {
                                            __assert_fail(b"md5cksum.length == ctx->cksum_size\x00"
                                                              as *const u8 as
                                                              *const libc::c_char,
                                                          b"k5sealiov.c\x00"
                                                              as *const u8 as
                                                          ...
                                                          (*::std::mem::transmute::<&[u8; 121],
                                                                                    &[libc::c_char; 121]>(b"krb5_error_code make_seal_token_v1_iov(krb5_context, krb5_gss_ctx_id_rec *, int, int *, gss_iov_buffer_desc *, int, int)\x00")).as_ptr());
                                        }
                                        memcpy(ptr.offset(14 as libc::c_int as
                                                              isize) as
                                                   *mut libc::c_void,
                                               md5cksum.contents as
                                                   *const libc::c_void,
                                               md5cksum.length as
                                                   libc::c_ulong);
                                    }
                                ...
                                /* create the seq_num */
                                code =
                                    kg_make_seq_num(context, (*ctx).seq,
                                                    if (*ctx).initiate() as
                                                           libc::c_int != 0 {
                                                        0 as libc::c_int
                                                    } else {
                                ...
                                if !(code != 0 as libc::c_int) {
                                    if conf_req_flag != 0 {
                                        if (*ctx).sealalg ==
                                               SEAL_ALG_MICROSOFT_RC4 as
                                                   libc::c_int {
                                            let mut bigend_seqnum:
                                                    [libc::c_uchar; 4] =
                                                [0; 4];
                                            let mut enc_key:
                                                    *mut krb5_keyblock =
                                            ...
                                            let mut i: size_t = 0;
                                            store_32_be((*ctx).seq_send as
                                                            libc::c_uint,
                                                        bigend_seqnum.as_mut_ptr()
                                                            as
                                                            *mut libc::c_void);
                                            code =
                                                krb5_k_key_keyblock(context,
                                                                    (*ctx).enc,
                                                                    &mut enc_key);
                                            if code != 0 as libc::c_int {
                                                current_block =
                                                ...
                                                if (*enc_key).length ==
                                                    ...
                                                    __assert_fail(b"enc_key->length == 16\x00"
                                                                      as
                                                                      *const u8
                                                                      as
                                                                      *const libc::c_char,
                                                ...
                                                code =
                                                    kg_arcfour_docrypt_iov(context,
                                                                           enc_key,
                                                                           0
                                                                               as
                                                                               libc::c_int,
...
pub unsafe extern "C" fn kg_seal_iov(mut minor_status: *mut OM_uint32,
    ...
    if qop_req != 0 as libc::c_int as libc::c_uint {
        *minor_status = -(2045022968 as libc::c_long) as OM_uint32;
        return (14 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    ...
    if conf_req_flag != 0 && kg_integ_only_iov(iov, iov_count) != 0 {
        /* may be more sensible to return an error here */
        conf_req_flag = 0 as libc::c_int
    }
    context = (*ctx).k5_context;
    match (*ctx).proto {
        0 => {
            code =
                make_seal_token_v1_iov(context, ctx, conf_req_flag,
                                       conf_state, iov, iov_count, toktype)
        }
        1 => {
            code =
                gss_krb5int_make_seal_token_v3_iov(context, ctx,
                                                   conf_req_flag, conf_state,
                                                   iov, iov_count, toktype)
        }
        _ => { code = -(2045022968 as libc::c_long) as krb5_error_code }
    }
    if code != 0 as libc::c_int {
...
pub unsafe extern "C" fn kg_seal_iov_length(mut minor_status: *mut OM_uint32,
                                            mut context_handle: gss_ctx_id_t,
                                            mut conf_req_flag: libc::c_int,
                                            mut qop_req: gss_qop_t,
                                            mut conf_state: *mut libc::c_int,
 ...
 -> OM_uint32 {
    ...
    let mut k5_padlen: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut code: krb5_error_code = 0;
    let mut context: krb5_context = 0 as *mut _krb5_context;
    let mut dce_or_mic: libc::c_int = 0;
    if qop_req != 0 as libc::c_int as libc::c_uint {
        *minor_status = -(2045022968 as libc::c_long) as OM_uint32;
        return (14 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    ...
    (*header).buffer.length = 0 as libc::c_int as size_t;
    trailer = kg_locate_iov(iov, iov_count, 7 as libc::c_int as OM_uint32);
    if !trailer.is_null() {
    ...
    dce_or_mic =
        ((*ctx).gss_flags & 0x1000 as libc::c_int as libc::c_uint !=
             0 as libc::c_int as libc::c_uint ||
             toktype == 0x101 as libc::c_int) as libc::c_int;
    /* For CFX, EC is used instead of padding, and is placed in header or trailer */
    padding =
        kg_locate_iov(iov, iov_count,
                      9 as libc::c_int as OM_uint32); /* Header */
    if padding.is_null() {
        if conf_req_flag != 0 && (*ctx).proto == 0 as libc::c_int &&
               dce_or_mic == 0 {
            *minor_status = 22 as libc::c_int as OM_uint32; /* Kerb-Header */
            return (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
        }
    } else {
    ...
    if (*ctx).proto == 1 as libc::c_int {
        ...
        gss_headerlen = 16 as libc::c_int as size_t;
        if conf_req_flag != 0 {
            gss_headerlen =
                (gss_headerlen as
                     libc::c_ulong).wrapping_add(k5_headerlen as
                                                     libc::c_ulong) as size_t
                    as size_t;
            gss_trailerlen =
                (16 as libc::c_int as
                     libc::c_uint).wrapping_add(k5_trailerlen) as size_t;
            code =
                krb5_c_padding_length(context, enctype,
                                      data_length.wrapping_sub(assoc_data_length).wrapping_add(16
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
                                                                                                   libc::c_ulong),
            ...
            if k5_padlen == 0 as libc::c_int as libc::c_uint &&
                ...
                code = krb5_c_block_size(context, enctype, &mut ec);
                if code != 0 as libc::c_int {
                    *minor_status = code as OM_uint32;
                    return (13 as libc::c_ulong as OM_uint32) <<
                               16 as libc::c_int
                }
            } else { ec = k5_padlen as size_t }
            gss_trailerlen =
                (gss_trailerlen as libc::c_ulong).wrapping_add(ec) as size_t
                    as size_t
        } else {
            gss_trailerlen = k5_trailerlen as size_t
            /* Kerb-Checksum */
        }
        ...
        k5_padlen =
            if (*ctx).sealalg == SEAL_ALG_MICROSOFT_RC4 as libc::c_int {
                1 as libc::c_int
            } else { 8 as libc::c_int } as libc::c_uint;
        if k5_padlen == 1 as libc::c_int as libc::c_uint {
            gss_padlen = 1 as libc::c_int as size_t
        } else {
            gss_padlen =
                (k5_padlen as
                     libc::c_ulong).wrapping_sub(data_length.wrapping_sub(assoc_data_length).wrapping_rem(k5_padlen
                                                                                                              as
                                                                                                              libc::c_ulong))
        }
    }
    data_length =
        (data_length as libc::c_ulong).wrapping_add(gss_padlen) as size_t as
            size_t;
    if (*ctx).proto == 0 as libc::c_int {
        ...
        data_size =
            (14 as libc::c_int as
                 libc::c_ulong).wrapping_add((*ctx).cksum_size).wrapping_add(k5_headerlen
                                                                                 as
                                                                                 libc::c_ulong);
        if dce_or_mic == 0 {
            data_size =
                (data_size as libc::c_ulong).wrapping_add(data_length) as
                    size_t as size_t
        }
        gss_headerlen =
            gssint_g_token_size((*ctx).mech_used, data_size as libc::c_uint)
                as size_t;
        ...
        if dce_or_mic == 0 {
            gss_headerlen =
                (gss_headerlen as libc::c_ulong).wrapping_sub(data_length) as
                    size_t as size_t
        }
    }
    ...
    if trailer.is_null() {
        gss_headerlen =
            (gss_headerlen as libc::c_ulong).wrapping_add(gss_trailerlen) as
                size_t as size_t
    } else { (*trailer).buffer.length = gss_trailerlen }
    if gss_padlen == 0 as libc::c_int as libc::c_ulong || !padding.is_null() {
    } else {
        __assert_fail(b"gss_padlen == 0 || padding != NULL\x00" as *const u8
                          as *const libc::c_char,
                      b"k5sealiov.c\x00" as *const u8 as *const libc::c_char,
                      460 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 112],
                                                &[libc::c_char; 112]>(b"OM_uint32 kg_seal_iov_length(OM_uint32 *, gss_ctx_id_t, int, gss_qop_t, int *, gss_iov_buffer_desc *, int, int)\x00")).as_ptr());
    }
    if !padding.is_null() { (*padding).buffer.length = gss_padlen }
...
pub unsafe extern "C" fn krb5_gss_wrap_iov(mut minor_status: *mut OM_uint32,
                                           mut context_handle: gss_ctx_id_t,
                                           mut conf_req_flag: libc::c_int,
                                           mut qop_req: gss_qop_t,
                                           mut conf_state: *mut libc::c_int,
 ...
 -> OM_uint32 {
    ...
    major_status =
        kg_seal_iov(minor_status, context_handle, conf_req_flag, qop_req,
                    conf_state, iov, iov_count, 0x201 as libc::c_int);
    return major_status;
}
#[no_mangle]
#[c2rust::src_loc = "491:1"]
pub unsafe extern "C" fn krb5_gss_wrap_iov_length(mut minor_status:
                                                      *mut OM_uint32,
                                                  mut context_handle:
                                                      gss_ctx_id_t,
                                                  mut conf_req_flag:
 ...
 -> OM_uint32 {
    let mut major_status: OM_uint32 = 0;
    major_status =
        kg_seal_iov_length(minor_status, context_handle, conf_req_flag,
...
pub unsafe extern "C" fn krb5_gss_get_mic_iov(mut minor_status:
                                                  *mut OM_uint32,
                                              mut context_handle:
                                                  gss_ctx_id_t,
                                              mut qop_req: gss_qop_t,
 ...
 -> OM_uint32 {
    let mut major_status: OM_uint32 = 0;
    major_status =
        kg_seal_iov(minor_status, context_handle, 0 as libc::c_int, qop_req,
                    0 as *mut libc::c_int, iov, iov_count,
                    0x101 as libc::c_int);
    return major_status;
}
...
pub unsafe extern "C" fn krb5_gss_get_mic_iov_length(mut minor_status:
                                                         *mut OM_uint32,
                                                     mut context_handle:
                                                         gss_ctx_id_t,
                                                     mut qop_req: gss_qop_t,
 ...
 -> OM_uint32 {
    let mut major_status: OM_uint32 = 0;
    major_status =
        kg_seal_iov_length(minor_status, context_handle, 0 as libc::c_int,
                           qop_req, 0 as *mut libc::c_int, iov, iov_count,
                           0x101 as libc::c_int);
    return major_status;
}
