...
pub mod gssapiP_generic_h {
    ...
    use super::gssapi_h::{gss_OID_desc, gss_int32, OM_uint32};
...
pub mod gssapiP_krb5_h {
    ...
    use super::krb5_h::{krb5_principal, krb5_magic, krb5_key,
                        ...
                        krb5_ui_4, krb5_error_code, krb5_enctype,
                        krb5_keyblock, krb5_pointer, krb5_keyusage,
                        krb5_checksum};
    use super::k5_thread_h::k5_mutex_t;
    use super::k5_int_h::{krb5_authdata_context, _krb5_context, krb5_key_st};
    use super::gssapi_h::{OM_uint32, gss_OID_desc, gss_qop_t};
    use super::stddef_h::size_t;
    use super::stdint_uintn_h::uint64_t;
    ...
    extern "C" {
        ...
        pub fn kg_get_seq_num(context: krb5_context, key: krb5_key,
                              cksum: *mut libc::c_uchar,
                              buf: *mut libc::c_uchar,
                              direction: *mut libc::c_int,
                              seqnum: *mut krb5_ui_4) -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "284:1"]
        pub fn kg_confounder_size(context: krb5_context,
                                  enctype: krb5_enctype) -> libc::c_int;
        #[no_mangle]
        #[c2rust::src_loc = "316:1"]
        pub fn kg_arcfour_docrypt_iov(context: krb5_context,
                                      keyblock: *const krb5_keyblock,
                                      usage: libc::c_int,
                                      kd_data: *const libc::c_uchar,
                                      kd_data_len: size_t,
        ...
        pub fn gss_krb5int_unseal_v3_iov(context: krb5_context,
                                         minor_status: *mut OM_uint32,
                                         ctx: *mut krb5_gss_ctx_id_rec,
                                         iov: *mut gss_iov_buffer_desc,
                                         iov_count: libc::c_int,
                                         conf_state: *mut libc::c_int,
                                         qop_state: *mut gss_qop_t,
                                         toktype: libc::c_int) -> OM_uint32;
        #[no_mangle]
        ...
        pub fn kg_make_checksum_iov_v1(context: krb5_context,
                                       type_0: krb5_cksumtype,
                                       token_cksum_len: size_t, seq: krb5_key,
                                       enc: krb5_key,
        ...
        pub fn kg_fixup_padding_iov(minor_status: *mut OM_uint32,
                                    iov: *mut gss_iov_buffer_desc,
        ...
        pub fn gss_krb5int_rotate_left(ptr: *mut libc::c_void, bufsiz: size_t,
                                       rc: size_t) -> libc::c_int;
    }
    /* _GSSAPIP_KRB5_H_ */
}
...
pub use self::k5_platform_h::{C2RustUnnamed, C2RustUnnamed_0, C2RustUnnamed_1,
                              store_16_be, store_32_be, load_16_be, k5_bcmp};
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_ui_4, krb5_boolean,
                       ...
                       _krb5_ap_req, krb5_ap_req, _profile_t,
                       _krb5_auth_context, krb5_c_checksum_length,
                       krb5_c_crypto_length, krb5_k_key_keyblock,
                       krb5_free_checksum_contents, krb5_free_keyblock};
...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_ctx_id_t, gss_int32,
                         gss_OID_desc_struct, gss_OID_desc,
                         gss_buffer_desc_struct, gss_buffer_desc, gss_qop_t,
                         gss_ctx_id_struct};
...
pub use self::gssapiP_krb5_h::{sgn_alg, SGN_ALG_HMAC_SHA1_DES3_KD,
                               ...
                               kg_get_seq_num, kg_confounder_size,
                               kg_arcfour_docrypt_iov, kg_decrypt_iov,
                               gss_krb5int_unseal_v3_iov, kg_locate_iov,
                               kg_locate_header_iov, kg_iov_msglen,
                               kg_release_iov, kg_make_checksum_iov_v1,
                               krb5_gss_save_error_info, kg_fixup_padding_iov,
                               kg_allocate_iov, gss_krb5int_rotate_left};
...
unsafe extern "C" fn kg_unseal_v1_iov(mut context: krb5_context,
    ...
    let mut sealalg: libc::c_int = 0;
    let mut signalg: libc::c_int = 0;
    let mut md5cksum: krb5_checksum =
        krb5_checksum{magic: 0,
                      checksum_type: 0,
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut cksum_len: size_t = 0 as libc::c_int as size_t;
    let mut conflen: size_t = 0 as libc::c_int as size_t;
    let mut direction: libc::c_int = 0;
    let mut seqnum: krb5_ui_4 = 0;
    let mut retval: OM_uint32 = 0;
    let mut sumlen: size_t = 0;
    let mut sign_usage: krb5_keyusage = 23 as libc::c_int;
    md5cksum.length = 0 as libc::c_int as libc::c_uint;
    md5cksum.contents = 0 as *mut krb5_octet;
    ...
    if !header.is_null() {
        ...
        __assert_fail(b"header != NULL\x00" as *const u8 as
                      ...
                      (*::std::mem::transmute::<&[u8; 138],
                                                &[libc::c_char; 138]>(b"OM_uint32 kg_unseal_v1_iov(krb5_context, OM_uint32 *, krb5_gss_ctx_id_rec *, gss_iov_buffer_desc *, int, size_t, int *, gss_qop_t *, int)\x00")).as_ptr());
    }
    ...
    if (*header).buffer.length <
           token_wrapper_len.wrapping_add(22 as libc::c_int as libc::c_ulong)
       {
        *minor_status = 0 as libc::c_int as OM_uint32;
        return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    ptr =
        ((*header).buffer.value as
             *mut libc::c_uchar).offset(token_wrapper_len as isize);
    signalg = *ptr.offset(0 as libc::c_int as isize) as libc::c_int;
    signalg |=
        (*ptr.offset(1 as libc::c_int as isize) as libc::c_int) <<
            8 as libc::c_int;
    sealalg = *ptr.offset(2 as libc::c_int as isize) as libc::c_int;
    sealalg |=
        (*ptr.offset(3 as libc::c_int as isize) as libc::c_int) <<
            8 as libc::c_int;
    if *ptr.offset(4 as libc::c_int as isize) as libc::c_int !=
           0xff as libc::c_int ||
    ...
    if toktype != 0x201 as libc::c_int && sealalg != 0xffff as libc::c_int {
        *minor_status = 0 as libc::c_int as OM_uint32;
        return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    if toktype == 0x201 as libc::c_int &&
           !(sealalg == 0xffff as libc::c_int || sealalg == (*ctx).sealalg) {
        *minor_status = 0 as libc::c_int as OM_uint32;
        return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    if (*ctx).sealalg == SEAL_ALG_NONE as libc::c_int &&
           signalg > 1 as libc::c_int ||
    ...
    match signalg {
        17 => {
            cksum_len = 8 as libc::c_int as size_t;
            if toktype != 0x201 as libc::c_int {
                sign_usage = 15 as libc::c_int
            }
        }
        4 => { cksum_len = 20 as libc::c_int as size_t }
        _ => {
            *minor_status = 0 as libc::c_int as OM_uint32;
            return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
        }
    ...
    code =
        kg_get_seq_num(context, (*ctx).seq,
                       ptr.offset(14 as libc::c_int as isize),
                       ptr.offset(6 as libc::c_int as isize), &mut direction,
                       &mut seqnum) as OM_uint32;
    ...
    if toktype == 0x201 as libc::c_int {
        if sealalg != 0xffff as libc::c_int {
            if (*ctx).sealalg == SEAL_ALG_MICROSOFT_RC4 as libc::c_int {
                let mut bigend_seqnum: [libc::c_uchar; 4] = [0; 4];
                let mut enc_key: *mut krb5_keyblock = 0 as *mut krb5_keyblock;
                let mut i: size_t = 0;
                store_32_be(seqnum,
                            bigend_seqnum.as_mut_ptr() as *mut libc::c_void);
                code =
                    krb5_k_key_keyblock(context, (*ctx).enc, &mut enc_key) as
                        OM_uint32;
                if code != 0 as libc::c_int as libc::c_uint {
                    retval =
                    ...
                    if (*enc_key).length == 16 as libc::c_int as libc::c_uint
                       {
                    } else {
                        __assert_fail(b"enc_key->length == 16\x00" as
                    ...
                    while i < (*enc_key).length as libc::c_ulong {
                        let ref mut fresh0 =
                            *((*enc_key).contents as
                                  *mut libc::c_char).offset(i as isize);
                        *fresh0 =
                            (*fresh0 as libc::c_int ^ 0xf0 as libc::c_int) as
                                libc::c_char;
                        i = i.wrapping_add(1)
                    }
                    code =
                        kg_arcfour_docrypt_iov(context, enc_key,
                                               0 as libc::c_int,
                                               &mut *bigend_seqnum.as_mut_ptr().offset(0
                                                                                           as
                                                                                           libc::c_int
                                                                                           as
                                                                                           isize),
                ...
                code =
                    kg_decrypt_iov(context, 0 as libc::c_int,
                                   ((*ctx).gss_flags &
                                        0x1000 as libc::c_int as libc::c_uint
                                        != 0 as libc::c_int as libc::c_uint)
                                       as libc::c_int,
                                   0 as libc::c_int as size_t,
                                   0 as libc::c_int as size_t, (*ctx).enc,
                                   22 as libc::c_int, 0 as *mut libc::c_void,
                                   iov, iov_count) as OM_uint32;
                current_block = 2631791190359682872;
            }
            match current_block {
                    ...
                    if code != 0 as libc::c_int as libc::c_uint {
                        retval =
                            (13 as libc::c_ulong as OM_uint32) <<
                                16 as libc::c_int;
                        current_block = 7397202668667826222;
                    } else { current_block = 10512632378975961025; }
                }
            }
        } else { current_block = 10512632378975961025; }
        match current_block {
            ...
            _ => {
                conflen =
                    kg_confounder_size(context,
                                       (*(*ctx).enc).keyblock.enctype) as
                        size_t;
                current_block = 12961834331865314435;
            }
        }
    } else { current_block = 12961834331865314435; }
    match current_block {
        12961834331865314435 => {
            if (*header).buffer.length !=
                   token_wrapper_len.wrapping_add(14 as libc::c_int as
                                                      libc::c_ulong).wrapping_add(cksum_len).wrapping_add(conflen)
               {
                retval =
                ...
                match signalg {
                    17 => { md5cksum.checksum_type = -(138 as libc::c_int) }
                    4 => { md5cksum.checksum_type = 0xc as libc::c_int }
                    _ => { abort(); }
                }
                code =
                    krb5_c_checksum_length(context, md5cksum.checksum_type,
                                           &mut sumlen) as OM_uint32;
                if code != 0 as libc::c_int as libc::c_uint {
                    retval =
                        (13 as libc::c_ulong as OM_uint32) <<
                            16 as libc::c_int
                } else {
                    md5cksum.length = sumlen as libc::c_uint;
                    /* compute the checksum of the message */
                    code =
                        kg_make_checksum_iov_v1(context,
                                                md5cksum.checksum_type,
                                                cksum_len, (*ctx).seq,
                                                (*ctx).enc, sign_usage, iov,
                                                iov_count, toktype,
                                                &mut md5cksum) as OM_uint32;
                    if code != 0 as libc::c_int as libc::c_uint {
                        retval =
                            (13 as libc::c_ulong as OM_uint32) <<
                                16 as libc::c_int
                        ...
                        match signalg {
                            4 | 17 => {
                                code =
                                    k5_bcmp(md5cksum.contents as
                                                *const libc::c_void,
                                            ptr.offset(14 as libc::c_int as
                                                           isize) as
                                                *const libc::c_void,
                                            cksum_len) as OM_uint32;
                                if code != 0 as libc::c_int as libc::c_uint {
                                    code = 0 as libc::c_int as OM_uint32;
                                    retval =
                                        (6 as libc::c_ulong as OM_uint32) <<
                                            16 as libc::c_int
                                } else {
                                    /*
    ...
    krb5_free_checksum_contents(context, &mut md5cksum);
    *minor_status = code;
    return retval;
}
/*
...
unsafe extern "C" fn kg_unseal_iov_token(mut minor_status: *mut OM_uint32,
                                         mut ctx: *mut krb5_gss_ctx_id_rec,
                                         mut conf_state: *mut libc::c_int,
                                         mut qop_state: *mut gss_qop_t,
                                         mut iov: *mut gss_iov_buffer_desc,
 ...
 -> OM_uint32 {
    ...
    let mut context: krb5_context = (*ctx).k5_context;
    let mut ptr: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut header: gss_iov_buffer_t = 0 as *mut gss_iov_buffer_desc_struct;
    ...
    if (*ctx).gss_flags & 0x1000 as libc::c_int as libc::c_uint ==
           0 as libc::c_int as libc::c_uint && toktype == 0x201 as libc::c_int
       {
        let mut data_length: size_t = 0;
        let mut assoc_data_length: size_t = 0;
        kg_iov_msglen(iov, iov_count, &mut data_length,
                      &mut assoc_data_length);
        input_length =
            (input_length as
                 libc::c_ulong).wrapping_add(data_length.wrapping_sub(assoc_data_length))
                as size_t as size_t;
        if !padding.is_null() {
            input_length =
                (input_length as
                     libc::c_ulong).wrapping_add((*padding).buffer.length) as
                    size_t as size_t
        }
        if !trailer.is_null() {
            input_length =
                (input_length as
                     libc::c_ulong).wrapping_add((*trailer).buffer.length) as
                    size_t as size_t
        }
    }
    code =
        gssint_g_verify_token_header((*ctx).mech_used, &mut bodysize,
                                     &mut ptr, -(1 as libc::c_int),
    ...
    if bodysize < 2 as libc::c_int as libc::c_uint {
        *minor_status = -(2045022964 as libc::c_long) as OM_uint32;
        return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    toktype2 = load_16_be(ptr as *const libc::c_void) as libc::c_int;
    ptr = ptr.offset(2 as libc::c_int as isize);
    bodysize = bodysize.wrapping_sub(2 as libc::c_int as libc::c_uint);
    match toktype2 {
        1028 | 1284 | 1029 => {
            code =
                gss_krb5int_unseal_v3_iov(context, minor_status, ctx, iov,
                                          iov_count, conf_state, qop_state,
                                          toktype) as krb5_error_code
        }
        257 | 513 | 258 => {
            code =
                kg_unseal_v1_iov(context, minor_status, ctx, iov, iov_count,
                                 ptr.wrapping_offset_from((*header).buffer.value
                                                              as
                                                              *mut libc::c_uchar)
                                     as libc::c_long as size_t, conf_state,
                                 qop_state, toktype) as krb5_error_code
        }
        _ => {
            *minor_status = -(2045022964 as libc::c_long) as OM_uint32;
            code =
                ((9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int) as
                    krb5_error_code
        }
    }
    if code != 0 as libc::c_int {
...
unsafe extern "C" fn kg_unseal_stream_iov(mut minor_status: *mut OM_uint32,
                                          mut ctx: *mut krb5_gss_ctx_id_rec,
                                          mut conf_state: *mut libc::c_int,
                                          mut qop_state: *mut gss_qop_t,
                                          mut iov: *mut gss_iov_buffer_desc,
 ...
 -> OM_uint32 {
    ...
    let mut ptr: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut bodysize: libc::c_uint = 0;
    let mut code: OM_uint32 = 0 as libc::c_int as OM_uint32;
    let mut major_status: OM_uint32 =
        (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int;
    let mut context: krb5_context = (*ctx).k5_context;
    let mut conf_req_flag: libc::c_int = 0;
    let mut toktype2: libc::c_int = 0;
    let mut i: libc::c_int = 0 as libc::c_int;
    let mut j: libc::c_int = 0;
    let mut tiov: *mut gss_iov_buffer_desc = 0 as *mut gss_iov_buffer_desc;
    let mut stream: gss_iov_buffer_t = 0 as *mut gss_iov_buffer_desc_struct;
    let mut data: gss_iov_buffer_t = 0 as gss_iov_buffer_t;
    let mut theader: gss_iov_buffer_t = 0 as *mut gss_iov_buffer_desc_struct;
    let mut tdata: gss_iov_buffer_t = 0 as gss_iov_buffer_t;
    let mut tpadding: gss_iov_buffer_t = 0 as *mut gss_iov_buffer_desc_struct;
    let mut ttrailer: gss_iov_buffer_t = 0 as *mut gss_iov_buffer_desc_struct;
    if toktype == 0x201 as libc::c_int {
    } else {
        __assert_fail(b"toktype == KG_TOK_WRAP_MSG\x00" as *const u8 as
                          *const libc::c_char,
                      b"k5unsealiov.c\x00" as *const u8 as
                          *const libc::c_char,
                      386 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 120],
                                                &[libc::c_char; 120]>(b"OM_uint32 kg_unseal_stream_iov(OM_uint32 *, krb5_gss_ctx_id_rec *, int *, gss_qop_t *, gss_iov_buffer_desc *, int, int)\x00")).as_ptr());
    }
    if toktype != 0x201 as libc::c_int ||
           (*ctx).gss_flags & 0x1000 as libc::c_int as libc::c_uint != 0 {
        code = 22 as libc::c_int as OM_uint32
    } else {
        stream =
            kg_locate_iov(iov, iov_count, 10 as libc::c_int as OM_uint32);
        if !stream.is_null() {
        } else {
        ...
        ptr = (*stream).buffer.value as *mut libc::c_uchar;
        code =
            gssint_g_verify_token_header((*ctx).mech_used, &mut bodysize,
                                         &mut ptr, -(1 as libc::c_int),
                                         (*stream).buffer.length as
        ...
        if code != 0 as libc::c_int as libc::c_uint {
            ...
            ptr = ptr.offset(2 as libc::c_int as isize);
            bodysize =
                bodysize.wrapping_sub(2 as libc::c_int as libc::c_uint);
            tiov =
                calloc((iov_count as
                            size_t).wrapping_add(2 as libc::c_int as
                                                     libc::c_ulong),
                       ::std::mem::size_of::<gss_iov_buffer_desc>() as
                           libc::c_ulong) as *mut gss_iov_buffer_desc;
            if tiov.is_null() {
                code = 12 as libc::c_int as OM_uint32
            } else {
                /* HEADER */
                let fresh1 = i;
                i = i + 1;
                theader =
                    &mut *tiov.offset(fresh1 as isize) as
                        *mut gss_iov_buffer_desc;
                (*theader).type_0 = 2 as libc::c_int as OM_uint32;
                (*theader).buffer.value = (*stream).buffer.value;
                (*theader).buffer.length =
                    ptr.wrapping_offset_from((*stream).buffer.value as
                                                 *mut libc::c_uchar) as
                        libc::c_long as size_t;
                if bodysize < 14 as libc::c_int as libc::c_uint ||
                       (*stream).buffer.length !=
                           (*theader).buffer.length.wrapping_add(bodysize as
                                                                     libc::c_ulong)
                   {
                    major_status =
                        (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
                    ...
                    (*theader).buffer.length =
                        ((*theader).buffer.length as
                             libc::c_ulong).wrapping_add(14 as libc::c_int as
                                                             libc::c_ulong) as
                            size_t as size_t;
                    ...
                    loop  {
                        ...
                        if type_0 == 1 as libc::c_int as libc::c_uint {
                            if !data.is_null() {
                                ...
                                data =
                                    &mut *iov.offset(j as isize) as
                                        *mut gss_iov_buffer_desc;
                                tdata =
                                    &mut *tiov.offset(i as isize) as
                                        *mut gss_iov_buffer_desc
                            }
                        }
                        if type_0 == 1 as libc::c_int as libc::c_uint ||
                            ...
                            let fresh2 = i;
                            i = i + 1;
                            *tiov.offset(fresh2 as isize) =
                                *iov.offset(j as isize)
                        }
                        j += 1
                    }
                    match current_block {
                        ...
                        _ => {
                            if data.is_null() {
                                ...
                                i = i + 1;
                                tpadding =
                                    &mut *tiov.offset(fresh3 as isize) as
                                        *mut gss_iov_buffer_desc;
                                (*tpadding).type_0 =
                                    9 as libc::c_int as OM_uint32;
                                (*tpadding).buffer.length =
                                    0 as libc::c_int as size_t;
                                (*tpadding).buffer.value =
                                    0 as *mut libc::c_void;
                                let fresh4 = i;
                                i = i + 1;
                                ttrailer =
                                    &mut *tiov.offset(fresh4 as isize) as
                                        *mut gss_iov_buffer_desc;
                                (*ttrailer).type_0 =
                                ...
                                match toktype2 {
                                    1028 | 1284 | 1029 => {
                                        ...
                                        let mut k5_headerlen: libc::c_uint =
                                            0 as libc::c_int as libc::c_uint;
                                        let mut k5_trailerlen: libc::c_uint =
                                            0 as libc::c_int as libc::c_uint;
                                        if (*ctx).have_acceptor_subkey() != 0
                                           {
                                            enctype =
                                                (*(*ctx).acceptor_subkey).keyblock.enctype
                                        } else {
                                            enctype =
                                                (*(*ctx).subkey).keyblock.enctype
                                        }
                                        conf_req_flag =
                                            (*ptr.offset(0 as libc::c_int as
                                                             isize) as
                                                 libc::c_int &
                                                 0x2 as libc::c_int !=
                                                 0 as libc::c_int) as
                                        ...
                                        if rrc !=
                                               0 as libc::c_int as
                                                   libc::c_ulong {
                                            if gss_krb5int_rotate_left(((*stream).buffer.value
                                                                            as
                                                                           ...
                                                                           as
                                                                           *mut libc::c_void,
                                                                       (*stream).buffer.length.wrapping_sub(16
                                                                                                                as
                                                                                                                libc::c_int
                                                                                                                as
                                                                                                                libc::c_ulong),
                                                ...
                                                if conf_req_flag != 0 {
                                                    ...
                                                    if code !=
                                                        ...
                                                        (*theader).buffer.length
                                                            ...
                                                            ((*theader).buffer.length
                                                                 as
                                                                 libc::c_ulong).wrapping_add(k5_headerlen
                                                                                                 as
                                                                                                 libc::c_ulong)
                                                                as size_t as
                                                                size_t;
                                                        ...
                                                        if code !=
                                                                   ...
                                                                   libc::c_uint
                                                           {
                                                            ...
                                                            (*ttrailer).buffer.length
                                                                =
                                                                ec.wrapping_add((if conf_req_flag
                                                                                        !=
                                                                                        0
                                                                                    {
                                                                                     16
                                                            ...
                                                            (*ttrailer).buffer.value
                                                                ...
                                                                ((*stream).buffer.value
                                                                     as
                                                                     *mut libc::c_uchar).offset((*stream).buffer.length
                                                                                                    as
                                                                                                    isize).offset(-((*ttrailer).buffer.length
                                                                                                                        as
                                                                                                                        isize))
                                                                    as
                                                                    *mut libc::c_void;
                                    ...
                                    257 | 513 | 258 => {
                                        (*theader).buffer.length =
                                            ((*theader).buffer.length as
                                                 libc::c_ulong).wrapping_add((*ctx).cksum_size.wrapping_add(kg_confounder_size(context,
    ...
    /* GSS: -------GSS-HEADER--------+-DATA--+-PAD-+----------GSS-TRAILER----------*/
                                    /* validate lengths */
                                    {
                                        if (*stream).buffer.length <
                                               (*theader).buffer.length.wrapping_add((*tpadding).buffer.length).wrapping_add((*ttrailer).buffer.length)
                                           {
                                            code =
                                            ...
                                            /* setup data */
                                            (*tdata).buffer.length =
                                                (*stream).buffer.length.wrapping_sub((*ttrailer).buffer.length).wrapping_sub((*tpadding).buffer.length).wrapping_sub((*theader).buffer.length);
                                            if !data.is_null() {
                                            } else {
                                                __assert_fail(b"data != NULL\x00"
                                                                  as *const u8
                                                                  as
                                                                  *const libc::c_char,
                                                              b"k5unsealiov.c\x00"
                                            ...
                                            if (*data).type_0 &
                                                ...
                                                if code !=
                                                    ...
                                                    memcpy((*tdata).buffer.value,
                                                           ((*stream).buffer.value
                                                                as
                                                                *mut libc::c_uchar).offset((*theader).buffer.length
                                                                                               as
                                                                                               isize)
                                                               as
                                                               *const libc::c_void,
                                                ...
                                                _ => {
                                                    if i <=
                                                                   ...
                                                                   libc::c_int
                                                       {
                                                        ...
                                                        __assert_fail(b"i <= iov_count + 2\x00"
                                                                          as
                                                                          *const u8
                                                                          as
                                                                          *const libc::c_char,
    ...
    if !tiov.is_null() { free(tiov as *mut libc::c_void); }
    *minor_status = code;
    return major_status;
}
#[no_mangle]
#[c2rust::src_loc = "586:1"]
pub unsafe extern "C" fn kg_unseal_iov(mut minor_status: *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    if (*ctx).terminated() as libc::c_int != 0 || (*ctx).established() == 0 {
        *minor_status = 39756039 as libc::c_long as OM_uint32;
        return (8 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    if !kg_locate_iov(iov, iov_count,
                      10 as libc::c_int as OM_uint32).is_null() {
        code =
            kg_unseal_stream_iov(minor_status, ctx, conf_state, qop_state,
                                 iov, iov_count, toktype)
    } else {
        code =
            kg_unseal_iov_token(minor_status, ctx, conf_state, qop_state, iov,
                                iov_count, toktype)
    }
    return code;
}
...
pub unsafe extern "C" fn krb5_gss_unwrap_iov(mut minor_status: *mut OM_uint32,
                                             mut context_handle: gss_ctx_id_t,
                                             mut conf_state: *mut libc::c_int,
                                             mut qop_state: *mut gss_qop_t,
                                             mut iov:
 ...
 -> OM_uint32 {
    ...
    major_status =
        kg_unseal_iov(minor_status, context_handle, conf_state, qop_state,
                      iov, iov_count, 0x201 as libc::c_int);
    return major_status;
}
...
pub unsafe extern "C" fn krb5_gss_verify_mic_iov(mut minor_status:
                                                     *mut OM_uint32,
                                                 mut context_handle:
                                                     gss_ctx_id_t,
                                                 mut qop_state:
 ...
 -> OM_uint32 {
    let mut major_status: OM_uint32 = 0;
    major_status =
        kg_unseal_iov(minor_status, context_handle, 0 as *mut libc::c_int,
                      qop_state, iov, iov_count, 0x101 as libc::c_int);
    return major_status;
}
