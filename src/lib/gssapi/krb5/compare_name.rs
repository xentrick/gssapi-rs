...
pub mod gssapiP_krb5_h {
    ...
    use super::krb5_h::{krb5_principal, krb5_context, krb5_boolean,
                        krb5_error_code};
...
pub use self::gssapiP_krb5_h::{_krb5_gss_name_rec, krb5_gss_name_t,
                               kg_compare_name, krb5_gss_init_context};
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
 * Copyright 1993 by OpenVision Technologies, Inc.
 *
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_gss_compare_name(mut minor_status:
                                                   *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    *name_equal =
        kg_compare_name(context, name1 as krb5_gss_name_t,
                        name2 as krb5_gss_name_t) as libc::c_int;
