...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_gss_context_time(mut minor_status:
                                                   *mut OM_uint32,
                                               mut context_handle:
                                                   gss_ctx_id_t,
 ...
 -> OM_uint32 {
    ...
    if (*ctx).initiate() == 0 { lifetime += (*(*ctx).k5_context).clockskew }
    if lifetime <= 0 as libc::c_int {
        *time_rec = 0 as libc::c_int as OM_uint32;
        *minor_status = 0 as libc::c_int as OM_uint32;
        return (12 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    } else {
        *time_rec = lifetime as OM_uint32;
        *minor_status = 0 as libc::c_int as OM_uint32;
