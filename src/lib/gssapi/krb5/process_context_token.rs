...
pub mod gssapiP_krb5_h {
    ...
    use super::gssapi_h::{OM_uint32, gss_OID_desc, gss_ctx_id_struct,
...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_ctx_id_t,
                         ...
                         gss_buffer_desc_struct, gss_buffer_t, gss_qop_t,
                         gss_ctx_id_struct};
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_gss_process_context_token(mut minor_status:
                                                            *mut OM_uint32,
                                                        mut context_handle:
                                                            gss_ctx_id_t,
                                                        mut token_buffer:
 ...
 -> OM_uint32 {
    ...
    majerr =
        kg_unseal(minor_status, context_handle, token_buffer,
                  0 as gss_buffer_t, 0 as *mut libc::c_int,
                  0 as *mut gss_qop_t, 0x102 as libc::c_int);
    if majerr &
    ...
    (*ctx).set_terminated(1 as libc::c_int as libc::c_uint);
