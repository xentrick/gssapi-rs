...
pub mod gssapiP_krb5_h {
    use super::gssapi_h::{gss_OID_set_desc_struct, gss_OID_set};
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "93:26"]
        pub static kg_all_mechs: gss_OID_set;
    }
    /* _GSSAPIP_KRB5_H_ */
}
...
use self::gssapiP_krb5_h::kg_all_mechs;
/* -*- mode: c; indent-tabs-mode: nil -*- */
/*
...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5_gss_indicate_mechs(mut minor_status:
                                                     *mut OM_uint32,
                                                 mut mech_set:
                                                     *mut gss_OID_set)
 -> OM_uint32 {
    return generic_gss_copy_oid_set(minor_status,
                                    kg_all_mechs as *const gss_OID_set_desc,
                                    mech_set);
}
