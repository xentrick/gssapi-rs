...
#[c2rust::header_src = "/usr/include/bits/thread-shared-types.h:55"]
...
#[c2rust::header_src = "/usr/include/bits/pthreadtypes.h:55"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-thread.h:55"]
pub mod k5_thread_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/krb5.h:55"]
pub mod krb5_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-int.h:55"]
pub mod k5_int_h {
    /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-err.h:55"]
pub mod k5_err_h {
    /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/* include/k5-err.h */
/*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-plugin.h:55"]
pub mod k5_plugin_h {
    /* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/profile.h:55"]
pub mod profile_h {
    /*
 * profile.h
 */
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/krb5/authdata_plugin.h:55"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi.h:55"]
pub mod gssapi_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:55"]
pub mod gssapiP_krb5_h {
    ...
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "1077:8"]
    pub struct krb5_gss_set_allowable_enctypes_req {
        pub num_ktypes: OM_uint32,
        pub ktypes: *mut krb5_enctype,
    }
    ...
    use super::gssapi_h::{gss_cred_usage_t, OM_uint32};
    /* _GSSAPIP_KRB5_H_ */
}
...
#[c2rust::header_src = "/usr/include/stdlib.h:55"]
pub mod stdlib_h {
    extern "C" {
        #[no_mangle]
...
#[c2rust::header_src = "/usr/include/assert.h:55"]
pub mod assert_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "67:1"]
...
#[no_mangle]
#[c2rust::src_loc = "63:1"]
pub unsafe extern "C" fn gss_krb5int_set_allowable_enctypes(mut minor_status:
                                                                *mut OM_uint32,
                                                            mut cred_handle:
                                                                *mut gss_cred_id_t,
                                                            desired_oid:
 ...
 -> OM_uint32 {
    ...
    let mut new_ktypes: *mut krb5_enctype = 0 as *mut krb5_enctype;
    let mut major_status: OM_uint32 = 0;
    let mut cred: krb5_gss_cred_id_t = 0 as *mut _krb5_gss_cred_id_rec;
    let mut kerr: krb5_error_code = 0 as libc::c_int;
    let mut req: *mut krb5_gss_set_allowable_enctypes_req =
        0 as *mut krb5_gss_set_allowable_enctypes_req;
    /* Assume a failure */
    *minor_status = 0 as libc::c_int as OM_uint32;
    major_status = (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int;
    if (*value).length ==
           ::std::mem::size_of::<krb5_gss_set_allowable_enctypes_req>() as
               libc::c_ulong {
    } else {
        __assert_fail(b"value->length == sizeof(*req)\x00" as *const u8 as
                      ...
                      (*::std::mem::transmute::<&[u8; 110],
                                                &[libc::c_char; 110]>(b"OM_uint32 gss_krb5int_set_allowable_enctypes(OM_uint32 *, gss_cred_id_t *, const gss_OID, const gss_buffer_t)\x00")).as_ptr());
    }
    req = (*value).value as *mut krb5_gss_set_allowable_enctypes_req;
    ...
    if (*req).ktypes.is_null() {
        ...
        if !(*cred).req_enctypes.is_null() {
            free((*cred).req_enctypes as *mut libc::c_void);
        }
        (*cred).req_enctypes = 0 as *mut krb5_enctype;
    ...
    new_ktypes =
        k5calloc((*req).num_ktypes.wrapping_add(1 as libc::c_int as
                                                    libc::c_uint) as size_t,
                 ::std::mem::size_of::<krb5_enctype>() as libc::c_ulong,
                 &mut kerr) as *mut krb5_enctype;
    if !new_ktypes.is_null() {
        i = 0 as libc::c_int as libc::c_uint;
        j = 0 as libc::c_int as libc::c_uint;
        while i < (*req).num_ktypes && *(*req).ktypes.offset(i as isize) != 0
              {
            if krb5_c_valid_enctype(*(*req).ktypes.offset(i as isize)) != 0 {
                let fresh0 = j;
                j = j.wrapping_add(1);
                *new_ktypes.offset(fresh0 as isize) =
                    *(*req).ktypes.offset(i as isize)
            }
            i = i.wrapping_add(1)
        }
        *new_ktypes.offset(j as isize) = 0 as libc::c_int;
        if j == 0 as libc::c_int as libc::c_uint {
            free(new_ktypes as *mut libc::c_void);
            kerr = -(1765328234 as libc::c_long) as krb5_error_code
        } else {
            k5_mutex_lock(&mut (*cred).lock);
            if !(*cred).req_enctypes.is_null() {
                free((*cred).req_enctypes as *mut libc::c_void);
