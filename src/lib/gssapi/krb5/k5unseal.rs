...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/k5-platform.h:51"]
pub mod k5_platform_h {
    ...
    use super::byteswap_h::{__bswap_32, __bswap_16};
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi.h:51"]
pub mod gssapi_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/generic/gssapiP_generic.h:51"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:51"]
pub mod gssapiP_krb5_h {
    ...
    use super::krb5_h::{krb5_principal, krb5_magic, krb5_key,
                        ...
                        krb5_keyblock, krb5_pointer, krb5_const_pointer};
    ...
    extern "C" {
        ...
        #[no_mangle]
        #[c2rust::src_loc = "323:1"]
        pub fn kg_decrypt(context: krb5_context, key: krb5_key,
        ...
        pub fn gss_krb5int_unseal_token_v3(contextptr: *mut krb5_context,
                                           minor_status: *mut OM_uint32,
                                           ctx: *mut krb5_gss_ctx_id_rec,
                                           ptr: *mut libc::c_uchar,
                                           bodysize: libc::c_uint,
...
#[c2rust::header_src = "/usr/include/bits/byteswap.h:51"]
pub mod byteswap_h {
    #[inline]
    #[c2rust::src_loc = "48:1"]
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi_alloc.h:51"]
...
unsafe extern "C" fn kg_unseal_v1(mut context: krb5_context,
    ...
    let mut conflen: libc::c_int = 0 as libc::c_int;
    let mut signalg: libc::c_int = 0;
    let mut sealalg: libc::c_int = 0;
    let mut bad_pad: libc::c_int = 0 as libc::c_int;
    ...
    let mut cksum_len: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    match signalg {
        17 => {
            cksum_len = 8 as libc::c_int as libc::c_uint;
            if toktype != 0x201 as libc::c_int {
                sign_usage = 15 as libc::c_int
            }
        }
        4 => { cksum_len = 20 as libc::c_int as libc::c_uint }
        _ => {
            *minor_status = 0 as libc::c_int as OM_uint32;
            return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
        }
    }
    if (bodysize as size_t) <
           (14 as libc::c_int as libc::c_uint).wrapping_add(cksum_len) as
               libc::c_ulong {
        *minor_status = 0 as libc::c_int as OM_uint32;
        return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    ...
    if toktype == 0x201 as libc::c_int {
        let mut tmsglen: size_t =
            (bodysize as
                 libc::c_uint).wrapping_sub((14 as libc::c_int as
                                                 libc::c_uint).wrapping_add(cksum_len))
                as size_t;
        if sealalg != 0xffff as libc::c_int {
            plain = malloc(tmsglen) as *mut libc::c_uchar;
            if plain.is_null() {
            ...
            if (*ctx).sealalg == SEAL_ALG_MICROSOFT_RC4 as libc::c_int {
                ...
                code = krb5_k_key_keyblock(context, (*ctx).enc, &mut enc_key);
                if code != 0 {
                ...
                if (*enc_key).length == 16 as libc::c_int as libc::c_uint {
                    ...
                    __assert_fail(b"enc_key->length == 16\x00" as *const u8 as
                                      *const libc::c_char,
                                  b"k5unseal.c\x00" as *const u8 as
                                      *const libc::c_char,
                                  191 as libc::c_int as libc::c_uint,
                                  (*::std::mem::transmute::<&[u8; 25],
                                                            &[libc::c_char; 25]>(b"OM_uint32 kg_unseal_v1()\x00")).as_ptr());
                }
                i = 0 as libc::c_int;
                ...
                code =
                    kg_decrypt(context, (*ctx).enc, 22 as libc::c_int,
                               0 as *mut libc::c_void,
                               ptr.offset(14 as libc::c_int as
                                              isize).offset(cksum_len as
                                                                isize) as
                                   krb5_const_pointer, plain as krb5_pointer,
                               tmsglen as libc::c_uint)
            }
            if code != 0 {
                free(plain as *mut libc::c_void);
                *minor_status = code as OM_uint32;
            ...
            plain =
                ptr.offset(14 as libc::c_int as
                               isize).offset(cksum_len as isize)
        }
        plainlen = tmsglen;
        conflen = kg_confounder_size(context, (*(*ctx).enc).keyblock.enctype);
        if tmsglen < conflen as size_t {
            if sealalg != 0xffff as libc::c_int {
                free(plain as *mut libc::c_void);
            }
            *minor_status = 0 as libc::c_int as OM_uint32;
        ...
        padlen =
            *plain.offset(tmsglen.wrapping_sub(1 as libc::c_int as
                                                   libc::c_ulong) as isize) as
                size_t;
        if tmsglen.wrapping_sub(conflen as libc::c_ulong) < padlen {
            /* Don't error out yet, to avoid padding oracle attacks.  We will
             * treat this as a checksum failure later on. */
            padlen = 0 as libc::c_int as size_t;
            bad_pad = 1 as libc::c_int
        }
        token.length =
            tmsglen.wrapping_sub(conflen as
                                     libc::c_ulong).wrapping_sub(padlen);
        if token.length != 0 {
            ...
            memcpy(token.value,
                   ...
                   token.length);
        } else { token.value = 0 as *mut libc::c_void }
    } else if toktype == 0x101 as libc::c_int {
        token = *message_buffer;
        plain = token.value as *mut libc::c_uchar;
    ...
    if code != 0 { return code as OM_uint32 }
    ...
    match signalg {
        4 | 17 => {
            ...
            data_ptr =
                malloc((8 as libc::c_int as
                            libc::c_ulong).wrapping_add(plainlen)) as
                    *mut libc::c_char;
            if data_ptr.is_null() {
                if sealalg != 0xffff as libc::c_int {
                    free(plain as *mut libc::c_void);
            ...
            memcpy(data_ptr.offset(8 as libc::c_int as isize) as
                       *mut libc::c_void, plain as *const libc::c_void,
                   plainlen);
            plaind.length =
                (8 as libc::c_int as libc::c_ulong).wrapping_add(plainlen) as
                    libc::c_uint;
            plaind.data = data_ptr;
            code =
                krb5_k_make_checksum(context, md5cksum.checksum_type,
                                     (*ctx).seq, sign_usage, &mut plaind,
                                     &mut md5cksum);
            ...
            code =
                k5_bcmp(md5cksum.contents as *const libc::c_void,
                        ptr.offset(14 as libc::c_int as isize) as
                            *const libc::c_void, cksum_len as size_t)
        }
        _ => {
            *minor_status = 0 as libc::c_int as OM_uint32;
            return (9 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    ...
    if sealalg != 0xffff as libc::c_int { free(plain as *mut libc::c_void); }
    /* compare the computed checksum against the transmitted checksum */
    if code != 0 || bad_pad != 0 {
        if toktype == 0x201 as libc::c_int { gssalloc_free(token.value); }
        *minor_status = 0 as libc::c_int as OM_uint32;
        return (6 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    /* It got through unscathed.  Make sure the context is unexpired. */
    if toktype == 0x201 as libc::c_int { *message_buffer = token }
    if !conf_state.is_null() {
        *conf_state = (sealalg != 0xffff as libc::c_int) as libc::c_int
    }
    if !qop_state.is_null() { *qop_state = 0 as libc::c_int as gss_qop_t }
    /* do sequencing checks */
    if (*ctx).initiate() as libc::c_int != 0 &&
           direction != 0xff as libc::c_int ||
           (*ctx).initiate() == 0 && direction != 0 as libc::c_int {
        if toktype == 0x201 as libc::c_int {
            gssalloc_free(token.value);
            (*message_buffer).value = 0 as *mut libc::c_void;
            (*message_buffer).length = 0 as libc::c_int as size_t
    ...
    retval = gssint_g_seqstate_check((*ctx).seqstate, seqnum as uint64_t);
...
pub unsafe extern "C" fn kg_unseal(mut minor_status: *mut OM_uint32,
                                   mut context_handle: gss_ctx_id_t,
                                   mut input_token_buffer: gss_buffer_t,
                                   mut message_buffer: gss_buffer_t,
                                   mut conf_state: *mut libc::c_int,
                                   mut qop_state: *mut gss_qop_t,
                                   mut toktype: libc::c_int) -> OM_uint32 {
    ...
    let mut vfyflags: libc::c_int = 0 as libc::c_int;
    ...
    /* verify the header */
    ptr = (*input_token_buffer).value as *mut libc::c_uchar;
    err =
        gssint_g_verify_token_header((*ctx).mech_used, &mut bodysize,
                                     &mut ptr, -(1 as libc::c_int),
                                     (*input_token_buffer).length as
                                         libc::c_uint, vfyflags);
    if err != 0 {
    ...
    match toktype2 {
        1028 | 1284 | 1029 => {
            ret =
                gss_krb5int_unseal_token_v3(&mut (*ctx).k5_context,
                                            minor_status, ctx, ptr, bodysize,
                                            message_buffer, conf_state,
                                            qop_state, toktype)
        }
        257 | 513 | 258 => {
            ret =
                kg_unseal_v1((*ctx).k5_context, minor_status, ctx, ptr,
                             bodysize as libc::c_int, message_buffer,
    ...
    if ret != 0 as libc::c_int as libc::c_uint {
        krb5_gss_save_error_info(*minor_status, (*ctx).k5_context);
    }
    return ret;
}
/* minor_status */
...
pub unsafe extern "C" fn krb5_gss_unwrap(mut minor_status: *mut OM_uint32,
                                         mut context_handle: gss_ctx_id_t,
                                         ...
                                         mut qop_state: *mut gss_qop_t)
 -> OM_uint32 {
    let mut rstat: OM_uint32 = 0;
    rstat =
        kg_unseal(minor_status, context_handle, input_message_buffer,
...
pub unsafe extern "C" fn krb5_gss_verify_mic(mut minor_status: *mut OM_uint32,
                                             mut context_handle: gss_ctx_id_t,
                                             mut message_buffer: gss_buffer_t,
 ...
 -> OM_uint32 {
    let mut rstat: OM_uint32 = 0;
    rstat =
        kg_unseal(minor_status, context_handle, token_buffer, message_buffer,
                  0 as *mut libc::c_int, qop_state, 0x101 as libc::c_int);
    return rstat;
}
