...
pub use self::gssapi_h::{OM_uint32, gss_uint32, gss_name_t,
                         gss_OID_desc_struct, gss_OID, gss_name_struct};
use self::string_h::memcmp;
use self::gssapi_krb5_h::{gss_mech_krb5, gss_mech_krb5_old};
use self::gssapiP_krb5_h::krb5_gss_duplicate_name;
/* -*- mode: c; indent-tabs-mode: nil -*- */
/*
...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5_gss_canonicalize_name(mut minor_status:
                                                        *mut OM_uint32,
