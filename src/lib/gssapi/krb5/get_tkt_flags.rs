...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/generic/gssapi_ext.h:24"]
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn gss_krb5int_get_tkt_flags(mut minor_status:
                                                       *mut OM_uint32,
                                                   context_handle:
                                                       gss_ctx_id_t,
 ...
 -> OM_uint32 {
    ...
    rep.value = &mut (*ctx).krb_flags as *mut krb5_flags as *mut libc::c_void;
    rep.length = ::std::mem::size_of::<krb5_flags>() as libc::c_ulong;
