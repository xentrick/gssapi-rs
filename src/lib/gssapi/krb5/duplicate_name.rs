...
pub use self::gssapiP_krb5_h::{_krb5_gss_name_rec, krb5_gss_name_t,
                               krb5_gss_save_error_info, kg_duplicate_name,
...
#[no_mangle]
#[c2rust::src_loc = "29:1"]
pub unsafe extern "C" fn krb5_gss_duplicate_name(mut minor_status:
                                                     *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    let mut princ: krb5_gss_name_t = 0 as *mut _krb5_gss_name_rec;
    let mut outprinc: krb5_gss_name_t = 0 as *mut _krb5_gss_name_rec;
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    princ = input_name as krb5_gss_name_t;
    code = kg_duplicate_name(context, princ, &mut outprinc);
    if code != 0 {
        *minor_status = code as OM_uint32;
    ...
    krb5_free_context(context);
    *dest_name = outprinc as gss_name_t;
