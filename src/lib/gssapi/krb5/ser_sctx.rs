 ...
 */
    ...
    use super::krb5_h::{krb5_magic, krb5_enctype, krb5_deltat, krb5_flags,
                        ...
                        krb5_principal_data, krb5_kdc_req, _krb5_auth_context,
                        krb5_authdata, krb5_principal};
    ...
    extern "C" {
        ...
        #[no_mangle]
        #[c2rust::src_loc = "1782:1"]
        pub fn k5_size_authdata_context(kcontext: krb5_context,
                                        context: krb5_authdata_context,
                                        sizep: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1786:1"]
        pub fn k5_externalize_authdata_context(kcontext: krb5_context,
                                               context: krb5_authdata_context,
        ...
        pub fn k5_internalize_authdata_context(kcontext: krb5_context,
                                               ptr:
        ...
        pub fn k5_size_auth_context(auth_context: krb5_auth_context,
                                    sizep: *mut size_t) -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1799:1"]
        pub fn k5_externalize_auth_context(auth_context: krb5_auth_context,
                                           buffer: *mut *mut krb5_octet,
                                           lenremain: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1802:1"]
        pub fn k5_internalize_auth_context(argp: *mut krb5_auth_context,
                                           buffer: *mut *mut krb5_octet,
                                           lenremain: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1806:1"]
        pub fn k5_size_authdata(authdata: *mut krb5_authdata,
                                sizep: *mut size_t) -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1809:1"]
        pub fn k5_externalize_authdata(authdata: *mut krb5_authdata,
                                       buffer: *mut *mut krb5_octet,
                                       lenremain: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1813:1"]
        pub fn k5_internalize_authdata(authdata: *mut *mut krb5_authdata,
                                       buffer: *mut *mut krb5_octet,
                                       lenremain: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1850:1"]
        pub fn k5_size_context(context: krb5_context, sizep: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1853:1"]
        pub fn k5_externalize_context(context: krb5_context,
                                      buffer: *mut *mut krb5_octet,
                                      lenremain: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
        #[c2rust::src_loc = "1857:1"]
        pub fn k5_internalize_context(argp: *mut krb5_context,
                                      buffer: *mut *mut krb5_octet,
                                      lenremain: *mut size_t)
         -> krb5_error_code;
        #[no_mangle]
...
pub mod gssapiP_generic_h {
    ...
    extern "C" {
        ...
        #[no_mangle]
        #[c2rust::src_loc = "180:1"]
        pub fn gssint_g_seqstate_free(state: g_seqnum_state);
        #[no_mangle]
        #[c2rust::src_loc = "181:1"]
        pub fn gssint_g_seqstate_size(state: g_seqnum_state,
                                      sizep: *mut size_t);
        #[no_mangle]
        #[c2rust::src_loc = "182:1"]
        pub fn gssint_g_seqstate_externalize(state: g_seqnum_state,
                                             buf: *mut *mut libc::c_uchar,
                                             lenremain: *mut size_t)
         -> libc::c_long;
        #[no_mangle]
        #[c2rust::src_loc = "184:1"]
        pub fn gssint_g_seqstate_internalize(state_out: *mut g_seqnum_state,
                                             buf: *mut *mut libc::c_uchar,
                                             lenremain: *mut size_t)
         -> libc::c_long;
    }
...
pub use self::types_h::{__uint8_t, __int16_t, __uint16_t, __int32_t,
                        __uint32_t, __int64_t, __uint64_t};
...
pub use self::krb5_h::{krb5_octet, krb5_int16, krb5_ui_2, krb5_int32,
                       ...
                       krb5_kdc_req, _krb5_ap_req, krb5_ap_req, _profile_t,
                       _krb5_auth_context, krb5_k_create_key, krb5_k_free_key,
...
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         ...
                         k5_size_auth_context, k5_externalize_auth_context,
                         k5_internalize_auth_context, k5_size_authdata,
                         k5_externalize_authdata, k5_internalize_authdata,
                         k5_size_context, k5_externalize_context,
                         k5_internalize_context, k5_size_keyblock,
                         k5_externalize_keyblock, k5_internalize_keyblock,
                         k5_size_principal, k5_externalize_principal,
                         k5_internalize_principal, krb5_ser_pack_int32,
                         krb5_ser_unpack_int32, krb5_ser_pack_bytes,
                         krb5_ser_unpack_bytes, krb5int_accessor};
...
pub use self::gssapiP_krb5_h::{_krb5_gss_name_rec, krb5_gss_name_t,
                               ...
                               krb5_gss_ctx_id_t, kg_release_name,
                               kg_init_name};
 ...
 */
#[c2rust::src_loc = "42:1"]
unsafe extern "C" fn kg_oid_externalize(mut oid: gss_OID,
                                        mut buffer: *mut *mut krb5_octet,
                                        mut lenremain: *mut size_t)
 -> krb5_error_code {
    let mut err: krb5_error_code = 0;
    err =
        krb5_ser_pack_int32(-(1760647369 as libc::c_long) as krb5_int32,
                            buffer, lenremain);
    if err != 0 { return err }
    err = krb5_ser_pack_int32((*oid).length as krb5_int32, buffer, lenremain);
    if err != 0 { return err }
    err =
        krb5_ser_pack_bytes((*oid).elements as *mut krb5_octet,
                            (*oid).length as size_t, buffer, lenremain);
    if err != 0 { return err }
    err =
        krb5_ser_pack_int32(-(1760647369 as libc::c_long) as krb5_int32,
                            buffer, lenremain);
...
#[c2rust::src_loc = "62:1"]
unsafe extern "C" fn kg_oid_internalize(mut argp: *mut gss_OID,
                                        mut buffer: *mut *mut krb5_octet,
                                        mut lenremain: *mut size_t)
 -> krb5_error_code {
    ...
    if ibuf as libc::c_long != -(1760647369 as libc::c_long) {
        return 22 as libc::c_int
    }
    oid =
        malloc(::std::mem::size_of::<gss_OID_desc>() as libc::c_ulong) as
            gss_OID;
    if oid.is_null() { return 12 as libc::c_int }
    if krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain) != 0 {
        free(oid as *mut libc::c_void);
        return 22 as libc::c_int
    }
    (*oid).length = ibuf as OM_uint32;
    (*oid).elements = malloc(ibuf as size_t);
    if (*oid).elements.is_null() {
        free(oid as *mut libc::c_void);
        return 12 as libc::c_int
    }
    if krb5_ser_unpack_bytes((*oid).elements as *mut krb5_octet,
                             (*oid).length as size_t, &mut bp, &mut remain) !=
           0 {
        free((*oid).elements);
        free(oid as *mut libc::c_void);
        return 22 as libc::c_int
    ...
    if krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain) != 0 {
        free((*oid).elements); /* For the header and trailer */
        free(oid as *mut libc::c_void);
        return 22 as libc::c_int
    }
    if ibuf as libc::c_long != -(1760647369 as libc::c_long) {
...
unsafe extern "C" fn kg_oid_size(mut oid: gss_OID, mut sizep: *mut size_t)
 -> krb5_error_code {
    ...
    if !oid.is_null() {
        ...
        required =
            (required as
                 libc::c_ulong).wrapping_add((*oid).length as libc::c_ulong)
                as size_t as size_t;
...
#[c2rust::src_loc = "139:1"]
unsafe extern "C" fn kg_seqstate_externalize(mut arg: g_seqnum_state,
                                             mut buffer: *mut *mut krb5_octet,
                                             mut lenremain: *mut size_t)
 -> krb5_error_code {
    let mut err: krb5_error_code = 0;
    err =
        krb5_ser_pack_int32(-(1760647368 as libc::c_long) as krb5_int32,
                            buffer, lenremain);
    if err == 0 as libc::c_int {
        err =
            gssint_g_seqstate_externalize(arg, buffer, lenremain) as
                krb5_error_code
    }
    if err == 0 as libc::c_int {
        err =
...
unsafe extern "C" fn kg_seqstate_internalize(mut argp: *mut g_seqnum_state,
                                             mut buffer: *mut *mut krb5_octet,
                                             mut lenremain: *mut size_t)
 -> krb5_error_code {
    let mut ibuf: krb5_int32 = 0;
    ...
    if ibuf as libc::c_long != -(1760647368 as libc::c_long) {
        return 22 as libc::c_int
    }
    err =
        gssint_g_seqstate_internalize(argp, &mut bp, &mut remain) as
            krb5_error_code;
    if err != 0 { return err }
    /* Read in and check our trailing magic number */
    if krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain) != 0 {
        gssint_g_seqstate_free(*argp); /* For the header and trailer */
        return 22 as libc::c_int
    }
    if ibuf as libc::c_long != -(1760647368 as libc::c_long) {
        gssint_g_seqstate_free(*argp);
        return 22 as libc::c_int
    }
    *buffer = bp;
    *lenremain = remain;
...
#[c2rust::src_loc = "195:1"]
unsafe extern "C" fn kg_seqstate_size(mut arg: g_seqnum_state,
    ...
    if !arg.is_null() {
        required =
            (2 as libc::c_int as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<krb5_int32>()
                                                 as libc::c_ulong);
        gssint_g_seqstate_size(arg, &mut required);
        kret = 0 as libc::c_int;
        *sizep =
            (*sizep as libc::c_ulong).wrapping_add(required) as size_t as
                size_t
...
pub unsafe extern "C" fn kg_ctx_size(mut kcontext: krb5_context,
                                     mut ctx: krb5_gss_ctx_id_t,
                                     mut sizep: *mut size_t)
 -> krb5_error_code {
    let mut kret: krb5_error_code = 0;
    let mut required: size_t = 0;
    ...
    if !ctx.is_null() {
        ...
        required =
            (required as
                 libc::c_ulong).wrapping_add((2 as libc::c_int as
                                                  libc::c_ulong).wrapping_mul(::std::mem::size_of::<int64_t>()
                                                                                  as
                                                                                  libc::c_ulong))
                as size_t as size_t;
        required =
            (required as
                 libc::c_ulong).wrapping_add(::std::mem::size_of::<[libc::c_uchar; 16]>()
                                                 as libc::c_ulong) as size_t
                as size_t;
        kret = 0 as libc::c_int;
        if kret == 0 && !(*ctx).here.is_null() {
            kret = k5_size_principal((*(*ctx).here).princ, &mut required)
        }
        if kret == 0 && !(*ctx).there.is_null() {
            kret = k5_size_principal((*(*ctx).there).princ, &mut required)
        }
        if kret == 0 && !(*ctx).subkey.is_null() {
            kret =
                k5_size_keyblock(&mut (*(*ctx).subkey).keyblock,
                                 &mut required)
        }
        if kret == 0 && !(*ctx).enc.is_null() {
            kret =
                k5_size_keyblock(&mut (*(*ctx).enc).keyblock, &mut required)
        }
        if kret == 0 && !(*ctx).seq.is_null() {
            kret =
                k5_size_keyblock(&mut (*(*ctx).seq).keyblock, &mut required)
        }
        if kret == 0 { kret = kg_oid_size((*ctx).mech_used, &mut required) }
        if kret == 0 && !(*ctx).seqstate.is_null() {
            kret = kg_seqstate_size((*ctx).seqstate, &mut required)
        }
        if kret == 0 {
            kret = k5_size_context((*ctx).k5_context, &mut required)
        }
        if kret == 0 {
            kret = k5_size_auth_context((*ctx).auth_context, &mut required)
        }
        if kret == 0 && !(*ctx).acceptor_subkey.is_null() {
            kret =
                k5_size_keyblock(&mut (*(*ctx).acceptor_subkey).keyblock,
                                 &mut required)
        }
        if kret == 0 && !(*ctx).authdata.is_null() {
            ...
            i = 0 as libc::c_int;
            while kret == 0 &&
                      !(*(*ctx).authdata.offset(i as isize)).is_null() {
                kret =
                    k5_size_authdata(*(*ctx).authdata.offset(i as isize),
                                     &mut required);
                i += 1
            }
        }
        if kret == 0 {
            let mut initiator_name: krb5_gss_name_t =
                0 as *mut _krb5_gss_name_rec;
            initiator_name =
                if (*ctx).initiate() as libc::c_int != 0 {
                    (*ctx).here
                } else { (*ctx).there };
            if !initiator_name.is_null() &&
                   !(*initiator_name).ad_context.is_null() {
                kret =
                    k5_size_authdata_context(kcontext,
...
pub unsafe extern "C" fn kg_ctx_externalize(mut kcontext: krb5_context,
                                            mut ctx: krb5_gss_ctx_id_t,
                                            mut buffer: *mut *mut krb5_octet,
                                            mut lenremain: *mut size_t)
 -> krb5_error_code {
    ...
    if !ctx.is_null() {
        ...
        if kg_ctx_size(kcontext, ctx, &mut required) == 0 &&
               required <= remain {
            /* Our identifier */
            krb5_ser_pack_int32(39756040 as libc::c_long as krb5_int32,
                                &mut bp, &mut remain);
            /* Now static data */
            krb5_ser_pack_int32((*ctx).initiate() as krb5_int32, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).established() as krb5_int32, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).have_acceptor_subkey() as krb5_int32,
                                &mut bp, &mut remain);
            krb5_ser_pack_int32((*ctx).seed_init() as krb5_int32, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).gss_flags as krb5_int32, &mut bp,
                                &mut remain);
            krb5_ser_pack_bytes((*ctx).seed.as_mut_ptr() as *mut krb5_octet,
                                ::std::mem::size_of::<[libc::c_uchar; 16]>()
                                    as libc::c_ulong, &mut bp, &mut remain);
            krb5_ser_pack_int32((*ctx).signalg, &mut bp, &mut remain);
            krb5_ser_pack_int32((*ctx).cksum_size as krb5_int32, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).sealalg, &mut bp, &mut remain);
            krb5_ser_pack_int32((*ctx).krb_times.authtime, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).krb_times.starttime, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).krb_times.endtime, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).krb_times.renew_till, &mut bp,
                                &mut remain);
            krb5_ser_pack_int32((*ctx).krb_flags, &mut bp, &mut remain);
            Some(kaccess.ser_pack_int64.expect("non-null function pointer")).expect("non-null function pointer")((*ctx).seq_send
                                                                                                                     as
                                                                                                                     int64_t,
                                                                                                                 &mut bp,
                                                                                                                 &mut remain);
            Some(kaccess.ser_pack_int64.expect("non-null function pointer")).expect("non-null function pointer")((*ctx).seq_recv
                                                                                                                     as
                                                                                                                     int64_t,
                                                                                                                 &mut bp,
                                                                                                                 &mut remain);
            ...
            if kret == 0 && !(*ctx).mech_used.is_null() {
                kret =
                    kg_oid_externalize((*ctx).mech_used, &mut bp, &mut remain)
            }
            if kret == 0 && !(*ctx).here.is_null() {
                kret =
                    k5_externalize_principal((*(*ctx).here).princ, &mut bp,
                                             &mut remain)
            }
            if kret == 0 && !(*ctx).there.is_null() {
                kret =
                    k5_externalize_principal((*(*ctx).there).princ, &mut bp,
                                             &mut remain)
            }
            if kret == 0 && !(*ctx).subkey.is_null() {
                kret =
                    k5_externalize_keyblock(&mut (*(*ctx).subkey).keyblock,
                                            &mut bp, &mut remain)
            }
            if kret == 0 && !(*ctx).enc.is_null() {
                kret =
                    k5_externalize_keyblock(&mut (*(*ctx).enc).keyblock,
                                            &mut bp, &mut remain)
            }
            if kret == 0 && !(*ctx).seq.is_null() {
                kret =
                    k5_externalize_keyblock(&mut (*(*ctx).seq).keyblock,
                                            &mut bp, &mut remain)
            }
            if kret == 0 && !(*ctx).seqstate.is_null() {
                kret =
                    kg_seqstate_externalize((*ctx).seqstate, &mut bp,
                                            &mut remain)
            }
            if kret == 0 {
                kret =
                    k5_externalize_context((*ctx).k5_context, &mut bp,
                                           &mut remain)
            }
            if kret == 0 {
                kret =
                    k5_externalize_auth_context((*ctx).auth_context, &mut bp,
                                                &mut remain)
            }
            if kret == 0 {
                kret = krb5_ser_pack_int32((*ctx).proto, &mut bp, &mut remain)
            }
            if kret == 0 {
                kret =
                    krb5_ser_pack_int32((*ctx).cksumtype, &mut bp,
                                        &mut remain)
            }
            if kret == 0 && !(*ctx).acceptor_subkey.is_null() {
                kret =
                    k5_externalize_keyblock(&mut (*(*ctx).acceptor_subkey).keyblock,
                                            &mut bp, &mut remain)
            }
            if kret == 0 {
                kret =
                    krb5_ser_pack_int32((*ctx).acceptor_subkey_cksumtype,
                                        &mut bp, &mut remain)
            }
            if kret == 0 {
                kret =
                    krb5_ser_pack_int32((*ctx).cred_rcache, &mut bp,
                                        &mut remain)
            }
            if kret == 0 {
                let mut i: krb5_int32 = 0 as libc::c_int;
                ...
                /* authdata count */
                kret = krb5_ser_pack_int32(i, &mut bp, &mut remain);
                if kret == 0 && !(*ctx).authdata.is_null() {
                    /* authdata */
                    i = 0 as libc::c_int;
                    while kret == 0 &&
                          ...
                          {
                        kret =
                            k5_externalize_authdata(*(*ctx).authdata.offset(i
                                                                                as
                                                                                isize),
                                                    &mut bp, &mut remain);
                        i += 1
            ...
            if kret == 0 {
                ...
                if !initiator_name.is_null() &&
                       !(*initiator_name).ad_context.is_null() {
                    kret =
                        k5_externalize_authdata_context(kcontext,
                                                        (*initiator_name).ad_context,
                                                        &mut bp, &mut remain)
                }
            }
            ...
            if kret == 0 {
                kret =
                    krb5_ser_pack_int32(39756040 as libc::c_long as
                                            krb5_int32, &mut bp, &mut remain)
            }
            if kret == 0 { *buffer = bp; *lenremain = remain }
        }
    }
    return kret;
}
...
pub unsafe extern "C" fn kg_ctx_internalize(mut kcontext: krb5_context,
                                            mut argp: *mut krb5_gss_ctx_id_t,
                                            mut buffer: *mut *mut krb5_octet,
                                            mut lenremain: *mut size_t)
 -> krb5_error_code {
    let mut kret: krb5_error_code = 0;
    ...
    if ibuf as libc::c_long == 39756040 as libc::c_long {
        kret = 12 as libc::c_int;
        /* Get a context */
        if remain >=
               (17 as libc::c_int as
               ...
               {
                   ctx =
                       malloc(::std::mem::size_of::<krb5_gss_ctx_id_rec>() as
                                  libc::c_ulong) as *mut krb5_gss_ctx_id_rec;
                   !ctx.is_null()
               } {
            memset(ctx as *mut libc::c_void, 0 as libc::c_int,
                   ::std::mem::size_of::<krb5_gss_ctx_id_rec>() as
                       libc::c_ulong);
            (*ctx).magic = ibuf;
            /* Get static data */
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).set_initiate(ibuf as libc::c_uint);
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).set_established(ibuf as libc::c_uint);
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).set_have_acceptor_subkey(ibuf as libc::c_uint);
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).set_seed_init(ibuf as libc::c_uint);
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).gss_flags = ibuf as OM_uint32;
            krb5_ser_unpack_bytes((*ctx).seed.as_mut_ptr() as *mut krb5_octet,
                                  ::std::mem::size_of::<[libc::c_uchar; 16]>()
                                      as libc::c_ulong, &mut bp, &mut remain);
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).signalg = ibuf;
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).cksum_size = ibuf as size_t;
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).sealalg = ibuf;
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            ...
            krb5_ser_unpack_int32(&mut ibuf, &mut bp, &mut remain);
            (*ctx).krb_flags = ibuf;
            Some(kaccess.ser_unpack_int64.expect("non-null function pointer")).expect("non-null function pointer")(&mut (*ctx).seq_send
                                                                                                                       as
                                                                                                                       *mut uint64_t
                                                                                                                       as
                                                                                                                       *mut int64_t,
                                                                                                                   ...
                                                                                                                   &mut remain);
            kret =
                Some(kaccess.ser_unpack_int64.expect("non-null function pointer")).expect("non-null function pointer")(&mut (*ctx).seq_recv
                                                                                                                           as
                                                                                                                           *mut uint64_t
                                                                                                                           as
                                                                                                                           *mut int64_t,
                                                                                                                       &mut bp,
                                                                                                                       &mut remain);
            if kret != 0 { free(ctx as *mut libc::c_void); return kret }
            let mut tmp: gss_OID = 0 as *mut gss_OID_desc_struct;
            kret = kg_oid_internalize(&mut tmp, &mut bp, &mut remain);
            if kret == 0 as libc::c_int {
                (*ctx).mech_used = tmp
            } else if kret == 22 as libc::c_int { kret = 0 as libc::c_int }
            /* Now get substructure data */
            kret = k5_internalize_principal(&mut princ, &mut bp, &mut remain);
            if kret == 0 as libc::c_int {
                kret =
                    kg_init_name(kcontext, princ, 0 as *mut libc::c_char,
                                 0 as *mut libc::c_char,
                                 0 as krb5_authdata_context,
                                 0x1 as libc::c_int, &mut (*ctx).here);
                if kret != 0 { krb5_free_principal(kcontext, princ); }
            } else if kret == 22 as libc::c_int { kret = 0 as libc::c_int }
            if kret == 0 {
                kret =
                    k5_internalize_principal(&mut princ, &mut bp,
                                             &mut remain);
                if kret == 0 as libc::c_int {
                    kret =
                        kg_init_name(kcontext, princ, 0 as *mut libc::c_char,
                                     0 as *mut libc::c_char,
                                     0 as krb5_authdata_context,
                                     0x1 as libc::c_int, &mut (*ctx).there);
                    if kret != 0 { krb5_free_principal(kcontext, princ); }
                } else if kret == 22 as libc::c_int {
                    kret = 0 as libc::c_int
                }
            }
            if kret == 0 &&
                   {
                       kret =
                           intern_key(&mut (*ctx).subkey, &mut bp,
                                      &mut remain);
                       (kret) != 0
                   } {
            ...
            if kret == 0 &&
                   {
                       kret =
                           intern_key(&mut (*ctx).enc, &mut bp, &mut remain);
                       (kret) != 0
                   } {
                if kret == 22 as libc::c_int { kret = 0 as libc::c_int }
            }
            if kret == 0 &&
                   {
                       kret =
                           intern_key(&mut (*ctx).seq, &mut bp, &mut remain);
                       (kret) != 0
                   } {
                if kret == 22 as libc::c_int { kret = 0 as libc::c_int }
            }
            if kret == 0 {
                kret =
                    kg_seqstate_internalize(&mut (*ctx).seqstate, &mut bp,
                                            &mut remain);
                if kret == 22 as libc::c_int { kret = 0 as libc::c_int }
            }
            if kret == 0 {
                kret =
                    k5_internalize_context(&mut (*ctx).k5_context, &mut bp,
                                           &mut remain)
            }
            if kret == 0 {
                kret =
                    k5_internalize_auth_context(&mut (*ctx).auth_context,
                                                &mut bp, &mut remain)
            }
            if kret == 0 {
            ...
            if kret == 0 &&
                   {
                       kret =
                           intern_key(&mut (*ctx).acceptor_subkey, &mut bp,
                                      &mut remain);
                       (kret) != 0
                   } {
                if kret == 22 as libc::c_int { kret = 0 as libc::c_int }
            ...
            if kret == 0 {
                let mut nadata: krb5_int32 = ibuf;
                let mut i: krb5_int32 = 0;
                if nadata > 0 as libc::c_int {
                    (*ctx).authdata =
                        calloc((nadata as
                                    size_t).wrapping_add(1 as libc::c_int as
                                                             libc::c_ulong),
                               ::std::mem::size_of::<*mut krb5_authdata>() as
                                   libc::c_ulong) as *mut *mut krb5_authdata;
                    if (*ctx).authdata.is_null() {
                        kret = 12 as libc::c_int
                    } else {
                        i = 0 as libc::c_int;
                        while kret == 0 && i < nadata {
                            kret =
                                k5_internalize_authdata(&mut *(*ctx).authdata.offset(i
                                                                                         as
                                                                                         isize),
                                                        &mut bp, &mut remain);
                            i += 1
            ...
            if kret == 0 {
                ...
                if initiator_name.is_null() {
                    ...
                    kret =
                        k5_internalize_authdata_context(kcontext,
            ...
            if kret == 0 && ibuf as libc::c_long != 39756040 as libc::c_long {
                kret = 22 as libc::c_int
            }
            if kret == 0 {
                *buffer = bp;
                ...
                *argp = ctx
                ...
                if !(*ctx).there.is_null() {
                    kg_release_name(kcontext, &mut (*ctx).there);
                }
                if !(*ctx).here.is_null() {
                    kg_release_name(kcontext, &mut (*ctx).here);
                }
