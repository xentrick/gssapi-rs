...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/krb5/gssapiP_krb5.h:25"]
pub mod gssapiP_krb5_h {
    use super::k5_int_h::{_krb5_context, krb5_key_st};
    use super::krb5_h::{krb5_context, krb5_key, krb5_pointer,
                        krb5_const_pointer, krb5_error_code, krb5_keyblock};
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_ui_4, krb5_boolean,
                       ...
                       krb5_const_pointer, krb5_post_recv_fn, krb5_context,
                       krb5_pre_send_fn, krb5_trace_callback, krb5_trace_info,
                       _krb5_trace_info, krb5_prompt_type, _krb5_keyblock,
                       krb5_keyblock, krb5_key, _profile_t};
...
use self::gssapiP_krb5_h::{kg_encrypt, kg_arcfour_docrypt, kg_decrypt};
/* -*- mode: c; c-basic-offset: 4; indent-tabs-mode: nil -*- */
/*
...
#[no_mangle]
#[c2rust::src_loc = "32:1"]
pub unsafe extern "C" fn kg_make_seq_num(mut context: krb5_context,
                                         mut key: krb5_key,
                                         mut direction: libc::c_int,
                                         mut seqnum: krb5_ui_4,
                                         mut cksum: *mut libc::c_uchar,
                                         mut buf: *mut libc::c_uchar)
 -> krb5_error_code {
    let mut plain: [libc::c_uchar; 8] = [0; 8];
    plain[4 as libc::c_int as usize] = direction as libc::c_uchar;
    plain[5 as libc::c_int as usize] = direction as libc::c_uchar;
    plain[6 as libc::c_int as usize] = direction as libc::c_uchar;
    plain[7 as libc::c_int as usize] = direction as libc::c_uchar;
    if (*key).keyblock.enctype == 0x17 as libc::c_int ||
           (*key).keyblock.enctype == 0x18 as libc::c_int {
        /* Yes, Microsoft used big-endian sequence number.*/
        store_32_be(seqnum, plain.as_mut_ptr() as *mut libc::c_void);
        return kg_arcfour_docrypt(&mut (*key).keyblock, 0 as libc::c_int,
                                  cksum, 8 as libc::c_int as size_t,
                                  &mut *plain.as_mut_ptr().offset(0 as
                                                                      libc::c_int
                                                                      as
                                                                      isize),
                                  8 as libc::c_int as size_t, buf)
    }
    store_32_le(seqnum, plain.as_mut_ptr() as *mut libc::c_void);
    return kg_encrypt(context, key, 24 as libc::c_int, cksum as krb5_pointer,
                      plain.as_mut_ptr() as krb5_const_pointer,
                      buf as krb5_pointer, 8 as libc::c_int as libc::c_uint);
}
...
#[no_mangle]
#[c2rust::src_loc = "62:1"]
pub unsafe extern "C" fn kg_get_seq_num(mut context: krb5_context,
                                        mut key: krb5_key,
                                        mut cksum: *mut libc::c_uchar,
                                        mut buf: *mut libc::c_uchar,
                                        mut direction: *mut libc::c_int,
                                        mut seqnum: *mut krb5_ui_4)
 -> krb5_error_code {
    ...
    if (*key).keyblock.enctype == 0x17 as libc::c_int ||
           (*key).keyblock.enctype == 0x18 as libc::c_int {
        code =
            kg_arcfour_docrypt(&mut (*key).keyblock, 0 as libc::c_int, cksum,
                               8 as libc::c_int as size_t, buf,
                               8 as libc::c_int as size_t, plain.as_mut_ptr())
    } else {
        code =
            kg_decrypt(context, key, 24 as libc::c_int, cksum as krb5_pointer,
                       buf as krb5_const_pointer,
                       plain.as_mut_ptr() as krb5_pointer,
                       8 as libc::c_int as libc::c_uint)
    }
    if code != 0 { return code }
    if plain[4 as libc::c_int as usize] as libc::c_int !=
           plain[5 as libc::c_int as usize] as libc::c_int ||
           plain[4 as libc::c_int as usize] as libc::c_int !=
               plain[6 as libc::c_int as usize] as libc::c_int ||
           plain[4 as libc::c_int as usize] as libc::c_int !=
               plain[7 as libc::c_int as usize] as libc::c_int {
        return 39756043 as libc::c_long as krb5_error_code
    }
    *direction = plain[4 as libc::c_int as usize] as libc::c_int;
    if (*key).keyblock.enctype == 0x17 as libc::c_int ||
           (*key).keyblock.enctype == 0x18 as libc::c_int {
        *seqnum =
            (plain[3 as libc::c_int as usize] as libc::c_int |
                 (plain[2 as libc::c_int as usize] as libc::c_int) <<
                     8 as libc::c_int |
                 (plain[1 as libc::c_int as usize] as libc::c_int) <<
                     16 as libc::c_int |
                 (plain[0 as libc::c_int as usize] as libc::c_int) <<
                     24 as libc::c_int) as krb5_ui_4
    } else {
        *seqnum =
            (plain[0 as libc::c_int as usize] as libc::c_int |
                 (plain[1 as libc::c_int as usize] as libc::c_int) <<
