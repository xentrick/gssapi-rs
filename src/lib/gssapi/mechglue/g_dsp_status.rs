 ...
 */
   ...
   things */
        ...
        pub fn gssint_g_display_com_err_status(minor_status: *mut OM_uint32,
                                               status_value: OM_uint32,
                                               status_string: gss_buffer_t)
         -> OM_uint32;
        #[no_mangle]
        #[c2rust::src_loc = "261:1"]
        pub fn gssint_mecherrmap_get(minor: OM_uint32, mech_oid: gss_OID,
                                     mech_minor: *mut OM_uint32)
         -> libc::c_int;
    }
    /* _GSSAPIP_GENERIC_H_ */
}
...
#[c2rust::header_src = "/usr/include/libintl.h:30"]
pub mod libintl_h {
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "44:1"]
...
pub use self::mglueP_h::{gss_name_struct, gss_cred_id_struct, gss_mechanism,
                         gss_config, gssint_get_mechanism};
...
pub use self::gssapi_alloc_h::{gssalloc_strdup, gssalloc_malloc};
...
pub unsafe extern "C" fn gss_display_status(mut minor_status: *mut OM_uint32,
                                            ...
                                            mut req_mech_type: gss_OID,
                                            mut message_context:
                                                *mut OM_uint32,
                                            mut status_string: gss_buffer_t)
 -> OM_uint32 {
    let mut mech_type: gss_OID = req_mech_type;
    let mut mech: gss_mechanism = 0 as *mut gss_config;
    let mut m_oid: gss_OID_desc =
        {
            let mut init =
    ...
    if minor_status.is_null() || message_context.is_null() ||
           status_string.is_null() {
    ...
    if status_value == 0 as libc::c_int as libc::c_uint {
        (*status_string).value =
            gssalloc_strdup(b"Unknown error\x00" as *const u8 as
    ...
    let mut m_status: OM_uint32 = 0 as libc::c_int as OM_uint32;
    let mut status: OM_uint32 = 0;
    err = gssint_mecherrmap_get(status_value, &mut m_oid, &mut m_status);
    if err != 0 {
        *minor_status = err as OM_uint32;
        *minor_status = gssint_mecherrmap_map_errcode(*minor_status);
        return (5 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    if m_oid.length == 0 as libc::c_int as libc::c_uint {
        /* Magic flag for com_err values.  */
        status =
            gssint_g_display_com_err_status(minor_status, m_status,
                                            status_string);
    ...
    if !mech.is_null() && (*mech).gss_display_status.is_some() {
        let mut r: OM_uint32 = 0;
        r =
            (*mech).gss_display_status.expect("non-null function pointer")(minor_status,
                                                                           status_value,
                                                                           status_type,
                                                                           mech_type,
                                                                           message_context,
...
unsafe extern "C" fn displayMajor(mut status: OM_uint32,
                                  mut msgCtxt: *mut OM_uint32,
                                  mut outStr: gss_buffer_t) -> OM_uint32 {
    let mut oneVal: OM_uint32 = 0;
    let mut mask: OM_uint32 = 0x1 as libc::c_int as OM_uint32;
    let mut currErr: OM_uint32 = 0;
    let mut errStr: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut i: libc::c_int = 0;
    let mut haveErr: libc::c_int = 0 as libc::c_int;
    /* take care of the success value first */
    if status == 0 as libc::c_int as libc::c_uint {
        errStr =
            dgettext(b"mit-krb5\x00" as *const u8 as *const libc::c_char,
                     b"The routine completed successfully\x00" as *const u8 as
                         *const libc::c_char)
    } else if *msgCtxt == 0 as libc::c_int as libc::c_uint &&
                  {
                      oneVal =
                          status &
        ...
        match oneVal {
            16777216 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"A required input parameter could not be read\x00"
            ...
            33554432 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"A required output parameter could not be written\x00"
                                 as *const u8 as *const libc::c_char)
            }
            50331648 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"A parameter was malformed\x00" as *const u8 as
                                 *const libc::c_char)
            }
            _ => {
                errStr =
        ...
        if status & (0o377 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
               != 0 {
            *msgCtxt = 1 as libc::c_int as OM_uint32
        } else {
            oneVal =
                status &
                    (0o177777 as libc::c_ulong as OM_uint32) <<
                        0 as libc::c_int;
            if oneVal != 0 as libc::c_int as libc::c_uint {
                *msgCtxt = oneVal << 1 as libc::c_int
            } else { *msgCtxt = 0 as libc::c_int as OM_uint32 }
        }
    } else if (*msgCtxt == 0 as libc::c_int as libc::c_uint ||
                   *msgCtxt == 1 as libc::c_int as libc::c_uint) &&
                  {
                      oneVal =
                          status &
                              (0o377 as libc::c_ulong as OM_uint32) <<
        ...
        oneVal =
            status &
                (0o177777 as libc::c_ulong as OM_uint32) << 0 as libc::c_int;
        if oneVal != 0 as libc::c_int as libc::c_uint {
            *msgCtxt = oneVal << 1 as libc::c_int
        } else { *msgCtxt = 0 as libc::c_int as OM_uint32 }
    } else if (*msgCtxt == 0 as libc::c_int as libc::c_uint ||
                   *msgCtxt >= 2 as libc::c_int as libc::c_uint) &&
                  {
                      oneVal =
                          status &
                              (0o177777 as libc::c_ulong as OM_uint32) <<
		 ...
		 */
        if *msgCtxt >= 2 as libc::c_int as libc::c_uint {
            oneVal = *msgCtxt >> 1 as libc::c_int
        } else {
            oneVal =
                status &
                    (0o177777 as libc::c_ulong as OM_uint32) <<
        ...
        while i < 16 as libc::c_int {
            if oneVal & mask != 0 {
                haveErr = 1 as libc::c_int;
                break ;
            } else { mask <<= 1 as libc::c_int; i += 1 }
        }
        /* isolate the bit or if not found set to illegal value */
        if haveErr != 0 {
            currErr = oneVal & mask
        } else {
            currErr = ((1 as libc::c_int) << 17 as libc::c_int) as OM_uint32
        } /* illegal value */
        match currErr {
            1 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"The routine must be called again to complete its function\x00"
                                 as *const u8 as *const libc::c_char)
            }
            2 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"The token was a duplicate of an earlier token\x00"
                                 as *const u8 as *const libc::c_char)
            }
            4 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"The token\'s validity period has expired\x00"
                                 as *const u8 as *const libc::c_char)
            }
            8 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"A later token has already been processed\x00"
                                 as *const u8 as *const libc::c_char)
            }
            16 => {
                errStr =
                    dgettext(b"mit-krb5\x00" as *const u8 as
                                 *const libc::c_char,
                             b"An expected per-message token was not received\x00"
                                 as *const u8 as *const libc::c_char)
            }
            _ => {
                errStr =
		 ...
		 */
        if haveErr == 0 {
            *msgCtxt = 0 as libc::c_int as OM_uint32
        } else if oneVal &
                      (0o177777 as libc::c_ulong as OM_uint32) <<
                          0 as libc::c_int ^ mask != 0 {
            *msgCtxt =
                (oneVal &
                     (0o177777 as libc::c_ulong as OM_uint32) <<
                         0 as libc::c_int ^ mask) << 1 as libc::c_int
        } else { *msgCtxt = 0 as libc::c_int as OM_uint32 }
    }
    if errStr.is_null() {
        errStr =
    ...
    if (*outStr).value.is_null() {
        (*outStr).length = 0 as libc::c_int as size_t;
        return (13 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    return 0 as libc::c_int as OM_uint32;
}
