 ...
 */
        ...
        pub fn gssint_unwrap_aead(_: gss_mechanism, _: *mut OM_uint32,
                                  _: gss_union_ctx_id_t, _: gss_buffer_t,
...
pub use self::mglueP_h::{gss_name_struct, gss_cred_id_struct,
                         ...
                         gss_mechanism, gss_config, gssint_unwrap_aead,
...
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn gss_unwrap(mut minor_status: *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    if input_message_buffer.is_null() ||
           (input_message_buffer.is_null() ||
                (*input_message_buffer).value.is_null() ||
    ...
    if !mech.is_null() {
        if (*mech).gss_unwrap.is_some() {
            status =
                (*mech).gss_unwrap.expect("non-null function pointer")(minor_status,
                                                                       (*ctx).internal_ctx_id,
                                                                       input_message_buffer,
                                                                       output_message_buffer,
                                                                       conf_state,
        ...
        } else if (*mech).gss_unwrap_aead.is_some() ||
                      (*mech).gss_unwrap_iov.is_some() {
            status =
                gssint_unwrap_aead(mech, minor_status, ctx,
                                   input_message_buffer, 0 as gss_buffer_t,
...
pub unsafe extern "C" fn gss_unseal(mut minor_status: *mut OM_uint32,
                                    mut context_handle: gss_ctx_id_t,
                                    mut input_message_buffer: gss_buffer_t,
                                    mut output_message_buffer: gss_buffer_t,
                                    mut conf_state: *mut libc::c_int,
                                    mut qop_state: *mut libc::c_int)
 -> OM_uint32 {
    return gss_unwrap(minor_status, context_handle, input_message_buffer,
                      output_message_buffer, conf_state,
                      qop_state as *mut gss_qop_t);
}
