...
#[no_mangle]
#[c2rust::src_loc = "33:1"]
pub unsafe extern "C" fn gss_export_name_composite(mut minor_status:
                                                       *mut OM_uint32,
                                                   mut name: gss_name_t,
 ...
 -> OM_uint32 {
    ...
    if !exp_composite_name.is_null() {
        ...
        (*exp_composite_name).length = 0 as libc::c_int as size_t
    }
    if minor_status.is_null() {
    ...
    status =
        Some((*mech).gss_export_name_composite.expect("non-null function pointer")).expect("non-null function pointer")(minor_status,
