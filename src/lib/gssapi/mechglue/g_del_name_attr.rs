...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn gss_delete_name_attribute(mut minor_status:
                                                       *mut OM_uint32,
                                                   mut name: gss_name_t,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    if (*mech).gss_delete_name_attribute.is_none() {
        return (16 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    status =
        Some((*mech).gss_delete_name_attribute.expect("non-null function pointer")).expect("non-null function pointer")(minor_status,
