...
/* Internal mechglue routines */
        ...
        pub fn gssint_display_internal_name(_: *mut OM_uint32, _: gss_OID,
 ...
 */
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn val_dsp_name_args(mut minor_status: *mut OM_uint32,
                                       mut input_name: gss_name_t,
                                       mut output_name_buffer: gss_buffer_t,
                                       mut output_name_type: *mut gss_OID)
 -> OM_uint32 {
    /* Initialize outputs. */
...
#[no_mangle]
#[c2rust::src_loc = "72:1"]
pub unsafe extern "C" fn gss_display_name(mut minor_status: *mut OM_uint32,
                                          mut input_name: gss_name_t,
 ...
 -> OM_uint32 {
    ...
    major_status =
        val_dsp_name_args(minor_status, input_name, output_name_buffer,
                          output_name_type);
    ...
    (*output_name_buffer).value =
        gssalloc_malloc((*(*union_name).external_name).length.wrapping_add(1
                                                                               as
                                                                               libc::c_int
                                                                               as
                                                                               libc::c_ulong));
