 ...
 */
#[c2rust::src_loc = "31:1"]
unsafe extern "C" fn val_unwrap_iov_args(mut minor_status: *mut OM_uint32,
...
#[no_mangle]
#[c2rust::src_loc = "61:1"]
pub unsafe extern "C" fn gss_unwrap_iov(mut minor_status: *mut OM_uint32,
                                        mut context_handle: gss_ctx_id_t,
                                        mut conf_state: *mut libc::c_int,
                                        mut qop_state: *mut gss_qop_t,
                                        mut iov: *mut gss_iov_buffer_desc,
 ...
 -> OM_uint32 {
    ...
    status =
        val_unwrap_iov_args(minor_status, context_handle, conf_state,
...
#[no_mangle]
#[c2rust::src_loc = "117:1"]
pub unsafe extern "C" fn gss_verify_mic_iov(mut minor_status: *mut OM_uint32,
                                            mut context_handle: gss_ctx_id_t,
                                            mut qop_state: *mut gss_qop_t,
                                            mut iov: *mut gss_iov_buffer_desc,
                                            mut iov_count: libc::c_int)
 -> OM_uint32 {
    ...
    let mut mech: gss_mechanism = 0 as *mut gss_config;
    status =
        val_unwrap_iov_args(minor_status, context_handle,
                            0 as *mut libc::c_int, qop_state, iov, iov_count);
    if status != 0 as libc::c_int as libc::c_uint { return status }
    ...
    if (*mech).gss_verify_mic_iov.is_none() {
        return (16 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    status =
        (*mech).gss_verify_mic_iov.expect("non-null function pointer")(minor_status,
                                                                       (*ctx).internal_ctx_id,
                                                                       qop_state,
                                                                       iov,
                                                                       iov_count);
