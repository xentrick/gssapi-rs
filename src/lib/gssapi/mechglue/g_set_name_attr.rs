...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn gss_set_name_attribute(mut minor_status:
                                                    *mut OM_uint32,
                                                mut name: gss_name_t,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    status =
        Some((*mech).gss_set_name_attribute.expect("non-null function pointer")).expect("non-null function pointer")(minor_status,
