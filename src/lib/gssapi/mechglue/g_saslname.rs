...
pub use self::types_h::{__int32_t, __uint32_t, __ssize_t};
...
pub use self::gssapi_h::{gss_name_t, gss_OID, gss_OID_desc_struct, OM_uint32,
                         ...
                         gss_indicate_mechs, gss_release_buffer,
                         gss_release_oid_set};
pub use self::krb5_h::{krb5_error_code, krb5_int32, krb5_crypto_iov,
                       _krb5_crypto_iov, krb5_data, _krb5_data, krb5_magic,
                       krb5_cryptotype, krb5_key, krb5_context, krb5_keyusage,
                       krb5_cksumtype, krb5_key_st, _krb5_context,
...
static mut basis_32: [libc::c_char; 33] =
    [65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 81, 82,
     83, 84, 85, 86, 87, 88, 89, 90, 50, 51, 52, 53, 54, 55, 0];
#[c2rust::src_loc = "34:1"]
unsafe extern "C" fn oidToSaslName(mut minor: *mut OM_uint32, mech: gss_OID,
                                   mut sasl_name: *mut libc::c_char)
 -> OM_uint32 {
    let mut derBuf: [libc::c_uchar; 2] = [0; 2];
    ...
    let mut cksumBuf: [libc::c_uchar; 20] = [0; 20];
    let mut q: *mut libc::c_uchar = cksumBuf.as_mut_ptr();
    let mut p: *mut libc::c_char = sasl_name;
    if (*mech).length > 127 as libc::c_int as libc::c_uint {
        *minor = 34 as libc::c_int as OM_uint32;
        return (1 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    derBuf[0 as libc::c_int as usize] = 0x6 as libc::c_int as libc::c_uchar;
    derBuf[1 as libc::c_int as usize] = (*mech).length as libc::c_uchar;
    iov[0 as libc::c_int as usize].flags = 3 as libc::c_int;
    iov[0 as libc::c_int as usize].data.length =
        2 as libc::c_int as libc::c_uint;
    iov[0 as libc::c_int as usize].data.data =
        derBuf.as_mut_ptr() as *mut libc::c_char;
    iov[1 as libc::c_int as usize].flags = 3 as libc::c_int;
    iov[1 as libc::c_int as usize].data.length = (*mech).length;
    iov[1 as libc::c_int as usize].data.data =
        (*mech).elements as *mut libc::c_char;
    iov[2 as libc::c_int as usize].flags = 6 as libc::c_int;
    iov[2 as libc::c_int as usize].data.length =
        ::std::mem::size_of::<[libc::c_uchar; 20]>() as libc::c_ulong as
            libc::c_uint;
    iov[2 as libc::c_int as usize].data.data =
        cksumBuf.as_mut_ptr() as *mut libc::c_char;
    *minor =
        krb5_k_make_checksum_iov(0 as krb5_context, 0x9 as libc::c_int,
                                 0 as krb5_key, 0 as libc::c_int,
                                 iov.as_mut_ptr(), 3 as libc::c_int as size_t)
            as OM_uint32;
    ...
    memcpy(p as *mut libc::c_void,
           b"GS2-\x00" as *const u8 as *const libc::c_char as
               *const libc::c_void, 4 as libc::c_int as libc::c_ulong);
    p = p.offset(4 as libc::c_int as isize);
    let fresh0 = p;
    p = p.offset(1);
    *fresh0 =
        basis_32[(*q.offset(0 as libc::c_int as isize) as libc::c_int >>
    ...
    *fresh1 =
    ...
    p = p.offset(1);
    *fresh2 =
        basis_32[((*q.offset(1 as libc::c_int as isize) as libc::c_int &
                       0x3f as libc::c_int) >> 1 as libc::c_int) as usize];
    let fresh3 = p;
    p = p.offset(1);
    *fresh3 =
        basis_32[((*q.offset(1 as libc::c_int as isize) as libc::c_int &
    ...
    p = p.offset(1);
    *fresh4 =
        basis_32[((*q.offset(2 as libc::c_int as isize) as libc::c_int &
                       0xf as libc::c_int) << 1 as libc::c_int |
                      *q.offset(3 as libc::c_int as isize) as libc::c_int >>
                          7 as libc::c_int) as usize];
    let fresh5 = p;
    p = p.offset(1);
    *fresh5 =
        basis_32[((*q.offset(3 as libc::c_int as isize) as libc::c_int &
                       0x7f as libc::c_int) >> 2 as libc::c_int) as usize];
    let fresh6 = p;
    p = p.offset(1);
    *fresh6 =
        basis_32[((*q.offset(3 as libc::c_int as isize) as libc::c_int &
                       3 as libc::c_int) << 3 as libc::c_int |
                      *q.offset(4 as libc::c_int as isize) as libc::c_int >>
                          5 as libc::c_int) as usize];
    let fresh7 = p;
    p = p.offset(1);
    *fresh7 =
        basis_32[(*q.offset(4 as libc::c_int as isize) as libc::c_int &
                      0x1f as libc::c_int) as usize];
    let fresh8 = p;
    p = p.offset(1);
    *fresh8 =
        basis_32[(*q.offset(5 as libc::c_int as isize) as libc::c_int >>
                      3 as libc::c_int) as usize];
    let fresh9 = p;
    p = p.offset(1);
    *fresh9 =
        basis_32[((*q.offset(5 as libc::c_int as isize) as libc::c_int &
                       7 as libc::c_int) << 2 as libc::c_int |
                      *q.offset(6 as libc::c_int as isize) as libc::c_int >>
                          6 as libc::c_int) as usize];
    let fresh10 = p;
    p = p.offset(1);
    *fresh10 =
        basis_32[((*q.offset(6 as libc::c_int as isize) as libc::c_int &
                       0x3f as libc::c_int) >> 1 as libc::c_int) as usize];
    let fresh11 = p;
    p = p.offset(1);
...
#[c2rust::src_loc = "87:1"]
unsafe extern "C" fn oidToSaslNameAlloc(mut minor: *mut OM_uint32,
                                        mech: gss_OID,
                                        mut sasl_name: gss_buffer_t)
 -> OM_uint32 {
    let mut status: OM_uint32 = 0;
    let mut tmpMinor: OM_uint32 = 0;
    (*sasl_name).value =
        malloc((::std::mem::size_of::<[libc::c_char; 16]>() as
...
pub unsafe extern "C" fn gss_inquire_saslname_for_mech(mut minor_status:
                                                           *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    if !sasl_mech_name.is_null() {
        (*sasl_mech_name).length = 0 as libc::c_int as size_t;
        (*sasl_mech_name).value = 0 as *mut libc::c_void
    }
    if !mech_name.is_null() {
        (*mech_name).length = 0 as libc::c_int as size_t;
        (*mech_name).value = 0 as *mut libc::c_void
    }
    if !mech_description.is_null() {
        (*mech_description).length = 0 as libc::c_int as size_t;
    ...
    mech = gssint_get_mechanism(desired_mech as gss_const_OID);
    if mech.is_null() {
        return (1 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    } else {
        if (*mech).gss_inquire_saslname_for_mech.is_none() {
            ...
            status =
                (*mech).gss_inquire_saslname_for_mech.expect("non-null function pointer")(minor_status,
                                                                                          public_mech,
                                                                                          sasl_mech_name,
                                                                                          mech_name,
                                                                                          mech_description);
...
pub unsafe extern "C" fn gss_inquire_mech_for_saslname(mut minor_status:
                                                           *mut OM_uint32,
                                                       sasl_mech_name:
                                                           gss_buffer_t,
                                                       mut mech_type:
 ...
 -> OM_uint32 {
    let mut status: OM_uint32 = 0;
    let mut tmpMinor: OM_uint32 = 0;
    let mut mechSet: gss_OID_set = 0 as gss_OID_set;
    let mut i: size_t = 0;
    if !minor_status.is_null() {
        *minor_status = 0 as libc::c_int as OM_uint32
    }
    ...
    status = gss_indicate_mechs(minor_status, &mut mechSet);
    if status != 0 as libc::c_int as libc::c_uint { return status }
    i = 0 as libc::c_int as size_t;
    status = (1 as libc::c_ulong as OM_uint32) << 16 as libc::c_int;
    while i < (*mechSet).count {
        let mut mech: gss_mechanism = 0 as *mut gss_config;
        let mut mappedName: [libc::c_char; 16] = [0; 16];
        mech =
            gssint_get_mechanism(&mut *(*mechSet).elements.offset(i as isize)
                                     as *mut gss_OID_desc_struct as
                                     gss_const_OID);
        if !mech.is_null() && (*mech).gss_inquire_mech_for_saslname.is_some()
           {
            status =
                (*mech).gss_inquire_mech_for_saslname.expect("non-null function pointer")(minor_status,
                                                                                          sasl_mech_name,
                                                                                          mech_type);
            if status == 0 as libc::c_int as libc::c_uint { break ; }
        }
        if status == (1 as libc::c_ulong as OM_uint32) << 16 as libc::c_int &&
               (*sasl_mech_name).length ==
                   (::std::mem::size_of::<[libc::c_char; 16]>() as
                        libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                        libc::c_ulong) &&
               oidToSaslName(&mut tmpMinor,
               ...
               memcmp((*sasl_mech_name).value,
                      ...
                      (::std::mem::size_of::<[libc::c_char; 16]>() as
                           libc::c_ulong).wrapping_sub(1 as libc::c_int as
                                                           libc::c_ulong)) ==
                   0 as libc::c_int {
            if !mech_type.is_null() { *mech_type = &mut (*mech).mech_type }
            status = 0 as libc::c_int as OM_uint32;
            break ;
        } else { i = i.wrapping_add(1) }
    }
    gss_release_oid_set(&mut tmpMinor, &mut mechSet);
    return status;
}
