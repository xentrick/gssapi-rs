...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/mechglue/mglueP.h:28"]
pub mod mglueP_h {
 ...
 */
        ...
        pub fn gssint_wrap_aead(_: gss_mechanism, _: *mut OM_uint32,
                                _: gss_union_ctx_id_t, _: libc::c_int,
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi_ext.h:28"]
...
pub use self::mglueP_h::{gss_name_struct, gss_cred_id_struct,
                         ...
                         gss_mechanism, gss_config, gssint_wrap_aead,
 ...
 */
#[c2rust::src_loc = "30:1"]
unsafe extern "C" fn val_wrap_args(mut minor_status: *mut OM_uint32,
...
#[no_mangle]
#[c2rust::src_loc = "66:1"]
pub unsafe extern "C" fn gss_wrap(mut minor_status: *mut OM_uint32,
                                  mut context_handle: gss_ctx_id_t,
                                  mut conf_req_flag: libc::c_int,
                                  mut qop_req: gss_qop_t,
                                  mut input_message_buffer: gss_buffer_t,
 ...
 -> OM_uint32 {
    ...
    if !mech.is_null() {
        if (*mech).gss_wrap.is_some() {
            status =
                (*mech).gss_wrap.expect("non-null function pointer")(minor_status,
                                                                     (*ctx).internal_ctx_id,
                                                                     conf_req_flag,
                                                                     qop_req,
                                                                     input_message_buffer,
            ...
            if status != 0 as libc::c_int as libc::c_uint {
                *minor_status =
                    gssint_mecherrmap_map(*minor_status,
                      ...
                      (*mech).gss_wrap_iov.is_some() &&
                          (*mech).gss_wrap_iov_length.is_some() {
            status =
                gssint_wrap_aead(mech, minor_status, ctx, conf_req_flag,
                                 qop_req, 0 as gss_buffer_t,
                                 input_message_buffer, conf_state,
                                 output_message_buffer)
        } else {
...
pub unsafe extern "C" fn gss_seal(mut minor_status: *mut OM_uint32,
                                  mut context_handle: gss_ctx_id_t,
                                  mut conf_req_flag: libc::c_int,
                                  mut qop_req: libc::c_int,
                                  mut input_message_buffer: gss_buffer_t,
                                  mut conf_state: *mut libc::c_int,
                                  mut output_message_buffer: gss_buffer_t)
 -> OM_uint32 {
    return gss_wrap(minor_status, context_handle, conf_req_flag,
                    qop_req as gss_qop_t, input_message_buffer, conf_state,
                    output_message_buffer);
}
/*
...
unsafe extern "C" fn gssint_wrap_size_limit_iov_shim(mut mech: gss_mechanism,
                                                     mut minor_status:
                                                         *mut OM_uint32,
                                                     mut context_handle:
                                                         gss_ctx_id_t,
 ...
 -> OM_uint32 {
    let mut iov: [gss_iov_buffer_desc; 4] =
        [gss_iov_buffer_desc{type_0: 0,
            ...
            4];
    let mut status: OM_uint32 = 0;
    let mut ohlen: OM_uint32 = 0;
    iov[0 as libc::c_int as usize].type_0 = 2 as libc::c_int as OM_uint32;
    iov[0 as libc::c_int as usize].buffer.value = 0 as *mut libc::c_void;
    iov[0 as libc::c_int as usize].buffer.length = 0 as libc::c_int as size_t;
    iov[1 as libc::c_int as usize].type_0 = 1 as libc::c_int as OM_uint32;
    iov[1 as libc::c_int as usize].buffer.length = req_output_size as size_t;
    iov[1 as libc::c_int as usize].buffer.value = 0 as *mut libc::c_void;
    iov[2 as libc::c_int as usize].type_0 = 9 as libc::c_int as OM_uint32;
    iov[2 as libc::c_int as usize].buffer.value = 0 as *mut libc::c_void;
    iov[2 as libc::c_int as usize].buffer.length = 0 as libc::c_int as size_t;
    iov[3 as libc::c_int as usize].type_0 = 7 as libc::c_int as OM_uint32;
    iov[3 as libc::c_int as usize].buffer.value = 0 as *mut libc::c_void;
    iov[3 as libc::c_int as usize].buffer.length = 0 as libc::c_int as size_t;
    if (*mech).gss_wrap_iov_length.is_some() {
    } else {
        __assert_fail(b"mech->gss_wrap_iov_length\x00" as *const u8 as
                          *const libc::c_char,
                      b"g_seal.c\x00" as *const u8 as *const libc::c_char,
                      181 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 124],
                                                &[libc::c_char; 124]>(b"OM_uint32 gssint_wrap_size_limit_iov_shim(gss_mechanism, OM_uint32 *, gss_ctx_id_t, int, gss_qop_t, OM_uint32, OM_uint32 *)\x00")).as_ptr());
    }
    status =
        (*mech).gss_wrap_iov_length.expect("non-null function pointer")(minor_status,
                                                                        context_handle,
                                                                        conf_req_flag,
                                                                        qop_req,
                                                                        0 as
                                                                            *mut libc::c_int,
                                                                        iov.as_mut_ptr(),
                                                                        (::std::mem::size_of::<[gss_iov_buffer_desc; 4]>()
                                                                             as
                                                                             libc::c_ulong).wrapping_div(::std::mem::size_of::<gss_iov_buffer_desc>()
                                                                                                             as
                                                                                                             libc::c_ulong)
                                                                            as
                                                                            libc::c_int);
    ...
    ohlen =
        iov[0 as libc::c_int as
                usize].buffer.length.wrapping_add(iov[3 as libc::c_int as
                                                          usize].buffer.length)
            as OM_uint32;
    if iov[2 as libc::c_int as usize].buffer.length ==
           0 as libc::c_int as libc::c_ulong && ohlen < req_output_size {
        *max_input_size = req_output_size.wrapping_sub(ohlen)
    } else { *max_input_size = 0 as libc::c_int as OM_uint32 }
    return 0 as libc::c_int as OM_uint32;
}
/* New for V2 */
/* minor_status */
...
pub unsafe extern "C" fn gss_wrap_size_limit(mut minor_status: *mut OM_uint32,
                                             mut context_handle: gss_ctx_id_t,
                                             mut conf_req_flag: libc::c_int,
                                             mut qop_req: gss_qop_t,
                                             mut req_output_size: OM_uint32,
                                             mut max_input_size:
                                                 *mut OM_uint32)
 -> OM_uint32 {
    let mut ctx: gss_union_ctx_id_t = 0 as *mut gss_union_ctx_id_struct;
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    if (*mech).gss_wrap_size_limit.is_some() {
        major_status =
            (*mech).gss_wrap_size_limit.expect("non-null function pointer")(minor_status,
                                                                            (*ctx).internal_ctx_id,
                                                                            conf_req_flag,
                                                                            qop_req,
                                                                            req_output_size,
        ...
        major_status =
            gssint_wrap_size_limit_iov_shim(mech, minor_status,
                                            (*ctx).internal_ctx_id,
                                            conf_req_flag, qop_req,
                                            req_output_size, max_input_size)
    } else {
        major_status = (16 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
