...
pub use self::mglueP_h::{gss_name_struct, gss_cred_id_struct, gss_mechanism,
                         ...
                         gss_union_ctx_id_struct, gssint_get_mechanism};
...
pub use self::gssapi_ext_h::{gss_buffer_set_desc_struct, gss_buffer_set_t,
                             ...
                             gss_iov_buffer_t, gss_const_key_value_set_t,
 ...
 */
#[c2rust::src_loc = "31:1"]
unsafe extern "C" fn val_wrap_iov_args(mut minor_status: *mut OM_uint32,
...
#[no_mangle]
#[c2rust::src_loc = "62:1"]
pub unsafe extern "C" fn gss_wrap_iov(mut minor_status: *mut OM_uint32,
                                      mut context_handle: gss_ctx_id_t,
                                      mut conf_req_flag: libc::c_int,
                                      mut qop_req: gss_qop_t,
                                      mut conf_state: *mut libc::c_int,
 ...
 -> OM_uint32 {
    ...
    status =
        val_wrap_iov_args(minor_status, context_handle, conf_req_flag,
...
#[no_mangle]
#[c2rust::src_loc = "122:1"]
pub unsafe extern "C" fn gss_wrap_iov_length(mut minor_status: *mut OM_uint32,
                                             mut context_handle: gss_ctx_id_t,
                                             mut conf_req_flag: libc::c_int,
                                             mut qop_req: gss_qop_t,
                                             mut conf_state: *mut libc::c_int,
...
pub unsafe extern "C" fn gss_get_mic_iov(mut minor_status: *mut OM_uint32,
                                         mut context_handle: gss_ctx_id_t,
                                         mut qop_req: gss_qop_t,
                                         mut iov: *mut gss_iov_buffer_desc,
                                         mut iov_count: libc::c_int)
 -> OM_uint32 {
    ...
    let mut mech: gss_mechanism = 0 as *mut gss_config;
    status =
        val_wrap_iov_args(minor_status, context_handle, 0 as libc::c_int,
    ...
    status =
        (*mech).gss_get_mic_iov.expect("non-null function pointer")(minor_status,
                                                                    (*ctx).internal_ctx_id,
                                                                    qop_req,
                                                                    iov,
                                                                    iov_count);
...
pub unsafe extern "C" fn gss_get_mic_iov_length(mut minor_status:
                                                    *mut OM_uint32,
                                                mut context_handle:
                                                    gss_ctx_id_t,
                                                mut qop_req: gss_qop_t,
 ...
 -> OM_uint32 {
    ...
    status =
        (*mech).gss_get_mic_iov_length.expect("non-null function pointer")(minor_status,
                                                                           (*ctx).internal_ctx_id,
                                                                           qop_req,
                                                                           iov,
                                                                           iov_count);
...
pub unsafe extern "C" fn gss_release_iov_buffer(mut minor_status:
                                                    *mut OM_uint32,
                                                mut iov:
                                                    *mut gss_iov_buffer_desc,
                                                mut iov_count: libc::c_int)
 -> OM_uint32 {
    ...
    if iov.is_null() { return 0 as libc::c_int as OM_uint32 }
    i = 0 as libc::c_int;
    while i < iov_count {
        if (*iov.offset(i as isize)).type_0 &
            ...
            *fresh0 &= !(0x20000 as libc::c_int) as libc::c_uint
        }
        i += 1
    }
    return status;
