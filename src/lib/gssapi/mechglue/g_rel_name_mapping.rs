...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn gss_release_any_name_mapping(mut minor_status:
                                                          *mut OM_uint32,
                                                      mut name: gss_name_t,
                                                      mut type_id:
                                                          gss_buffer_t,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    if (*mech).gss_release_any_name_mapping.is_none() {
        return (16 as libc::c_ulong as OM_uint32) << 16 as libc::c_int
    }
    status =
        Some((*mech).gss_release_any_name_mapping.expect("non-null function pointer")).expect("non-null function pointer")(minor_status,
