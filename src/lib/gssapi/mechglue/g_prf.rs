...
#[no_mangle]
#[c2rust::src_loc = "29:1"]
pub unsafe extern "C" fn gss_pseudo_random(mut minor_status: *mut OM_uint32,
                                           mut context_handle: gss_ctx_id_t,
                                           mut prf_key: libc::c_int,
                                           prf_in: gss_buffer_t,
                                           mut desired_output_len: ssize_t,
 ...
 -> OM_uint32 {
    ...
    if !mech.is_null() {
        if (*mech).gss_pseudo_random.is_some() {
            status =
                (*mech).gss_pseudo_random.expect("non-null function pointer")(minor_status,
                                                                              (*ctx).internal_ctx_id,
                                                                              prf_key,
                                                                              prf_in,
                                                                              desired_output_len,
