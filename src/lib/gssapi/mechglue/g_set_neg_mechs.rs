...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/gssapi/mechglue/mglueP.h:26"]
pub mod mglueP_h {
...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/include/gssapi/gssapi_ext.h:26"]
...
#[no_mangle]
#[c2rust::src_loc = "28:1"]
pub unsafe extern "C" fn gss_set_neg_mechs(mut minor_status: *mut OM_uint32,
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    ...
    while i < (*union_cred).count {
        ...
        if mech.is_null() {
            ...
            if !(*mech).gss_set_neg_mechs.is_none() {
                ...
                status =
                    (*mech).gss_set_neg_mechs.expect("non-null function pointer")(minor_status,
    ...
    if status == 0 as libc::c_int as libc::c_uint && avail == 0 {
