...
pub unsafe extern "C" fn generic_gss_add_buffer_set_member(mut minor_status:
 ...
 -> OM_uint32 {
    let mut set: gss_buffer_set_t = 0 as *mut gss_buffer_set_desc_struct;
    let mut p: gss_buffer_t = 0 as *mut gss_buffer_desc_struct;
    ...
    (*set).elements =
        gssalloc_realloc((*set).elements as *mut libc::c_void,
                         (*set).count.wrapping_add(1 as libc::c_int as
                                                       libc::c_ulong).wrapping_mul(::std::mem::size_of::<gss_buffer_desc>()
                                                                                       as
                                                                                       libc::c_ulong))
...
pub unsafe extern "C" fn generic_gss_release_buffer_set(mut minor_status:
 ...
 -> OM_uint32 {
    ...
    *minor_status = 0 as libc::c_int as OM_uint32;
    if (*buffer_set).is_null() { return 0 as libc::c_int as OM_uint32 }
    ...
    (**buffer_set).count = 0 as libc::c_int as size_t;
