...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/crypto/builtin/des/des_int.h:28"]
pub mod des_int_h {
    extern "C" {
        /* key_parity.c */
        #[no_mangle]
        #[c2rust::src_loc = "177:1"]
        pub fn mit_des_fixup_key_parity(_: *mut libc::c_uchar);
        /* weak_key.c */
        #[no_mangle]
...
use self::des_int_h::{mit_des_fixup_key_parity, mit_des_is_weak_key};
...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn k5_des_fixup_key_parity(mut keybits:
                                                     *mut libc::c_uchar) {
...
#[no_mangle]
#[c2rust::src_loc = "36:1"]
pub unsafe extern "C" fn k5_des_is_weak_key(mut keybits: *mut libc::c_uchar)
 -> krb5_boolean {
    return mit_des_is_weak_key(keybits) as krb5_boolean;
}
