 ...
 */
#[no_mangle]
#[c2rust::src_loc = "29:22"]
pub static mut krb5int_c_mit_des_zeroblock: mit_des_cblock = [0; 8];
/* = all zero */
#[no_mangle]
#[c2rust::src_loc = "31:1"]
pub unsafe extern "C" fn krb5int_des_cbc_encrypt(mut data:
                                                     *mut krb5_crypto_iov,
...
#[no_mangle]
#[c2rust::src_loc = "70:1"]
pub unsafe extern "C" fn krb5int_des_cbc_decrypt(mut data:
                                                     *mut krb5_crypto_iov,
                                                 mut num_data: libc::c_ulong,
                                                 mut schedule:
                                                     *const des_ks_struct,
    ...
    while k5_iov_cursor_get(&mut cursor, block.as_mut_ptr()) != 0 {
        ...
        while i < 8 as libc::c_int {
            ...
            kp = kp.offset(-1);
            temp2 =
                (left >> 23 as libc::c_int | left << 9 as libc::c_int) ^ *kp;
            right ^=
                des_SP_table[7 as libc::c_int as
                                 usize][(temp2 &
                                             0x3f as libc::c_int as
            ...
            kp = kp.offset(-1);
            temp2 =
                (left >> 11 as libc::c_int | left << 21 as libc::c_int) ^ *kp;
            right ^=
                des_SP_table[3 as libc::c_int as
                                 usize][(temp2 &
                                             0x3f as libc::c_int as
...
pub unsafe extern "C" fn krb5int_des_cbc_mac(mut data: *const krb5_crypto_iov,
                                             mut num_data: libc::c_ulong,
                                             mut schedule:
                                                 *const des_ks_struct,
    ...
    store_32_be(left, out as *mut libc::c_void);
    store_32_be(right,
