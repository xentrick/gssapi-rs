...
#[c2rust::header_src =
  "/home/nmavis/dev/gssapi-rs/code/src/lib/crypto/krb/crypto_int.h:35"]
...
#[no_mangle]
#[c2rust::src_loc = "37:1"]
pub unsafe extern "C" fn krb5_c_init_state(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    return (*(*ktp).enc).init_state.expect("non-null function pointer")(key,
                                                                        keyusage,
                                                                        new_state);
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "49:1"]
pub unsafe extern "C" fn krb5_c_free_state(mut context: krb5_context,
                                           mut key: *const krb5_keyblock,
 ...
 -> krb5_error_code {
    ...
    (*(*ktp).enc).free_state.expect("non-null function pointer")(state);
