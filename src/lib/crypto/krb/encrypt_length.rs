...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_c_encrypt_length(mut context: krb5_context,
                                               mut enctype: krb5_enctype,
                                               mut inputlen: size_t,
                                               mut length: *mut size_t)
 -> krb5_error_code {
    let mut ktp: *const krb5_keytypes = 0 as *const krb5_keytypes;
    let mut header_len: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut padding_len: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut trailer_len: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    *length =
        (header_len as
             libc::c_ulong).wrapping_add(inputlen).wrapping_add(padding_len as
                                                                    libc::c_ulong).wrapping_add(trailer_len
                                                                                                    as
                                                                                                    libc::c_ulong);
