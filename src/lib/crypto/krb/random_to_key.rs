...
pub mod crypto_int_h {
    ...
    extern "C" {
        ...
        pub fn k5_des_fixup_key_parity(keybits: *mut libc::c_uchar);
    }
    /* CRYPTO_INT_H */
}
...
pub use self::crypto_int_h::{rand2key_func, krb5_keytypes, prf_func,
...
#[no_mangle]
#[c2rust::src_loc = "39:1"]
pub unsafe extern "C" fn krb5_c_random_to_key(mut context: krb5_context,
                                              mut enctype: krb5_enctype,
                                              mut random_data: *mut krb5_data,
                                              mut random_key:
                                                  *mut krb5_keyblock)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    let mut ktp: *const krb5_keytypes = 0 as *const krb5_keytypes;
    if random_data.is_null() || random_key.is_null() ||
           (*random_key).contents.is_null() {
    ...
    if (*random_key).length as libc::c_ulong != (*(*ktp).enc).keylength {
        return -(1765328195 as libc::c_long) as krb5_error_code
    }
    ret =
        (*ktp).rand2key.expect("non-null function pointer")(random_data,
                                                            random_key);
    if ret != 0 {
        explicit_bzero((*random_key).contents as *mut libc::c_void,
                       (*random_key).length as size_t);
    }
    return ret;
}
#[no_mangle]
#[c2rust::src_loc = "64:1"]
pub unsafe extern "C" fn k5_rand2key_direct(mut randombits: *const krb5_data,
 ...
 -> krb5_error_code {
    ...
    memcpy((*keyblock).contents as *mut libc::c_void,
           (*randombits).data as *const libc::c_void,
           (*randombits).length as libc::c_ulong);
    return 0 as libc::c_int;
}
#[inline]
#[c2rust::src_loc = "75:1"]
unsafe extern "C" fn eighth_byte(mut b: *mut libc::c_uchar) {
...
#[no_mangle]
#[c2rust::src_loc = "83:1"]
pub unsafe extern "C" fn k5_rand2key_des(mut randombits: *const krb5_data,
                                         mut keyblock: *mut krb5_keyblock)
 -> krb5_error_code {
    if (*randombits).length != 7 as libc::c_int as libc::c_uint {
        return -(1765328206 as libc::c_long) as krb5_error_code
    }
    (*keyblock).magic = -(1760647421 as libc::c_long) as krb5_magic;
...
pub unsafe extern "C" fn k5_rand2key_des3(mut randombits: *const krb5_data,
                                          mut keyblock: *mut krb5_keyblock)
 -> krb5_error_code {
    let mut i: libc::c_int = 0;
    if (*randombits).length != 21 as libc::c_int as libc::c_uint {
        return -(1765328206 as libc::c_long) as krb5_error_code
    }
    (*keyblock).magic = -(1760647421 as libc::c_long) as krb5_magic;
    /* Take the seven bytes, move them around into the top 7 bits of the
    ...
    while i < 3 as libc::c_int {
        memcpy(&mut *(*keyblock).contents.offset((i * 8 as libc::c_int) as
                                                     isize) as *mut krb5_octet
                   as *mut libc::c_void,
               &mut *(*randombits).data.offset((i * 7 as libc::c_int) as
                                                   isize) as *mut libc::c_char
                   as *const libc::c_void, 7 as libc::c_int as libc::c_ulong);
        eighth_byte(&mut *(*keyblock).contents.offset((i * 8 as libc::c_int)
                                                          as isize));
        k5_des_fixup_key_parity(&mut *(*keyblock).contents.offset((i *
                                                                       8 as
                                                                           libc::c_int)
                                                                      as
                                                                      isize));
