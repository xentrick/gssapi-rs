 ...
 */
    ...
    extern "C" {
        #[no_mangle]
        #[c2rust::src_loc = "126:35"]
        pub static krb5int_enctypes_list: [krb5_keytypes; 0];
        #[no_mangle]
        #[c2rust::src_loc = "127:18"]
        pub static krb5int_enctypes_length: libc::c_int;
        #[no_mangle]
...
pub use self::krb5_h::{krb5_octet, krb5_int32, krb5_boolean, krb5_kvno,
                       ...
                       krb5_cryptotype, krb5_flags, krb5_deltat,
                       krb5_error_code, krb5_magic, _krb5_data, krb5_data,
                       krb5_pointer, krb5_const_pointer, krb5_post_recv_fn,
                       ...
                       _krb5_encrypt_block, krb5_encrypt_block,
                       _krb5_checksum, krb5_checksum, _krb5_enc_data,
                       krb5_enc_data, _krb5_crypto_iov, krb5_crypto_iov,
                       _profile_t, krb5_c_encrypt, krb5_c_decrypt,
                       krb5_c_encrypt_length, krb5_c_block_size,
                       krb5_c_make_random_key, krb5_c_random_make_octets,
                       krb5_c_random_seed, krb5_c_string_to_key,
                       krb5_c_make_checksum, krb5_c_verify_checksum,
                       krb5_c_checksum_length, krb5_c_valid_enctype,
...
pub use self::k5_int_h::{_krb5_context, plugin_interface, dns_canonhost,
                         ...
                         make_data, alloc_data, plugin_mapping,
...
pub use self::crypto_int_h::{krb5_enc_provider, krb5_cksumtypes, verify_func,
                             ...
                             crypt_func, crypto_length_func, find_cksumtype,
                             krb5int_enctypes_list, krb5int_enctypes_length,
...
#[no_mangle]
#[c2rust::src_loc = "48:1"]
pub unsafe extern "C" fn krb5_encrypt(mut context: krb5_context,
                                      mut inptr: krb5_const_pointer,
                                      mut outptr: krb5_pointer,
                                      mut size: size_t,
                                      mut eblock: *mut krb5_encrypt_block,
                                      mut ivec: krb5_pointer)
 -> krb5_error_code {
    let mut inputd: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    let mut ivecd: krb5_data =
        krb5_data{magic: 0, length: 0, data: 0 as *mut libc::c_char,};
    ...
    if !ivec.is_null() {
        ret =
            krb5_c_block_size(context, (*(*eblock).key).enctype,
                              &mut blocksize);
        if ret != 0 { return ret }
        ivecd = make_data(ivec, blocksize as libc::c_uint)
    }
    /* size is the length of the input cleartext data. */
    inputd = make_data(inptr as *mut libc::c_void, size as libc::c_uint);
    /*
     * The size of the output buffer isn't part of the old api.  Not too
     * safe.  So, we assume here that it's big enough.
     */
    ret =
        krb5_c_encrypt_length(context, (*(*eblock).key).enctype, size,
                              &mut outlen);
    if ret != 0 { return ret }
    outputd.ciphertext = make_data(outptr, outlen as libc::c_uint);
    return krb5_c_encrypt(context, (*eblock).key, 0 as libc::c_int,
                          if !ivec.is_null() {
                              &mut ivecd
                          } else { 0 as *mut krb5_data }, &mut inputd,
                          &mut outputd);
}
/* * @deprecated Replaced by krb5_c_* API family. */
#[no_mangle]
#[c2rust::src_loc = "83:1"]
pub unsafe extern "C" fn krb5_decrypt(mut context: krb5_context,
                                      mut inptr: krb5_const_pointer,
                                      mut outptr: krb5_pointer,
                                      mut size: size_t,
                                      mut eblock: *mut krb5_encrypt_block,
 ...
 -> krb5_error_code {
    ...
    inputd.ciphertext =
        make_data(inptr as *mut libc::c_void, size as libc::c_uint);
    /* we don't really know how big this is, but the code tends to assume
       ...
       buffer size */
    outputd = make_data(outptr, size as libc::c_uint);
    return krb5_c_decrypt(context, (*eblock).key, 0 as libc::c_int,
                          if !ivec.is_null() {
                              &mut ivecd
                          } else { 0 as *mut krb5_data }, &mut inputd,
                          &mut outputd);
...
pub unsafe extern "C" fn krb5_process_key(mut context: krb5_context,
                                          mut eblock: *mut krb5_encrypt_block,
                                          mut key: *const krb5_keyblock)
 -> krb5_error_code {
    (*eblock).key = key as *mut krb5_keyblock;
    return 0 as libc::c_int;
}
/* * @deprecated Replaced by krb5_c_* API family. */
#[no_mangle]
#[c2rust::src_loc = "123:1"]
pub unsafe extern "C" fn krb5_finish_key(mut context: krb5_context,
                                         mut eblock: *mut krb5_encrypt_block)
 -> krb5_error_code {
    return 0 as libc::c_int;
}
...
pub unsafe extern "C" fn krb5_string_to_key(mut context: krb5_context,
                                            mut eblock:
...
pub unsafe extern "C" fn krb5_init_random_key(mut context: krb5_context,
                                              mut eblock:
                                                  *const krb5_encrypt_block,
                                              mut keyblock:
                                                  *const krb5_keyblock,
                                              mut ptr: *mut krb5_pointer)
 -> krb5_error_code {
    let mut data: krb5_data =
        make_data((*keyblock).contents as *mut libc::c_void,
                  (*keyblock).length);
    return krb5_c_random_seed(context, &mut data);
}
/* * @deprecated Replaced by krb5_c_* API family. */
#[no_mangle]
#[c2rust::src_loc = "147:1"]
pub unsafe extern "C" fn krb5_finish_random_key(mut context: krb5_context,
                                                mut eblock:
                                                    *const krb5_encrypt_block,
                                                mut ptr: *mut krb5_pointer)
 -> krb5_error_code {
...
pub unsafe extern "C" fn krb5_random_key(mut context: krb5_context,
                                         mut eblock:
                                             *const krb5_encrypt_block,
...
pub unsafe extern "C" fn krb5_eblock_enctype(mut context: krb5_context,
                                             mut eblock:
                                                 *const krb5_encrypt_block)
 -> krb5_enctype {
...
#[no_mangle]
#[c2rust::src_loc = "183:1"]
pub unsafe extern "C" fn krb5_use_enctype(mut context: krb5_context,
                                          mut eblock: *mut krb5_encrypt_block,
...
pub unsafe extern "C" fn krb5_encrypt_size(mut length: size_t,
                                           mut crypto: krb5_enctype)
 -> size_t {
    let mut ret: size_t = 0; /* XXX */
    if krb5_c_encrypt_length(0 as krb5_context, crypto, length, &mut ret) != 0
       {
...
pub unsafe extern "C" fn krb5_checksum_size(mut context: krb5_context,
                                            mut ctype: krb5_cksumtype)
 -> size_t {
    let mut ret: size_t = 0; /* XXX */
    if krb5_c_checksum_length(context, ctype, &mut ret) != 0 {
        return -(1 as libc::c_int) as size_t
    }
    return ret;
}
...
unsafe extern "C" fn guess_enctype(mut ctype: krb5_cksumtype)
 -> krb5_enctype {
    let mut ctp: *const krb5_cksumtypes = 0 as *const krb5_cksumtypes;
    let mut i: libc::c_int = 0;
    if ctype == -(138 as libc::c_int) { return 0x17 as libc::c_int }
    ctp = find_cksumtype(ctype);
    if ctp.is_null() || (*ctp).enc.is_null() { return 0 as libc::c_int }
    i = 0 as libc::c_int;
    while i < krb5int_enctypes_length {
        if (*krb5int_enctypes_list.as_ptr().offset(i as isize)).enc ==
               (*ctp).enc {
            return i
        }
        i += 1
...
pub unsafe extern "C" fn krb5_calculate_checksum(mut context: krb5_context,
                                                 mut ctype: krb5_cksumtype,
                                                 mut in_0: krb5_const_pointer,
                                                 mut in_length: size_t,
                                                 mut seed: krb5_const_pointer,
                                                 mut seed_length: size_t,
                                                 mut outcksum:
                                                     *mut krb5_checksum)
 -> krb5_error_code {
    let mut input: krb5_data =
        make_data(in_0 as *mut libc::c_void, in_length as libc::c_uint);
    let mut keyblock: krb5_keyblock =
        krb5_keyblock{magic: 0,
                      enctype: 0,
                      length: 0,
                      contents: 0 as *mut krb5_octet,};
    let mut kptr: *mut krb5_keyblock = 0 as *mut krb5_keyblock;
    let mut ret: krb5_error_code = 0;
    ...
    if !seed.is_null() {
        ...
        keyblock.length = seed_length as libc::c_uint;
        keyblock.contents = seed as *mut libc::c_uchar;
        kptr = &mut keyblock
    }
    ret =
        krb5_c_make_checksum(context, ctype, kptr, 0 as libc::c_int,
                             &mut input, &mut cksum);
    if ret != 0 { return ret }
    if (*outcksum).length < cksum.length {
        memset(cksum.contents as *mut libc::c_void, 0 as libc::c_int,
    ...
    memcpy((*outcksum).contents as *mut libc::c_void,
...
pub unsafe extern "C" fn krb5_verify_checksum(mut context: krb5_context,
                                              mut ctype: krb5_cksumtype,
 ...
 -> krb5_error_code {
    ...
    ret =
        krb5_c_verify_checksum(context, kptr, 0 as libc::c_int, &mut input,
                               cksum, &mut valid);
    if ret != 0 { return ret }
...
pub unsafe extern "C" fn krb5_random_confounder(mut size: size_t,
                                                mut ptr: krb5_pointer)
 -> krb5_error_code {
    let mut random_data: krb5_data = make_data(ptr, size as libc::c_uint);
    return krb5_c_random_make_octets(0 as krb5_context, &mut random_data);
}
#[no_mangle]
#[c2rust::src_loc = "307:1"]
pub unsafe extern "C" fn krb5_encrypt_data(mut context: krb5_context,
                                           mut key: *mut krb5_keyblock,
                                           mut ivec: krb5_pointer,
                                           mut data: *mut krb5_data,
                                           mut enc_data: *mut krb5_enc_data)
 -> krb5_error_code {
    let mut ret: krb5_error_code = 0;
    ...
    ret =
        krb5_c_encrypt_length(context, (*key).enctype,
                              (*data).length as size_t, &mut enclen);
    if ret != 0 { return ret }
    if !ivec.is_null() {
        ret = krb5_c_block_size(context, (*key).enctype, &mut blocksize);
        if ret != 0 { return ret }
        ivecd = make_data(ivec, blocksize as libc::c_uint)
    }
    (*enc_data).magic = -(1760647418 as libc::c_long) as krb5_magic;
    (*enc_data).kvno = 0 as libc::c_int as krb5_kvno;
    (*enc_data).enctype = (*key).enctype;
    ret = alloc_data(&mut (*enc_data).ciphertext, enclen as libc::c_uint);
    if ret != 0 { return ret }
    ret =
        krb5_c_encrypt(context, key, 0 as libc::c_int,
                       if !ivec.is_null() {
                           &mut ivecd
                       } else { 0 as *mut krb5_data }, data, enc_data);
    if ret != 0 { free((*enc_data).ciphertext.data as *mut libc::c_void); }
    return ret;
}
#[no_mangle]
#[c2rust::src_loc = "341:1"]
pub unsafe extern "C" fn krb5_decrypt_data(mut context: krb5_context,
                                           mut key: *mut krb5_keyblock,
                                           mut ivec: krb5_pointer,
                                           mut enc_data: *mut krb5_enc_data,
                                           mut data: *mut krb5_data)
 -> krb5_error_code {
    ...
    if ret != 0 { return ret }
    ret =
        krb5_c_decrypt(context, key, 0 as libc::c_int,
                       if !ivec.is_null() {
                           &mut ivecd
                       } else { 0 as *mut krb5_data }, enc_data, data);
    if ret != 0 { free((*data).data as *mut libc::c_void); }
    return 0 as libc::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "368:1"]
pub unsafe extern "C" fn valid_cksumtype(mut ctype: krb5_cksumtype)
 -> krb5_boolean {
    return krb5_c_valid_cksumtype(ctype);
}
#[no_mangle]
#[c2rust::src_loc = "374:1"]
pub unsafe extern "C" fn is_keyed_cksum(mut ctype: krb5_cksumtype)
 -> krb5_boolean {
    return krb5_c_is_keyed_cksum(ctype);
}
#[no_mangle]
#[c2rust::src_loc = "380:1"]
pub unsafe extern "C" fn is_coll_proof_cksum(mut ctype: krb5_cksumtype)
 -> krb5_boolean {
...
pub unsafe extern "C" fn valid_enctype(mut etype: krb5_enctype)
 -> krb5_boolean {
