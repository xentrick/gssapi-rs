...
pub mod crypto_int_h {
    ...
    extern "C" {
        ...
        pub fn krb5int_c_iov_decrypt_stream(ktp: *const krb5_keytypes,
                                            key: krb5_key,
...
pub use self::crypto_int_h::{krb5_keytypes, prf_func, rand2key_func,
                             ...
                             find_enctype, krb5int_c_iov_decrypt_stream,
...
#[no_mangle]
#[c2rust::src_loc = "29:1"]
pub unsafe extern "C" fn krb5_k_decrypt_iov(mut context: krb5_context,
                                            mut key: krb5_key,
 ...
 -> krb5_error_code {
    ...
    if !krb5int_c_locate_iov(data, num_data, 7 as libc::c_int).is_null() {
        return krb5int_c_iov_decrypt_stream(ktp, key, usage, cipher_state,
                                            data, num_data)
    }
    return (*ktp).decrypt.expect("non-null function pointer")(ktp, key, usage,
                                                              cipher_state,
                                                              data, num_data);
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "49:1"]
pub unsafe extern "C" fn krb5_c_decrypt_iov(mut context: krb5_context,
                                            mut keyblock:
                                                *const krb5_keyblock,
                                            mut usage: krb5_keyusage,
                                            mut cipher_state:
 ...
 -> krb5_error_code {
    ...
    ret =
        krb5_k_decrypt_iov(context, key, usage, cipher_state, data, num_data);
