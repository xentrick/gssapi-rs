...
#[no_mangle]
#[c2rust::src_loc = "30:1"]
pub unsafe extern "C" fn krb5_c_is_keyed_cksum(mut ctype: krb5_cksumtype)
 -> krb5_boolean {
    let mut ctp: *const krb5_cksumtypes = 0 as *const krb5_cksumtypes;
    ctp = find_cksumtype(ctype);
    if ctp.is_null() { return 0 as libc::c_int as krb5_boolean }
    return ((*ctp).flags & 0x1 as libc::c_int == 0) as libc::c_int as
               krb5_boolean;
}
