...
#[no_mangle]
#[c2rust::src_loc = "29:1"]
pub unsafe extern "C" fn krb5_k_encrypt_iov(mut context: krb5_context,
                                            mut key: krb5_key,
 ...
 -> krb5_error_code {
    ...
    return (*ktp).encrypt.expect("non-null function pointer")(ktp, key, usage,
                                                              cipher_state,
                                                              data, num_data);
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "43:1"]
pub unsafe extern "C" fn krb5_c_encrypt_iov(mut context: krb5_context,
                                            mut keyblock:
                                                *const krb5_keyblock,
                                            mut usage: krb5_keyusage,
                                            mut cipher_state:
 ...
 -> krb5_error_code {
    ...
    ret =
        krb5_k_encrypt_iov(context, key, usage, cipher_state, data, num_data);
