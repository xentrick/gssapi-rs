...
#[no_mangle]
#[c2rust::src_loc = "35:1"]
pub unsafe extern "C" fn krb5_c_prf_length(mut context: krb5_context,
 ...
 -> krb5_error_code {
    ...
    if !len.is_null() {
        ...
        __assert_fail(b"len\x00" as *const u8 as *const libc::c_char,
                      b"prf.c\x00" as *const u8 as *const libc::c_char,
                      40 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 72],
                                                &[libc::c_char; 72]>(b"krb5_error_code krb5_c_prf_length(krb5_context, krb5_enctype, size_t *)\x00")).as_ptr());
    }
...
#[no_mangle]
#[c2rust::src_loc = "48:1"]
pub unsafe extern "C" fn krb5_k_prf(mut context: krb5_context,
                                    mut key: krb5_key,
                                    mut input: *mut krb5_data,
 ...
 -> krb5_error_code {
    ...
    if !input.is_null() && !output.is_null() {
        ...
        __assert_fail(b"input && output\x00" as *const u8 as
                          *const libc::c_char,
                      b"prf.c\x00" as *const u8 as *const libc::c_char,
                      55 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 77],
                                                &[libc::c_char; 77]>(b"krb5_error_code krb5_k_prf(krb5_context, krb5_key, krb5_data *, krb5_data *)\x00")).as_ptr());
    }
    if !(*output).data.is_null() {
    } else {
        __assert_fail(b"output->data\x00" as *const u8 as *const libc::c_char,
                      b"prf.c\x00" as *const u8 as *const libc::c_char,
    ...
    (*output).magic = -(1760647422 as libc::c_long) as krb5_magic;
    if (*ktp).prf_length != (*output).length as libc::c_ulong {
        return -(1765328206 as libc::c_long) as krb5_error_code
    }
    ret =
        (*ktp).prf.expect("non-null function pointer")(ktp, key, input,
                                                       output);
    return ret;
}
/* *
...
#[no_mangle]
#[c2rust::src_loc = "71:1"]
pub unsafe extern "C" fn krb5_c_prf(mut context: krb5_context,
