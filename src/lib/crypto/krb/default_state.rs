...
#[no_mangle]
#[c2rust::src_loc = "35:1"]
pub unsafe extern "C" fn krb5int_des_init_state(mut key: *const krb5_keyblock,
                                                mut usage: krb5_keyusage,
                                                mut state_out: *mut krb5_data)
 -> krb5_error_code {
    if alloc_data(state_out, 8 as libc::c_int as libc::c_uint) != 0 {
...
#[no_mangle]
#[c2rust::src_loc = "45:1"]
pub unsafe extern "C" fn krb5int_default_free_state(mut state:
                                                        *mut krb5_data) {
    free((*state).data as *mut libc::c_void);
    *state = empty_data();
}
